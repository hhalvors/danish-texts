...
%      p. 334   +1   Schleiden quoted „Du weißt ... and never closed: there is
%                    no “ anywhere in the gap before "Anfr. Skr."
%      p. 348   +1   Likewise the Lewes citation „antog ... , closed nowhere.
%                                                        ---------
%                    running balance through p. 383:         0
%
%            The zero here is a COINCIDENCE -- two dropped opening marks and
%            two dropped closing marks happen to cancel -- not evidence that
%            the compositor set every mark.
%
...
%  * NUMERAL RANGES follow the printed sort, which differs by type size: at
%    body size the range dash measures the same as the em dash (76--79 px
%    against 76--78 px at 600 dpi, measured on pp. 370 and 380), so it is set
%    ---; in footnote-size type the range sort is visibly shorter (45 px
%    against 55) and is set --.
...
% --- p. 238 ---
\opage{238} % FOLIO MISPRINT: this page's folio is set „233“ instead of „238“ (a 3
...
% --- p. 296 ---
\opage{296} \setcounter{footnote}{0}%
...
% --- p. 327 ---
\opage{327} \setcounter{footnote}{0}%
...
% --- p. 328 ---
\opage{328} \setcounter{footnote}{0}%
Urvæsen erklæres nu rigtignok for et indvortes, ubilledligt og usynligt
Væsen, men bliver just, idet Positiviteten slaaes fast, ved sin dogmatiske
Umiddelbarhed til et udvortes, billedligt og anskueligt Væsen. Den dybe
Skuen, den umiddelbare Idee-Skuen, er i Almindelighed en mystisk-dogmatisk
Skuen af et Negativt-Positivt, et Ubilledligt-Billedligt; det Dybe kjendes
da især derpaa, at den Skuende ikke marker
% PRINTER'S DEFECT: "marker" set with plain a for æ ("mærker"); the a is
% unambiguous at 600 dpi beside the æ of "især" on the same line.
Modsigelsen. Skal den umiddelbare Idee-Skuen faae videnskabelig Betydning,
kan det kun skee derved, at Kritiken ikke blot paaviser, men ogsaa
gjennemreflecterer den fra alle Sider frembrydende Modsigelse. Modsigelsen
er, at det i Naturen Umiddelbare er saa reflecteret; Modsigelsen er, at det
saaledes Reflecterede er saa umiddelbart. Saalidt som den exacte
Uendelighedsanalyse er færdig dermed, at hver endelig Størrelse opfattes som
et Integral af uendelig smaa Størrelser, ligesaa lidt er den dialektiske
Idee-Analyse afsluttet dermed, at det Umiddelbare reflecterer sig i det
Reflecterede; thi de articulerende Mellembestemmelser, som heraf udvikle sig,
ere utallige.

Ideeriget er i Forhold til den ydre, deri begrundede Planteverden et System
af Reflexionsexistenser, indholdsrige Existenserindringer; Ideernes Reflexion
i Individualformernes reflecterede Umiddelbarhed er, som Lysets Klarhed, en
forklaret Umiddelbarhed. I denne Klarhed sees Exemplarexistenserne gjennem
deres Individualideer reflecterede i Artens Idee, Artsideerne med deres
Individualideer reflecterede i Slægtens Idee, Slægtsideerne med deres
Artsideer i Familiens, gjennem Familiens i Ordenens, gjennem Ordenens i
Klassens, gjennem Klassens i Rækkens, gjennem Rækkens concrete, indholdsrige
Idee i Rigets Grundidee, i Dybet.

% Display sub-head, letterspaced in the print, set flush with the paragraph
% indent, exactly as α) Plantelivet. on p. 287; Greek label, so a
% \subsubsection* like the lettered heads.
\subsubsection*{β) Dyrelivet.}

Som organisk Natur er Ideen Liv, og den levende Existens, væsentlig seet, en
Idee-Existens; men Idee-Existensen
% --- p. 329 ---
\opage{329} \setcounter{footnote}{0}%
...
subjectiv Bestaaen ved at concentrere sig til et sig fornemmende Selv, en
Sjæl, og saaledes selvstændiggjør det Ideelle, vinder den tilsvarende
Organisme med det Samme objectiv Bestaaen i et sluttet System af Organer og
Lemmer.

Som orienterende Synspunkter vælge vi: en Sammenstilling af \emph{Dyr og
Plante}; en Betragtning af den dyriske Individualitet, forsaavidt dens
Grundtræk lade sig bestemme ved det almindelige Forhold mellem \emph{Dyr og
Dyrerækker}; endelig et Overblik over Mangfoldigheden af de typisk-teleologiske
Charakterer i \emph{Dyreverdenen}.

αα) \emph{Dyr og Plante.} At angive den kategoriske Forskjel mellem Plante og
Dyr er ingenlunde det Samme som at opregne de Kjendemærker, hvorefter Man i
ethvert Tilfælde vilde være istand til at afgjore,
% "afgjore" with plain o for ø: verified at 600 dpi against the plainly
% slashed ø of "bør" on the next line.
hvorvidt et givet Levende bør henregnes til Plante- eller til Dyreriget. Den
sidste Opgave er af praktisk Interesse og har, hvad de laveste Former angaaer,
som bekjendt, sine store Vanskeligheder\footnote{% printed mark: *)
Den blandt Garverne under Navn af „Troldsmør“ bekjendte \textit{Æthalium
septicum}, som Fries har henregnet til \textit{Myxogasteres} (Sliimsvampe),
har De Bary (Zeitschrift für wissenschaftl. Zool. von Siebold und Kölliker,
10ter Bd. 1860. S. 89--168) nu henregnet til Dyrene (\textit{Mycetozoa}). Af
Sporen fremkommer nemlig et Infusoriet \textit{Euglena} lignende Væsen, der
bevæger sig frit omkring ved Hjælp af eet eller to Svømmehaar, og som har en
eller to pulserende Vacuoler. Efter to til tre Dages Forløb tabes
Svømmehaaret; Kroppen bliver mere rund, Bevægelsen langsommere, og nu seer
Individet ud som en \textit{Amoeba}. Der danner sig nu en grenet Sliimmasse,
der flyder omkring i den fugtige Bark; mange af disse smaa grenede
Sliimstrenge forene sig og danne et Net, o. s. v. Have vi nu her et Dyr eller
en Plante? Af Bevægelserne kan det ikke sees, thi Algernes Sværmsporer have
jo ogsaa Bevægelse; af den indre Bygning kan det heller ikke
% the printed page break of this note falls here (p. 329 | p. 330)
sees; thi vel er her ikke Spor af Nerver, men hos Amoeber, forsaavidt man
antager dem for Dyr, og Rhizopoder opdager man jo heller intet Spor af
Nerver. Det Argument, at en Organisme, der optager fast Stof som Næring, maa
være et Dyr, er i et Tilfælde som det nærværende, hvor Ernæringsprocessen er
saa dunkel, af ingen Betydning. Imod Analogien med Amoeber og Rhizopoder,
hvad Udviklingsmaaden og den saakaldte Sarcodesliim angaaer, staaer en
ligesaa fremherskende Analogie med Svampene.};
% --- p. 330 ---
\opage{330} \setcounter{footnote}{0}%
den første derimod er af reen theoretisk Natur og frembyder aldeles ingen
Vanskelighed. \emph{Dyret har en Sjæl, Planten ikke}; denne Adskillelse er
ligesaa principmæssig som populær.

Altsaa: Dyret er besjælet; men hvad er egentlig en Sjæl? Søge vi det for
Sjælen Eiendommelige deri, at den i sin umiddelbare Existeren er et
fornemmende Væsen\footnote{% printed mark: *)
At de Undersøgelser, hvorved det skal afgjøres, om et organisk Phænomen
bliver at henregne enten under Plante- eller under Dyreriget, tilsidst, naar
Iagttagelsernes Kreds er sluttet, maae beroe paa kategoriske Bestemmelser, og
forsaavidt paa en Fastsættelse af Begreber, er en Selvfølge. --- „Ich mache
ferner darauf aufmerksam, daß die neueren Untersuchungen der niederen
Organismen und alle Grenzstreitigkeiten zwischen Thier- und Pflanzenreich
zwar einerseits zur Einsicht in eine ausserordentlich mannigfache und innige
Berührung beider Reiche, aber andererseits in gleichem Grade zu einer immer
schärferen Auffassung der Grenzlinie und zur bestimmteren Darstellung der
diesen Reichen zu Grunde liegenden Begriffe geführt haben, mögen auch von
manchen Forschern im Widerspruch mit ihren positiven Leistungen Zweifel an
dieser theoretischen Wahrheit in wenig klarer Weise erhoben worden sein.“
A. Wigand. Ueber die Stellung der Myxomycetes zu dem Thier- und
Pflanzenreich. Jahrbücher für wissenschaftl. Botanik. herausg. von
N. Pringsheim. 3ter Band. Berlin 1861. S. 48.}, saa følger heraf en
tredobbelt Opgave: at bestemme, hvad Fornemmelsen er, hvorledes Fornemmelse
forholder sig til Vilkaarlighed, og hvorledes Fornemmelsens og
Vilkaarlighedens
% --- p. 331 ---
\opage{331} \setcounter{footnote}{0}%
...
besjælet\footnote{% printed mark: *)
\textit{Genera ejus plura.} --- siger Plinius \textit{(hist. natur. XXXVII.
12.)} om Ravet --- \textit{Attritu digitorum} \emph{\textit{accepta caloris
anima}} \textit{trahunt in se paleas ...} A. Humboldt. Kosmos overs. 1 Deel.
S. 158. Anm. (S. 105). Jvfr. Aristotel. \textit{De anima I. 2.}}. Naar
Stofferne i den chemiske Proces adskilles og forenes ifølge Valgslægtskabet,
seer det livagtig ud, som om det alligevel var Kjærlighed (φιλία) og Strid
(νεῖκος), Sympathie og Antipathie, altsaa virkelige Fornemmelser,
Tilbøieligheder og Stemninger, hvoraf Elementernes Vexelvirkning væsentlig
fremgik\footnote{% printed mark: **)
Aber Geselligkeit --- siger M. J. Schleiden spøgende --- ist, wie beim
Menschen. so bei den Elementen die erste Stufe der Gesittung;
% PRINTER'S DEFECT: a full stop after "Menschen" where the German requires a
% comma; the mark is a square baseline dot with no tail at 600 dpi, against
% plainly tailed commas in the same line. Transcribed as printed.
% Note also that this quotation is NEVER OPENED with „ in the print.
die verwandtschaftlichen Beziehungen unter den Elementen, wie die Chemie es
sinnig nennt, führen zur Paarung. Die schmutzige Kohle wird in ihrer
...
seiner Ehe mit dem flüchtigen zarten Wasserstoff zum weich sich
anschmiegenden Wasser; dieselbe luftige Fee weiß den grämlichen und
ungeselligen Stickstoff zu fesseln, und siehe da, das flüchtig reizende
Ammoniakgas ist das Kind dieser Verbindung. Oder sage ich lieber so:
Kohlensäure, Wassergas und Ammoniak sind die Seelen des rohen
Elementarlebens; fertig gebildet schwingen
% the printed page break of this note falls here (p. 331 | p. 332)
sie sich zu einem höheren Dasein auf; sie gehen über in die Pflanze, in
welcher für sie ein neuer Läuterungsproceß beginnt. Die Beseelung der
Pflanzen. Studien. Leipzig 1855. S. 149--150.}. Glasset, der klinger,
% --- p. 332 ---
\opage{332} \setcounter{footnote}{0}%
lader jo sin Stemme høre, og gjør ligesom et Forsøg paa at tale. Er
Affectionen en Fornemmelse, hvorfor skulde Lyden da ikke være en Røst? „Alt,
hvad der er til, har Stemme, har Røst, men de ere derefter. Den Stav, der
slaaer paa en Klokke, faaer ogsaa en Fornemmelse af Slaget; den bærer og
zittrer indtil sit Inderste, men den kan ikke faae Noget ud af det; den
ryster og bæver, men Ingen veed deraf, i det Høieste den Haand, som holder
den. Klokken derimod er et ædlere Væsen; den forarbeider Indtrykket, og
svarer med en høi, klar, gjennemtrængende Tone. Indtrykket bliver hos den til
et Udbrud“\footnote{% printed mark: *)
N. M. Petersen. Forelæsn. vedkmd. de nordiske Sprog. Indbydelsesskr. til
Kbhvns Universit. Fest. 1861. S. 5.}.

„Hele Naturen“ --- siger Perty\footnote{% printed mark: **)
Perty. Allgem. Naturgesch. 1 Band. S. 110.} --- „er i strengeste Forstand
levende og besjælet. Alle Forandringer i de enkelte Naturting, forsaavidt de
ikke ere mechaniske, ere et Værk af de dem iboende eller dem udenfra gribende
Kræfter eller Sjæle.“ --- Men, naar Elementærkræfter identificeres med
Sjælekræfter, naar Alt i Naturen lever, og hvert Atom har sin egen Sjæl (thi
ogsaa dette antager Perty, at hvert Atom er en Sjæl\footnote{% printed mark: ***)
Jedes Atom ist ein für sich selbstständig Bestehendes, von einer Seele
Bewegtes --- ist nur diese Seele niederster Art selbst. Anfr. Skr. S. 115.}):
saa kan det naturligviis heller ikke være Tvivl underkastet, at ogsaa Planten
maa have en Sjæl. „Vi antage altsaa, at der ogsaa i Planten er en Sjal.
% PRINTER'S DEFECT: "Sjal" set with plain a for æ, unambiguous at 600 dpi
% against the æ of "Sjæl" twice in the two preceding lines.
Ogsaa Planten har en Virksomhed, der gaaer ud over det Nær\-%
% --- p. 333 ---
\opage{333} \setcounter{footnote}{0}%
værende. Den forfølger et fjernt Maal, og det ikke blot lidende, automatisk,
omtrent som naar Bevægelserne i det optrukne Uhrværk fuldende deres Kredsløb,
men den stræber selvvirksomt, med en vis Frihed i Valget af sine Midler, med
en udholdende, ligesom overlagt Iver imod dette Maal. Den søger at opholde
sig selv, den sætter sig i Modsætning til Omverdenen, den bekjæmper og
beseirer det udenfor liggende Materielle for at tilegne sig det. Den voxer og
formerer sig ved denne Tilegnelse, som den ikke foretager og udfører iblinde,
men med et vist Valg og en vis Omsorg. Under denne bestandige, sig idelig
fornyende Conflict medierer den sig ikke blot en materiel Legemstilvæxt, men
den sørger for Noget, som endnu ikke existerer, for et med den selv Liigt,
som først skal komme, for et Afkom. Den forbereder dette sidste Resultat af
sin mangesidig levende Virksomhed med stor Selvstændighed, Conseqvens og
Hensigtsmæssighed, uddanner det med stor Fuldkommenhed i Functioner, og
knytter saaledes med stille hemmelighedsfuld Varsomhed det Nærværende til en
fjern Fremtid .... Vi gjøre derfor Planten Uret, vi miskjende dens Natur og
Værdighed, naar vi betragte den, som om den ikke ligesaavel som Dyret var
begavet med en til bestemte Virksomheder ledende, ikke udenfra bestemmende,
men samtlige Tilværelsesbetingelser i sig selv bærende, sin organiske Eenhed
fuldendende Urkraft. Dog, jeg troer at have ved disse Ord tilstrækkelig
antydet, at ogsaa den stille, tilsyneladende saa indesluttede og ligesom i
sig nedsænkede Planteverden har en
\emph{Sjæl}“\footnote{% printed mark: *)
K. Ph. v. Martius. Die Seele der Pflanzen. Reden und Vorträge aus dem Gebiete
der Naturforschung. Stuttgart und Tübing. 1838. S. 271--74.}.

Det i denne Betragtningsmaade Tvetydige, Uklare og Uholdbare er let at
opdage. Her maa skjelnes, og skjelnes skarpt, imellem det Livløse og det
Levende, imellem det blot Levende og det Besjælede, imellem physisk Affection
og psychisk
% --- p. 334 ---
\opage{334} \setcounter{footnote}{0}%
Fornemmelse\footnote{% printed mark: *)
I et ligesaa skarpsindigt som vndigt og vittigt Foredrag ---
% PRINTER'S DEFECT: "vndigt" set with a v sort for y ("yndigt"). At 600 dpi,
% with the descender zone in view, the glyph carries no tail and matches the
% v of "vittigt" on the same line exactly, while every y on the page
% ("Physiologer", "mystiske") has a clear descender.
Studien. Die Beseel. d. Pfl. --- har Schleiden tilretteviist de Physiologer,
som i deres mystiske Uklarhed endnu vedblive at begave Planten med en Sjæl.
--- „Du weißt, wenn ich euch mit diesen Herren böse thue, daß das Ganze doch
Nichts ist, als eine Variation auf das alte Shakespeare'sche Thema:\par
\emph{„Ihr guten Leute, aber schlechten Musikanten.“}\par\noindent
Wie in aller Welt will man es denn rechtfertigen, daß ein Mann deshalb, weil
er ein guter Botaniker oder Physiker ist, auch nothwendig ein guter Philosoph
sein müsse .... Doch ich verirre mich schon wieder. Ich wollte von
\emph{Martius} und \emph{Fechner} sprechen, die Beide gute Leute, aber
schlechte Musikanten --- verzeihe, vielmehr Philosophen --- sind.
\emph{Martius} mit seiner Seele und seiner Unsterblichkeit der Pflanzen macht
mir wenig Noth. Beides sind so oberflächliche und verwaschene Träume, daß
Nichts daran zu widerlegen ist, weil man Nichts packen kann; es sind
wesenlose Nebelbilder.... Bedeutender als Gegner scheint \emph{Fechner} zu
sein, schon deshalb, weil wir es bei ihm nicht mit einem flüchtig gefaßten
und flüchtig hingeworfenen Gedanken, sondern mit einem dicken Buche --- her
sigtes til: Nanna oder über das Seelenleben der Pflanze von G. Th. Fechner,
Leipzig 1848 ---, mit zahlreichen Citaten und anderm gelehrten Flitterstaat
zu thun haben. Aber nur um so trauriger! Ein Stoff für ein reizendes kleines
Verschen so breit getreten, daß er wissenschaftlich wie ästhetisch widerlich
wird .... Bei Gelegenheit der Frage, ob die Pflanze Nerven besitze, sagt er:
„Mir scheint der Faserstoff der Pflanzen, wenn man doch einmal Fasern
verlangt, ebenso gut geeignet und für die Pflanzen passender zu Nerven, als
das thierische Eiweiß.“ Der einzige Satz zeigt die absoluteste Unwissenheit
in Bezug auf die innere Organisation der Pflanze. Faserstoff, in der
...
% PRINTER'S OMISSION: the „Du weißt … quotation opened above is never closed;
% at 600 dpi the gap between "nicht." and "Anfr." carries no “ mark.
Anfr. Skr. S. 153--155.}. Men er det et Misgreb at ville hævde Idealitetens
Ret paa en saa umiddelbar Maade, at Ideen uden videre gjøres til Eet med
Livet, og Livet med Sjælen:
% --- p. 335 ---
\opage{335} \setcounter{footnote}{0}%
da er det paa den anden Side et ikke mindre farligt Misgreb at lade
Forstanden lægge et saa afgjørende kritisk Eftertryk paa Adskillelsen af det
Ideelle og det Materielle, det Levende og det Livløse, det Besjælede og det
Ubesjælede, at Forskjellen mangler Identitet, og den hele Opfattelse bliver
ideelos. Er Opfattelsen først bleven ideelos,
% "ideelos" twice with plain o for ø, verified at 600 dpi against the
% plainly slashed ø of "først" in the same line.
da staaer kun een af to Udveie tilbage: enten maa den kritiske Forstandighed
standse ved Antinomien mellem Natur og Aand som ved en uoverstigelig Skranke,
eller som ved et Magtsprog decretere Naturlighedens absolute Souverainitet og
nedsætte det Aandelige til en physisk Yttring af det Materielle. Hvilken
Udvei den i Forstandskritiken hildede Bevidsthed skal vælge, kommer da
ingenlunde til at beroe paa videnskabelig Indsigt; nei, Valget afgjores her
% "afgjores" with plain o for ø, verified at 600 dpi.
paa en anden Maade, nemlig ved Indskydelser. Nogle have nemlig deres
Indskydelser fra Friheden --- „die unbedingte Freiheit“! Andre fra
Nødvendigheden --- „die absolute Nothwendigkeit“! Hvilken af disse
Indskydelser, der i en given Subjectivitet skal blive den herskende, er
fornemmelig betinget af Stemningen og kommer altsaa til at beroe paa,
hvorvidt den i Sindet herskende Stemning, \emph{Grundstemningen}, er, for at
anvende et til Dilemmaet svarende Stemningsudtryk, enten mere \emph{idealsk}
eller mere \emph{bestialsk}.

Det første for Sjælen som Sjæl Eiendommelige, det Mærke, hvorved
Sjæleprincipet just adskiller sig fra det almindelige Livsprincip, er
Fornemmelsen. Men hvad er Fornemmelse? Umiddelbar Selvreflexion, Selvets
ubevidste Selvopdagelse, dets Indtryk af sig selv under Indtryk af Andet, et
Befindende, hvori det finder sig sat. Hvorledes man end definerer Udtrykket,
altid vil det vise sig, at Fornemmelsen gjælder det tilværende Selv: hvor
Selvet ikke reflecteres som Selv, er der ingen Fornemmelse. Som umiddelbar
Selvreflexion er Fornemmelsen tillige Bevidsthedens meest umiddelbare
Yttring. Da Fornemmelsen altsaa er det i Bevidst\-%
% --- p. 336 ---
\opage{336} \setcounter{footnote}{0}%
heden meest Umiddelbare, kan kun den Fornemmende mærke, hvad Fornemmelse er;
det ligger i Sagens Natur, at her ikke gives noget mere Fatteligt, hvormed
man kunde begynde. Men ligesom i det Hele intet Umiddelbart lader sig
bestemme uden ved Reflexion, saaledes kan Fornemmelsen heller ikke opfattes,
fastholdes og charakteriseres som Fornemmelse uden en reflecterende
Bevidsthed. Der hører intet mindre end en menneskelig Selvbevidsthed, og det
endog en med Kategoriernes Dialektik fortrolig Bevidsthed til, for at
bestemme denne ureflecterede Reflexion og tydeliggjøre Fornemmelsens
Kategorie.

Dersom en Dialektiker uden videre begyndte med den Sætning: \emph{der gives
...
eensidigt Hang til det Paradoxe. Men hvad skulle vi nu sige, naar
Physiologen, den empirisk-forskende, kritisk-reflecterende Physiolog selv
ligefrem vedkjender sig det som en Hovedsætning, en for Physiologien
afgjørende Grundsætning, at Bevidstheden begynder med Fornemmelser, der slet
ikke mærkes?

„Bevidsthed i videre Betydning“ --- siger Lewes\footnote{% printed mark: *)
Hverdagsl. Physiol. 2. S. 71.} --- „er Indbegrebet af alle vore
Fornemmelser, Foreningen af mange Strømme af Sensibilitet. Bevidsthed i
snævrere Forstand er kun et andet Udtryk for Sensibilitet: vi have ligesaa
mange forskjellige Former af Sensibilitet, som vi have forskjellige Slags
Fornemmelser. Medens nogle af disse sammenflydende Strømme ere saa svage, at
de bemærkes ligesaa lidt som Stjernerne ved Middagstid, ere andre saa rolige
og stadige, at de ikke tildrage sig Opmærksomhed, medmindre deres Løb
forstyrres. Saaledes ere sunde Mennesker neppe istand til at skjelne de
Fornemmelser, der fremkaldes ved Blodomløbet eller Tar\-%
% --- p. 337 ---
\opage{337} \setcounter{footnote}{0}%
...
„Lad os see“ --- hedder det paa et tidligere Sted\footnote{% printed mark: *)
Anfr. Skr. 2. S. 49--50.} --- „om større Nøiagtighed i Sproget ikke vil
hjælpe os i vor Undersøgelse. Det paastaaes fra alle Sider, at Fornemmelser
ikke kunne finde Sted uden Bevidsthed. Lad saa være; men naar man kommer til
at tale om Bevidstheden selv, finde vi, at Hjernen betragtes som det eneste
Sæde for den, og heraf slutter man naturligviis, at ingen Fornemmelse kan
frembringes ved et Indtryk, medmindre dette Indtryk naaer til Hjernen. Naar
det viser sig, at et Dyr uden Hjerne giver alle de Tegn til Følelse, som det
gav, da det havde sin Hjerne, sige Physiologerne, at man ikke maa troe, at
det hjerneløse Dyr virkelig \emph{har} Fornemmelser; langtfra! det har
\emph{kun sensitive Indtryk}, som fremkalde \emph{Reflexbevægelser} uden
nogen Bevidsthed hos Dyret. At have Fornemmelser og at være sig Fornemmelser
bevidst er Eet og det Samme. \emph{At have} en Fornemmelse og \emph{at vide},
at man har den, ere to forskjellige Ting, ikke det Samme. Kundskab kan ikke
findes uden Bevidsthed; men Bevidsthed kan findes --- og findes ofte --- uden
Kundskab.“
...
ikke ligefrem taler om Fornemmelser, der ikke fornemmes\footnote{% printed mark: **)
For at undgaae de „skrigende Modsigelser“ (Anfr. Skr. 2. S. 51) vil Lewes
definere Fornemmelsen som „den blotte Reaction af den sensitive Organisme“
(S. 55); men just i denne Anledning viser det
% the printed page break of this note falls here (p. 337 | p. 338)
...
Fornemmelse og at være sig den bevidst er Eet og det Samme;“ men paa den
anden Side (S. 56) gjør man saa igjen vel i ikke at fastholde denne
Grundsætning; thi det Spørgsmaal: „Hører Fornemmelsen op i den Tid, man
ophører at være sig den bevidst?“ besvares udtrykkelig med: „Nei, Indtrykket
er vedblevet.“ Fornemmelsen hører altsaa ikke op, fordi man ophører at have
Fornemmelsen; man kan altsaa have Fornemmelser, som man ikke har.}, men om
% --- p. 338 ---
\opage{338} \setcounter{footnote}{0}%
Fornemmelser, der ikke bemærkes, ikke udtrykkelig bringes til Bevidsthed; men
hvad opnaaer man saa herved? At lægge Modsigelsen ind i Bevidstheden selv!
man bliver ved Conseqvensen nødt til at indrømme, at der gives en ubevidst
Bevidsthed, og saa ere vi jo lige nær. „Den Kjendsgjerning, at vi have en
sensitiv Organisme, er ubestridelig, ligesom at denne Organisme uophorlig
% "uophorlig" with plain o for ø, verified at 600 dpi (both o's plain).
exciteres af ydre og indre Pirringsmidler.
% DOUBTFUL READING: the initial capital of "Pirringsmidler" falls in a badly
% under-inked patch of the right margin; only fragments survive. They are
% consistent with the Fraktur P of "Paa-" lower on the page, and
% "Pirringsmidler" is the sense-reading. Rejected: ABBYY's "Birringsmidler"
% and tesseract's "Virringsmidler", neither a word.
Enhver saadan Excitation af den sensitive Organisme maa være en Fornemmelse.
Disse Fornemmelser maae nødvendigviis blive meget forskjellige, eftersom de
exciterede Organer og de exciterende Aarsager ere forskjellige; men de maae
alle være Fornemmelser; de ere alle virksomme Tilstande af den almindelige
Egenskab Sensibilitet. Altsaa maae de alle være Momenter i
Bevidstheden\footnote{% printed mark: *)
Anfr. Skr. 2. S. 50--51.}.“
...
Vilkaarlighed}. Den sig fornemmende Selvhed er vel under Paavirkningen
lidende, men bliver dog ved denne Liden bestemt
% --- p. 339 ---
\opage{339} \setcounter{footnote}{0}%
til umiddelbar Selvbestemmelse; herfra udspringer Vilkaarligheden. I
Vilkaarlighedens Udspring viser sig den samme Modsigelse som i
Fornemmelsens. Ligesom der fra den passive Side begyndes med Fornemmelser,
der ikke fornemmes, saaledes begyndes der fra den active Side med
Vilkaarlighedsyttringer, der ikke ere vilkaarlige. Vilkaarlighed forudsætter
et Valg, et Valg forudsætter Overveielse, Overveielse igjen Reflexion; men i
Selvets første dunkle, umiddelbare Vilkaarlighedsyttring er der ligesaalidt
Valgfrihed, som der i den første dunkle, umiddelbare Selvfornemmelse er
Reflexion. Og dog er her i dette første Dunkle baade Reflexion og
Valgfrihed: den uvilkaarlige Vilkaarlighed bærer i sig Valgfrihedens Anlæg,
ligesom den Selvfornemmelse, der ikke fornemmer sig selv, i sig bærer
Reflexionens Anlæg. Hvor naturligt det Ureflecterede og Reflexionen, det
Uvilkaarlige og Vilkaarligheden gaae sammen i sjælelig Eenhed, sees t. Ex.,
naar et Dyr pludselig gribes af Angst og flygter.
...
tydelige Spor af Valgfrihed, at der ikke kan være Tvivl om, at det sig
saaledes Bevægende maa være et Besjælet: saa er og bliver Selvbestemmelse
altid et Indvortes og kan som et Indvortes umulig kjendes og bestemmes ved en
Iagttagelse, der maa holde sig til det blot Udvortes. En Bevægelse kan i det
Udvortes tage sig ud som en Yttring af Vilkaarlighed, og dog skyldes en
physisk Nødvendighed; omvendt kan en Livsyttring tage sig ud, som om den
fremgik af physisk Nødvendighed, og dog hidrøre fra en Vilkaarlighed,
forsaavidt den er betinget af Selvfornemmelse, er en Reaction af et sig
fornemmende Selv. At det nu med Hensyn hertil maa være Naturforskeren yderst
vanskeligt at skjelne imellem Planten og det lavere Dyr, er for\-%
% --- p. 340 ---
\opage{340} \setcounter{footnote}{0}%
staaeligt\footnote{% printed mark: *)
.... es fragt sich .... noch, ob und in wiefern ein Maß der Empfindung selbst
und des Geistigen überhaupt möglich sei. Factisch ist bis jetzt kein solches
vorhanden oder, vorsichtiger gesprochen, bis jetzt als solches anerkannt,
vielmehr bis auf die neueste Zeit bezweifelt oder geleugnet worden, daß ein
solches überhaupt zu finden. Selbst Herbarts Versuch einer mathematischer
% "mathematischer" as printed (the German requires "mathematischen"); the
% terminal "er" is clear at 600 dpi.
Psychologie hat nicht auf einem solchen zu fussen vermocht; der wichtigste
Einwand, den man ihm von jeher entgegengehalten hat; ungeachtet Herbart das
Maß so zu sagen in den Händen hatte. G. Th. Fechner. Psychophysik. 1.
S. 54--55.}, ligesom det ogsaa er forstaaeligt, at de Physiologer, der endnu
...
principiel Forskjel mellem Plante og Dyr, en Forskjel, der i det Hele
fremlyser af de modsatte Organismers Eiendommelighed. --- „Om vi nu ogsaa i
særdeles mange Tilfælde endnu ikke kunne forklare den første Aarsag til
Bevægelserne i Planteriget, saa er dog idetmindste Bevægelsesorganernes
Mechanisme saa temmelig bekjendt, ligesom ogsaa Phænomenerne selv for
størstedelen lade sig opfatte som Spændingsphænomener, enten ifølge en
Delenes Sammentrækning, der under Udtørringen indtræder til forskjellig Tid,
eller ifølge lokal Turgescens og Slappelse i bestemte parenchymatiske Væv,
Phænomener, der sandsynligviis skyldes en Diffusion og staae under Indflydelse
af Livseenheden i den hele Plante. Muskler og Nerver, som i de høiere
Dyreklasser betinge Bevægelserne, mangle hos Planterne;
Bevægelsesphænomenerne i de høiere Grupper af Planteriget kunne desaarsag
ikke vel sammenlignes med de
% --- p. 341 ---
\opage{341} \setcounter{footnote}{0}%
vilkaarlige Bevægelser i Dyreriget, der staae under Sensoriets
Indflydelse\footnote{% printed mark: *)
H. Schacht. Lehrbuch der Anatomie und Physiologie der Gewächse. 2ter Theil.
Berlin 1859. S. 504--505.}.“
...
stor Vildfarelse. Fra det Elementære til det Organiske kan Overgangen kun
skee ved et tilsvarende Princip; fra Plantelivet til Dyrelivet kan Overgangen
ligeledes kun skee ved et tilsvarende Princip. Men ligesom Planten kun er
hævet over det Elementære derved, at det assimilerer sig det Elementære og
organiserer det Uorganiske, saaledes er Dyret igjen kun hævet over Planten
derved, at det assimilerer sig det Organiske\footnote{% printed mark: **)
Herved oversees ingenlunde, at Planter jo ogsaa behøve organiske Stoffer, og
at omvendt Dyr ernære sig med uorganiske Stoffer, som de tage directe fra
Jorden, Luften og Vandet; her tænkes derimod paa den Forvandling, det hele
vegetative Liv undergaaer i Dyreorganismen.} og forvandler det hele System af
vegetative Functioner til Grundlag for det Animale.
...
Vilkaarlighedens Yttringer antyde, at den hidtil blot vegeterende Organisme
har faaet en Sjæl. Men disse to Stadier kunne dog umulig tænkes adskilte
saaledes, at Dyreorganismen virkelig skulde begynde med et Liv uden Sjæl, og
derefter, idet den, saa at sige, erholdt en Sjæl i Tilgift, leve baade
% --- p. 342 ---
\opage{342} \setcounter{footnote}{0}%
med Liv og Sjæl. Hvor urimelig en saadan Antagelse er, fremlyser
saavel af Sagens Natur som af de physiologiske Phænomener.

Dersom det dyriske Livsprincip ikke oprindelig var et Sjæleprincip,
vilde Fornemmelsens og Vilkaarlighedens Oprindelse være en absolut
uoploselig Gaade.% uoploselig: plain o for ø, positively unslashed at 600 dpi
 En Fornemmelse, der endnu ikke fornemmes, kan umulig
have Realitet, medmindre den har sin ideelle Realitet i et tilsvarende
Fornemmelsesprincip. Fornemmelsesprincipet, som fra Begyndelsen af
ikke selv er fornemmende, lægger just an paa at tilveiebringe
Fornemmelsens physiske Betingelser, at articulere sin Organisme saaledes,
at Selvfornemmelsens Maal kan naaes, naar Organerne, de fornodne
Midler og Media, ere tilveiebragte. At Maalet er naaet, betegnes saa
derved, at det organiserende Princip udtrykkelig tager sin Organisme i
Besiddelse og saaledes yttrer sig som Vilkaarlighedens ideelle Centrum,
som det sig fornemmende Selv. Da nu Selvfornemmelsen er dialektisk
Eet med Vilkaarligheden, maa Fornemmelsesprincipet \textit{eo ipso} være
...
indsees, at Livseenheden ingenlunde svækkes ved den storre
Mangfoldighed af Organer og Livsyttringer, der udmærke de høiere Individer
fremfor de lavere. Tvertimod! jo mere articuleret den paagjældende
Organisme er, desto mere centraliseret er Livet igjen i det Hele: jo
storre Mangfoldighed, desto stærkere Eenhed, jo rigere Midler, desto
mere afgjørende Formaal, jo flere forskjelligartede Selvhedsmomenter,
desto kraftigere Selvhed.

Bevidsthedslivets Functioner sees fra dette Synspunkt i et dobbelt
Forhold til de paagjældende Organer, nemlig: 1)~\emph{i et materielt
Afhængighedsforhold}, forsaavidt de Punkt for Punkt ere betingede af
Organismernes physiske Be\-%
% --- p. 343 ---
\opage{343} \setcounter{footnote}{0}%
skaffenhed; 2)~\emph{i et ideelt Selvstændighedsforhold}, forsaavidt
...
formedelst Organerne med hverandre indbyrdes, er da ifolge denne
Forholdsfordobling bestemt ikke blot ved Organernes legemlige
\emph{Sammen\-%
hængseenhed}, men i sidste Instans ved den organiske Principeenhed, den
sjælelige, i og ved det hele Legeme articulerede, \emph{Selveenhed}.

Erkjendelsen af den i de besjælede Organismer herskende Livseenhed
er i den nyere Tid bleven altfor utilborligt tilbagetrængt ved den
overveiende Opmærksomhed, Physiologien --- vistnok ifolge Forskningernes
naturlige Gang --- har maattet henvende paa Delenes Liv, navnlig paa
„Cellelivet“. „De sidste tyve Aar“, siger Lewes\footnote{Anfr. Skr. 2. S. 439--40.},
„ville i Historien gaae under Navn af Celleperioden, saa mangfoldige
have Undersogelserne været, og saa slaaende Resultaterne, i Henseende
til den Rolle, Cellerne spille.... Cellen betragtes som det sande
biologiske Atom. Der lever ikke andet end Celler, eller hvad der ligefrem
kan føres tilbage til Celler... Enhver Celle i Organismen er uafhængig:
den fodes, den voxer, den reproducerer sig, og den doer, som om den
var en eencellet Plante eller et eencellet Dyr. Et Organs Væxt og
Forfald er ligesom en Nations eller et Træes Væxt og Forfald. De
enkelte Celler, hvoraf Organet er sammensat, voxe og døe, ligesom de
enkelte Mennesker eller de enkelte Blade voxe og døe. Der er en vis
aggregat Eenhed, men den bestaaer af særskilte Individer. Ligesom en
Nations eller et Træes Liv er Indbegrebet af Livet i alle deres enkelie
% enkelie: printed thus (i, dotted, no t-bar at 600 dpi) where sense requires "enkelte"
Dele, saaledes er Livet i en Organisme Indbegrebet af Livet i dens
enkelte Celler. Dette er en af den nyere Videnskabs store Aabenbaringer.
Man taler ikke mere
% --- p. 344 ---
\opage{344} \setcounter{footnote}{0}%
om et Middelpunkt for Livsvirksomheden; thi man veed, at der er
Myriader af Middelpunkter.“

Den logiske Halvhed, hvorved denne idelig tilbagevendende
Aggregationslære udmærker sig, er i vort Foregaaende paa mange Steder
og fra mange Sider allerede belyst. Ikke nok, at Begrebsforholdet
imellem det Hele og dets Dele, det Indre og det Ydre slet ikke ændses,
og at her altsaa ikke kan være Tanke om Noget, der kunde ligne et
% "her": the right margin of this line is faded to fragments in the Google scan;
% reading from sense and stroke-count, alternative rejected: "hi"
Forsog til en videnskabelig Fremstilling af Begrebet: Organisme; men
selv de Billeder, Analogier og Lignelser, som her bydes os i Begrebernes
Sted, ere saa skjodeslost anbragte, at endog et flygtigt Blik maa see
det Uholdbare. Livet i den enkelte Celle bliver her sammenlignet med
den Enkeltes Liv i Nationen. Mey, maae vi spørge, gjælder det da
% Mey: printed thus (the third sort is a descending y, unlike the n of "n." above
% it on the same page) where sense requires "Men"
virkelig om den Enkelte i Nationen, at han er saa ganske og aldeles
uafhængig, at han fødes, voxer, udvikler sig og døer, som om han alene
udgjorde hele Nationen, hele Staten? Dersom dette nu ikke giver nogen
god Mening, hvordan kan det da give en god Mening, at den enkelte
Celle i Organismen skulde være saa ganske og aldeles uafhængig, at den
kan fødes, at den kan voxe, at den kan reproducere sig og døe, som om
den var en Organisme for sig, en isoleret Organisme, en eencellet Plante
eller et eencellet Dyr? Istedetfor en Gjentagelse af det Almindelige
ville vi, for om muligt at opdage det i de mange „Middelpunkter“
herskende Middelpunkt, i denne Sammenhæng foretrække en Undersøgelse
af en i sin Art eiendommelig Organisme. Her er t.~Ex. et befrugtet
Fugleæg, nærmere bestemt, et Hønseæg. At her i Blommens Myriader
af Celler er Myriader af relative Middelpunkter, kan vel paa en Maade
indrømmes; men naar Spørgsmaalet er, om der i denne Middelpunkternes
Mangfoldighed ikke skulde vise sig et oprindelig herskende Middelpunkt,
da behøve vi jo blot at henvise til Kimen. „Det er Kimen, der lidt
efter lidt voxer og forvandler sig til en
% --- p. 345 ---
\opage{345} \setcounter{footnote}{0}%
...
Saaledes som dette hele Anlæg endnu er i sit forste Stadium, kan
man jo vel fra et Synspunkt ville i Kimen og Blommen see et Aggregat
af Celler; men dette Aggregat er alligevel intet Aggregat. Ved et
Aggregat maa det udtrykkelig forudsættes, at de enkelte Dele have en af
det Hele og af hverandre indbyrdes uafhængig Oprindelse; Aggregatet
kommer jo netop istand derved, at allerede forhaanden værende
Bestanddele sammenhobes og forbindes paa udvortes Maade. Ere nu
Kimens og Blommens Celler paa denne Maade hver for sig selvstændige,
saa at de med Hensyn til Oprindelse og individuel Bestaaen holde sig i
Uafhængighed saavel af det Hele som af hverandre indbyrdes? Man
behover just ikke at være nogen stor Physiolog for at indsee, hvor falsk,
hvor aldeles uholdbar og grundfalsk en saadan Opfattelsesmaade er. I
den store Vrimmel af Blommeceller, som fremkomme ved „Kløvningen“,
er der ikke en eneste, om hvilken det med Sandhed kan siges, at den
efter sin Oprindelse er uafhængig, at den fødes, at den voxer, at den
reproducerer sig og doer, som om den var en isoleret Organisme, en
eencellet Plante eller et eencellet Dyr.

At hver Celle paa hvert Punkt kun er en Deel for sig ved at være
Moment for det Hele, at dens eiendommelige Anlæg er præformeret i og
med det Heles Anlæg, dens Enkeltliv i og med Livsudviklingen i det
Hele, sees da tydelig nok i Beskuelsen af den Række planmæssige, til
Paradigmets Fordringer svarende Forandringer, Kimen undergaaer. „De
Forandringer,“ --- hedder det --- „der foregaae i Kimen den forste
Dag, ere følgende: Den udbreder sig noget mere til alle Sider og sondrer
% forste, sondrer: plain o; the same lines carry a plainly slashed ø in
% "følgende" and "øverste"
sig i to Lag, hvoraf det øverste er
% --- p. 346 ---
\opage{346} \setcounter{footnote}{0}%
mere gjennemsigtigt og kaldes det \emph{animale} eller \emph{dyriske}
Blad, det nederste er mere melkehvidt og kaldes det \emph{vegeta\-%
tive} eller \emph{Sliimbladet}. At de kaldes saaledes, er, fordi af det
% the intervening "eller" is set tight in both instances, the names alone spaced
overste udvikle sig ... alle Organerne for de Dyrene egne Livsyttringer:
...
dem, der repræsentere det animale, og dem, der repræsentere det
vegetative Liv, er paaviist os af selve Naturen i Kimens forste Formen.
% "forste Formen": printed thus
Snart danner sig imidlertid et tredie Lag mellem begge disse tvende.
Det kaldes \emph{Karbladet}, thi deri udvikle sig Hjertet, Blodkarrene og
selve Blodet, altsaa ligesom et for begge hine Organklasser fælleds
System.“ (Eschricht\footnote{Tolv Foredr. S. 4--5. --- „Efter Bischof findes
der den Eiendommelighed ved det menneskelige Æg, at disse Blade ligge i den
...
Allerede de Dannelsesphænomener, Udrugningen den forste Dag
saaledes hidforer, kunne, naar deres Væsen gjennemtænkes, tilstrækkelig
godtgjøre Aggregatlærens utilborlige Overfladiskhed. Holde vi os til den
givne Udtydning --- og en anden Udtydning kan da i ethvert Tilfælde
kun ændre, ingenlunde ophæve Grundtanken ---, da er det jo dog
aldeles uimodsigeligt, at den Organisation, der foregaaer i det animale
Blad, maa være væsentlig forskjellig fra den, der foregaaer i det
vegetative. Den for hvert Blad eiendommelige Organisation forudsætter en
eiendommelig Celledannelse. Hver Celles forbigaaende Enkeltliv er
inderlig bestemt ved en tilsvarende Erindringsenergie, en Totalvirkning af
Eiendomme\-%
% --- p. 347 ---
\opage{347} \setcounter{footnote}{0}%
ligheden i det Blad, hvortil den hører; omvendt er Bladets
Eiendommelighed igjen bestemt ved de eiendommelige Celler. Den
Organiseringens Dialektik, at alle de enkelte Celler og Cellepunkter i hvert
Blad aflede deres indre Eiendommelighed fra den i Bladet herskende
Dannelsesdrift, medens Bladet selv igjen erholder sin Eiendommelighed
fra den i Cellernes Vrimmel punctualiserede Formvirksomhed, er just et
kategorisk Udtryk for den i Mangfoldigheden herskende Eenhed.
Saalidt som nogen enkelt Celle her kan fore et af sit tilsvarende Blad
uafhængigt Liv, ligesaa lidt kunne Dannelserne i det ene Blad paa
nogetsomhelst Punkt foregaae uafhængigt af Dannelserne i det andet.
Her danner sig ikke et animalt Blad tilligemed et vegetativt, som om
den ene af disse Formationer oprindelig var den anden uvedkommende;
nei, her dannes et \emph{animalt} Blad, \emph{fordi} her dannes et
\emph{vege\-%
tativt}, her dannes et \emph{saadant} animalt, \emph{fordi} her dannes et
\emph{saadant} vegetativt: den ene af disse Dannelser er med al sin
% only the first member of each pair is letterspaced; the repeated "animalt"
% and "vegetativt" are set tight
Eiendommelighed væsentlig begrundet i den anden. Det er da heller ikke
paa Grund af udvortes Omstændigheder, ikke ifolge Sammenhobning af
en Mængde indbyrdes uafhængige Celler, at Karbladet træder til og
...
Anlægets Eenhed, hvoraf de ovrige Dannelser fremgaae. Her er,
væsentlig seet, ikke en eneste charakteristisk Yttring af den i Karbladet
...
belemrer Videnskaben; men herved undgaaer det hans Opmærksomhed,
at han ved at forkaste Livsprincipet tillige forkaster
Organisationsprincipet, og ved at
% --- p. 348 ---
\opage{348} \setcounter{footnote}{0}%
forkaste Organisationsprincipet absolut maa komme til en principlos
Opfattelse baade af Livet og af Organismen. Ogsaa i denne Henseende
er Lewes med sin sensualistiske Skarpsindighed et talende Exempel.
„Aristoteles,“ siger han, „antog, at Livsphænomenerne bleve beherskede
af forskjellige Livsprinciper (Sjæle, \textit{ψυχαί}, kalder han dem), der
vare sondrede hvert for sig, men alle underordnede eet hoieste Princip.
Denne Forestilling herskede i mange Aarhundreder og blev kaldt tillive
igjen for faa Aar siden af Prout. Kant definerer Livet som „et indre
Virksomhedsprincip“: en Organisme er „det, hvori enhver Deel paa een
Gang er Middel og Øiemed.“ Dette kan man med samme Ret sige om
% Øiemed: the capital carries the diagonal that the O of "Organisme" on the
% same line lacks
Gjæringen. Treviranus kalder Livet „den stadige Eensformighed af
Phænomener under Forskjelligheden i ydre Paavirkninger“, hvilket ligesaa
godt kan siges om et Uhr, eftersom Phænomenerne ophore at være
eensformige, saasnart ydre Paavirkninger paa nogen Maade forstyrre
Organismen eller Mechanismen. Bichats berømte Definition: „Livet er
Indbegrebet af de Functioner, hvorved Doden modstaaes“, er kun en
anden Form af Stahls Definition og er i enhver Henseende uholdbar;
thi paa den ene Side er den kun en Omskrivning af den Tautologie, at
Livet er det Middel, hvorved vi leve, og paa den anden Side erklærer
den, at Livet moder en uvenlig Modstand i de ydre Potenser, medens
% "uvenlig": the right margin of this line is faded; the word reads u + three
% short sorts + l i g. Alternative rejected: "utrolig"
Intet er vissere, end at ydre Potenser ere en \emph{nodvendig Betingelse}
for Livsphænomener.... Dugés kalder Livet „organiserede Væseners
særegne Virksomhed“, og Béclard siger: „Livet er Indbegrebet af de
Phænomener, der ere egne for organiserede Væsener. Det bestaaer
væsentlig deri, at alle organiserede Væsener til en vis Tid ere
Middelpunkter, hvortil fremmede Stoffer trænge ind og tilegnes, og fra
hvilke andre udgaae.“ De Blainvilles Definition, der er bleven optagen
af Auguste Comte og Charles Robin, lyder saaledes: „Livet er den
dobbelte indre Bevægelse af Sammensætning og Oplosning,
% --- p. 349 ---
\opage{349} \setcounter{footnote}{0}%
der paa een Gang foregaaer overalt og uafbrudt“; men dette passer kun
paa Ernæringen og omfatter ikke alle Hovedphænomenerne, medens der
ved den af Herbert Spencer foreslaaede Definition, nemlig: „Livet er
den endelige Forening af ueensartede Forandringer, der baade ere
samtidige og folge efter hverandre, i Overeensstemmelse med ydre
samtidige Existenser og Folger“, er den Mislighed, at den ikke er
fuldkommen forstaaelig, naar den er løsreven fra hans detaillerede
Forklaring deraf. --- Maaskee folgende Definition vilde være meest
forstaaelig og lettest at huske: „Livet er den dynamiske Betingelse for
Organismen“\footnote{Hverdagsl. Physiol. 2. S. 437--38.}.

For at fatte, hvad Physiologen her tænker sig ved en Organisme,
ville vi endnu hore ham anstille en Sammenligning imellem Organismen
og Maskinen. „Uden Liv er Organismen uden Bevægelse. Ligesaa lidt
som vi kunne tænke os Uhret sat i Gang ved en Følelse, kunne vi
tænke os Organismen virke uden Liv. Dette er Aarsagen til den
Utilboielighed, som ofte foles til at opfatte Organismen som en Maskine;
men denne Utilboielighed vil vige, naar vi betænke, hvor vidunderligt
det ene Led er foiet til det andet i et Hele, der bestaaer af mange
Dele, og sammenligne det med den noget lignende Sammenfoining af en
Maskine, og samtidig erindre, at Lighed ikke er Eenshed, og at
Organismen, skjondt den er en Maskine, er en \emph{levende} Maskine,
hvis Liv er en Kilde til store Uligheder.... En Organisme er en Maskine
og virker mechanisk, forsaavidt dens Bevægelser \emph{ere nodvendigt
bestemte ved dens Organers Sam\-%
menfoining}. Men Organismen er forskjellig fra Maskinen deri, at den er
levende, at den har Sensibilitet til Hoveddrivfjeder; og dens Bevægelser,
som kaldes mechaniske eller automatiske, \emph{bestemmes alle ved en
Impuls, som udgaaer fra ledende Fornemmelser}. Den adskiller sig
% --- p. 350 ---
\opage{350} \setcounter{footnote}{0}%
fremdeles fra en Maskine derved, at der kan udvikle sig nye Evner i
den.... Nye Forbindelser mellem de enkelte Led opstaae, saa at en
Forening af Bevægelser, der idag er umulig, maaskee kan være let om
en Maaned\footnote{Anfr. Skr. 2. S. 166--170.}.“

Uden at opholde os ved Forfatterens i hoi Grad flygtige og
overfladiske Opfattelse af Kants Definition eller de øvrige „Forsøg“, ville
vi blot gjore opmærksom paa det Utilfredsstillende i hans eget Tillob til
en nærmere Fastsættelse af Livets og Organismens Begreb. Naar der
sporges, hvad Organisme er, henviser han til Livet, og naar der sporges,
hvad Livet er, henviser han til Organismen.
...
hedder, at „Livet er den dynamiske Betingelse for Organismen“, saa
skulde man jo næsten antage, at denne dynamiske Betingelse, der er „en
Kilde til saa store Uligheder“ imellem „Maskinen“ og Organismen,
maatte efter Forfatterens Mening væsentlig være, hvad man ellers kalder
Livsprincipet; men da dette udtrykkelig benegtes paa et andet Sted
(Anfr. Skr. 2. S. 432--33), kan den foreslaaede Definition kun betegne,
at Livet er en Betingelse for „det hele Indbegreb af Betingelser, der ere
nodvendige til Organismens Virksomhed“. Men hvad er vel en saadan
alle Betingelser betingende Betingelse, naar herved ikke der tænkes paa
det i Andethedens Form reflecterede Udtryk for Selvheden, det
Ubetingede? Kun en Talemaade!

Allerdunklest er dog Udtrykket: „en levende Maskine“, dersom man
virkelig skal tænke sig noget Bestemt derved og opfatte det i et Begreb.
At Organismen er en levende Maskine, kan nemlig betegne to aldeles
modsatte Ting: der kan betegne, at Organismen er levende, fordi den er en
% "der kan betegne": printed thus, where the sense is "det"
% --- p. 351 ---
\opage{351} \setcounter{footnote}{0}%
Maskine, men det kan ogsaa betegne, at Organismen er levende, uagtet
den er en Maskine. I forste Tilfælde beroer Organismens Liv paa
Maskineriets Fuldkommenhed; i sidste Tilfælde danner det Organiske en
charakteristisk Modsætning til det Mechaniske. Fra hvilken Side vi tage
det, er Tingen lige urimelig.

Gaae vi ud fra den første Antagelse, da kan det vel indrommes, at
% første (slashed) stands beside "forste" (unslashed) on this page
vore Maskiner --- Tærskemaskiner, Kartemaskiner, Høvlemaskiner, o. s. v.
--- ere, hvor snildt de end iovrigt kunne være indrettede, dog endnu
hoist ufuldkomne i Sammenligning med den Mechanik, der udmærker
den mere sammensatte Organisme. Men kan nu Organismens Liv
virkelig betragtes som et Resultat af dens fuldkomnere Maskinerie? Denne
Synsmaade lader sig ikke fastholde. Dersom Livet i Organismen er en
Virkning af et hoist indviklet Maskineries Fuldkommenhed, hvorledes
kan man da betragte Cellelivet som det Oprindelige? hvorledes kunne
Protozoerne, og i det Hele de lavere Dyr, være „levende Maskiner“? En
Organisme kan, hvad Maskineriet angaaer, vise sig hoist ufuldkommen
og endda være levende; omvendt kan en Maskine udmærke sig ved en
hoi Grad af mechanisk Fuldkommenhed og endda være uendelig langt
fra at hore blandt de levende Væsener. Den hoieste Virksomhed, et
mechanisk Hele ved sine Deles Vexelvirkning kan udvikle, har sit Maal
i „den levende Kraft“\footnote{Den levende Kraft (\textit{force vive}), en
Kategorie, der er indført af Leibnitz, betegnes i den rationelle Mechanik ved
$mv^2$ eller ved $\frac{mv^2}{2}$, idet $m$ er Massen og $v$ Hastigheden.
--- Hvad der i det Foregaaende --- under Behandlingen af
„Uendelighedsproblemet“ --- er anført om Forholdet imellem Rummet $s$, Tiden
$t$, Hastigheden $v$ og Kraften $\varphi$, vil, naar vi, for at holde os til et
specielt Exempel, antage $\varphi$ for constant, i denne Sammenhæng være
til\-%
% the note runs on to the foot of printed p. 352
strækkeligt til at oplose, hvorledes Udtrykket $\frac{mv^2}{2}$ faaer sin
særegne Betydning. Af $s = f(t)$ følger jo $\frac{ds}{dt} = v$,
$\frac{d^2s}{dt^2} = \varphi = \frac{dv}{dt}$. Forsaavidt $\varphi$, den
accelererende Kraft (\textit{force accélératrice}), virker paa Massen $m$,
fremkommer den bevægende Kraft $m\varphi$ (\textit{force motrice}). Virker nu
den bevægende Kraft i en given Tid, udfører den et Arbeide, som har sit
Maal i Produktet af den bevægende Kraft og det i denne Tid tilbagelagte
Rum: saaledes er $m\varphi ds$ et Arbeidselement, og $m\varphi s$ en
Arbeidsmængde. Af $m\varphi = m\frac{dv}{dt}$ følger $m\varphi dt = mdv$. Men
$dt$ er jo, ifølge $\frac{ds}{dt} = v$, liig med $\frac{ds}{v}$; altsaa:
$m\varphi ds = mvdv$. Ved at integrere denne Ligning erholder man
$m\varphi s = \frac{mv^2}{2}$, eller $2m\varphi s = mv^2$, et Udtryk, som
viser, at \emph{den levende Kraft er den dobbelte Arbeidsmængde}.}; men den
levende Kraft er endnu ikke Liv.
% --- p. 352 ---
\opage{352} \setcounter{footnote}{0}%

En levende Maskine! Det er vanskeligt at fastholde dette Begreb;
thi hvad er en Maskine? „Et sluttet System af mechaniske Kræfter!“
--- Ingenlunde! En Maskine er ikke et heelt System; den er i det
Hoieste kun et Brudstykke deraf. For at opfatte et mechanisk Hele som
en Maskine maae vi lægge særligt Eftertryk paa Stykværket, paa
Sammensætningen, paa det Middelbare. Ligesom Maskinen ikke har sit
forste Bevægende i sig selv, har den heller ikke sit Formaal i sig selv;
dens Bygning og Brug er i alle Dele bestemt ved den ydre
Hensigtsmæssighed: den træller under Andethedens Lov, den er kun
bestemt til at arbeide.

Som Maskine skulde Organismen altsaa have sin Bestemmelse
udenfor sig, nemlig i Arbeidet; som levende Maskine skulde den have sit
Formaal i sig, i Kræfternes Vedligeholdelse, i Selvopholdelsen. Men saa
skarp er Modsætningen imellem Kræfternes Arbeiden og deres
Vedligeholdelse, at det Ene, i streng mechanisk Forstand, ligefrem ophæver det
Andet: forsaavidt et mechanisk Hele er Maskine og arbeider,
% --- p. 353 ---
\opage{353} \setcounter{footnote}{0}%
...
Kræfter, udforer det intet Arbeide og er ikke i Charakteer af Maskine;
altsaa: \emph{forsaavidt Organismen er en Maskine, kan den ikke være
levende; forsaavidt den er levende, kan den ikke være Maskine}.

Den mechaniske Strid imellem Kræfternes Vedligeholdelse
(Organismens Opgave) og deres Anvendelse til Arbeide (Maskinens Opgave)
kan anskueliggjøres i faa Træk. Man forestille sig et Pendul bragt i
Svingning; man tænke sig enhver Hindring for Bevægelsen
(Gnidningsmodstand, Luftens Modstand o. dsl.) aldeles bortfjernet: hvad saa? saa
vil Pendulet vedblive med en fra Svingning til Svingning uforandret
Bevægelse at svinge i det Uendelige; og hvorfor? fordi den hele
Bevægelse er anlagt paa en Vedligeholdelse af de tilsvarende Kræfter.
Hver Gang „Amplituden“ er liig med „Elongationen“, og altsaa
Vinkelhastigheden $=0$, vil den bevægende Kraft være i sit Maximum, og i
Begreb med at forvandle sig til levende Kraft. Naar Amplituden er
$=0$, vil den bevægende Kraft være $=0$; men nu har den levende
Kraft naaet sit Maximum og er i Begreb med at gjore Amplituden til
den modsatte Side liig med den uforandrede Elongation. Efterat dette
Vendepunkt er naaet, er den levende Kraft og dermed Vinkelhastigheden
rigtignok igjen $=0$; men saa er den bevægende Kraft paany i sit
Maximum, og saaledes vedbliver det\footnote{Kalde vi Elongationen
(Udslagsvinkelen) $\alpha$, Massen $m$, Tyngdens Acceleration $g$; den
bevægende Kraft $m\varphi$, Pendulets Længde $r$, Amplituden (den Vinkel, som
Pendulet ved Tidspunktet $t$ danner med Verticalen) $\Theta$, saa vise
Ligningerne:
\[ mv^2 = 2mgr\,(\cos\Theta - \cos\alpha) \quad \text{og} \]
\[ m\varphi = mg\sin\Theta \]
% the note runs on to the foot of printed p. 354
den uophorlige Omsætning af levende Kraft i bevægende, og omvendt. Da
$mv^2$ og $mg\sin\Theta$ ere ueensartede, kunne de vel ikke ligefrem supplere
hinanden (deres Sum ikke være constant); men derimod kunne de ved en
Forvandling udtømme sig i hinanden saaledes, at den ene voxer, idet den
anden aftager, og har naaet sit Maximum, naar den anden er $0$.}.
% --- p. 354 ---
\opage{354} \setcounter{footnote}{0}%
...
Anbringe vi derimod en Modstand, selv om det kun er den
ubetydelige, Luftmediet frembyder: strax er Forholdet forandret. At
overvinde Luftens Modstand er jo at udføre et Arbeide; at udføre et
Arbeide er at virke som Maskine: vort \textit{Perpetuum mobile} er nu
forvandlet til en arbeidende Maskine. Den anvendte Modstand, det
paalagte Arbeide, vil, hver lang Tid der end kan medgaae, inden den
fuldkomne Standsning indtræder, dog øieblikkelig bevirke et kategorisk
Misforhold imellem den levende og den bevægende Kraft. Den hele
levende Kraft kan nu ikke, som forhen, forvandle sig til Bevægekraft,
efterdi den for en Deel medgaaer til Arbeidets Udførelse; Følgen heraf
er, at Bevægekraften maa aftage, maa bestandig nærme sig til $0$, og
Maskinen være i Begreb med at gaae i Staae\footnote{Da Luftens Modstand
mod et svingende Pendul kan ansees for proportional med Hastigheden, saa vil,
naar $c$ er en constant numerisk Værdi, denne Modstand være $= cv$.
Bevægelsen af Pendulet kan da, naar vi holde os til smaa Udslagsvinkler,
bestemmes ved Ligningen:
\[ \vartheta = A_0 e^{-\frac{1}{2}ct}\left\{\cos\left(t\sqrt{\frac{g}{r}-\frac{c^2}{4}}\right)
 + \frac{c}{2\sqrt{\frac{g}{r}-\frac{c^2}{4}}}\sin\left(t\sqrt{\frac{g}{r}-\frac{c^2}{4}}\right)\right\}, \]
hvor $\vartheta$ betegner „Amplituden“. Ligningen kan gives Formen:
\[ \vartheta = A_0 e^{-\frac{1}{2}ct}\left\{\cos qt + \frac{c}{2q}\sin qt\right\}
 \quad (1). \]
% the note runs on to the foot of printed p. 355
Til $t = 0$ svarer $\vartheta = A_0$, altsaa er $A_0$ Udgangselongationen og
tillige et Maximum af $\vartheta$; den næste Værdi af $t$, som gjør
$\vartheta$ til Maximum, er bestemt ved $qt = 2\pi$; den efter
Udgangselongationen næstfølgende Elongation til samme Side svarer altsaa til
$t = \frac{2\pi}{q}$, og kan betegnes ved $A_1$, den næste $A_2$ svarer til
$t = \frac{4\pi}{q}$, almindeligt: $A_n$ til $\frac{2n\pi}{q}$. Sættes nu i
(1) $t = \frac{2n\pi}{q}$, faaes $A_n = A_0 e^{-\left(\frac{\pi c}{q}\right)n}$,
der udtrykker, at Elongationerne $A_0$, $A_1$, $A_2$ \dots\ danne en aftagende
geometrisk Række.}.
% --- p. 355 ---
\opage{355} \setcounter{footnote}{0}%

At hele Systemer af mechaniske Functioner ere medvirkende i den
levende Organisme og høre med til Organisationen selv, kan Ingen drage
i Tvivl; men denne Omstændighed kan paa ingen Maade retfærdiggjøre
Benævnelsen: „levende Maskine“. Et relativt sluttet mechanisk System
er hverken levende eller Maskine. Solsystemet t.~Ex. er et mechanisk
System; men hvem vilde vel for Alvor kalde Solsystemet en Maskine
eller tale om det Arbeide, Solsystemet udforer. Men er Solsystemet
ingen Maskine, da er det ligesaa lidt en Organisme. Systemets Lighed
med Organismen bestaaer deri, at det ligesom denne har sine over- og
underordnede Middelpunkter i sig selv, i et herskende Middelpunkt, at
det, istedetfor at sætte Kræfterne til paa Arbeider, kun anvender dem
til Selvvedligeholdelse; dets Lighed med Maskinen bestaaer deri, at det
hele er mechanisk, at de Kræfter, paa hvis Vedligeholdelse den
selvopholdende Virksomhed gaaer ud, ikke ere Livets Kræfter, men kun
mechaniske Yttringer af Mechanikens „levende Kraft“\footnote{Under
Forudsætninger og Betingelser, hvis nærmere Udvikling ikke hører med i denne
Sammenhæng, angiver den rationelle Mechanik i exact Form \emph{Principet
for Vedligeholdelsen af den levende Kraft}. I Conseqvens af d'Alemberts
Princip
% the note runs on to the foot of printed p. 356, where it ends
for „de tabte Kræfters Ligevægt“ faaer man --- efter at have opløst et
System af Kræfter efter de tre Coordinataxer og ladet den virtuelle
Forskyttelse af Systemet efter Forløbet af Tiden $t$ falde sammen med den
virkelige Bevægelse i det følgende Tidselement $dt$ --- Ligningen:
\[ \Sigma m\left(\frac{d^2x}{dt^2}dx + \frac{d^2y}{dt^2}dy
 + \frac{d^2z}{dt^2}dz\right) = \Sigma m\,(Xdx + Ydy + Zdz), \]
hvoraf man saa endvidere, dersom hoire Side er et exact Differential, erholder
ved Integration:
\[ \Sigma m\left[\left(\frac{dx}{dt}\right)^2 + \left(\frac{dy}{dt}\right)^2
 + \left(\frac{dz}{dt}\right)^2\right] = 2\Sigma m\int(Xdx + Ydy + Zdz) \]
\[ = 2\Sigma m\int Pds, \]
--- saaledes som Ramus Analyt. Mechanik. (S. 220--221) har udtrykt det ---
„idet $P$ er den tangentielle Kraft for Punktet $m$ d. e. den paavirkende
Krafts Composant efter Banens Element $ds$. Naar $v$ betyder Hastigheden af
$m$ til en hvilkensomhelst Tid $t$, $v_0$ Hastigheden til en bestemt Tid, for
hvilken alle Coordinaterne have givne Værdier, $x = x_0$, $y = y_0$,
$z = z_0$, saa er:
\[ \Sigma mv^2 - \Sigma mv_0^2 = 2F(x, y, z) - 2F(x_0, y_0, z_0). \]
\dots\ Dersom altsaa under Systemets Bevægelse alle Punkterne til
forskjellige Tider komme i de samme Stillinger, saa svarer dertil stedse den
samme Værdi af $\Sigma mv^2$ eller af Summen af alle Masserne hver
multipliceret med Hastighedens Qvadrat, som kaldes \emph{Systemets levende
Kraft}“.}.

% --- p. 356 ---
\opage{356} \setcounter{footnote}{0}%
„Men“ --- kunde Nogen indvende --- „uagtet Kategorien: levende
Maskine, saaledes belyst, jo vistnok tager sig ud som et Slags rund
Fiirkant: saa fører det dog i videnskabelig Forstand ikke til Noget at
hænge sig i et enkelt Udtryk og polemisere mod en Benævnelse, der,
naar den da ikke tages altfor bogstavelig, jo umulig kan give
Anledning til nogen væsentlig Misforstaaelse.“ Vi svare: ved at
indføre usande eller dog kun halvsande Kategorier indsmugler man lidt
efter lidt en Mængde falske Biforestillinger; men falske
Biforestillinger ere ofte til langt større Hinder for Sandhedens
Erkjendelse end de grovere Feiltagelser og mere iøinefaldende
Misforstaaelser.
% The whole lower half of p. 356 is the run-over of the footnote called
% on p. 355 (the „levende Kraft“ note, with Ramus's equations); by the
% house rule it is set at its call and so belongs to the pp. 342--355
% batch, not to this one. This batch begins at the first word of body
% text on p. 356.

% --- p. 357 ---
\opage{357} \setcounter{footnote}{0}%
...
Henblik til Maskinen betragte Forplantningsorganerne som et Parti for
sig ved Siden af de øvrige Organer: hvad skulde der saa være iveien
for at antage de allerbesynderligste Forplantningsmaader? --- Ere
nemlig „begge Kjønnenes Forplantningsredskaber saaledes uddannede og
ligge i et saadant Leie og Forhold til hinanden, at de af dem begge
afsondrede Forplantningsstoffer kunne komme i gjensidig Berøring,“
hvad skulde der da være iveien for at eet og samme Dyr kunde
„befrugte sine egne Æg med sin egen Sæd“ og saaledes blive baade
Fader og Moder til sit eget Afkom\footnote{% printed mark: *)
„Det var .... Anstød imod den sammenlignende Anatomies i mine Oine
utvivlsomme Sætninger, der, i Forening med min egen Mangel paa Evne
til at kunne tænke mig en Hermaphrodit eller en Hermaphroditisme,
...
% „Oine“ as printed: the capital is the plain Fraktur O (same sort as
% „Organismen“ in the body above and „Oiemed“ on p. 368), with the
% face's internal hairline but no slash crossing the bowl. Not
% normalised to „Øine“.
}?

Seet fra „Maskinens“ og Maskineriets Standpunkt er en fuldstændig
Hermaphroditisme saa langt fra at stride imod Begrebet af et
fuldkomnere Dyr, at vi snarere maae undre os over, at denne
Forplantningsmaade, der nu kun gjælder for visse lavere Former, ikke
er bleven til et Udmærkelsestegn for de høiere. Er Organismen
virkelig et Slags „levende Maskine“, hvi skulde man da ikke give den
organiske Maskine, der selv kan fabrikere baade Sæd og Æg --- ikke
alene vexelviis Sæd til en andens Æg og Æg
% --- p. 358 ---
\opage{358} \setcounter{footnote}{0}%
til en andens Sæd, men (hvad der jo næsten tyder paa en
misundelsesværdig \textit{αὐτάρκεια}) Sæd til sine egne Æg, Æg til sin
egen Sæd, --- Fortrinet for den, der er saa eensidig construeret, at
den kun kan frembringe een af Delene: enten Sæd eller Æg. Man vil jo
dog --- under iøvrigt lige Omstændigheder --- neppe betænke sig paa at
give den Mølle, der kan arbeide paa een Gang baade som Oliemølle og
Grynmølle, Fortrinet for den, der er saa eensidig construeret, at den
kun kan med een af Delene: enten med Olie eller med
Gryn\footnote{% printed mark: *); the note runs over pp. 358 | 359 | 360
Det forstaaer sig af sig selv, at Spørgsmaal som disse: „er en
\textit{generatio æquivoca} mulig?“ „er en Hermaphroditisme mulig?“
ikke kunne besvares ved apriorisk Udvikling af Organismens
Grundbegreb, men maae afgjøres ved Kjendsgjerningsbeviser.
Philosophien har i saa Henseende kun den Opgave, at fastholde de
kategoriske Synspunkter og paasee, at det Logiske i Beviisførelsen
skeer sin Ret. Ligesom de skærpede Undersøgelser over
\textit{generatio æquivoca} først egentlig have taget deres
Udgangspunkt i en Tvivlen, en paa Erkjendelsen af Organismens Natur og
de organiske Væseners Vilkaar begrundet Tvivlen om Muligheden og
Naturligheden af en saadan Forplantningsmaade, saaledes have jo nu
ogsaa Undersøgelserne over Hermaphroditismen taget deres Udgangspunkt
i en lignende Tvivlen. Maa det være tilfredsstillende at see,
hvorledes Forskningen har vidst at gjennemføre Undersøgelserne over
...
for at anføre et Exempel --- udtrykkelig (S.~28) erklæret sig imod
Læren om \textit{generatio æquivoca}, og saaledes --- „Dank dem
Aufschwunge, den die Wissenschaft durch Verbesserung der Hilfsmittel
zur Beobachtung und durch exactere Forschungsmethoden genommen hat,“
--- lagt Vægt paa det i Undersøgelserne Stringente. Men lidt senere
hen (S.~31--32) overraskes man i høi Grad ved at see samme Forfatter
paa den
% the note runs over the printed page break here: p. 358 | p. 359
allernaiveste Maade, som om Intet var iveien, ingen
Indsigelser gjorte, ingen Tvivl reiste, erklære sig for Læren om
Hermaphroditismen. Hvordan skal Man nu forstaae dette? Er det
Naturstridige og Usandsynlige i Læren om Hermaphroditismen ikke
ligesaa afstikkende som i Læren om \textit{generatio æquivoca}? er der
ikke reist en videnskabelig motiveret „Tvivl om Hermaphroditismens
Virkelighed?“ --- Men under Forudsætning af, at en motiveret Tvivl er
reist, er det da ikke --- „Dank dem Aufschwunge, den die Wissenschaft
durch exactere Forschungsmethoden genommen hat,“ --- en i Videnskaben
uafviselig Fordring, at en saadan Tvivl skal \emph{enten anerkjendes
og vedligeholdes eller ogsaa hæves ved et fuldgyldigt, for Sagkyndige
tilfredsstillende Kjendsgjerningsbeviis}? Er da virkelig Tvivlen
hævet? er der maaskee præsteret et Kjendsgjerningsbeviis, som virkelig
godtgjør „\emph{Tilstedeværelsen af virkelig mandlige og qvindelige
Forplantningsorganer i samme Skabning}“, idet det godtgjør, ikke blot
at eet og samme Individ kan i et Forplantningsredskab have Sæd, i et
andet Æg, men tillige at „Redskabet er det indeholdte
Forplantningsstofs Dannelsessted“ (J. Steenstrup over Hermaphrod.
S.~12--13)? Men saa burde Forfatteren dog idetmindste have omtalt
Beviset og nævnt os det Skrift, hvori Beviset findes?

Hvad her fra et philosophisk Synspunkt kan indvendes imod Gegenbaurs
Fremgangsmaade, er ingenlunde det, at han for sit Vedkommende anseer
det for vist, at der gives Hermaphroditer i den lavere Dyreverden, men
det, at Hermaphroditismens Problem slet ikke er til for ham, ikke er
med i hans Fremstilling. Selv i de Afdelinger, hvor han, t. Ex. i
Læren om Molluskerne, omhandler Forplantningsorganerne (S.~371--385)
og forklarer os, hvad der skal forstaaes ved „Zwitterdrüsen“, er
Problemet fuldstændig ignoreret. Alt foredrages i Forsikkringens og
Erklæringens thetiske Form, som om Hermaphroditismen var i den
allernaturligste Overeensstemmelse med den almindelige
Forplantningslov; Læren om Hermaphroditismen tages som ufeilbar og
slaaes fast som et Dogme, der nu een Gang hører med i den zoologiske
Troesbekjendelse. --- I Handwörterbuch der Physiologie von R. Wagner.
4r Bd. 1853, Art. \emph{Zeugung} S.~742 flg. og i Vergleichende
Anatomie
% the note runs over the printed page break here: p. 359 | p. 360
und Physiologie von C. Bergmann und R. Leuckart. 1852,
\emph{Hermaphroditismus} S.~585 og 589 er Spørgsmaalets logiske Side
aldeles forqvaklet.
}.

% --- p. 359 ---
\opage{359} \setcounter{footnote}{0}%
At anerkjende den principielle Forskjel imellem Maskine og Organisme,
imellem den blot physiske og den organiske
% --- p. 360 ---
\opage{360} \setcounter{footnote}{0}%
Proces, er at \emph{anerkjende et Organisationsprincip er at
anerkjende et Livsprincip}. Maa det nu forudsættes, at Organismen,
Plantens saavelsom Dyrets, er et Værk af Livsprincipet, et Selvhedens
Produkt, saa er ogsaa Grundforskjellen mellem Plante og Dyr at henføre
til en afgjørende Principforskjel\footnote{% printed mark: *); the note runs over pp. 360 | 361
Forskjellen imellem den Yngel af med hverandre sammenhængende,
hverandre i Udviklingen fremhjælpende Dyreindivider og den Yngel af
organisk sammenhængende Planteindivider, der afgive Momenter og Led i
Plantens naturlige Individualitet, er umiskjendelig. --- „Til Slutning
vil jeg endnu“ siger Steenstrup (Om Forpl. og Udvikl. gjennem
vexlende Generationer. S.~69) „tilføie, at ligesom i Opamningen den
hele Befordring af Ynglens Vel kun skeer ved en stille og rolig
organisk Virksomhed, \emph{kun er en Function under Individernes
vegetative Liv}, saaledes erindre virkelig alle de Dyrformer, ved hvis
Udvikling en Opamning finder Sted, aldeles om Planternes Forplantning
og Livscyclus; thi det Eiendommelige for Planten, og ligesom dennes
egentlige Særkjende, er, at Kimet, eller det oprindelige Individ i
Planteægget eller Frøet, kun igjennem en heel Række af Generationer
kan fremkalde Individer, som ere istand til igjen at frembringe Frøe
eller Individer af den første Form, hvorfra Planten havde sit
Udspring.“ Men den principielle Forskjel imellem Plante og Dyr er
...
.... Hos Corynerne eller Køllepolypperne løsnes den organiske
Forbindelse mellem In\-%
% the note runs over the printed page break here: p. 360 | p. 361
dividerne og Generationerne noget mere, de fuldkomnere,
...
Generationer hverandre mere lige; Medusernes første Generation er
endnu fastsiddende, men mere livlig og bevægelig i sine Dele; den
fuldkomnere Generations Individer begive sig fra Ammedyret, medens de
ere meget smaa, og undergaae betydelige Forandringer, efterat de ere
blevne frie og fritsvømmende; Salpernes Generationer endelig ere begge
frie og fritsvømmende, kun ere Individerne af den ene indbyrdes
organisk forenede, men have ikke Organer tilfælleds (i den udvoxne
Tilstand) .... Paa et endnu høiere og friere Trin ville vi ... træffe
Udviklingen hos Væsener, som fra Vanddyr ere blevne til Luftdyr, og
paa et saadant Trin finde vi det hos Bladlusene (\textit{Aphides}).
Allerede længe har man kjendt Bladlusenes Forplantning gjennem en
Række af Generationer; om Foraaret fremkommer der nemlig af Æggene en
Generation, som opvoxer og forvandler sig, og uden foregaaende
Befrugtning føder en ny Generation, denne paa samme Maade atter en
tredie, og saaledes gaaer det fort gjennem en 10--12 Uger, saa at man
endog hos enkelte Arter vil have iagttaget indtil 9 saadanne
forberedende Generationer; men tilsidst fremkommer der altid en
Generation, som bestaaer af Hanner og Hunner, af hvilke de første
efter Forvandlingen som oftest blive bevingede; Befrugtning og
Æglægning finder Sted, og den lange Række af Generationer tager sin
Begyndelse igjen i den samme Orden det næste Aar. --- Alle
Individerne ere frie og have frie Bevægelser, og undergaae en
Forvandling .... Phænomenerne for denne Udvikling vise sig ikke
længere hos \textit{Entozoa}, men hos \textit{Epiphyta} ...

I Biernes, Hvepsernes, Myrernes, Termiternes Udvikling og den derved
sig yttrende Opfostringsdrift see vi .... Ynglens Pleie fremkaldt ved
Villiesyttringer og vilkaarlige Handlinger af en Mængde Individer, som
ere fødte og baarne dertil: Ynglen, som skal udvikle sig til de
fuldkomnere, yngledygtige Individer, faaer ikke sin Beskyttelse
indeni Opfostrernes Legeme og faaer heller ikke sin Føde af et Organ i
dette, som afsondrer den; begge Dele ydes den udenfra ved Midler, som
de Pleiende ved deres bevidste Virksomhed skaffe tilveie.“ Anfr. Skr.
S.~64--66.
}. Ligesom Plantens Organisme er en ideel-%
% p. 360 ends with the hyphen of the compound „ideel-materiel“; the
% same compound is set mid-line on p. 362 („en ideel-materiel
% Fremstilling“), so the hyphen is the compound's own and is kept.
% --- p. 361 ---
\opage{361} \setcounter{footnote}{0}%
materiel Fyldestgjørelse af Plantelivets typisk-teleologiske
Fordringer, saaledes er Dyreorganismen med alle dens Eien\-%
% --- p. 362 ---
\opage{362} \setcounter{footnote}{0}%
...
paradigmatiske Selvudvikling. Det er da fra dette Synspunkt
begribeligt nok, at „\emph{Inddelingen af Legemets forskjellige
Organer: i dem, der repræsentere det animale, og dem, der
repræsentere det vegetative Liv, er paaviist os af selve Naturen i
Kimens første Formen.}“
% „Kimens første Formen.“ as printed --- the final word is unambiguously
% „Formen“ at 600 dpi (two-legged n, not r); the sense wants „Former“
% or „Form“. Transcribed as printed, not corrected.

ββ) \emph{Dyr og Dyrerækker.} At det sjælelige Liv i Dyret maa begynde
...
Synsmaade, der kun hidrører fra „en ulyksalig Tvetydighed i Sproget“,
men meget mere en Kjendsgjerning, der viser os det i al Begyndelse
Tvesidige, det i ethvert eiendommeligt Anlæg Dialektiske. Da det
dyriske Bevidsthedsliv udtaler sig med høist forskjellig Styrke og
Charakteer i de forskjellige Dyr, tør vi, naar vi skulle
charakterisere et saadant Bevidsthedsliv, naturligviis ikke vilkaarlig
holde os til denne eller hiin enkelte Formation; Opgaven bliver: ved
frit Henblik til de lavere, høiere og høieste Former at bestemme
Forholdet imellem Organismen og Bevidsthedslivet i Almindelighed, og
derhos at fremhæve de mere individualiserende Hovedtræk, saaledes som
disse paa forskjellige Udviklingstrin vise sig i de typisk adskilte
Rækker.

Hvad nu Opgavens første Deel angaaer, maa den dialektiske
Forskjelseenhed af det Ideelle og det Materielle, det Indre og det
Ydre, den væsentlige Centralitet og de phænomenale „Middelpunkter“,
igjen spille Hovedrollen. „Man beraaber sig ugeneert paa den
sammenlignende Anatomie, naar den kan bruges til at støtte den
Antagelse, at Hjernen eller den store Hjerne alene er det eneste Sæde
for Forstanden; men man seer roligt bort fra den, naar den bestemt
modsiger Tanken om, at Hjernen udelukkende er Sædet for Bevidsthed
eller Sandsning. Vi kunne ikke tilstede to Slags Maal og Vægt.
% --- p. 363 ---
\opage{363} \setcounter{footnote}{0}%
Hvis det Beviis, som Dyrene afgive, er godt i et Tilfælde, maa det
være godt i et andet. Hvad siger da den sammenlignende Anatomie? En
...
Kjendsgjerning, at mange Dyr slet ikke have den store Hjerne, og at
der endog blandt Fiskene findes idetmindste een, der ikke har Spor
deraf (og Zoologerne ville maaskee endnu finde mange andre), saa at,
medmindre vi erklære, at Amphioxus og alle de hvirvelløse Dyr ere
Maskiner uden Følelse eller Bevidsthed af nogen Art, ere vi nødte til
at indrømme, at der kan findes Bevidsthed uden det Organs
Tilstedeværelse, der siges at være dens udelukkende
Sæde\footnote{% printed mark: *)
Lewes. Anfr. Skr. 2. S.~93--95.
}.“ --- Altsaa: en Bevidsthed uden Hjerne, uden Forstand, en ubevidst
Bevidsthed!

Af det Ideelles organiske Identitet med det Materielle følger da for
det Første, at de sjælelige Functioner maae lade sig opfatte som
legemlige, saa at Sjælevirksomheden umiddelbart falder sammen med en
tilsvarende Organvirksomhed. Under et sensualistisk-empirisk Synspunkt
vil man altsaa fra det i Sjælefunctionerne Analoge slutte til
Organernes Analogie\footnote{% printed mark: **); the note runs over pp. 363 | 364
„Analogie und Homologie sind wesentlich verschiedene Begriffe, die nur
durch den gemeinsamen Ursprung der Vergleichung mit einander verknüpft
sind; dem einen aber liegen physiologische Thatsachen, dem andern
morphologische zu Grunde .... Die Kiemen eines Fisches sind die
Analoga der Lungen eines Vogels oder Säugethieres, d.~h. sie sind
beide Organe der Athmung, dagegen sind sie weit entfernt, einander
homolog zu sein. Als
% the note runs over the printed page break here: p. 363 | p. 364
Homologa würden sich dagegen die Flügel eines Vogels zu der
Brustflosse eines Fisches verhalten, die beide vordere Extremitäten
sind, dagegen würden dieselben Theile, mit der Flosse eines
Tintenfisches oder mit dem Flügel eines Schmetterlings verglichen,
bloße Analoga vorstellen, indem sie zwar alle Bewegungsorgane sind,
allein in wesentlich verschiedenen morphologischen Verhältnissen sich
finden.“ C. Gegenbaur. Grundzüge der vergleichenden Anatomie. Leipzig
1859. S.~35.
}, og omvendt fra Organernes til Functionernes. „Een\-%
% --- p. 364 ---
\opage{364} \setcounter{footnote}{0}%
...
bestandig større Afvexling og Sammensætning; men tillige finde vi, at
der ikke er blevet erhvervet nogen ny Egenskab, men at det samme Urvæv
med dets Sammentrækkelighed strækker til i alle de nye Phænomener.
Ikkedestomindre taler man, og det med Rette, om simple
Sammentrækninger, om vilkaarlige og uvilkaarlige Bevægelser, om
Bøining og Strækning og saa fremdeles. Jeg synes, man burde gjøre det
Samme i Henseende til Sensibilitet, eller Bevidsthed, der passende
kunde deles i tre Afdelinger: 1) Systembevidsthed; 2) Sandsebevidsthed;
3) Tankebevidsthed .... \emph{Systembevidsthed} omfatter alle de
...
Elementer, der danne Følelsen af Tilværelse .... Kun faa Forfattere
kunne frigjøre sig for de vanskelige Tvetydigheder i vor daglige Tale.
Tvetydigheden leder dem her til at antage, at Begrebet Bevidsthed og
endog Sandsning indbefatter noget af Tænkning. Men endskjøndt hvert
Dyr maa \emph{føle}, følger deraf ikke, at det \emph{tænker}. Ethvert
Dyr maa trække sig sammen, men deraf følger ikke, at det har
Stedbevægelse. Tænkning er Resultatet af en mere sammensat
Organisation,
% --- p. 365 ---
\opage{365} \setcounter{footnote}{0}%
end der er givet ethvert Dyr; men Bevidsthed er Attribut for hver
dyrisk Organisme. Hvor simple end Bevidsthedens Former ere hos de
lavere Dyr, maa den dog være væsentlig beslægtet med de mere
sammensatte Former hos de høiere Dyr. Hvis man ikke indrømmer dette,
er det umuligt at sige, hvor Sandsningen først optræder. Dersom
Bløddyret ikke sandser, gjør Krebsdyret det heller ikke. Dersom
Krabben er en Maskine, er Bien det ogsaa; dersom Bien er det, er
Bæveren, Elephanten, Hunden, Abekatten det
ogsaa\footnote{% printed mark: *)
Lewes. Anfr. Skr. 2. S.~76--78.
}.“

Ved den eiendommelige, sensualistisk-kraftige Maade, hvorpaa Lewes
overalt fremhæver Identiteten af den organiske og sjælelige
Virksomhed; ved den skarpsindige Kritik, hvormed han paa mange
Punkter forstaaer at blotte Inconseqvenserne i de af ham angrebne
Theorier; ved sin hele omfattende Bestræbelse for at paavise et for
Bevidsthedslivets forskjelligartede Yttringer fælleds organisk
Grundlag, har denne Physiolog fra sit empiriske Standpunkt
upaatvivlelig ydet den rationelle Physiologie betydelige Bidrag til
videre Fremskridt.

Grundtanken er fra den negative Side udtalt i den Sætning, at
„Hjernen paa ingen Maade er Bevidsthedens udelukkende Sæde.“ (Anfr.
Skr. 2. S.~4); positivt i den Sætning, at \emph{Bevidsthed} er „en for
Nervesystemet almindelig Egenskab“ (S.~7), „et Attribut for enhver
dyrisk Organisme“. For at klare Grundtanken begyndes her med en
Forklaring af „Nervekraften“. Hvorvidt „Nervekraften er eller ikke er
identisk med Electricitet“ (S.~9), kan for Tiden gjerne betragtes som
„et aabent Spørgsmaal“, naar vi kun erindre, at, „om end den elektriske
Hypothese tilsidst skulde gaae af med Seiren, maatte Physiologen dog
vedblive at betragte Nervekraften som noget Særeget --- hvis det er
Elektricitet, er det Elektricitet under visse særegne Forhold, som
give den en egen Characteer, der \emph{alene} findes i den levende
Nerve.“

% --- p. 366 ---
\opage{366} \setcounter{footnote}{0}%
...
Nervetraadene\footnote{% printed mark: *)
„Naar en Nervetraad pirres, sættes Neuriliteten i Bevægelse. Dersom
Traaden staaer i Forbindelse med Hjernen eller Rygmarven, er
Virkningen deraf en \emph{Fornemmelse}. Dersom Traaden staaer i
Forbindelse med en Muskel, er Virkningen en \emph{Sammentrækning}.
Dersom Traaden staaer i Forbindelse med en Kjertel, er Virkningen en
\emph{Afsondring}.“ Anfr. Skr. 2. S.~10.
}.“
% „Sensibililitet“ as printed: at 600 dpi the letterspaced word reads
% b-i-l-i-l-i-t-e-t, one „li“ too many; the correct „Sensibiliteten“
% stands three lines below on the same page. Transcribed as printed.

Men hvorledes forholder det sig nu egentlig med Sensibiliteten? ---
„Den philosophisk dannede Læser“ --- hedder det (S.~19) --- „vil blive
forundret ved at høre, at meget udmærkede Mænd i dette Øieblik
strides, om Sædet for Sandsningen selv er sensitivt, om Erkjendelsens
Sæde tillige er Bevidsthedens Sæde, og om ikke særskilte Dele af
Rygmarven ere bestemte til Overførelsen af \emph{Sensibilitet} --- ret
som om Sensibilitet var en Ting, der kunde bringes fra en Deel af
Legemet til en anden.“ --- Vistnok er det forunderligt, at man kan
„skjære, knibe, slide i eller galvanisere den graae Masse i Hjernen og
Rygmarven uden at fremkalde nogensomhelst Fornemmelse“, og det uagtet
vi vide, „at Hjernen er et Sæde for Sandsning, at Indtryk, der gjøres
paa de Nerver, der gaae til Cerebrospinalaxen, ikke fremkalde nogen
Sandsning, medmindre disse Centralorganer paavirkes, og dog see vi et
Menneske eller et Dyr uden mindste Modstand finde sig i, at man
skjærer et Stykke af dets Hjerne, eller stikker eller skjærer i den
graae Masse af dets Rygmarv;“ men Overraskelsen forsvinder, naar vi
indsee, at Sensibiliteten, den Egenskab, der findes ved det gangliøse
Væv, der udgjør den graae Masse i de nervøse Central\-%
% --- p. 367 ---
\opage{367} \setcounter{footnote}{0}%
...
For at den Grundsætning ret kan staae klart for os, „at Sensibilitet
er en \emph{inhærent Egenskab ved Ganglievæv}“ (S.~20), er det ogsaa
nødvendigt at gjøre en skarp Adskillelse imellem \emph{Egenskab og
Function}. „En Nerves Egenskab er for Exempel den, der tilkommer den
som Nerve, og ikke den, der hidrører fra dens Forbindelse med
nogetsomhelst andet Organ; den afhænger af dens Structur, ligesom
Staalets Elasticitet afhænger af Staalets Structur.“ En Nerves
Function derimod er „den Brug, som der gjøres af denne Egenskab, og
beroer paa de Forbindelser, hvori Nerven staaer til andre Dele af
Legemet. Egenskaben er uforanderlig, saalænge Bygningen bestaaer:
\emph{Eenshed i Bygning medfører overalt Eenshed i Egenskaber}“
(S.~21); hvorimod Functionerne ere ligesaa foranderlige som
Beskaffenheden af de organiske
Forbindelser\footnote{% printed mark: *)
Den blandt Physiologerne almindelig antagne Mening, at der skulde
gives to forskjellige Slags Nerver, der respectivt kaldes Følenerver
og Bevægelsesnerver, hvoraf den ene skulde være istand til at
fremkalde Fornemmelser, men ingen Bevægelser, den anden til at
fremkalde Bevægelser, men ingen Fornemmelser, afviser Lewes saavel ved
anatomiske som ved „philosophiske“ Argumenter og kommer saa (S.~40)
til følgende Slutning: „Der er ingen Grundforskjel imellem de to Slags
Nerver; begge staae i Sandsningens, begge i Bevægelsens Tjeneste, men
i forskjellig Grad. De kunne strengt taget kun deles i Muskelnerver og
...
Hudbevægelser. Men da Muskelnerverne have en stærk
Bevægelsesfunction, der langt overgaaer de andres, kunne vi lade
Navnet \emph{Bevægelsesnerver} vedblive at betegne de forreste Nerver;
og da fremdeles Hudnerverne ere Kanaler for \emph{stærkere og mere
for\-%
% The final sort of „forskjelligartede“ is malformed in the print: an
% open ɜ-shaped glyph, unlike both the „e“ beside it and the round s
% used elsewhere on this page (e.g. „andres“, „Bevægelsesnerver“). All
% three witnesses fail on it. Read as the e the sense requires.
skjelligartede} Fornemmelser, kunne vi lade Navnet
\emph{Følenerver} vedblive at betegne de bagerste Nerver.“
}.

% --- p. 368 ---
\opage{368} \setcounter{footnote}{0}%
...
„Sensibilitetens Sæde samme Udstrækning som de nervøse
Centralorganer.“ Men --- ogsaa dette maa udtrykkelig fremhæves ---
ihvorvel de nervøse Centralorganer alle have „\emph{eet fælleds Væv og
een fælleds Egenskab}, ere de dog indbyrdes mere eller mindre
forskjellige i deres Forbindelser med andre Dele og maae derfor have
forskjellige Functioner.“ (S.~44).

Som Beviis for, at Hjernens Sensibilitet beroer „paa den
\emph{histologiske}, og ikke paa den morphologiske Bygning --- med
andre Ord paa Vævet selv, og ikke paa nogen Gruppering af Vævet“,
anføres blandt Andet (S.~45) Følgende: „Man vil neppe negte, at
Insekter, Krebsdyr og Bløddyr besidde Sensibilitet .... Men hvad lærer
nu den sammenlignende Anatomie os? Den lærer, at svarende til denne
\emph{Egenskab}, som alle Dyr have tilfælleds, er der et \emph{Væv},
som de have tilfælleds; men ved Siden af denne \emph{histologiske}
Lighed findes der stor \emph{morphologisk} Forskjellighed. Nervevæv er
overalt eens, men Grupperingen af dette Væv er meget forskjellig.“

De anførte Træk maae i nærværende Oiemed, hvor Opgaven kun var at give
...
Prøve, indskrænke vi os i det Følgende til en Bedømmelse af den Side,
som særligt falder ind under den philosophiske Belysning.

Det er da for det Første iøinefaldende, at Forfatteren, ved at opfatte
Bevidstheden som en for Nervesystemet, navnlig for „det gangliøse
Væv“, almindelig Egenskab, fra Grunden af miskjender Bevidsthedslivets
Natur og Væsen. Bevidsthed er ikke en Egenskab; den er en Selvets
Grundfunction. Det
% --- p. 369 ---
\opage{369} \setcounter{footnote}{0}%
gangliøse Væv kan med al sin histologiske Eiendommelighed umulig være
det bevidste Selv: at tillægge et Ganglion Bevidsthed er at forvexle
Sjælens Organ med Sjælen. Det er ikke Ganglievævet, som ved en
Nervepirring bliver sig bevidst, og ved at blive sig bevidst bliver en
Sjæl; men det er omvendt Sjæleprincipet, som har organiseret sit
Nervesystem saaledes, at Sjælen kan blive sig bevidst formedelst
Gangliet. At der i Ganglievævene oprindelig begyndes med en ubevidst
Bevidsthed, med Fornemmelser, der ikke fornemmes, kan paa ingen Maade
berettige Physiologen enten til at opfatte Bevidstheden som en
almindelig Egenskab ved Nervesystemet eller til at definere
Fornemmelsen som „den blotte Reaction af den sensitive Organisme.“

Skulde Bevidstheden i sin første Begyndelse ikke være Andet end en
Beskaffenhed ved et Ganglievæv, og Fornemmelsen blot en Reaction af
den sensitive Organisme: hvad vilde saa den uimodsigelige Conseqvens
af denne Forudsætning være? En absolut Forskjel imellem Bevidsthed og
Bevidsthed, imellem „Tankebevidsthed“ og „Systembevidsthed“, en
Forskjel saa absolut som imellem Selvet og det Selvløse! Her kan da
under denne Forudsætning ikke være Tale om Slægtskab imellem de
selvløse Yttringer af et organisk Væv og de i Sjælen reflecterede
Selvyttringer. Den Forudsætning, at Bevidsthed som „et Attribut for
enhver dyrisk Organisme“ skulde i Form af „Systembevidsthed“
umiddelbart beroe paa „en Egenskab ved de gangliøse Væv“, staaer
altsaa i aabenbar Strid med den Grundsætning, at, „hvor simple end
Bevidsthedens Former ere hos de lavere Dyr, maa den dog være
væsentlig beslægtet med de mere sammensatte Former hos de høiere
Dyr“.

Er Bevidstheden „med de mere sammensatte Former hos de høiere Dyr“ kun
et System af organiske Yttringer uden noget sig derigjennem yttrende
Selv, saa komme vi jo dog
% the foot of p. 369 carries the gathering signature „24“ (p. 369 is
% the first page of sheet 24); not transcribed.
% --- p. 370 ---
\opage{370} \setcounter{footnote}{0}%
til at „hylde Descartes's Hypothese, at alle Dyr ere levende
Maskiner, hvis Bevægelser ere ganske bevidstlose“; thi --- det
er en uundgaaelig Conseqvens --- alle organisk-selvlose
Bevægelser ere bevidstløse\footnote{Det Ubevidste er, hvad vi lære af
Plantelivet, ingenlunde altid selvløst; men --- det er en for
Dyrephysiologien afgjørende Grundsætning --- \emph{det Selvløse er altid
bevidstløst.}}.
% printed mark: *). Note the printed alternation on this page:
% "bevidstlose" and "selvlose" with plain o in the body, "bevidstløse",
% "selvløst", "Selvløse", "bevidstløst" with slashed ø in the note.

Antage vi derimod, at Bevidstheden med „de mere sammensatte Former
hos de høiere Dyr“ er en „Tankebevidsthed“, en Bevidsthed, hvori et
Selv reflecterer sin Tilværen: da maa Bevidstheden hos de lavere Dyr
--- dersom vi virkelig skulle troe paa Forfatterens Ord (S. 78), „at
der midt imellem de uendelige Afvexlinger, hvorunder det dyriske Liv
optræder, bestandigt findes visse Overeensstemmelser, og at i
Skabelsens herlige Drama den beskedne Maskinkarl er af samme Natur
som den hoiere begavede Tragiker, der spiller de ædleste Roller“,
--- nodvendigviis ogsaa være en Tankebevidsthed, om end en yderlig
svag Tankebevidsthed. Men naar nu dette antages, hvad bliver der saa
af Indvendingen (S. 77) imod de Forfattere, som ikke kunne „frigjøre
sig for de vanskelige Tvetydigheder i vor daglige Tale“, Forfattere,
hvilke den bedaarende Tvetydighed leder til at antage, „at Begrebet
Bevidsthed og endog Sandsning indbefatter Noget af Tænkning.“
% "hoiere" here with plain o, against "høiere" seven lines above;
% "nodvendigviis" likewise plain. Both as printed.

„En Naturforsker“ --- siger vor Physiolog (Anfr. Skr. 2. S. 73---74)
--- „indrømmer, at en Abe er meget uliig en Østers, og at disse to
aldrig maae forvexles; men ved Siden af at være forskjellige, stemme
de ogsaa overeens: han klassificerer dem efter deres Forskjel; men
paa Grund af deres Grundovereensstemmelse henfører han begge til
Begrebet Dyr. Hvor forskjellige Dyr end ere, veed han, at der bag
alle Forskjelligheder ligger visse Ligheder; alle Dyr høre til det
store Rige, som kaldes Dyreriget, og adlyde de samme bio\-%
% --- p. 371 ---
\opage{371} \setcounter{footnote}{0}%
logiske Love. Netop denne Reform er det, jeg ønsker at faae indført i
vor Behandling af Nervesystemets Physiologie --- at vi vilde
erkjende de Ligheder, der ligge bag Ulighederne, og erkjende, at alle
nervøse Centralorganer \emph{som saadanne} have visse Egenskaber
tilfælleds. De Fornemmelser, der hidrøre fra de organiske Processer,
ere meget forskjellige fra dem, der hidrøre fra de fem Sandser, og
Smerte er forskjellig fra begge. Ikkedestomindre ere de alle
Fornemmelser. Sult er forskjellig fra Torst, Torst er forskjellig fra
Træthed, Syn er forskjellig fra Horelse; men alle disse ere Momenter
i den almindelige Bevidsthed, alle virksomme Tilstande af nervøse
Centralorganer.“
% "Torst", "Torst", "Horelse" with plain o; "ønsker", "indført",
% "nervøse", "hidrøre" with ø. As printed.

Men hvad kan det hjælpe, at man beraaber sig paa de bag
„Ulighederne“ liggende „Ligheder“, naar man ikke udtrykkelig kan
paavise den oprindelige Forskjelseenhed, den Identitet, hvoraf
Forskjellighederne fremgaae, og hvori de igjen lade sig opløse. Skal
Grundeenheden erkjendes, maae alle Bevidsthedsyttringer, alle
Fornemmelser, selv de allerdunkleste, jo have deres egentlige Grund i
det sjælelige Selv.

Kun forsaavidt Fornemmelsens Oprindelse i Selvet er indlysende,
lader Forholdet imellem Fornemmelse og „Perception“ sig
tydeliggjøre. At dette Forhold maa forekomme den med Dialektiken kun
lidet fortrolige Iagttager noget tvetydigt, er naturligt, eftersom
det i sit Væsen er saa afgjørende tvesidigt. See vi Forholdet fra
dets ene Side, tager det sig unegtelig ud, som om Fornemmelse uden
Perception var en reen Umulighed. „En vis Tilstand i Sandseorganerne
og en tilsvarende Perception fra Sjælens Side maae samvirke for at
frembringe en Fornemmelse; hver af disse Betingelser kan findes
alene; men da er Phænomenet ikke en virkelig Fornemmelse i den
Forstand, hvori vi her tage Ordet. Naar der saaledes falder et
Lysskjær paa Oiet under Sovnen, pirres det hele Sandseapparat for
Synet, medens Organet
% --- p. 372 ---
\opage{372} \setcounter{footnote}{0}%
for Perception er uvirksomt\footnote{Todd og Bowman: \textit{Physiological
Anatomy}, I. 402. --- Hverdagsl. Physiol. 2. S. 55.}.“ See vi derimod
Forholdet fra dets anden Side, ledes vi til at give Lewes Ret i, at
„en specifisk Pirring af Sandseapparatet“ maa ifølge sin Natur være
en Fornemmelse, siden den kan bevirke, at „den Sovende, uden at vide
deraf, flytter Hovedet bort fra Lyset.“
% printed mark: *)

Det i Forholdet Tvesidige beroer paa Fornemmelsens Identitet med
Opmærksomheden. At nu en saadan Identitet maa forudsætte en
tilsvarende Forskjellighed, forstaaer sig; men ved ganske at oversee
det i Forskjelligheden Identiske kommer Lewes til at gjøre en aldeles
uforsvarlig Adskillelse \emph{af Fornemmelse og Perception.} „Enhver
vil,“ siger han (Anfr. Skr. 2. S. 53), „indrømme, at
\emph{Opmærksomhed ikke skaber Fornemmelsen.} Alt, hvad den kan
\emph{gjøre, er at isolere en Fornemmelse fra Mængden af samtidige
Fornemmelser;} ja man kunde spørge, om Opmærksomhed er Andet end
denne Isolering af een Fornemmelse fra
Mængden“\footnote{Denne Forklaring lider af en dobbelt Mislighed. For
det Første betragtes Opmærksomheden som en reen Vilkaarlighedsact,
uagtet den til „Perceptionen“ svarende Opmærksomhed dog ogsaa har sin
uvilkaarlige Side; dernæst oversees det, at Opmærksomheden, selv naar
den opfattes som et Spontaneitetens Udtryk, umulig vilde være istand
til „at isolere en Fornemmelse fra Mængden af samtidige
Fornemmelser“, dersom den ikke formaaede at styrke den ene
Fornemmelse og svække de andre. Kan Opmærksomheden „ikke skabe
Fornemmelse“, hvor Indtrykket mangler, da kan Indtrykket heller ikke
skabe Fornemmelse, hvor al mulig Opmærksomhed mangler. --- „Jede
Zuwendung der Aufmerksamkeit zu einem Sinne ist als ein Erwachen
dieses Sinnes, und jede Abwendung davon als ein Versinken in
Schlafzustand zu fassen, aus dem ein Erwecken durch Willkühr oder
Reize stattfinden kann“ . . . . G. Th. Fechner. Elemente der
Psychophysik. Zweiter Theil. Leipzig. 1860. S. 450.}. I hvilken Grad
han, i Over\-%
% printed mark: **). Two notes on this page.
% The letterspacing breaks against the printed line-ends: "Opmærksomhed"
% is spaced but "Alt, hvad den kan" is not, and the run resumes at
% "gjøre". Transcribed as printed.
% --- p. 373 ---
\opage{373} \setcounter{footnote}{0}%
eensstemmelse med denne Betragtningsmaade, maa gjøre den af al
Opmærksomhed uafhængige Fornemmelse til en selvløs Reaction af et
paavirket „Centralorgan“, sees da tydeligt nok af følgende Erklæring
(S. 72): „De, der sige, at et Indtryk, der ikke bemærkes, ikke har
noget Moment af Fornemmelse i sig, sige, at naar det opfyldte Sind
ikke hører Vognene rulle paa Gaden, har Virkningen af
Luftsvingningerne paa Centralorganet for Hørelsen været den samme som
Virkningen paa Vinduesruden: der er kun blevet givet en reent physisk
Impuls. Jeg derimod paastaaer, at ligesom Vinduesruden reagerer i
Overeensstemmelse med Glassets Egenskaber, saaledes reagerer
Centralorganet for Hørelsen i Overeensstemmelse med nervøse
Centralorganers Egenskaber --- og Resultatet bliver mere end et
Indtryk: Indtrykket er sensitivt.“

Opfatte vi Fornemmelsen som en i Sjælen ved „Centralorganets
Reaction“ bevirket Selvyttring, da er det indlysende, at en
Fornemmelse umulig kan finde Sted uden al Opmærksomhed.
Opmærksomhed er jo netop et Udtryk for, at Sjælen \emph{mærker sig}
Fornemmelsen; thi Sjælen, hvis Væsen er Reflexion, kan kun
\emph{mærke} Fornemmelsen ved at \emph{mærke sig den}, d. e. ved at
blive opmærksom paa den. Det Sande i den af Lewes saa eensidig
fastholdte Synsmaade er, at Sjælen virkelig kan have Fornemmelser,
paa hvilke den kun henvender en uendelig ringe Grad af
Opmærksomhed. Dette er navnlig Tilfældet med den Fornemmelse, der
uvilkaarlig bringer den Sovende, hvis Oie afficeres af Lyset, til at
vende Hovedet bort; ligeledes med den Fornemmelse, den Hørende, der
dog ikke hører Vognenes Rullen, skjøndt Luftsvingningerne virke paa
Centralorganet for Hørelsen, i umærkelig Grad maa mærke sig. Hele
Vanskeligheden hæves, naar vi besinde os paa, at Fornemmelsens Styrke
maales med den tilsvarende Opmærksomhed, eller nøiagtigere, med en
anden Fornemmelse, ikke med Styrken af Centralorganets blot organiske
Reac\-%
% --- p. 374 ---
\opage{374} \setcounter{footnote}{0}%
tion\footnote{Ueberhaupt . . . ist das Verhältniß zweier Empfindungen
$\gamma$, $\gamma^{1}$, die den Reizen $\beta$, $\beta^{1}$ zugehören:
\[
  \frac{\gamma}{\gamma^{1}}
  = \frac{\log \frac{\beta}{\mathrm{b}}}{\log \frac{\beta^{1}}{\mathrm{b}}}
  = \frac{\log \beta - \log \mathrm{b}}{\log \beta^{1} - \log \mathrm{b}}
\]
also gleich dem Verhältnisse der Logarithmen der fundamentalen
Reizwerthe. In der Maßformel und ihren Ableitungen ist sowohl die
Größe des Reizes als der Empfindung jede auf eine Einheit
\emph{ihrer} Art zu beziehen. Denn da Reiz und Empfindung ganz
heterogener Natur sind, so können sie auch nur durch Einheiten ihrer
Art besonders gemessen, nicht aber ihnen eine gemeinsame Einheit
unterlegt werden. In der That erklären wir in unserem Masse der
Empfindung diese nicht als ein Wievielmal des Reizes, sondern als ein
Wievielmal einer als Einheit untergelegten Empfindungsgröße derselben
Art, und nur die Beziehung der Empfindung zu ihrer Einheit wird nach
der Beziehung des Reizes zu seiner Einheit bestimmt, indem beide
Beziehungen eine Function von einander sind, welche derartig ist,
daß, wenn die eine Beziehung gegeben ist, die andere daraus zu
folgern ist. Diese Function ist es, die durch unsere Maßformel
dargestellt wird. Elemente der Psychophysik. v. G. Th. Fechner. 2ter
Theil. Leipzig 1860. S. 18.\par
Idet Fornemmelse formedelst Indtrykket maales med Fornemmelse, bliver
Fornemmelsen tillige maalt med Opmærksomheden; thi den stærkere
Fornemmelse beviser just sin Styrke derved, at den i Forhold til
Indtrykket aftvinger Selvet en tilsvarende større Grad af
Opmærksomhed.}. Dette har Lewes overseet, og dog fremgaaer det med
indre Nodvendighed af de Exempler, hvorved han vil bevise det
Modsatte.
% printed mark: *). The note has two paragraphs, the second Nielsen's own
% remark; the superscripts on gamma and beta are printed as a raised
% figure 1, not as a prime. "Nodvendighed" with plain o, as printed.

„Naar man“ --- hedder det (Anfr. Skr. 2. S. 56) --- „trykker et
skarpt Instrument svagt mod hver Arm, har man to adskilte
Fornemmelser, der begge ere kjendelige. Om disse to Fornemmelser ere
samtidige eller følge efter hinanden, vedkommer ikke Sagen; de to
Indtryk paa Følenerverne frem\-%
% --- p. 375 ---
\opage{375} \setcounter{footnote}{0}%
kalde to Fornemmelser i deres Centralorganer. Men uagtet nu den
venstre Arm bevarer sin Sensibilitet, hvis man trykker Instrumentet
saa stærkt mod den høire Arm, at man fremkalder Smerte, taber man
Bevidstheden om Fornemmelsen i den venstre Arm; man kan ikke længere
mærke den Fornemmelse, der foraarsages af Instrumentet, der
ikkedestomindre trykker ligesom tidligere.“ Hvad beviser nu dette
Exempel? Det beviser, at det er, ikke den physiske Affection, men
...
Fornemmelse, der udtrykkelig mærkes, og en aldeles umærkelig
Fornemmelse, er jo uimodsigeligt og i fuldkommen Overeensstemmelse
med den Fordring, at vi skulle „erkjende de bag Lighederne liggende
Uligheder“. Der foregaaer altsaa en virkelig Forandring med en
Fornemmelse, naar denne efter at have været mærkelig gaaer over til
at blive umærkelig. Bliver nu „Indtrykket“ i den venstre Arm
uforandret, og er Fornemmelsen umiddelbart Eet med dette Indtryk:
hvorledes kan der da foregaae en Forandring med „Fornemmelsen“, det
vil sige: med Indtrykket, uagtet „Indtrykket“, det vil sige:
Fornemmelsen, forbliver uforandret? --- Havde Lewes, istedetfor at
opstille den Paastand, at vi have mange Fornemmelser, „der aldeles
ikke bemærkes“, indskrænket sig til at forsvare den Sætning, at vi
have mange Fornemmelser, der ere saa uendelig svage, at vi i endelig
Forstand ikke kunne bemærke dem, fordi den Opmærksomhed, de formaae
at vække, er saa uendelig ringe: det havde forandret Theorien
uendelig.

Ikke blot i den abstracte Størrelseslære, ogsaa i den concrete
Bevidsthedslære er „\emph{det Uendeliges Analyse}“ af afgjørende
Betydning\footnote{Von vorn herein und im Allgemeinen kann nicht
bestritten werden, daß das Geistige überhaupt qvantitativen
Verhältnissen unterliegt.
% the printed page break inside this note falls here
Denn nicht nur läßt sich von einer grösseren und geringeren Stärke
von Empfindungen sprechen, es giebt auch eine verschiedene Stärke von
Trieben, es giebt größere und geringere Grade der Aufmerksamkeit, der
Lebhaftigkeit von Erinnerungs- und Phantasiebildern, der Helligkeit
des Bewußtseins im Ganzen, wie der Intensität einzelner Gedanken.
G. Th. Fechner. Elemente der Psychophysik. 1ster Theil. Leipzig
1860. S. 55.}. En Fornemmelse uden al Op\-%
% printed mark: *). The note runs over onto p. 376, where its second
% half stands above the note belonging to p. 376 itself and carries no
% mark. "qvantitativen" and "grösseren" beside "größere", as printed.
% --- p. 376 ---
\opage{376} \setcounter{footnote}{0}%
mærksomhed, en Fornemmelse, som Selvet selv slet ikke mærker,
\emph{er en plat Umulighed}; en Fornemmelse, der i uendelig ringe
Grad bemærkes, eller, for at bruge et Udtryk, der minder om den
exacte Analyse, et til et Opmærksomhedsdifferential svarende
Fornemmelsesdifferential, altsaa et Fornemmelsesanlæg er derimod
\emph{en real Mulighed}. Man veed ikke ret, hvad man skal tænke sig
ved en uendelig svag Opmærksomhed, en uendelig dunkel, umærkelig
Fornemmelse, saalænge der tales i abstract almindelige Kategorier;
besinde vi os derimod paa, at den endelige Opmærksomhed jo kan
antages for et Integral af tilsvarende
Opmærksomhedsdifferentialer, den bevidste Fornemmelse for et Integral
af umærkelige Differentialvirkninger, da have vi i den rationelle
Mechanik en Garantie for Differentialvirkningers Realitet, som
Physiologie og Psychologie vel maae være enige om at
acceptere\footnote{\textit{Ponamus totam hanc facultatem}
(sc. \textit{attentionem}) $= \varphi$; \textit{elapso tempore}
$= \mathrm{t}$, \textit{si notionis robur sensim crescendo evectum est ad
quantitatem} $= \mathrm{z}$, \textit{residuum illius facultatis erit}
$\varphi - \mathrm{z}$. \textit{Perceptionis intensitatem ponamus esse
constantem, et} $= \beta$; \textit{habebimus:}
$\beta(\varphi - \mathrm{z})\mathrm{dt} = \mathrm{dz}$; \textit{unde}
$\beta\mathrm{t} = \mathrm{l}\dfrac{\mathrm{c}}{\varphi - \mathrm{z}}$.
\textit{Pro} $\mathrm{t} = 0$ \textit{etiam} $\mathrm{z} = 0$;
\textit{hinc}
$\beta\mathrm{t} = \mathrm{l}\dfrac{\varphi}{\varphi - \mathrm{z}}$,
$\mathrm{z} = \varphi(1 - \mathrm{e}^{-\beta\mathrm{t}})$; \textit{et}
$\dfrac{\mathrm{dz}}{\mathrm{dt}}
 = \beta\varphi\mathrm{e}^{-\beta\mathrm{t}}$. \textit{Hinc sequitur:
Facultatem mentis, notionem aliquam producendi, cito decrescere, nec
tamen unquam prorsus in nihilum abire} . . . . Herbart. Kl. phil.
Schr. II. S. 373. --- Jvfr. Heegaard. Den Herbartske Philosophie.
S. 159--178.}.
% printed mark: *). The Latin note is antiqua throughout; the "l" before
% each fraction is Herbart's logarithm sign (lower-case l, distinct at
% 600 dpi from the figure 1 in "1-e").

% --- p. 377 ---
\opage{377} \setcounter{footnote}{0}%
...
Differentialvirkning, af Opmærksomheden og derved af Selvet: saa tør
vi da ogsaa ansee det for afgjort, at der ikke kan gives nogen
Følelse, hvori der ikke er indeholdt en Medvirkning, var det endog
kun en Differentialvirkning, af Forestilling og Villie, og ingen
Villiesyttring, hvori der ikke er indeholdt en Medvirkning, var det
endog kun en Differentialvirkning, af Forstanden: \emph{det
fornemmende og forestillende Selv er, om end i allerdybeste
Dunkelhed, eo ipso et forstandigt og villende Selv.}
% "eo ipso" is set in Fraktur here, letterspaced with the rest of the run,
% not in antiqua.

Den Bevidsthedslivets Grundeenhed, der saaledes maa gjælde for alle
Dyreindividualitetens Former, har Naturen saa igjen anlagt og
udviklet paa en saa forskjellig Maade, at det Typisk-Teleologiske i
denne Forskjellighed vel maa siges at afgive den Inddelingsgrund
(\textit{fundamentum divisionis}), der oprindelig motiverer
Adskillelsen af Dyrerækkerne med derunder hørende Klasser, Ordener,
Familier o. s. v.

Blandt de forskjellige Hovedsider, hvorfra den typiske Forskjel
mellem Bloddyr, Leddyr og Hvirveldyr lader sig opfatte, er „den til
Grund for Nervesystemets Centraldele liggende Plan“ uden al Tvivl den
meest afgjorende. For de eenssidede skjæve eller straaledannede Dyr
(\textit{Animalia mollusca}) uden virkelige Lemmer egner sig det
spredte, uregelmæssige Nervesystem; Bugknudenervesystemet derimod for
de eenssidede leddede Dyr (\textit{A. articulata}) uden indre Skelet,
med mange eller ingen Lemmer; og Rygmarvssystemet for de eenssidede
uleddede Dyr (\textit{A. vertebrata}), hvis Beenbygning omslutter
Rygmarven, Nervesystemets Axe, og understotter fire indvendig leddede
Lemmer\footnote{\textit{La forme du système nerveux détermine donc la
forme de tout l'animal, et la raison en est simple: c'est qu' au fond
le système nerveux est tout l'animal en effet, et que tous les autres
systèmes ne sont là que pour le servir et l'entretenir. Il n'est donc
pas étonnant que, la forme de ce système restant la même pour chaque}
\emph{\textit{embranchement}}\textit{, la forme général de chaque}
\emph{\textit{embranchement}} \textit{reste la même, et que, cette
forme changeant d'un} \emph{\textit{embranchement}} \textit{à
l'autre, la forme de chaque} \emph{\textit{embranchemant}}
\textit{change.} \emph{\textit{Cuvier.}} \textit{Histoire de ses
travaux par P. Flourens. Paris 1845. p. 98.}}.
% printed mark: *). The note runs over onto p. 378. "afgjorende" and
% "understotter" with plain o; "eenssidede" with two s-sorts, confirmed
% by the printed line-break "eens-sidede" twice on the page;
% "embranchemant" for "embranchement" at the fourth occurrence, and
% "la forme général" for "générale", both as printed.

% --- p. 378 ---
\opage{378} \setcounter{footnote}{0}%
Betragte vi, for at holde os til bestemte Repræsentanter,
Nervesystemet i en Snegl, i en Bille og i en Hund, da tyder jo den
forskjellige Fordeling af Ganglieknuderne strax hen paa en typisk
Forskjel imellem lavere og høiere
Individualiteter\footnote{\textit{L'unité, la multiplicité de forme du
système nerveux, voilà ce qui décide de l'unité, de la multiplicité
des formes du règne animal} . . . . \textit{et c'est encore du
système nerveux que les diverses types, comparés entre eux, tirent
leur titre de distinction et de différence.} Anfr. Skr.
S. 98--99.}. Som et fra den sammenlignende Anatomie hentet Beviis
for, at Hjernens Sensibilitet hidrører fra dens Ganglievæv, medens
dens Functioner derimod beroe paa de forskjellige Organer, hvoraf
denne Sensibilitet er gjort afhængig ved de anatomiske Forbindelser,
anfører Lewes Forholdet imellem et Bloddyr og et Insekt. „Ganglierne
hos en Søhare (\textit{Aplysia}) ere“ --- siger han (Hverdagsl.
Physiol. 2. S. 99---100) --- „store nok til, at de kunde tjene mange
Functioner, hvis de vare forbundne med forskjellige Organer. Men
Søharens Legeme er ikke deelt i Ringe, hver med forskjellige
Organer. Det er een stor sammentrækkelig Masse, som ingen Been har at
gaae med, ingen Kloer til at gribe med; det kryber langsomt frem ved
Hjælp af dets store, kjødede Underflade, kaldet „Foden“. Da den har
saa faa Midler til at indvirke paa Omverdenen, kan der kun være ringe
\emph{sammensat} Virksomhed, lidet af det forskjelligartede Instinct,
som „Haveløberen“ (\textit{Carabus hortensis}) viser. Her (i
Have\-%
% printed mark: *). In the French note "L'unité", "multiplicité",
% "l'unité", "multiplicité" are letterspaced antiqua.
% --- p. 379 ---
\opage{379} \setcounter{footnote}{0}%
løberen) see vi en Organisme sammensat af et stort Antal
\emph{af forskjellige Organer}, der hvert have deres forskjellige
Anvendelse. Kunde vi maale den Nervekraft, der udvikles af den
formløse Søhare og den lille, men sammensatte Haveløber, vilde vi
uden Tvivl finde, at den første var overlegen i \emph{Mængde},
endskjøndt dens Functioner ere af en lavere Art.“

Gives der nu en væsentlig, ved Nervesystemets Eiendommelighed bestemt
Forskjel imellem Dyr og Dyr, imellem ufuldkomnere og fuldkomnere Dyr:
da gives der ogsaa en væsentlig Forskjel imellem Sjæle og Sjæle,
imellem ufuldkomnere og fuldkomnere Sjæle. Indrommes det, at der
existerer en Hunde-Sjæl, en Bille-Sjæl, en Snegle-Sjæl, da maa det
vel ogsaa indrømmes, at der existerer en Amphioxus-Sjæl, en
Cypris-Sjæl, en Polypsjæl; men uagtet enhver Sjæl væsentlig er en
Sjæl, sees den oprindelige Ulighed, den principielle Fleersidighed
dog allerede deraf, at Forskjellen imellem Hunde-Sjælen og
Bille-Sjælen er en anden, en ganske anden, end Forskjellen imellem
Hunde-Sjælen og Amphioxus-Sjælen, denne Forskjel igjen en anden, en
ganske anden, end Forskjellen imellem Amphioxus-Sjælen og
Bille-Sjælen, o. s. fr. Hvad der gjælder om Forskjellen imellem
ufuldkomnere og fuldkomnere Planter, at den nemlig maa bestemmes ved
det Typisk-Teleologiske, gjælder da ogsaa, og det i en endnu høiere
Grad, om Forskjellen imellem ufuldkomnere og fuldkomnere Dyr.
% "Indrommes" with plain o against "indrømmes" three lines below, as
% printed. "Amphioxus" and "Cypris" are set in Fraktur, not antiqua.

\emph{Hvad er nu egentlig et Dyr?} Naar vi sige om Dyret, at det har
et Legeme, at det har en Sjæl, saa gjøre vi jo, i Medfør af et
naturligt Indtryk, en ganske mærkelig Adskillelse imellem det: hvad
Dyret \emph{er}, og det: hvad Dyret \emph{har}. Ved saaledes at
ophøies til Besidder af Sjæl og Legeme, altsaa til en Slags
Proprietær eller Selveier, faaer det dyriske Selv en saa mærkværdig
Selvstændighed ligeoverfor den Sjæl og det Legeme,
\emph{hvoraf}, eller rettere: \emph{hvori} det bestaaer, at man
uvilkaarlig maa tænke paa det platoniske
% --- p. 380 ---
\opage{380} \setcounter{footnote}{0}%
„Selvdyr“ (ἀυτοζῶον: jvfr. Phil. Propædeut. S. 137---139) og næsten
antage, at „den sunde Forstand“ hvert Oieblik er i Begreb med at
hypostasere Dyrets Væsen til præexisterende Idee. Men tænke vi os nu
baade Sjælen og Legemet borte, hvad bliver der saa af Selvdyret? tage
vi Eiendelene bort, hvad bliver der da i dette Tilfælde af
Eiermanden? Intet, slet Intet!
% The Greek is printed with the smooth breathing over the alpha and the
% circumflex over the omega: ἀυτοζῶον, not the classical αὐτόζωον.
% Transcribed as printed. "Oieblik" with plain O.

Istedetfor at lade „Selvdyret“ have en Sjæl, kunne vi da forsøge, om
det maaskee vil gaae bedre med Forstaaelsen, dersom vi lode Dyrets
egentlige Væsen saaledes opgaae i det Sjælelige, at vi forandrede
Sætningen: \emph{Dyret har en Sjæl}, til Dommen: \emph{Dyret er en
Sjæl}. Vil det heller ikke ret lykkes os med denne Opfattelse, kunne
vi jo gjøre et Forsøg i den stik modsatte Retning og lade det
Sjælelige saaledes opgaae i det Legemlige, at vi, istedetfor at sige:
\emph{Dyret har et Legeme}, forandre Sætningen og sige: \emph{Dyret
er et Legeme}. Skulde det saa vise sig, at heller ikke dette Forsøg
tilfredsstiller enten den naturlige Sands eller den videnskabelige
Eftertanke, saa vil en Paaviisning af Vanskelighederne dog altid
kunne bidrage til at anskueliggjøre Opgaven, ja vel endog antyde
Veien til dens Løsning. Altsaa:

1) \emph{Dyret er væsentlig en Sjæl.} Her kan da fra dette Synspunkt
ikke være Tvivl om, at Dyret jo er en existerende Eenhed, et
virkeligt Selv. Som virkeligt Selv er den existerende Dyresjæl i en
legemlig Verden og selv legemlig; men Legemet har i Dyrets Liv ingen
Selvstændighed; det Legemlige er en Beskaffenhed ved Sjælen; her er i
Sjælens Existens en Fleerhed af legemlige Sider, efterdi her er en
Fleerhed af forskjellige Virkemaader. Systemet af Functionernes
legemlige Sider afgiver saa det articulerede Sjælephænomen, der i sin
materielle Umiddelbarhed tager sig ud som en Totalitet for sig, et
individuelt tilværende Legeme.

% --- p. 381 ---
\opage{381} \setcounter{footnote}{0}%
Er det nu virkelig den ene og samme Sjæl, som i sin fuldstændige
Udvikling lever paa een Gang baade legemlig og sjælelig: da kan det
ikke længere falde os ubegribeligt, at der, hvad Zoologien lærer, maa
findes en charakteristisk Overeensstemmelse imellem et Dyrs
Nervesystem og den i dets hele Legemsbygning udtalte Grundplan.
Istedetfor at reducere denne Overeensstemmelse til det blot
Almindelige maae vi meget mere tænke os den at være gjennemfort i alt
det Særlige og Enkelte indtil de allerfineste Træk. Er det virkelig
den ene og samme Sjæl, der lever saavel i de vegetative som i de
animale Functionssystemer, hvor kan det da betvivles, at f. Ex. en
Oxe maa have en anden Selvfornemmelse, andre Sandseindtryk og befinde
sig i sin Omverden anderledes end en Løve, just fordi Oxen har en
anden Levemaade, ikke blot andre Nerver, men tillige andre
Fordøielsesredskaber end Løven\footnote{„Es ist dieser gegenseitige
Einfluß der Veränderungen der verschiedenen Organsysteme besonders
durch G. Cuvier hervorgehoben worden --- \textit{Influence mutuelle
des variations dans les divers systèmes d'organes. Leçons d'anat.
comp. I. 2. éd. p 48} --- und nach ihm nennt man das sich hierauf
gründende Gesetz das der \emph{Correlation der Theile} . . . .
Allgemein läßt sich hier bemerken, daß mit der morphologischen
Sonderung einzelner Systeme auch deren Zusammenhang mit anderen im
Körper auftretenden Veränderungen inniger wird, daß also, je grössere
Selbstständigkeit einzelne Theile eines Thieres erreichen, desto
sicherer von ihrer Morphologie auf die der anderen geschlossen werden
kann“. Victor Carus. System der thierisch. Morphologie. Leipzig
1853. S. 241--43. --- Endvidere hedder det (Anfr. Skr. S. 398): „Nach
dem Gesetz der Correlation der Theile hängen nicht bloß die
Hauptsysteme des Thierkörpers, sondern auch die einzelnen Organe in
Bezug auf ihre morphologische Ausbildung unter einander zusammen, so
daß eine Modification des einen eine ähnliche in \emph{einem} andern
nicht bloß, sondern mehr oder weniger in \emph{allen} anderen zur
Folge hat.“}.
% printed mark: *). "gjennemfort" with plain o, as printed; "p 48"
% without a point after p, as printed.

% --- p. 382 ---
\opage{382} \setcounter{footnote}{0}%
Det er umuligt, at nogen legemlig existerende Sjæl kan være
fornemmende uden at være sandsende; hvorimod det vel er muligt, at
Sandsningen hos det lavt staaende Individ kan være i saa ringe Grad
articuleret, at her ligesaa lidt kan tales om særskilte Sandsninger,
som om særskilte Sandser eller Sandseorganer. Det er umuligt, at
nogen legemlig existerende Sjæl kan være fornemmende og sandsende
uden tillige at være tænkende; hvorimod det vel er muligt, at
„Tankebevidstheden“ kan være saa dunkel, at hver enkelt Tænkningsact
forsvinder som et Bevidsthedsdifferential for den endelige
Betragtning\footnote{Man maa for Alting ikke bilde sig ind, at det
gaaer til i Dyreverdenen som i Menneskeverdenen, at man absolut
behøver et Hoved for at kunne tænke. Langtfra! Den Tænkning, hvorom
her tales, gaaer for sig paa billigere Vilkaar: i Dyreverdenen ere
„de Hovedløse“ (\textit{Acephala}) ligesaavel tænkende som de, der
have Hoved.\par
Forsaavidt Tænkningen i sin oprindelig psychiske Naturform betegner
den ubevidst-bevidste Reflexionsact, hvorved Forskjelseenheden af
Selvfornemmelse og Gjenstandsfornemmelse uvilkaarlig sættes, kan man
vistnok meget vel tænke sig Hjernen erstattet af andre analoge
Gangliecomplexer. Vel maa det indrømmes, at en Hund tænker klarere
end en Snegl, at Hjernen i Hundens Hoved er et virksommere
Tænkningsorgan end Sneglens „Svælgring“; men at Sneglen med sit
ringere Hoved dog ogsaa tænker og, saa at sige, har i lyse Oieblikke
originale Snegletanker, maa blive os indlysende, naar vi betænke, at
dersom en Hund virkelig tænker klarere end en Snegl, saa kan det ikke
feile, at en Snegl jo igjen tænker klarere end en Søpølse, og det
uagtet Søpølsen, trods sin totale Mangel paa Hoved, dog som
existerende Sjæl altid er og bliver et tænkende Væsen.}.
% printed mark: *). The note has two paragraphs.

2) \emph{Dyret er væsentlig et Legeme.} Ere de lavere og laveste Dyr
existerende Sjæle ligesaavel som de høiere, saa er, eftersom enhver
Sjælefunction nødvendigviis har sin legemlige Side, Conseqvensen
heraf, at de høiere og høieste Dyr maae have deres Organismes
legemlige Eiendommelig\-%
% --- p. 383 ---
\opage{383} \setcounter{footnote}{0}%
heder at takke for deres eiendommelige Bevidsthedsliv ligesaavel som
de lavere og laveste. Have vi forhen opfattet det Legemlige som en
Beskaffenhed ved det Sjælelige, saa er her nu, ifølge det valgte
Synspunkt, al Grund til at vende Forholdet om og opfatte det
Sjælelige som en Beskaffenhed ved det Legemlige.

En saadan Synsmaade tør ikke uden videre erklæres for
materialistisk. Materialismen maa udtrykkelig fornegte Livsprincipet;
men en Sætning som denne: Dyret er væsentlig et Legeme, er ingenlunde
begrundet paa nogen udtrykkelig Principfornegtelse. Det lader sig jo
nemlig antage, at det vel er Legemet, der i alle sjælelige
Livsyttringer er det virkelige Agens, men at dette saaledes
virksomme Legeme dog ikkedestomindre skylder et eller andet
organiserende Princip --- som man nu efter Behag kan kalde enten
„Skaberen“ eller „Naturen“ eller „det Alintelligente“ eller hvad man
vil --- den eiendommelige Indretning, hvorved det er sat istand til
at udøve de mange forskjellige sjælelige Functioner. Men --- dette er
den opstillede Sætnings særegne Betydning --- istedetfor at have
Dyret som et sjæleligt Ene, have vi det nu som et legemligt Hele, „en
sensitiv Organisme“.

Da hele Organismen siges at være sensitiv, kunde det vel ved første
Oiekast synes, som havde vi i den almindelige Sensitivitet en
sjælelig Eenhed. Men dette er en Illusion. Sensitiviteten har først
sin reale Mulighed i Sensibiliteten; men Organismen i sin Heelhed er
jo ikke sensibel. Skulde den hele Organisme i Virkeligheden være
sensibel, saa maatte jo enhver af dens Dele være sensibel; men nu er,
efter hvad vi ovenfor have seet, Sensibiliteten kun „en Egenskab ved
det gangliøse Væv, der udgjør den graa Masse i de nervøse
Centralorganer“: saamange nervøse Centralorganer, saamange sensitive
Organismer, saamange Sensorier, saamange Bevidstheder, saamange
sjælelige „Middelpunkter“. Kan nu ethvert af disse „Middelpunkter“
--- efterdi For\-%
