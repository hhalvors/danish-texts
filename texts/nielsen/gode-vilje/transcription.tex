...
%  "Metaphys. XII, 10" on p. 1 has the numeral in antiqua; numerals are
%  left plain by house convention, see §5). Spaced antiqua
...
%
%  ACCURACY: full collation of all 141 pages, the title page and the
%  Rettelser against the scan, 24 Sep 2026 (REPAIR-PLAYBOOK §5C).
%  14 collators (10--11 pp. each, 2 waves, every line read at the image
%  at 300--600 dpi) + 2 blind second readers on every non-convention change
%  and every doubt (26 questions) + a post-repair re-sample of 6 fresh
%  pages (seed |post: pp. 30, 33, 59, 85, 91, 110): 0 errors, 0 emphasis
%  items. Page markers: all 141 confirmed at the right word.
%    OCRDIFF: embedded ABBYY layer | pp.1-70   | 425 candidates | 0 real | 425 witness's fault | 0 unresolved
%    OCRDIFF: embedded ABBYY layer | pp.71-141 | 483 candidates | 0 real | 483 witness's fault | 0 unresolved
%  (ocrdiff found none of the errors below: all were read at the image.)
%
%  8 transcriber's errors corrected (~0.06/page):
%      p.  47 n.  the elision rule between the verses has 9 dashes, not 8
%      p.  49     "vred, Kritiken" (comma, not full stop)
%      p.  63     "Havens sandselige": the "comma" was a paper fibre
%      p.  68     "Løven er et glubsk Dyr" (the file had "Loven")
%      p.  75     "løstes op" (long s; the file had "løftes")
%      p. 100 n., p. 107   "Leilighedssk." as printed (the file had
%                 normalised both to "Leilighedsskr.", which p. 96 prints)
%      p. 133 n.  "N. Lindberg" (the file had "R.")
%  1 misprint the file had silently corrected, restored as printed:
%      p. 100 n.  "Kryderiet" (one d)
%  4 misprints already as printed but uncommented, now commented:
%      p. 25 n. "apereri"; p. 47 n. "decit"; p. 64 surplus “; p. 119
%      "Phantheismen" (inside the Martensen quotation). p. 63 "Menen" is
%      now logged as "as printed", not as a certain misprint (it may be a
%      verbal noun beside "Viden"; cf. p. 62 "Forestillen og Tænken").
%  9 emphasis/antiqua items: letterspacing added at p. 40 "som", p. 52
%      "Jesu Liv" (the first of two; the second is unspaced), p. 88 the
%      first "sig selv", p. 92 "Kan", p. 140 "Een være Hersker!"; extent
%      p. 108 (the run starts at "at den Protest"); antiqua added at p. 68
%      "Apriori", "apriori" and p. 70 "Strom.".
%  4 paragraphing faults: spurious breaks removed at the turns to pp. 27
%      and 67; missing breaks restored at pp. 119 and 133 (indented first
%      lines).
%  7 LaTeX welds repaired: an inline % comment after a word ate the
%      newline and joined it to the next line's first word in the PDF
%      ("Under,maatte", "Sammeal", "denguddommelige", "ial",
%      "theistiskei", "denbiskoppelige", "VidensbegreberTroesbegreber");
%      the comments now stand on their own lines.
%  HOUSE CONVENTION (decided at this collation): numerals in citations are
%      left plain, although the print sets them in antiqua (roman "XII",
%      "Logik II", "S. IX" ...; ~20 sites). Only words are marked \textit.
%  HELD, file reading kept: p. 1 ἔστω (no acute visible; commented);
%      p. 22 "Hysteron-|Proteron" (line-end hyphen, compound kept);
%      p. 75 "nemlig," (faint mark; second reader: a comma); p. 95
%      "Mangfoldighed" and p. 109 "Negation" (a speck over a letter, not a
%      sort: both readers); p. 126 whether the full stop of "Fjerde
%      Confusion." is inside the spacing (cannot be told).
%
% ---------------------------------------------------------------------
...
%      p.  63      „Menen“ (as printed; possibly for „Mening“)
%      p.  64      χριστᾷ for χριστῷ; a surplus closing “
%      p.  25 n.   „apereri“ for „aperiri“; p. 47 n. „decit“ (for dicit?)
%      p. 100 n.   „Kryderiet“, one d
%      p. 119      „Phantheismen“ (inside the Martensen quotation)
...
% ἔστω: only the smooth breathing over the ε shows at 300 ppi; no acute visible (collation 2026-09-24; both readers). Absence taken as ink failure, not a printer's defect; accent kept.
„Οὐκ ἀγαθὸν πολυκοιρανίη, εἷς κοίρανος ἔστω.
...
% sic: "apereri" for "aperiri" in the print (600 dpi; collation 2026-09-24, blind second reader agrees); transcribed as printed
...
% p. 40: "som" is letterspaced, "Gud" is not (measured at 600--900 dpi; collation 2026-09-24, two readers; medium confidence)
\emph{som} Gud, en Historie, i hvilken \emph{det hellige Verdens\-%
...
% "decit" (for dicit?) is as printed, 600 dpi (collation 2026-09-24, blind second reader agrees)
...
straußiske „Indledning“ til \emph{Jesu Liv} for at overbevise sig om
...
Menen % as printed: "Menen" (p. 63 l. 5). Possibly a misprint for "Mening", possibly a deliberate verbal noun beside "Viden" (cf. p. 62 "Forestillen og Tænken"); collation 2026-09-24
...
% printer's defect: surplus closing “ after "skal" -- no „ opens "at Alt, baade ..." (collation 2026-09-24, blind second reader agrees); transcribed as printed
...
tilføies: „\textit{Apriori} construere ham (den ethiske Gud) kunne vi
ikke, thi kun det logisk Nødvendige, men ikke den frie Aand
lader sig \textit{apriori} construere.... \emph{Tvinge} den ethiske Gud til
...
Bekjendte: ligerviis som Løven er et glubsk Dyr, saa skulle vi
...
καὶ εὐλογίᾳ αὔξων καὶ πληθύνων. Clem. \textit{Strom.}
% --- p. 71 ---
...
% sic: a full stop after "Theolog" in the print (both witnesses and the 300 ppi image); transcribed as printed
log. opgive Troen paa det Historiske i Bespiisningens Under,
...
dens Løsning var da den, at det Hele løstes op i en fuld\-%
...
egentlig har „indsænket“ i „Menneskehedens Skjød“, \emph{sig
...
% p. 89: only "logisk-physisk" is letterspaced, not "objectiv-"
lukker al objectiv-\emph{logisk-physisk} og da med det Samme
...
% p. 91: only "Selv" is letterspaced
Eet. Thi han er den menneskelige \emph{Selv}aabenbaring af den
...
og Logos ere Eet. \emph{Kan} han virkelig ikke? Nei, det veed
...
% p. 93: a raised dot between "diplomatisk" and "Forekommenhed" read as a speck (word space both sides)
hinanden med al mulig diplomatisk Forekommenhed d. v. s. i
...
de blive kun i al Tvetydighed sammenrørte\footnote{Da Biskop Martensen (Leilighedssk. S. 114) i Anledning af mine
...
% "Kryderiet" with one d as printed (collation 2026-09-24, blind second reader agrees; the transcription had normalised it to "Krydderiet")
macherske Theologie Flæsket, den Hegelske Philosophie Kryderiet.
...
lighedssk. S. 102), „skal kun det kaldes Videnskab, der kan
...
saare let at bevise, \emph{at den Protest, Biskop Martensen
...
% sic: "Phantheismen" for "Pantheismen" (inside the quotation from Martensen), 800 dpi (collation 2026-09-24, blind second reader agrees); transcribed as printed
...
% printer's defect: "hverkeu" (turned n) for "hverken", p. 121 l. 11; transcribed as printed
der ganske vist er klar og forstaaelig, at den hverkeu er theistisk
...
% PRINTED: one closing “ only; the quotation opened at „til en ny Dualisme is never closed (quote balance +1)
Dommen, reel i Virken og Frembringen“. Hvad den
...
N. Lindberg i sin Anmeldelse af „Leilighedsskriftet“ (Dansk Kirke\-%
...
% sic, elliptical as printed (no "og"/verb supplied)
dighedsbestemmelser Frihedsbestemmelser, som Vidensbegreber
Troesbegreber.
...
homerisk-aristoteliske: \emph{Een være Hersker!} i Kraft og op\-%
