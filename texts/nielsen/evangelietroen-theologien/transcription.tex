...
%
%  TWO DEFECTS OF A DIFFERENT KIND, FOUND BY THAT PASS AND NOT REPAIRED — they
%        are transcription errors, not splice artefacts, and are left for the
%        editor rather than corrected on an agent's reading:
%        (1) printed p. VII: THE PAGE MARKER IS ONE CLAUSE TOO EARLY. The words
%            "tænker lidt nøiere efter." stand at the FOOT OF PRINTED p. VI in
%            the scan (PDF 11), not at the head of p. VII; p. VII begins,
%            indented, with "Skal her virkelig strides om, hvo det er, …".
%            Verified at 600 dpi. The marker should move after "efter." and
%            p. VII should then take a paragraph break.
%        (2) printed pp. 7/8: the file ends p. 7 with "…Videnskaben opkommer i
%            Christenheden," — a COMMA — and runs straight on into p. 8, whose
%            printed first line "Den Christne bliver naturkyndig; …" is
%            INDENTED, i.e. a new paragraph. A comma cannot precede an indented
%            paragraph, so either the mark is a full stop misread as a comma or
%            text is missing at the joint. Needs the page checked.
% ============================================================
