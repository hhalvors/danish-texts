...
%        and printed pp. 1--68 (Indledning: §§ 1--4 complete; § 5 "Troesprincipet:
%        Religionsphilosophiens Methode" from p.56, with run-heads
%        a) Troen og dens Indhold (p.57) and b) Troesbekjendelsen (p.67),
%        carried to p.68).
%        RESUME AT printed p.69 (PDF 82). See RESUME-NOTES.md.
