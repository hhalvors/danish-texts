...
%
%  STATUS: COMPLETE. Whole book translated (printed pp.3--204). Compiles clean
%        (175 pp. in the portable Latin-Modern test build; the Libertinus main
%        build differs in page count only). English quote balance 406/406.
%        (History note below records the batchwise build-out.)
%  ------------------------------------------------------------
%  Done through printed p.95.
...
%        §34 (printed p.184). §35 (the cosmological/geological/physiological
%        ideals — astronomy/geology/Valentin's machine-analogy; the „fordi"-play)
%        + §36 opening (Nature as Idea — big Hegel Naturphil/Einleitung quotes;
%        Nature as bride/corpse of the understanding; b) The Idea as Nature) —
%        atoms/aggregation — through printed p.194. Letterspaced §-openings; five
%        p.189 „forbi/fordi" flags noted. §36 (rest: Forchhammer chemistry — one
%        elementary substance; aggregation; c) The reality of the Idea of nature —
%        Hegel „Die Natur ist an sich..."; Moleschott „ohne Phosphor kein Gedanke";
%        Nature as birthing Idea) + Slutning/CONCLUSION (What vs. How; the imagined
%        superficial critic; men-of-overview) — through printed p.204, \end{document}.
%        Five more d/b glyph flags (besuden/desuden, forbi/fordi ×2, Ombannelser/
%        Omdannelser, undbrage/unddrage) noted inline. TRANSLATION COMPLETE.
% ============================================================
...
of dialectical speculative analysis, then it is nonetheless not for that reason untrue that the a priori
categories indispensable in every science are, when they are seen in their inner dialectical connection,
sides of the objective essence, moments of the Idea itself.

\begin{center}{\bfseries \S\,35.}\end{center}

\emph{To deny the Idea is to deny the real sciences' common ideal; to acknowledge this ideal is to
acknowledge the Idea.}

When it is said in the theory of science (S. 69) that only that science is cultivated which is cultivated
for its own sake, this will in other words say that every true theory must seek its satisfaction in the
Idea. The ground that the particular sciences do not relate to the Idea as Idea is by no means this, that
they lack an eye for the Idea, or are indifferent to the Idea; on the contrary! it is precisely out of
interest for the Idea that they choose their point of departure in the finite, and work themselves
through the real; for only on these conditions can the cognition of the Idea get its real content.

Since now a real science cannot possibly take its standpoint in the pure Idea, and just as little can
strive after any other completion than that which consists in true appropriation of the Idea's content,
the Idea in its ideality must be the goal for its striving, the absolute goal, the ideal. Insofar as the
Idea is the ideal, one does not begin with the principled, the teleological, the typical, but one strives
onward toward the principled, the teleological, the typical. That the matter stands thus can here be
shown by reference to definite ideals:

\begin{center}\emph{a) The cosmological ideal.}\end{center}

Astronomy has not begun, and cannot begin, either with a Platonic ἰδέα [idea], or an Aristotelian εἶδος
[form], or a Hegelian ``Begriff'' [concept]; astronomy must, it lies in the nature of things, begin with
observing facts and making calcu-
% ---- printed p.185 (PDF 193) ----
lations. Since now every science in a certain respect always continues as it has begun, astronomy will
not merely begin, but also continue, with observations and calculations, and it could to that extent at
first glance seem as though it, immersed in its observations and calculations, never heeded the Idea,
never came nearer to the Idea.

It is, however, not phenomena at random, but a definite circle of definitely connected phenomena, with
which astronomy occupies itself: the object of its observations and calculations is not this or that
contingent, but a totality subsisting in itself, resting on itself. The greater progress the science
makes, the more penetratingly, all-sidedly, and comprehensively the mutual relation, ground, and
character of the whole and the parts is known, the more distinctly the rational is seen, the more the
merely contingent vanishes.

That the solar system is a realized plan cannot then, from the standpoint of the science, be doubted.
How far this plan is realized with or without consciousness, with or without determining will, is a
quite different question; but that the plan, as it now for once is realized, shows a thoroughgoing
rationality, a wisdom, as though it were realized with divine knowledge, is from the side of the science
incontrovertible.

That astronomy, in that it solves the phoronomic tasks, is at the same time occasioned to treat
cosmological problems, can be seen from the connection between the theory of gravitation and the
Kantian-Laplacean hypothesis of a rotating primal nebula. If it now, what surely no one can deny, lies in
the science's interest to get this hypothesis worked out and grounded in such a way that the solar
system's formation, from the first, principled disposition down to its present articulation, thereby lets
itself be explained as a development typically-teleologically advancing toward completion; then it is at
the same time established that the astronomical science
% ---- printed p.186 (PDF 194) ----
presupposes the Idea's reality, and approaches the turning-point when the investigations' finite
piecework goes up in the unity of the cognition of the Idea, as into its ideal.

\begin{center}\emph{b) The geological ideal.}\end{center}

In that geology presupposes geognosy, it must necessarily take its beginning in the finite, in reality's
piecework.

To collect and investigate minerals, to characterize rock-species, to point out the relation between
strata, broken-through masses, neptunic, plutonic, and volcanic formations, and so on, belongs to such a
degree under the category of piecework that one would, on preliminary consideration, scarcely suppose
that such heterogeneous constituents could be worked together into a scientific whole, let alone that
their working-up should lead to a cognition of the Idea.

Nonetheless geognosy has become a science; the more this science masters the facts, the more thoroughly
it works up the elements of finitude, the more it points out beyond itself: geognosy is there for
geology's sake; but geology has the goal in itself, for its content is of the Idea. Geology is indeed at
its present stage still far from being able to present the earth's formation as the Idea's own
realization; but that this is nonetheless the ideal toward which it strives is unmistakable.

Seen from geognosy's standpoint the earth is only a pieced-together whole; from geology's standpoint the
earth-body is, on the contrary, to be grasped as an elementary organism, an essential whole whose parts
have gradually developed themselves out of an inner disposition. In the disposition's originality we then
have again the principled, in the parts' separation and the whole's planned articulation the
typically-teleological, i.e. we have, if the cognition of the infinite mediation were only complete, the
Idea realizing itself in the earth-formation.
% ---- printed p.187 (PDF 195) ----
\begin{center}\emph{c) The physiological ideal.}\end{center}

``One has often compared the organism and its individual parts with a machine or a similar
physical-chemical apparatus. The heart resembles a pump-work furnished with fitting valves, the arteries
elastic tubes, the eye a \textit{Camera obscura}, the vocal organs a tongue-instrument; the bones relate
as levers; the secretory organs in part as filtering apparatus; the lungs act as an evaporation apparatus
furnished with a large surface.'' (Valentin, Physiologie, worked up by Hannover, Copenhagen 1857, S. 5.)

When the physiologist thus permits himself to grasp even the human organism as a machine, this has not
only for the immediate self-feeling something offensive, but seems even to degrade science, and set it in
a Materialism irreconcilable with the Idea of life. This offensiveness dissolves, however, into a nothing
when one considers that a physiological investigation, just as little as any other investigation
belonging under reality, can take its point of departure in the pure Idea. That science, however, does
not, like Materialism, restrict itself to uttering an individual opinion, or content itself with a finite
machinery, but on the contrary sets itself to work its way into an inner infinity, can already be seen
from the way in which the above-adduced description is continued. ``But our mechanical apparatus'
arrangement is simple, poor, and imperfect; they consist of large parts, their mode of action is stable
and bounded, and they can be kept going only by supply, help, and repair from without; in the opposite
case they stop instantly. Our body's apparatus are, on the contrary, composed of an infinitely great
number of microscopic parts, which form just as many small workshops, whose activity engages in one
another, and according to circumstances is modified in manifold ways, since they are labile
arrangements. They do indeed need nourishment from without; but by
% ---- printed p.188 (PDF 196) ----
reason of their independence they are able not only to maintain the activity of the parts already at
hand, but they can themselves repair the worn-out parts, replace loss, and even create new workshops. The
living beings play at the same time the role of the machine, the machine-master, and the master-builder.''

By this last addition the category of the machine is carried out beyond its bound; the organism is again
organism, and physiology will, the more deeply it penetrates into the parts' typically-teleological
mediation, the more approach the cognition of the Idea.

The real sciences' relation to the Idea can be exactly determined by their relation to the teleological:
they cannot straightforwardly apply teleology, and they cannot do without teleology.

That the real knowledge must hold to the efficient causes has already been brought out. In the analysis
of reality one can just as little explain something's coming-to-be by appealing to its purposiveness as
by appealing to the pure Idea. The application of the teleological has in this respect often served as a
cover for ignorance.

It is a great misunderstanding to wish to help oneself with a purpose-cause instead of an efficient
cause, or to suppose that, when something happens without our being able to discover the efficient
causes, it is then for that reason immediately effected by an invisible will. The dilemma ``either
something happens in nature according to efficient causes, or it happens according to a purpose-cause''
does not hold. Just as the purpose is realized only in the system of means, so the purpose-cause is
realized only in the system of the efficient causes.

In the Idea as Idea the means are moments for the purpose, the efficient causes for the purpose-cause; in
the finite reality the means, the efficient causes, step especially forth as existing members, while the
purpose, the purpose-cause, dawns as a thought hovering over the development.
% ---- printed p.189 (PDF 197) ----
From this it is understood that the real knowledge, which holds immediately to the means, the efficient
causes, cannot look at the purpose, cannot immediately use the teleological.

The real knowledge must nonetheless not any the less presuppose and tacitly understand the teleological,
just as it also must presuppose and tacitly understand the Idea.

In the hypothetical inference ``If A is, then B must be; now A is, thus B is too,'' B's being is doubtless
grounded as a consequence of A's being, but A's being is, in the proposition ``now A is,'' only grasped
as fact, i.e. as contingent. The whole grounding thus rests on something contingent; if we again found
A's being grounded as a consequence of a preceding member and went millions of members back, this would
nonetheless not change the matter. In the infinite series of the members conditioning one another there
rules a thoughtless play of the blindly contingent and the blindly necessary: ``The thing is,
% [d/b glyph flags in the Danish (Rettelser): print ``forbi'' for ``fordi'' (= because) — five times on p.189]
because it is, and the thing is,
because another thing is''; in this thoughtlessness there is no grounding.

If one now casts the grounding away, one can easily imagine oneself able to explain nature's order without
needing any wisdom of nature. The explanation is then this: ``there is in nature an order of things, not
because there is an ordering principle, but
because a disorder of things is impossible. Nature is an infinite whole that consists in its parts. As
the parts are, so too must the whole be, and conversely: as the whole is, so must the parts be. Had we
another nature-whole, then we would also have other parts; nature's order rests precisely on this, that
the parts cannot do otherwise than correspond to the whole, and the whole to the parts. What must
therefore happen, happens, and what does not, according to the connection of things, necessarily have to
happen, does not happen either; see, that is the whole wisdom! If all that we now call order dissolved,
and the world-structure collapsed into chaos, then this would nonetheless happen only
because it necessarily
% ---- printed p.190 (PDF 198) ----
had to happen, and this apparent disorder would thus nonetheless be in its order.''

But thus to dissolve the grounding into a play of the contingent-necessary is unscientific. The scientific
grounding demands an essential first. The real knowledge must indeed start from the fact; but the fact is
for that reason not the essential first; from the facts in their contingency there is striving inward
toward the connection in the total, inward toward the original disposition, inward toward the ground, for
the ground is the essential first. This essential first is in the disposition's realization at the same
time the last, and yet there is a difference between the first and the last.

The contradiction, that the first and the last are in essence one and yet in reality different, can be
resolved only in the teleological: the teleological identity of the last and the first is not a superficial
circular motion, but the Idea itself, which, in that it realizes its content, grounds all reality.

If now the real sciences, each from its point of departure, are in motion to find out the given facts'
ground and grounding, then they are also all, each from its point of departure, in motion onward toward
the all-grounding Idea; even if none of the real sciences can relate to the Idea as Idea, the cognition of
the Idea is nonetheless none the less the common ideal for them all.

\begin{center}{\bfseries \S\,36.}\end{center}

\emph{To deny the Idea is to deny Nature; to acknowledge Nature is to acknowledge the Idea.}

Although the natural objects involuntarily offer themselves to immediate intuition, it is nonetheless a
difficult task to develop the concept \emph{Nature}, to state quite accurately and definitely what Nature
is. Insofar as the realm of nature is a realm of facts, and facts must be grasped by
% ---- printed p.191 (PDF 199) ----
experience, one would suppose that it properly fell to the science of experience to answer the question:
what is Nature?

Nonetheless one will in vain seek the answer in the proper doctrine of nature. We meet here the wonderful
thing, that the science which alone among all rightly understands how to investigate nature's objects,
nature's forces, nature's laws, in short: all that nature's is, nonetheless becomes embarrassed, and
begins to stammer and lisp, when it is to say definitely what nature is. Either it remains at loose
examples and figurative descriptions of ``the Mother of the All,'' of ``the Bearing,'' of ``the eternally
Existing in becoming and producing,'' or else, when the concept is to be indicated a little more fully,
and determined a little more sharply, it ends with a reference to some philosopher, e.g. to Aristotle.

That natural science cannot say what Nature is must, however, not be misunderstood as though it either did
not acknowledge the reality of the concept of nature, or were not able to connect a definite thought with
the word ``Nature''; on the contrary! what nature is, natural science can in its way present clearly
enough, but, be it well noted, thereby, that it presents, not Nature itself, but nature's facts and laws,
thus not straightforwardly, but mediately, and that for the good reason that Nature is an Idea, and no
science of experience able to present the Idea as Idea.

Insofar as Nature is Idea, the development of the concept of nature is a task for philosophy; but since
the Idea as Nature is only what it is in its productions, phenomena, and laws, the development of the
concept's content must necessarily belong under Empiricism. It is precisely a peculiarity of the concept
of nature that it with equal force separates and connects philosophy and Empiricism.
% ---- printed p.192 (PDF 200) ----
\begin{center}\emph{a) Nature as Idea.}\end{center}

In the thinking grasp of the natural things Empiricism meets, according to Hegel (Naturphil., Einl.), with
philosophy. ``\textit{Beim theoretischen Verhalten ist das Erste, daß wir von den natürlichen Dingen
zurücktreten, sie lassen, wie sie sind, und uns nach ihnen richten. Wir fangen hierbei von sinnlichen
Kenntnissen der Natur an. Wenn die Physik indessen nur auf Wahrnehmungen beruhte, und die Wahrnehmungen
nichts wären, als das Zeugniß der Sinne: so bestände das physikalische Thun nur im Sehen, Hören, Riechen
u. s. w., und die Thiere wären auf diese Weise auch Physiker. Es ist aber ein Geist, ein Denkendes,
welches sieht, hört u.s.w.} [In theoretical comportment the first thing is that we step back from the
natural things, leave them as they are, and direct ourselves according to them. We begin here from sensible
knowledge of nature. If physics, however, rested only on perceptions, and perceptions were nothing but the
testimony of the senses: then physical activity would consist only in seeing, hearing, smelling, and so on,
and the animals would in this way also be physicists. But it is a spirit, a thinking thing, that sees,
hears, and so on.]''

The next thing is then that the things, in their relation to us, receive the determinations of the
universal, or that we transform them into something universal. The more thought there is in the
representation, the more of the things' naturalness, finitude, and immediacy vanishes: ``\textit{durch den
sich eindrängenden Gedanken verarmt der Reichthum der unendlich vielgestalteten Natur, ihre Frühlinge
ersterben, ihre Farbenspiele erblassen. Was in der Natur von Leben rauscht, verstummt in der Stille des
Gedankens; ihre warme Fülle, die in tausendfaltig anziehenden Wundern sich gestaltet, verdorrt in trockne
Formen und zu gestaltlosen Allgemeinheiten, die einem trüben nördlichen Nebel gleichen.} [through the
intruding thought the wealth of infinitely manifold nature is impoverished, its springs die away, its
plays of color grow pale. What in nature rustles with life falls silent in the stillness of thought; its
warm fullness, which shapes itself in a thousandfold alluring wonders, withers into dry forms and into
shapeless universalities that resemble a dull northern mist.]''

These theoretical determinations are not only the opposite of the practical, but they are even in
contradiction with one another mutually, in that theory immediately seems to effect the opposite of what it
intends. ``\textit{Nämlich wir wollen die Natur erkennen, die wirklich ist, nicht etwas, das nicht ist;
statt sie nun zu lassen, und sie zu nehmen, wie sie in Wahrheit ist, statt sie wahrzunehmen, machen wir
etwas ganz Anderes daraus. Daburch, daß wir die Dinge denken, machen wir sie zu etwas Allgemeinem; die
Dinge sind aber einzelne,
% ---- printed p.193 (PDF 201) ----
und der Löwe überhaupt existirt nicht. Wir machen sie zu einem Subjectiven, von uns Producirten, uns
Angehörigen, und zwar uns als Menschen Eigenthümlichen; denn die Naturdinge denken nicht, und sind keine
Vorstellungen oder Gedanken.} [Namely, we want to know nature, which really is, not something that is not;
instead of now leaving it and taking it as it is in truth, instead of perceiving it, we make something quite
other out of it. By thinking the things, we make them into something universal; but the things are single,
and the lion in general does not exist. We make them into a subjective, produced by us, belonging to us, and
indeed peculiar to us as men; for the natural things do not think, and are no representations or thoughts.]''

To resolve this contradiction, Hegel appeals to natural philosophy, whose determination and aim it is that
spirit can in nature find its counter-image, its own essence, the existing concept. ``\textit{So ist die
Natur die Braut, mit der der Geist sich vermählt. Aber ist diese Gewißheit auch Wahrheit? Indem das Innere
der Natur nichts Anderes, als das Allgemeine ist: so sind wir, wenn wir Gedanken haben, in diesem Innern
der Natur bei uns selbst \ldots{} Ich in meinem Wesen ist der Begriff, das mit sich selbst Gleiche, durch
Alles Hindurchgehende, welches, indem es die Herrschaft über die besonderen Unterschiede behält, das in
sich zurückkehrende Allgemeine ist. Dieser Begriff ist zugleich die wahrhafte Idee, die göttliche Idee des
Universums, die allein das Wirkliche.} [Thus nature is the bride with whom spirit weds itself. But is this
certainty also truth? In that the inner of nature is nothing other than the universal: so we are, when we
have thoughts, in this inner of nature with ourselves \ldots{} I in my essence am the concept, the
self-same, going through all, which, in that it retains the mastery over the particular differences, is the
universal returning into itself. This concept is at the same time the true Idea, the divine Idea of the
universe, which alone is the actual.]''

The thinking consideration of nature must now show how nature in itself is the process of becoming spirit,
of sublating its being-other, --- and how the Idea itself is present at every stage of nature; ``\textit{von
der Idee entfremdet, ist die Natur nur der Leichnam des Verstandes. Die Natur ist aber nur an sich die Idee,
daher sie Schelling eine versteinerte, Andere sogar die gefrorne Intelligenz nannten \ldots{} Ist die Natur
die Idee in der Form des Andersseyns, so ist, nach dem Begriffe der Idee, die Idee darin nicht, wie sie an
und für sich ist, obgleich nichtsdestoweniger die Natur eine der Weisen der Idee ist, sich zu manifestiren,
und darin vorkommen muß.} [estranged from the Idea, nature is only the corpse of the understanding. But
nature is only in itself the Idea, wherefore Schelling called it a petrified, others even the frozen,
intelligence \ldots{} If nature is the Idea in the form of being-other, then, according to the concept of the
Idea, the Idea is therein not as it is in and for itself, although nonetheless nature is one of the modes of
the Idea to manifest itself, and must occur therein.]''

\begin{center}\emph{b) The Idea as Nature.}\end{center}

The Idea of nature, as it is grasped in the above Hegelian presentation, is still grasped only according to
its
% ---- printed p.194 (PDF 202) ----
essentiality; but to the Idea of nature belongs the real, and in reality the doctrine of experience holds;
the question thus becomes this, how far the science of experience, in that it penetrates more and more into
the essence of the natural things, now also really finds such first presuppositions as are in their essence
compatible with that natural-philosophical doctrine of Ideas.

Two presuppositions seem, when we in this connection consider the matter from Empiricism's standpoint, to
offer insurmountable barriers to a cognition of the Idea as Nature, namely matter's \emph{atoms} and their
\emph{aggregation}; these presuppositions ought therefore to be tested.

That natural science can neither give up the atomic theory, nor in its analyses of reality go out beyond it,
has already been dealt with in the foregoing; but by the fact that Empiricism with its analyses must stop at
material fundamental parts as at the separations' outermost bounds, the Idea's validity is not in the least
weakened. Only when Materialism once in time gets occasion to furnish a scientific, irrefutable proof of the
so-called elementary atoms' eternity and unchangeableness will all talk of Nature as Idea and the Idea as
Nature have an end.

If trumping assertions were proofs, then Materialism might indeed already be said to have brought many and
great and forceful proofs for the atoms' eternal unchangeableness; but insofar as a scientific proof is to
be built on facts and grounds, there has here, so far as is known, hitherto no proof yet come forth.

If Materialism now did not wholly disdain every regard to the relation between experience and the a priori,
it would surely not deny that the proposition about the atoms' eternity and unchangeableness cannot possibly
be fetched from any finite experience; but, when it becomes evident that the proposition is a priori,
belonging under metaphysics, one will not either be quite able to overlook the difficulties meeting here. To
presuppose eternal, in themselves unchangeable atoms is, in other
% ---- printed p.195 (PDF 203) ----
words, to declare the relative to be an absolute, to assume a swarm of unconditioned things; that is a
contradiction.

The dogmatic assertion of the atoms' unchangeableness finds no support in scientific Empiricism either.
Elementary substances such as sulphur, selenium, tellurium can indeed show a great likeness, without the
chemical art (cf. Forchhammer, Chemie S. 58) ``hitherto having been able to change one of these substances
into the other''; but if one now wishes on this to ground a proof for eternal, unchangeable selenium-atoms,
eternal, unchangeable tellurium-atoms, and so on, then chemistry's reserving expression, ``hitherto,'' will
remind us that science cannot own the dogmatic assertions of Materialism.

The separations effected by the galvanic column in the newer chemistry have indeed led to a multiplication
of hitherto unknown elementary substances; but if this fact is to be used as testimony that the advancing
analyses will gradually make good the assertion that matter is originally, that is: from eternity, sundered
into a manifold of different, heterogeneous, mutually absolutely independent elementary substances, then
such a view has no warrant whatever in science itself. The continued analyses have not merely brought about
an increase, but, as the decomposition of ammonium and cyanogen expressly shows, at the same time a
diminution of the number of the so-called elementary substances; chemistry
% [the Danish print reads „besuden" for „desuden" (d/b glyph confusion); corrected to „desuden" = besides]
besides still knows nothing either about absolute elementary substances or about absolute elements; it is,
says Forchhammer (Anf. Skr. S. 111), ``not probable that what we call an element should be uncompounded,
% [the Danish print reads „forbi" for „fordi" (d/b glyph confusion); corrected to „fordi" = because]
because we have hitherto not been able to separate it into still simpler constituents.''

Instead of, with Materialism, enthusing over the eternal, unchangeable elements, chemistry on the contrary
interests itself in the substances' changes,
% [the Danish print reads „Ombannelser" for „Omdannelser" (d/b glyph confusion); corrected to „Omdannelser" = transformations]
transformations, and transitions, and strives toward the turning-point when it will be possible to
% ---- printed p.196 (PDF 204) ----
reduce all separate substances to one elementary substance, in order out of this elementary substance again
to form and produce the separate substances. Should chemistry one day solve this great task, then matter
will again show itself as the in itself infinitely changeable, as the passive element of the form-activity,
the real possibility of the actual formations.

The other hindrance to the Idea's acknowledgment should now lie in the role that the atoms' aggregation
plays, insofar as the elementary aggregation-drive in all formations might be supposed to make the
typically-acting form-principle superfluous.

That the doctrine of aggregation has, from the side of reality, its irrefutable right over against a
metaphysical form-essence that would in its activity
% [the Danish print reads „undbrage" for „unddrage" (d/b glyph confusion); corrected to „unddrage" = withdraw]
withdraw itself from the conditions of finitude, is in its place conceded. But it is one thing that a
natural formation is mediated through atoms' aggregation, and a quite other thing that the aggregation
steps in place of the typically forming principle. Where this last is the case, the formation itself will
unmistakably bear the stamp of contingency; where, on the contrary, the typical has conquered the
contingent, there the aggregation shows itself, in the part as in the whole, in the smallest as in the
greatest, to be subordinated to the form-giving principle.

\begin{center}\emph{c) The reality of the Idea of nature.}\end{center}

Although Hegel in his Naturphilosophie misjudges the analysis of reality and therewith the actual itself,
he has nonetheless, so long as the consideration is held in the universal, an on the whole surely quite
true concept of the relation between nature as Idea and the natural reality. ``Die Natur ist an sich, in der
Idee göttlich; aber wie sie ist, entspricht ihr Seyn ihrem Begriffe nicht; sie ist vielmehr der unaufgelöste
Widerspruch. Ihre Eigenthümlichkeit ist das Gesetztseyn, das Negative, wie die Alten die Materie überhaupt
als das \textit{non-ens} gefaßt haben. So ist die Natur auch als der \emph{Abfall} der Idee von sich selbst
aus-
% ---- printed p.197 (PDF 205) ----
gesprochen worden, indem die Idee als diese Gestalt der Aeußerlichkeit in der Unangemessenheit ihrer selbst
mit sich ist. Nur dem Bewußtseyn, das selbst zuerst äußerlich und damit unmittelbar ist, d. i. dem
\emph{sinnlichen} Bewußtseyn, erscheint die Natur als das Erste, Unmittelbare, Sehende. [Nature is in
itself, in the Idea, divine; but as it is, its being does not correspond to its concept; it is rather the
unresolved contradiction. Its peculiarity is being-posited, the negative, as the ancients grasped matter in
general as the \textit{non-ens}. Thus nature has also been expressed as the \emph{falling-away} of the Idea
from itself, in that the Idea, as this shape of externality, is in the inadequacy of itself with itself.
Only to consciousness, which is itself at first external and thereby immediate, i.e. to the \emph{sensible}
consciousness, does nature appear as the first, the immediate, the seeing.]''

It makes an infinite difference from which standpoint one considers the natural formations. If we begin from
below and look upward, then it seems as though the highest, the soul-like, were only a
contingent-necessary product of the elementary, and in this elementary the Idea becomes wholly lost. If we
begin, on the contrary, from above with the ensouled individuals, and look downward, then the elementary is
transformed into a moment for the teleological form-activity, and the Idea shows itself. The strife
subsisting between these views is so much the more exciting as it culminates precisely in man's own thinking
brain.

Seen from the elementary standpoint, conscious thinking is just as natural an effect of the vibrations of
the brain-parts as the flame is an effect of the substances' combustion, and light an effect of the ether's
trembling. Insofar then as there is in the brain-mass oxygen, hydrogen, carbon, nitrogen, and phosphorus,
especially phosphorus: ``ohne Phosphor kein Gedanke!'' [no phosphorus, no thought!] (Moleschott); one does
not on this standpoint get a higher concept of phosphorus, for phosphorus one knows for once in the
elementary; but one gets a raw concept of the essence of thought.

Seen from the organic-soul-like standpoint, the relation turns itself about. If the brain-mass's oxygen and
nitrogen and phosphorus can, by their organic combinations, condition and call forth something so spiritual
as thinking and consciousness, then these combinations must not merely be owed to a peculiar
principle-activity, but the carbon-atoms and phosphorus-atoms must, when they can serve as moments in so
spiritual an activity, themselves at bottom be of a far more spiritual nature than one should believe when
one otherwise sees phosphorus
% ---- printed p.198 (PDF 206) ----
and carbon in trade and traffic. Instead of sinking down to a low representation of the essence of
consciousness, we raise ourselves then from this point to a higher concept of the inner nature in the
elements conditioning consciousness.

For him who looks at the elementary, at the elementary substances and their atoms, it must seem impossible
that typically-organic formations should be able to proceed from the elementary atoms indifferent to such
formations. One has therefore also in science, in order to explain to oneself the origin of life, taken
refuge in a supernatural creative act; but since the supernatural falls outside the domain of our objective
knowing, science itself has with right rejected this explanation.

If we now consider the living individuals as products of birthing nature, what must then be understood by
the category: Nature? By Nature there can here impossibly be thought a peculiar life-force, since a peculiar
life-force would, according to the force's inseparability from matter, presuppose a peculiar life-substance,
and no such thing is given. By Nature there can here then neither be thought the elementary constitution of
the fundamental parts, since the fundamental parts can, according to their elementary constitution, be found
in the most different, also wholly inorganic, combinations. By Nature one must, however one turns and twists
the matter, necessarily think the Idea birthing and producing in and through the elements. In its organizing
activity Nature is Idea, the elements are its own moments; but only in immediate unity with the material is
the Idea Nature, and in its naturalness outside itself in sensible otherness: the Idea's moments are for
themselves subsisting elements.

In its reality the Idea of nature is double-sided: according to this double-sidedness the empirical and the
philosophical view must incessantly alternate with one another, strive with one another, repel one another,
approach one another.

\begin{center}\rule{0.35\linewidth}{0.4pt}\end{center}
% ---- printed p.199 (PDF 207) ----
\begin{center}
  {\Large\bfseries Conclusion.}\par\vspace{4pt}
  \rule{2.5cm}{0.4pt}
\end{center}
\phantomsection
\addcontentsline{toc}{section}{Conclusion}

In that the Propaedeutic has now, by making use of ``Points from the History of Philosophy,'' treated the
most important problems belonging under the Theory of Knowledge, the Theory of Science, and the Doctrine of
Ideas, it has become on the one side a philosophical whole for itself, on the other side ``an Introduction
to Philosophy.'' Insofar as the division here indicated makes possible developments of totality that have
their ground and significance in their own inner infinity, the Propaedeutic is a scientific whole; insofar
as the tasks belonging under each section are treated in survey, and are illuminated by freely chosen
examples, adapted to the hearers' need but yet according with factual knowledge, the Propaedeutic is only
an Introduction.

The boundary between being a scientific whole and being an Introduction is movable: here is a strict law and
a great freedom. The law of the development lies here, as everywhere for what concerns philosophy, not in a
finite choice of the material, but in the manner in which the chosen material is treated, not in a What, but
in a How. Even when a peculiar discipline, be it Logic, or Psychology, or Naturphilosophie, is brought
forward, it lies in philosophy's character that it must fetch its material from very different sides. If
then something extraneous, overburdening, disturbing mixes itself in hereunder, the fault must not be sought
in the material's heterogeneity, but therein, that the development of the concept is hindered
% ---- printed p.200 (PDF 208) ----
instead of being furthered, thus not in a What, but in a How.

If this now holds of every one of philosophy's peculiar principal subjects, then it must in still far wider
extent hold of the Propaedeutic as Introduction to the whole of philosophy. Philosophy's building has many
and different entrances; wherefore one can also by many different ways be led into philosophy.

To illuminate how, for the Propaedeutic's part, it stands with What and How, we will by a retrospect test
some examples. Let the tasks be: to determine induction, to illuminate the systematic, and to present the
relation between reality and the Idea. For the illumination of the first task there can be treated:
induction's relation to natural science, especially Kepler's determination of the Mars orbit, and so on.
For the illumination of the second task there can be treated the different and yet in a deeper sense
corresponding manner in which the scientific system forms itself in mathematics, in crystallography, in
botany, in zoology, in philosophy. In the treatment of the third task there can be chosen: from astronomy
the world-structure, from geology the earth-body, from physiology the animal organism.

That here now, in the choice and treatment of such heterogeneous elements, great blunders can be committed,
must be conceded; but what here again and again ought to be emphasized is, that the blunder never consists
therein, that heterogeneous constituents are chosen, but must be seen from the connection in which they are
chosen, from the manner in which they are treated, thus not from the treatment's What, but from its How.

In every special science the question, what shall be taken up, how much shall be taken up, has an
irrefutable significance. In every science it depends indeed not only on the material, but also on the mode
of treatment; but since the positive special science is a material-science,
% ---- printed p.201 (PDF 209) ----
the material-question here plays after all a decisive role. If now philosophy is among all sciences the only
one that cannot subordinate itself to the finite material-question, but must from first to last reserve to
itself the greatest possible freedom with regard to the choice of material, while it, in requital for this
freedom, again subordinates itself to the strict law of the development of the concept; then it is also from
this explicable how deeply philosophy is offended when one, without heeding the treatment's inner How, only
asks after the What, and looks at the material.

Although the Propaedeutic's principal sections are organic members, insofar as here is a completed science,
they are nonetheless, insofar as this science is treated as Introduction, by no means fixed rubrics. The
Theory of Science and the Doctrine of Ideas can as separate sections disappear without essential loss, and
the whole Introduction be treated as a Theory of Knowledge; it depends only on how. That the Theory of
Knowledge and the Doctrine of Ideas can in corresponding manner be drawn together under the Theory of
Science, this and the Theory of Knowledge again under the Doctrine of Ideas, that titles, divisions,
headings, and so on can alternate without the content thereby changing its fundamental character, is solely
and alone conditioned by this, that the emphasis falls, not on the material's What, but on the development's
How.

How intolerable the material-question is when it from without forces its way in over philosophy can be seen
in the following manner.

Let each of the named tasks be treated, by application of the named examples, in such a way as a penetrating
factual development would demand it. Under the treatment of the induction-question there has then been gone
into a number of concrete cases, and, as regards especially the Keplerian procedure, the methodical pointed
out point by point,
% [the Danish print reads „forbi" for „fordi" (d/b glyph confusion); corrected to „fordi" = because]
because each point just fitted to elucidate a side of induction's essence. As regards the question of the
systematic, there have been applied some mathematical
% ---- printed p.202 (PDF 210) ----
formulas, some crystallographic and mineralogical characteristic marks emphasized, and so on and so on. We
will now assume --- for something such does at least let itself be assumed --- that the heterogeneous
examples have not, as regards factual expertise, had anything burdensome for the tolerably prepared and
otherwise attentive hearer, since only those points were chosen, and only those sides emphasized, which, in
that they served the development of the concept, just for that reason in an easy and natural way found their
explanation in the connection of the concept; we will thereby assume that the development of the concept
has, with regard to each of the tasks, been so fruitful, and effected so considerable a combustion of
material, that herein could at the same time be contained an example of the philosophical thinking's
assimilating power: we then have herein the necessary presuppositions.

What here by these presuppositions shall be illuminated is now this, that the solution of the named tasks
may be as apt and as carried-through as it will; were it even a Plato, an Aristotle, a Hegel himself, who
for many years had worked himself into the analyses of reality, in order finally to apply them to the profit
of the cognition of the Idea: as soon as one from without begins to count the rubrics, set the raw
material-question in motion, and place the concept-side in shadow, even a mastery of presentation helps not
the very least; the whole is and remains a caricature.

How is it now really that philosophy is here treated? ``Oh, so-so! here are indeed set up some reflections
over induction, system-formation, cognition of the Idea, and so on; but it has no merit, since the
presentation takes up extraneous constituents. That Socrates spoke of porters, cobblers, weavers,
ass-drivers, and the like, is in its order, since it was Socrates; but here there is talk of ellipses, great
axes, radius vector, sections in the cube, mechanical and crystalline rock-species, yes, even of the
difference between bird and fish: all
% ---- printed p.203 (PDF 211) ----
together extraneous material, which has nothing to do with philosophy.''

Such a critique may be as superficial as it will, it finds only the more easily entrance; yes, it is just
calculated upon a superficial consideration. Such a critique is always secure between one of two objections:
``what is presented is unintelligible!'' --- it is so easy to play the fool who in philosophy does not
understand what the educated man otherwise, when it is outside philosophy, would be ashamed not to
understand; it is so interesting to play the fool when this foolery slyly betrays the true thoroughness that
knows that ellipses are treated in mathematics, and rock-species in mineralogy, --- or: ``what is presented
is trivial, one has it all in one's schoolbooks, and is only bored by a repetition!'' Such a critique is
rewarding, for while the one who philosophizes, who in the sweat of his face has worked up the tasks, so
that their treatment could be secure, sharp, penetrating, instructive, comes to stand as a muddled head who
confuses the domains, and, without survey over the whole, loses himself in particulars, the one who judges
comes, by his bit of cheap critique, to stand as the clear head who distinguishes the domains, yes, as a
whole man of overview.

The scientific thinkers who really have the ability and the will to work themselves into a philosophical
factual development, follow the dialectic of essence, test the analysis of reality, and appraise the
endeavor to assimilate the material, will, by pointing out faults, applying corrections, and finding out a
better method, in truth contribute to philosophy's advancement, and the one who philosophizes must, even
when he sees himself sharply set right, owe them thanks. But such worried men of overview, who neither have
the desire nor the occasion to work themselves into the matter's inner How, but on the contrary for
critique's sake might perhaps even well have a little desire and occasion to help philosophy along by
clearing off the
% ---- printed p.204 (PDF 212) ----
topsoil, counting the rubrics, taxing the headings, and measuring the concept with the material's yardstick,
such assessment-men the one who philosophizes cannot owe thanks, for they offend philosophy; such conduct
is then also not suited to further the students' cultivation, the true concerned parties' intellectual
education, but so much the better suited to further the half-critique of those standing outside, the true
unconcerned parties' foolish self-importance.
