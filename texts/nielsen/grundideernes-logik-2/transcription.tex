...
%
%  OPEN:
%   * Hebrew (p.55 note, 12 runs) needs a Hebrew font or the pdflatex build
%     fails; pointing unverifiable at scan resolution.
...
% BUILD: the Hebrew above is Unicode; the pdflatex preamble has no Hebrew font, so the real build will need one (or a substitute) here.
