...
% ============================================================
%  ------------------------------------------------------------
%  REPAIRED 2026-09-26 after the full collation of the Danish (see transcription.tex header):
%  30 edits bring the English into line with the corrected Danish -- wrong words corrected
%  (Stræben>Spiren "sprouting", døbende>dødende "put to death", raaber>raader "rules",
%  Stats/Stat>Skats/Skat "treasure", livende>lidende "suffering", støbes/støber>stødes/støder,
%  Bevaren>Vedvaren "continuance", ulykkelige>ulyksalige "wretched", nedskue>nedkue "suppress",
%  Menneskelivvær>Mennesketilvær), paragraph breaks, the p.3 rule, Latin in \textit, Greek as
%  printed; translator's footnote on "besmere" removed (print reads "desmere"). Misprints the
%  Danish keeps as printed are translated by their intended sense (e.g. p.21 "Elskede" -> "the
%  loving one"; p.149 "ustkker" -> "uncertain", i.e. usikker).
%  ------------------------------------------------------------
...
as life and individuality themselves. The beloved's lively expressions are sheer allurements, since they all
...
if something Divine (θεῖον τι) had touched it; everything
...
which now lives and rules in him, by no means as something ensnaring,
...
put to death the I-hood, when one loves from a full, undivided heart. Never
...
assure itself of the undivided continuance of its possession, all the heat and
...
ran the Lord's words already about the first human being. How much does the human being not need to communicate himself and open his
...
and breathes fragrance up toward heaven. And it thereby shows its inner competence. For it leads to a marriage; a
...
full existence, needs the other.

The individuals here show themselves,
...
in honour. It is its bashfulness and carefulness, esteem's tenderest
...
feels itself as little and lowly, and now fears to be thrust back; partly it
...
sympathy and love. It then itself thrusts back in order to hold itself,
...
were jars and contrasts the more, and thereby irritates one into bantering with it. Everywhere in
...
same time here is a calm security in the full feeling of a glorious treasure's
...
to each other and knit themselves to each other. A rich treasure of the
...
and will not suppress or pervert what speaks as truth in his inmost, or
...
this high freedom from envy, this αφθονία, only very few pure, undemanding,
...
being easily feels, in whom the natural human existence [Mennesketilvær] has
...
oneself of one's happiness's unchanged continuance---so into the shared life
...
sign and pledge of love's unbroken continuance and unweakened strength.
...
it into the wretched condition; and the fairer the heaven that seemed
...
alone, he desires; and the thought that what is bestowed on him was yielded
...
becomes, for the wretched passion, a never-ceasing source of pain and
...
freedom. On a desert island the human being suffering under jealousy's
...
in his inmost not become impatient or dispirited, but let untiring sprouting
...
rests, casts itself into an unsteady and uncertain
