...
% ============================================================
%  ------------------------------------------------------------
%  ACCURACY — FULL COLLATION 2026-09-26 (REPAIR-PLAYBOOK §5C; pgtools/COLLATE-WORKFLOW.md)
%  Assessment: random sample of 6 pp. (seed v1: 33,36,128,45,18,16), 5 errors = 0.83/pg
%    (2 of them printer's misprints silently corrected).
%  Collation: title page, prefaces and all printed pp. 1-173 read at the image by 18 collators
%    (pre-cut bands of the native 600 ppi scan, in printed order despite the scan's shuffled
%    binding of pp.41-56). Every word-level change, restored misprint, paragraph change and
%    doubtful reading went to a blind second reader on pre-cut crops (154 questions incl.
%    8 controls, all controls correct); disputes and single-reader doubts to a blind third
%    reader; majority of three decides.
%  Post re-sample 6 pp. (seed |post: 20,33,85,118,140,171): 2 single-reader items, both possible
%    misprints silently corrected (p.33 print "Elskcnde"?, p.140 print "nklar"?) -- NOT applied,
%    held here; 0 wrong words. Rate after repair <= 0.33/pg, all of it misprint class.
%  Applied: 69 corrections (wrong words that read as Danish, e.g. Stræben>Spiren, Bevaren>
%    Vedvaren x3, døbende>dødende, raaber>raader, Stats>Skats, forbærve>fordærve x5,
%    Baretægt>Varetægt x3, ulykkelige>ulyksalige x2, livende>lidende; modernised forms restored,
%    e.g. poetiskt, fuldkomment, døede, Drivten, temmeligen, letteligen; Greek accents/breathings
%    as printed; punctuation; antiqua \textit for Latin: sub rosa, eo ipso, pio animo, corpora
%    tantum soluta agunt, religio; footnote calls *)); 45 printer's misprints restored as printed
%    (mostly turned n/u sorts: udeufor, Tilværelseus, iudividuel, Gjeustanden, uu, nn ...;
%    also elstende, letttelig, hrormed, hviker, Hrad, siz, ustkker ...), each with an AS PRINTED
%    comment; 7 paragraph-break corrections and one printed rule (p.3); "Priis 48 Sk." added to
%    the title page.
%  Page markers: the old markers for the binding-shuffled pp.41-56 were mislabelled (by PDF
%    order) and have been replaced; about 70 others moved to the first word of their page;
%    \opage{III}-\opage{VIII} added. The text itself was already in the right order.
%  Emphasis: none in this print (no letterspacing or Schwabacher seen on any page).
%  Greek: letter forms ϑ/ϰ normalised to θ/κ (as ſ to s); accents and breathings as printed.
%  Held, not applied: p.79 "og fulde kjende" (collator: "og tilfulde"; 3rd reader: p.78 ends
%    "ja" -- unresolved); p.135 Afskillelse (collator Adskillelse, two readers Afskillelse);
%    p.0 "Efterskrivt ved tredie Udgave" is bold Fraktur in print, file \textit; p.0 comma in
%    "blive som den var"; p.173 "saɯmen" (turned m?, one reader). Rejected by two readers:
%    p.87 "det" (the print has "ret"; kept as printed with comment), p.123 "Det;",
%    p.140 "tilkyder", p.146 "faner".
%  ocrdiff against the Google Fraktur layer: 20 real of 209 candidates (1/15 in the sample).
%  Working files: texts/sibbern/om-elskov/.parts/collation/oe-collation.tgz
%  ------------------------------------------------------------
...
\opage{III} I flere Aar har nærværende Bogs første Oplag været udsolgt, og der
...
blive \opage{IV} som den var; Forandringer --- Smaating fraregnede --- følte jeg
...
herpaa. Men i nærværende \opage{V} Bog, ligesom i sin psychologiske Pathologie,
...
So vertraut' ich oft \textit{sub rosa}.\\
...
Skjelnen imellem det til Formaalet egentligen Henhørende \opage{VI} og det
...
komme i Stand ved mig, \opage{VII} vil vel efterhaanden vise sig for mig. Dette
...
\opage{VIII} Iøvrigt har jeg, uagtet jeg maa tilstaae, at jeg i sin Tid ikke uden
...
%% ============================================================
\chapter*{Første Bog.}
\markboth{Første Bog}{Første Bog} \apage{1}
...
Betydning, og kalder ved den ud af det Synliges vidt \apage{2} udbredte
...
til den Evige og i Troen paa \apage{3} hans uendelige Væsen, og denne Tro og
...
ægte Elskov finder Den, hvis Stræben er en lykkelig, begge i Eet, i sin \apage{4}
...
er vaagen og overalt er rede til \apage{5} at træde til, ikke, naar han ei
...
% AS PRINTED (collation 2026-09-26): «træder tilbage, Elskovs» — print sets a comma (clear tail, 2x crop) before the capitalised new sentence "Elskovs Længsel"; file silently made it a period
...
viser sin første Kraft i den inderlige Fryd, den \apage{6} uudslukkelige Lyst,
% AS PRINTED (collation 2026-09-26): «hrormed det ene Individ dvæler» — print "hrormed": the second letter is a plain r sort, the same shape as the r later in the word (2x crop); file normalised to hvormed
% AS PRINTED (collation 2026-09-26): «og hviker i, ja taber» — print "hviker": the fourth letter has a looped ascender with an arm at x-height (k), not the plain l of "udslukkelige" on the line above (2x crop); file normalised to hvi
hrormed det ene Individ dvæler og hviker i, ja taber sig i, Beskuelsen
...
fortrinligt \apage{7} hos det elskede Individ. Enhver, der elsker af Hjertet,
...
% AS PRINTED (collation 2026-09-26): «udeufor os og fatte» — turned n: print "udeufor"; the 4th letter matches the u of the same word, not the n of "denne" or of "udenfor os." three lines below (2x crop)
erkjende det Fortrinlige udeufor os og fatte dets Værd. Rørte sig den
...
holder begge forenede ved en \apage{8} sand Glæde ved hinanden, der er heller
...
Inderste qvæget, ved Det, han skuer som ved en evig Skjønheds \apage{9} uendelige
...
% AS PRINTED (collation 2026-09-26): «Sands for Tilværelseus indre Væsen» — turned n: print "Tilværelseus", u-shaped letter open at top, unlike the n of "Væsen" and "en" on the same line (2x crop)
Spil, den dybere Sands for Tilværelseus indre Væsen, eller en stille i
...
ogsaa for den fjærnere Iagttager viser \apage{10} sig som det meest Fremspringende
...
% AS PRINTED (collation 2026-09-26): «virkelig ægte Elskov, Den Elskedes» — print sets a comma (tail visible, 2x crop) before the capitalised new sentence "Den Elskedes"; same pattern as p.5; file silently made it a period
Indflydelse, kommer det til en virkelig ægte Elskov, Den Elskedes altid
sig selv lige indre Væsen, der med sin blivende \apage{11} Grundcharacteer udgjør
...
% AS PRINTED (collation 2026-09-26): «Liv og Eiendrmmelighed gaaer frem» — r for o after the line-break hyphen (Eien-/drmmelighed); clear r with flag and foot on 4x crop, same page prints Eiendommelighed correctly earlier
Individets hele Liv og Eiendrmmelighed gaaer frem. Dog yttrer Sjælens
% AS PRINTED (collation 2026-09-26): «den stærkeste Iddflydelse i den Maade» — d for n: two identical d sorts with leftward ascender after the I, matching the d of -flydelse
indre Herlighed den stærkeste Iddflydelse i den Maade, paa hvilken den
...
den indre Grundbevægelse i Sjælen, af \apage{12} hvilken Livsvarmen gaaer frem,
...
i den Elskedes mangfoldige Bevægelser \apage{13} og Yttringer, naar Livet hos
...
har letteligen saadanne geniale Øieblikke. Dog kan der stundom virkelig
...
vort \apage{14} Øie i en Stund, da vort Sind er frit og aabent nok til at modtage
...
ingenlunde er altid den Elskov \apage{15} fremkaldet ved et Blændværk, der synes
...
gjennemtrængende Udfoldning af den individuelle Fylde, være det i \apage{16}
...
Væsen som skjønt, ved hvis \apage{17} Beskuelse en Mindelse om den evige Skjønhed
...
Fornemmelser. Som i Solens Lys og Varme organiskt Liv udfolder sig i
...
Naturen, og som \apage{18} Kjærlighedens vidtudstrakte Rige ligger hele Naturen
...
% AS PRINTED (collation 2026-09-26): «at den elstende Sjæl, følende» — ſt for ſk (the known *elstende* misprint); t is plain, contrast ſkeer on the line above
snart, at den elstende Sjæl, følende det sælsomt Dybe i Det, der bevæger
den, trækker sig tilbage i sig selv. Den begynder at føle Livets høie
Alvor; det er, som om noget Guddommeligt (θεῖον τι) havde berørt den;
...
Attraa og Stræben med Mod og Selvtillid. Derved kan da ogsaa \apage{19} efterhaanden
...
% AS PRINTED (collation 2026-09-26): «en anelselsfuld Forudfølelse» — dittographic misprint anel-sel-sfuld, confirmed on crop
i dens indre Lyst, og den stille, dybe Længsel og Glæde, i hvilken en
anelselsfuld Forudfølelse af et stort endnu slumrende Liv stod i den
...
gaaer tilbage, ret som om Livets hele Fylde strømmede \apage{20} til ham fra denne
...
Indflydelse, som nu lever og raader i ham, ingenlunde som noget
...
Aanden gjør overalt fri. Inderlig at hænge ved \apage{21} et elsket Væsen og at
...
tilintetgjørende og dødende Magt, naar man elsker af et fuldt, udeelt
Hjerte. Ingensinde føles det Jegiskes dybe Armod snarere.

% AS PRINTED (collation 2026-09-26): «den Elskede, i sig» — adjudicated (2nd/3rd readers)
Hvo der elsker, er af Hjertet ydmyg. Hvor lidet forekommer den
Elskede, i sig Følelsen af sin Mangelfuldhed værdig til at elskes af
...
Den dybe Beredvillighed til at give Alt hen for \apage{22} den Elskede og den dybe
...
hen, eller ligesom døede hen og løstes op i det almene evige Liv, og
...
Ydmyghedens søde Følelse ligger da nu ogsaa i Elskoven og hører \apage{23}
...
uendeligen ydmyge, saa meget de end ere for \apage{24} hinanden. Jo mere den
Elskende ophøies og prises, desto dybere føler han sig som Den, der
% AS PRINTED (collation 2026-09-26): «Gave, a han» — the t of "at" is not printed (2nd+3rd readers)
Intet er, og selv maa tage Det som en uendelig Himmelens Gave, a han
% AS PRINTED (collation 2026-09-26): «sin Elskede sag Meget. Derfor» — wrong sort: final letter of "saa" printed as g (clear descender, unlike the a before it)
kan være sin Elskede sag Meget. Derfor fylder ogsaa Kjærlighed med den
...
at det er saligere at modtage \apage{25} end at give, hvilket ogsaa ganske stemmer
...
selv saa henrevne, at vi i denne Henrevenhed selv \apage{26} modtage en fra en
...
til en ulyksalig høi Grad \apage{27} voxen Afvigelse fra Naturen og dens
...
tage det i Besiddelse. Begge \apage{28} Dele, Hengivenheden og Attraaen efter
...
Konstgreb, \apage{29} begjærlig efter Indsigt og fuld af Paafund; han
...
% AS PRINTED (collation 2026-09-26): «rig ellet fattig» — wrong sort: t (crossbar and ascender as in "fattig") for r
igjen, saa at Eros hverken er rig ellet fattig, og ligeledes staaer
...
i blot organisk Henseende er Drivten i sit Udspring en individuel og
...
delende Alt med samme, at nyde \apage{30} Livet som en uafbrudt Elsken. Derfor
...
den udeelte Vedvaren af dets Besiddelse, optændes nu letteligen alt det
...
let midt under den himmelske Glæde en fra Skinsygens frygtelige Helvede \apage{31}
...
vi blive ved \apage{32} med at betragte Elskoven i den skjønne Skikkelse, hvori
...
saaledes løde Herrens Ord allerede om det første \apage{33} Menneske.
...
% AS PRINTED (collation 2026-09-26): «hvori han ellers letttelig hilder» — print has "letttelig" (three t), confirmed at 2x crop; file silently corrected
for Meget, hvori han ellers letttelig hilder sig selv, at han kan lette
...
er. Umiddelbart, som Begge leve, ligger den Enes Liv og hele \apage{34} Sjæl aaben
...
med dobbelt Styrke. \apage{35} Ligesom Intet kan være ham mere magtpaaliggende hos
...
vilde ellers selv fordærve sin Elskovs rene Skjønhed. Samvittighedens
...
dobbelt; just \apage{36} idet han afspeiler sig selv, som han lever i og for et
...
klarere, end for sig selv i sine urolige Øieblikke. Hvor meget og hvor \apage{37}
...
i det Livsforhold, der endnu altid maatte blive ved at være poetiskt og
...
ud et heelt Liv igjennem. Ja dens indre Skjønhed og \apage{39} Kraft viser sig
...
og mere Det, der er det \apage{40} rette Væsen, det indre Aandelige, kan komme til
...
Existents trænger til det andet.

Individerne vise sig her da som de
...
til hinanden hørende Dele af \apage{41} en høiere Heelhed, men en Heelhed, hvilken
...
Fyldestgjørelser ideligen kunne \apage{42} vende tilbage, og Kjærligheden ideligen
...
Evighed, derfor lever nærmest \apage{43} den nuværende Slægt. Ei heller gaaer hiin
...
sig selv et høiere og herligere Liv, medens de \apage{44} fremelske --- en egentlig
...
Helligt og Poetiskt ud af Gjenstandene og alene leve af dette overalt i
...
\apage{45} naturligt Liv. Dog, selv et sundt og reent Gemyt kan vel, især under
...
en uophørlig Sørgen og Virken for elskede Væsener, en ny \apage{46} Kjærlighedens
...
alle gode Øieblikke føles Elskov som en uendelig Omhu og Varetægt, og i
...
Betænkning og Bekræftelse \apage{47} gjennemtrængende udbrede sig til de øvrige. Jo
...
Blyhed og Vaersomhed, Agtelsens ømmeste Yttring, en vis hellig, til
...
og nu frygter for at stødes tilbage; deels stræber det ogsaa selv imod;
...
jo stærkere Modstanden \apage{48} var, eller kunde have været, i første Øieblik, jo
...
at kunne sunde sig, til at aabne sig ret fuldkomment for Sympathie og
Kjærlighed. Det støder da selv tilbage for at holde sig, imedens det
...
ofte tillige en vis Skyhed og Strenghed, ja en vis indre Stolthedens
Følelse, hvortil Sindet ligesom tyer hen, naar det Tidspunct nærmer sig,
% AS PRINTED (collation 2026-09-26): «skal føle sig sig hendraget» — dittography "sig sig" as printed
da Hjertet skal føle sig sig hendraget saa stærkt til et andet Hjerte,
at det skal tabe sig selv til dette. Fordærvelig bliver denne Stolthed
...
hiin \apage{49} hellige Fjærnhed under Elskovs Hengivenhed og Sympathie! Selv under
...
Ogsaa udadtil yttrer sig hiin vaersomme Fiinhed, saavelsom hiin i sig
...
det kan være mod mangt et \apage{50} efter Elskovs søde Glæde længselfuldt Gemyt,
...
% AS PRINTED (collation 2026-09-26): «de Elskende uu gjækkes» — turned sort: print "uu" for "nu" (both letters u-shaped at 2x crop; the n of "synes" on the same line is normal)
Følelsens Inderlighed. Men medens de Elskende uu gjækkes og synes at
slaae sig selv løs fra deres Kjærligheds Overmagt, nyde de netop det
søde Samqvem med hinanden. 

\apage{51} Dog er ogsaa ellers i det Hele Elskovs muntre, ofte saa tækkelige
...
støder og contrasterer \apage{52} desmere, og derved irriterer til at gjækkes
dermed.% [collation 2026-09-26: print has "desmere" (d, not b); FLAG resolved]
...
\apage{53} alvorliggjørende Magt. Selv i Elskoven yttrer sig da nu ogsaa denne Lyst
...
Forbittrelser og Udsoninger. Dog, disse Opirringers Fordærvelighed vil
...
vækker Lysten, \apage{54} det Henrykkende og Rørende, saa meget det end er den
...
Elskede? Hvo der elsker, lære \apage{55} dog at elske med dyb Inderlighed uden den
...
skjænke os Fryd viser \apage{56} Elskov sin kraftige og velgjørende Indflydelse.
...
% AS PRINTED (collation 2026-09-26): «Gjeustanden, jo mere alt Personligt» — turned sort: print "Gjeustanden" (u for n; the n of "-anden" in the same word is normal)
Gjeustanden, jo mere alt Personligt kan tie og tabe sig i den fulde
...
% AS PRINTED (collation 2026-09-26): «forhøier vor persolige Selvfølelse» — dropped letter: print "persolige", set closed with no gap
Tilfredsstillelse: Endeligen er Alt, hvad der opliver og forhøier vor
persolige Selvfølelse, af ikke ringe Magt i at fremkalde Glæde. Paa
...
virker med og giver Følelserne Dybde og Inderlighed. \apage{57}
...
en rolig Tryghed \apage{58} i den fulde Følelse af en herlig Skats tilforladelige
Besiddelse.
...
Sindsrørelser, \apage{59} dette komme nu til inderlig Klarhed i ham, og han tilegne
...
% AS PRINTED (collation 2026-09-26): «Derfor maa nn ogsaa til Elskoven» — turned sort: print has "nn" for "nu" (both letters n-form on 2x native crop; contrast "nu" elsewhere on the page)
Alt, hvad der lever deri, sin Bestaaen. Derfor maa nn ogsaa til Elskoven
...
den anden Side ved en fast \apage{60} Beslutning tilegne os det nye Liv, der gaaer
...
Elskoven, end Følelsen af denne \apage{61} Troskab fra vor egen og Visheden om den
...
sig til hinanden. En rig Skat af de \apage{62} skjønneste Erindringer tager
...
modstrider den. Dog, saadanne Tilfælde komme vi til at betragte
nærmere, naar vi komme til at tale om ulykkelig Elskov. \apage{63}
...
deels ved \apage{64} Kraften af det Gode og Herlige, de i hinanden skue og
...
% AS PRINTED (collation 2026-09-26): «skue ind dets dybere Væsen» — print omits "i" ("ſkue ind dets dybere Væsen"); file silently supplied it
hinanden skue ind dets dybere Væsen og nyde dets dybere Fylde.
...
skal drive ham ustadig og veiløs om, og sætte \apage{65} Sindet i Uro og Tvedragt
...
overalt glædedes ved at møde sin Gud. Misunder \apage{66} dog ikke Eders Elskede
...
inderlige, søde Omhyggelighed, den hjertelige Varetægt, som vil, at den
...
sig selv tro, og ei vil nedkue eller forvende, hvad der som Sandhed
...
Uskyldige og Gode, end \apage{67} at udsætte sig for Fare og Ufred, og glemme ei at
...
Skal ogsaa det salige Liv være et brændende, og ei engang \apage{68} Hjemgangen til
...
% AS PRINTED (collation 2026-09-26): «og iudividuel Fylde» — turned n (prints as u); compared with n of "nu den" on the same line in a 600 ppi crop
naar Livet har hævet sig til ægte Frihed og fuld Personlighed og
iudividuel Fylde, nu den Egoismens Braad kan falde ud, hvormed vi her
...
% AS PRINTED (collation 2026-09-26): «et følgeude Liv» — turned n (prints as u); compared with n of "nei" on the same line in a 600 ppi crop
ingenlunde skal troes at være fortabt eller forbi for et følgeude Liv,
...
hvorsomhelst. Og \apage{69} hvad Sympathien og Meddeelagtigheden angaaer, og den
...
nemlig giver sig saaledes hen, at det i og med det samme (\textit{eo ipso}) giver
sig hen til Herren, hvem vi møde paa tusinde Veie. --- Dog, til denne
% AS PRINTED (collation 2026-09-26): «αφθονία» — no breathing on the initial alpha in print (2 readers); the earlier occurrence of the word has it. ϑ/ϰ letter forms are normalised to θ/κ throughout, as ſ is to s.
høie Misundelsesfrihed, denne αφθονία, ere kun meget faa rene,
...
%% ============================================================
\chapter*{Anden Bog.}
\markboth{Anden Bog}{Anden Bog} \apage{70}
...
ormstukne, og næsten ikke een ret fuldkomment moden og tillokkende? \apage{71}
...
udspringende, være det og af de stærkeste \apage{72} Drivter bevægede Elskov, der
...
Forhold frembyder os uden Ophør den evindelige \apage{73} Tomhed.“ Men hvor
...
snarest, medens \apage{74} den Elskedes Hjerte endnu er frit. Ligger først en
...
ulykkelig givt? Men i en ungdommelig Periode kan Individet ei engang
...
det end, at Hjertet ellers bevæges af ægte Agtelses og \apage{75} Velvillies
...
bestemtere Skikkelse; \apage{76} Følelsernes Fylde har virket, som den kunde, og
...
% AS PRINTED (collation 2026-09-26): «en Fordriug med» — turned n (prints as u); compared with n of "bringer"/"en" on the same line, enlarged crop
at overskue sin Tilstand, jo mere det bringer en Fordriug med,
...
vil henrive den maaskee uroligt higende Natur, virke langsomt, \apage{77} til den
...
indre høiere \apage{78} Stemmes tilforladelige Samstemming lader Individerne blive
visse paa, at det ei er Vilkaarlighedens Spil og eget Tykke, der driver
dem. Ethvert Egteskab maa sluttes med et fromt Sind (\textit{pio animo}). Men det
...
hendes Elskov, at skulle trækkes ind i Egteskabets Sorger, ja \apage{79} bære
...
% AS PRINTED (collation 2026-09-26): «Hertil kommer. at til den» — full stop printed for comma (2nd+3rd readers)
...
ogsaa en urolig Utaalmodighed, sin fordærvelige Indflydelse. Naturens
...
leve med hinanden og at skue hinanden ret ind i Sjælen og \apage{80} fulde kjende
...
altfor ofte ile Menneskene utaalmodigen fremad, uden at samle Sindet \apage{81} og
% AS PRINTED (collation 2026-09-26): «og redeligeu at gjøre» — turned n: final letter printed u (open at top, joined at foot), crop checked
at gaae ind i sig selv, og redeligeu at gjøre sig Rede for deres Hjertes
...
sat sig fast, \apage{82} for at enhver kan aabne sig for det nye Livs
gjennemtrængende Varme, og begge ret kunne blive til Eet. Det bekjendte:
\textit{corpora tantum soluta agunt}, kan ogsaa overføres paa det Sjælelige. Men
...
Mellemrummet imellem begge Tidspuncter ikke, som det \apage{83} forhen hos os ved
...
% AS PRINTED (collation 2026-09-26): «saa mange Lidenstaber» — ſt ligature for ſk after the line-break hyphen (Liden-/ſtaber); glyph identical to the ſt of Sindsſtemninger on the next line, crop checked
nu skulde lide ved at gives til Priis for en af saa mange Lidenstaber
% AS PRINTED (collation 2026-09-26): «altid vaersomme, stundom» — extra e: printed "vaerſomme", a and e as two separate sorts, crop checked
eller Sindsstemninger bevæget Mængdes just ei altid vaersomme, stundom
...
maa skee, fordi Elskendes \apage{84} Samliv dog engang maa frem for Dagen, og
...
plager mangt et Sind; \apage{85} ja det hændes vel, at Den, der viiste stor Omhu og
...
% AS PRINTED (collation 2026-09-26): «nnder idelig Strid» — turned u: first letter printed n (joined at top, like the next n), crop checked against "under" three lines below
ødende for Aand og Hjerte, at leve nnder idelig Strid og Disharmonie med
...
Bestand nok, for at det næste Skridt bør \apage{86} voves. Hvo der, indseende, at
...
Og dog, dersom ingen Tilknytning skal turde ende med en Gjenadskillelse,
...
% AS PRINTED (collation 2026-09-26): «det uvisse først,» — comma printed at paragraph end (2nd+3rd readers)
sig for at vække det uvisse først,

\begin{center}\rule{0.28\linewidth}{0.4pt}\end{center} \apage{87}
...
% AS PRINTED (collation 2026-09-26): «at ret dem forundte» — "ret" printed for "det" (2nd+3rd readers)
...
hende, hvem hun maa beherske for at \apage{88} kunne leve med ham. Der er Noget,
...
Betydning og dens Dybde, og pleier og nærer \apage{89} den med Lyst. Clärchens
...
Sindelag maa \apage{90} intet Menneske være, mindst en Qvinde, der skal være
Egtefælle og Moder.
...
noget Paafaldende, naar \apage{91} kun Begge ikke ere for ulige i Aand og Dannelse.
...
deres saa ofte temmeligen henvisnede Stammer med friskere Safter, og
...
være Fyrste med den Forret at \apage{92} være udelukket fra at nyde en reen
...
Sider; thi da fører det let med sig, at den Yngre ei kommer \apage{93} til at finde
...
ja ligesom med Flid sætte sig fast, som om det var en \textit{religio}, en hellig
...
Mildhedens og Overbærelsens og en vis sjælelig Varetægts og Omhues dybe
og søde Følelser. Et kraftigt følende Væsen vil endog ikke, at det
skulde synes for den Elskedes Øine at være Mere eller Andet, \apage{94} end hvad
...
heftigt fordrende Individer, der med en sælsom Forvirring \apage{95} yttre sig og
...
tillige ved den Fjærnhed, \apage{96} hvorved Begge holdes ude fra hinanden, og
...
aandfuldere, ja fordærve hele Forholdet. Mennesket maa overalt være
aarvaagent og vogte sit Hjerte \apage{97} og vaage over sin Elskedes tillige og
...
Elskovens Fylde, end Nogen i \apage{98} Øieblikket troer. Og De, der ofte irritere
...
isolerede Liv ved Siden af hinanden, \apage{99} istedetfor at leve et, begges hele
...
hinanden og gjøre af hinanden; og nu, \apage{100} for dog at bringe en vis
...
\apage{101} altid kjærkomne, og kunne ei være det, naar de træde forstyrrende ind i
...
Indre, alt Dette træder frem i Mennesket i et Indbegreb af Forestillinger \apage{102}
...
udtrykker og nyder sit indre Liv, saa at derved begges aandelige \apage{103} Liv paa
...
dele Alt, hvad der griber ind i det Liv, enhver af dem lever! Er end \apage{104}
...
Noget maa, som Schiller treffende lader Choret synge i \apage{105} Bruden fra
...
% AS PRINTED (collation 2026-09-26): «Den Lignelse, at eu Mand er viet» — turned n: print has "eu" for "en" (clear u, open at top, against the n of "Mand" beside it; confirmed on a 600 ppi crop)
Opfyldelse. Den Lignelse, at eu Mand er viet til sit Studium og sit
...
vistnok ei altid er. Men hvor skjøn er især Qvindens Stilling \apage{106} i denne
...
skjøn Tjeneste, og det en dobbelt skjøn, naar den dreier sig umiddelbart \apage{107}
om høitagtede Mænds Personligheder, det føler letteligen ethvert opvakt
og fyrigt qvindelige Væsen, hos hvem den naturlige Mennesketilvær ei har
...
% AS PRINTED (collation 2026-09-26): «komme hun ttl den Raadighed» — wrong sort: print has "ttl" (second letter shows t-crossbar and t height, stray specks either side) — second eye advised
tjene, komme hun ttl den Raadighed, der tilkommer hende i Huset! Ingen
...
den sande Følelse der, \apage{108} den ægte, dybe Kjærlighed, der gjør aarvaagen og
...
fra, at jordisk Overflod og Pragt skulde fremme en \apage{109} begyndende
...
% AS PRINTED (collation 2026-09-26): «her vaersom og høre» — extra letter: print reads "vaersom" (clear e, normal spacing)
Menneskene. Især være Qvinden her vaersom og høre ikke op at være
kjærlighedsfuld og ydmyg af Hjertet, fordi hun er bleven lykkelig. Vel
er det naturligt nok, at det qvindelige Væsen, der, medens hun \apage{110} endnu
...
blot som en Gjeld ønske vi dog ikke, at Elskov skal ydes os. \apage{111} Ingen
...
har aabnet sig. Og hvad ikke slige Lyster, hvad ikke alskens \apage{112}
...
ægte Nydelse derfor, fordærve det Sødeste og Qvægeligste i deres Samliv,
den ømme dybe Omhu for hinanden og den hyggelige Tilbagetrukkenhed og
% AS PRINTED (collation 2026-09-26): «kjærlighedsfulde Indskrækning, der først» — dropped letter: print reads "Indskrækning" (no n, even spacing; cf. correct "Indskrænkning" p.109)
kjærlighedsfulde Indskrækning, der først gjør Samlivet til et sandt
idylliskt Liv, Noget, hvorved Egteskabet i sin Begyndelse saa meget
forskjønnes.
...
sig og antaget en \apage{113} bestemt Skikkelse, skulle løsnes, for at voxe sammen
...
% AS PRINTED (collation 2026-09-26): «Ligevægt i Aanden: Men» — colon printed (2nd+3rd readers)
...
sin forrige Bane, sværmer omkring i den nye Region, uden \apage{114} fast Holdning i
...
slet ikke hvile aldeles, da Livet \apage{115} kun danner sig og griber om sig i og
...
Eensidighed kan nu komme frem, og det \apage{116} viser sig ofte ret tydeligt, at
...
Vedvaren, saaledes ind i Samlivet, at derved mangen Irritering opstaaer,
...
vel kunne stemme sammen, fordi de ei svare til hinanden, \apage{117} hvor meget end
...
\apage{118} enhver ugrundet. Nidkjærheden vilde endog ei synes stor nok, naar den ei
...
Kjærlighedens uafbrudte Vedvaren og usvækkede Styrke. Netop med Elskovs
Tvivl og Qvaler, Ængstelser og Forbittrelser \apage{119} sønderriver sig her det
...
komme til en Fordring, ansporer til de mange \apage{120} harmfulde Bevægelser, til
...
Indtændthed og Heftighed, der efterhaanden, som den fordærver Elskovens
egen Skjønhed og gjør Sindet øde, nu ogsaa fordærver og ødelægger det
hele Samliv. Just Individets Lykke fører det ind i den ulyksalige
...
% AS PRINTED (collation 2026-09-26): «dog let saa vaersomt og frygtsomt» — print sets "vaersomt" (separate a and e sorts, confirmed on a tight crop) for varsomt; file silently corrected
Sindelag, tilbøieligt til Ro, saa kues det let, eller bliver dog let saa
vaersomt og frygtsomt, at Samlivets Friskhed, Livelighed og Munterhed
...
saadan \apage{121} Ukjærlighed kommer da tilsidst den heftige skinsyge Kjærlighed,
...
\apage{122} Vi see saaledes, endnu uden at en Tredies foruroligende Tiltræden virker
...
hvad den \apage{123} indtil Jalousie heftige og brændende Elskende vil møde og vide
...
attraaer han, og den Tanke, at Det, der skjænkes ham, alene ydedes ham
...
paalægger ogsaa da piinlige og indsnævrende \apage{124} Baand, og forjager den
...
% AS PRINTED (collation 2026-09-26): «en ægte Kjærlighed.. Ikke» — doubled full stop in print (two baseline dots, confirmed on a tight crop); file silently corrected
...
Kæmpen og Higen, Tvivlen og \apage{125} Forsagen, den idelige Reflexion paa sig selv
...
det, Dette bliver nu for den ulyksalige Lidenskab en aldrig standsende
...
gad det under Jalousiens \apage{126} Heftighed lidende Menneske leve med den
...
føre til \apage{127} Mistillidens eller de ideligen paa ny opæggede Tvivls
...
% AS PRINTED (collation 2026-09-26): «du end elsker,. dog finde» — comma followed by a stray stop (2nd+3rd readers)
dig, saa beslut hos dig selv, at nu \apage{128} vil du, saa heftigt du end elsker,.
dog finde dig i, om det skulde saa være, at Gjenkjærligheden hos din
% AS PRINTED (collation 2026-09-26): «stærkere eller tryggere» — already as printed (collator PRN)
...
ikke utaalmodig eller modløs, men lade ufortrødent Spiren til det Bedre
...
vel de fleste med ungdommelig Fyrighed \apage{129} elskende Sjæle nær nok for
...
% AS PRINTED (collation 2026-09-26): «Det viser sig her, hror farligt» — misprint "hror" for "hvor": second letter is an r sort, identical to the final r (native crop, positive signal)
tilforladelig nok, eller aldrig høi, reen og guddommelig nok. Det viser
sig her, hror farligt det er at have andre Guder foruden Herren. Just
...
%% ============================================================
\chapter*{Tredie Bog.}
\markboth{Tredie Bog}{Tredie Bog} \apage{130}
...
at besidde en tilforladelig Tilflugt \apage{131} under alle Livets Hændelser: hvilke
...
% AS PRINTED (collation 2026-09-26): «fængsler et elskværdigt. Væsen» — stray full stop printed (2nd+3rd readers)
...
det bliver tungt og trykkende for det følende \apage{132} Hjerte! Imod alle
...
et oprørt \apage{133} Hav, veiløs kastes frem og tilbage under en urolig Vexel af
...
Nødvendighed, endog om Hjertet maaskee endnu ei har revet \apage{134} sig løs, er
...
ringere Tilladelighed fremkalder, \apage{135} naar de betragtes fra Lovgivningens
...
saa var ofte Egteskabet det endnu mindre. Det forholder sig \apage{136} hermed som
...
Forældrenes Adskillelse være det Raadeligste. En rolig, fredelig, tryg
...
knytte Forbindelser, der \apage{137} aldrig burde have været indgaaede, saa bør,
...
Letsind og Uregjerlighed \apage{138} var. Mangen Disharmonie, der nu fører til et
...
paa Adskillelsens Lethed gjorde mindre agtsom og omhyggelig. Naar
...
% AS PRINTED (collation 2026-09-26): «til det Heie ogsaa de» — i printed for l (2nd+3rd readers)
være det Raadeligste. Dog glemme man ikke, at til det Heie ogsaa de
...
Ærefrygts og Religiøsitets Følelser i Bevægelse, kunne bringe
...
kirkelig Act, som de indgaaes ved den. Som da \apage{139} overhovedet Skilsmisse vel
...
\apage{140} at en saadan Hengivenhed, et Liv, hvori det saaledes har tilhørt en
...
ingensinde henhøre. Og heri have vi da \apage{141} Noget, som kan orientere og lede i
...
% AS PRINTED (collation 2026-09-26): «skuffe sig. Hrad der ei er ægte» — wrong sort r for v; clear flagged r, cf. "vende" next lines
vogte sig for at skuffe sig. Hrad der ei er ægte og godt, kan ei føre til
...
% AS PRINTED (collation 2026-09-26): «vende siz som fiendtlige» — wrong sort z for g; flat-topped ʒ-form, unlike the closed-bowl g of "mod sig selv" two lines above
Love, naar vi overtræde dem, vende siz som fiendtlige mod os selv;
...
Personen, som Person, og fordi denne Person var \apage{142} os og er os, hvad den var
...
heldigen paa dette og kan holde sig selv reent, saa vil \apage{143} det netop føle
...
Qvide og Plage, og er dem en saa stor Anledning eller \apage{144} Fristelse til, at
...
% AS PRINTED (collation 2026-09-26): «Skilsmisse er just et altid» — misprint "et" for "ei": second letter is a t with crossbar and t-height (crop checked); stray speck above, no i-dot
En i Mindelighed fuldbragt Skilsmisse er just et altid, om end Begges
...
mange matte og mørknede. Et Brud med Den, der engang var Hjertet \apage{145} kjær,
...
Forhold, der vitterligen blev indgaaet \apage{146} uden egentlig Kjærlighed, tør
...
Tilbøieligheden dertil, hvor det har bundet sig \apage{147} ved et Løvte, som, var
...
Andens Skyld, uagtet den indre Modstræben, at holde \apage{148} fast, for ei at
...
og altid uretlige og \apage{149} formastelige Bemægtigelse skal blive ved at binde
...
% AS PRINTED (collation 2026-09-26): «Beslutning og vaersomt. Thi» — already as printed (collator PRN)
...
seer sig fængslet, kan ei tænke sig som det, der uden en Styrelse, det maa
...
% AS PRINTED (collation 2026-09-26): «ustadig og ustkker» — print has 7 sorts u-ſt-k-k-e-r: the second sort is the ſt ligature, identical to the ſt of "ustadig" in the same line (checked at 2x/6x crop); intended "usikker". File's 
ustadig og ustkker%[collation 2026-09-26: the print reads "ustkker" (ſt for ſk); kept as printed, see AS PRINTED note]
...
\apage{150} selv! Hvor vigtige Beslutninger skulle fattes i Anliggender, der dreie
...
eller løse Forvirringer, ville vi strax gaae til en anden \apage{151} Gjenstand, om
...
endnu mere maa en kraftig Følelse for \apage{152} den egteskabelige Forbindelses
...
Nogen. Denne Betragtning kan ogsaa finde Plads der, hvor det just \apage{153} ikke
...
de bedste Følelser til at opoffre sit indre sjælelige \apage{154} Velbefindende, for
...
stridige Bevæggrunde og \apage{155} Tilskyndelser, som indtræder, naar Talen er om at
...
men ogsaa agte selv den begjærede Lyksalighed for meget, til at kjøbe den \apage{156}
...
\begin{center}\rule{0.28\linewidth}{0.4pt}\end{center} \apage{157}
...
Kraft i en Menneskesjæl, og hvor det er et Menneskes Tilskikkelse, \apage{158} at
...
midt i sit rette Element, naar \apage{159} den mildeste Luft vifter og lokker; at
...
faae Raaderum eller
\apage{160} spille Mester. Det er noget saa usigeligt Qvægende, Oplivende, Noget,
...
er dog i og for sig allerede en kummerlig \apage{161} Tilfredsstillelse. Og derfor
...
Bortfjærnelsen stundom mere og hurtigere, end man skulde ventet. \apage{162} Thi har
...
% AS PRINTED (collation 2026-09-26): «saa høit, Dog» — comma for full stop before capital "Dog" (comma clearly formed at 2x crop)
...
ved Siden af Elskoven, fordi, naar den stærke Begjæring og Higen \apage{163} kommer
...
skal komme ved en lykkelig, al Attraa stillende Forbindelse; og \apage{164} for den
...
som paa det Væld, hvoraf et nyt kraftigt Liv er i Stand \apage{165} til at rinde
...
\apage{166} den Elskede, og spørger: hvor? hvorhen?, og derfor ogsaa let kommer til
at spørge: til hvad Ende dog og hvorfor det maatte lide det smertelige
% AS PRINTED (collation 2026-09-26): «Tab, og nn ei synes sig» — "nn" for "nu" (turned u; both letters show the n top arch at 2x crop, line-end)
Tab, og nn ei synes sig at have et fast Punct, hvortil det kan fæste
...
levende Udmaling af sammes Elskværdighed, \apage{167} er derimod trøstende og
...
desto rigere vil i Sjælens Inderste \apage{168} Samfundet med den Fraskilte endnu
...
Kraft føle denne \apage{169} midt i sine Længsler efter den Bortrykkede og i sin
...
Rige! Er det \apage{170} Kjærlighedens Natur, at den bringer et Individ til, saaledes
...
beredes \apage{171} Den, der tager Tilskikkelsen, som enhver Tilskikkelse skal og kan
...
rensende Liv, som et \apage{172} Liv i Gud og et Liv for Evigheden. At døe --- saa
...
og et roligt, trygt, \apage{173} lidenskabsfrit Liv indtræde. Og det kan ofte være
