...
\apage{1} \begin{center}\large\S~1.\end{center}
\markboth{\S~1}{\S~1}
...
selv vil sees,  \apage{2} og maae forfølge den i dens hele Conseqvents, saa at altsaa
...
derved har været \apage{5}  i Bevægelse, saa ledes vi herved til at betragte
...
danne sig, blive det dog tilsidst kun  \apage{6} 5) \emph{Tilværelsens}, eller som man
...
%% ============================================================
\grouphead{Indledende Betragtninger.\\[2pt]\normalsize Om Erkjendelse i Almindelighed.} \apage{7} 
...
\emph{deels} dennes Bestemtvorden og dermed indtrædende \apage{8}  Kommen til Bevidsthed,
...
\emph{Anm.~1.} Naar der her tales om et „er", saa see vi her ikke allene
...
For at det Sande skal komme til en saadan høiere \apage{13}  Hersken, maa først den paa
...
Gyldighed, fordi vi anerkjende ifølge en i Indsigt grundet udtrykkelig \apage{14} 
...
\apage{15} En saadan intelligent Erkjenden danner sig under al til sit Maal kommende
...
Sammenhængs og Forholds Forfølgelse, deels b) bestaaer i en Erkjendelse \apage{16}  af selve
...
hvilken sidste deels den æsthetiske, deels Troen og hvad der monne være at  \apage{18} stille
...
Tre Ting er der herved at see hen til: Vi bemærke,  \apage{20} at vi ikke allene maae a)
...
Forsaavidt den indtrædende Spørgen og Randsagelse  \apage{21} fører til den Prøvelse,
...
besjælet, beaandet.\par} \apage{22} 
...
Detail, ved en intelligent og rational Forfølgelse af selve Sagens Detail,  \apage{23}
...
Iagttagen af  \apage{24} alt det Enkelte i dets Enkelthed bestandig gjøre sin Ret gjeldende,
...
\markboth{\S~8}{\S~8}
\begin{center}Philosophie \apage{25}  gaaer d) ud paa en altomfattende Grunderkjendelse.
...
Gang Det, vi antage og ifølge denne \apage{26}  Antagen erkjende; men Bestræbelsen gaaer da
...
Paalideligheden af alle hine relativt første Kilder \apage{27}  og Gyldigheden af deres
...
kræve os selv til Regnskab med Hensyn \apage{28}  til vor Opfattelse af det Objective, men
...
Stilling med Hensyn til det Objective, vor hele \apage{29}  Indlemmethed i og Grundforhold til
...
\emph{Anm.~2.} Her opstaaer det Spørgsmaal, hvorvidt en saadan Lære, som
...
\emph{Anm.~3.} Angaaende en Skepticisme, som Humes, er noget Lignende at
...
\emph{Anm.~5.} Det maa her overhovedet bemærkes, at vor Bestemmelse af
...
Opklaring, forud gjør sig gjeldende hos os. Alt, hvad nu Philosophien \apage{34}  saaledes
...
ligeledes i visse Partier af saadanne Videnskaber, som ellers ikke høre  \apage{35} herhen,
...
sin Almeengyldighed eller Universalitet (altsaa tillige som  \apage{36} det for os Gyldige). Her
...
\emph{Anm.~2.} Naar i og gjennem det Factiske det Algyldige skal studeres,
...
Til Indbegrebet af alt Det, vi have kaldet det Givne, \apage{42}  og nu have stillet hen for os
...
fremstilles som den, der skal løse Tilværelsens Gaade, efter selv først at have  \apage{43}
...
\emph{Anm.~1.} Kant begyndte sin Philosophies hele Værk (i Begyndelsen af
...
Hvorledes er Viden overhovedet muelig?\par} \apage{45} 
...
Givne imøde og kræve Tilfredsstillelse, ere af reen objectiv Natur, eller gjøre sig  \apage{48}
...
Hvad der i vor Tid saa meget er bleven omtalt angaaende Tænkens og Værens
...
\emph{Anm.~4.} Angaaende den altomfattende Construction \textit{a priori} og
...
være høist misligt.\par} \apage{55} 
...
allene, komme vi til at tale længere hen i \S~15 og 16.\par} \apage{56} 
...
Tilbageførelse til og Indoptagethed i det Alconstitutives, \apage{57}  det Uendeliges og Eviges
...
%% ============================================================
\grouphead{Philosophiens Grundlag og dens Værk.} \apage{59} 
...
Under de mange givne Tings Betragtning træder der, udaf den tænkende Aands eget \apage{60} 
...
\emph{Anm.~3.} Vi maae her see hen til det Sporadiske i Tilværelsen, hvilket
...
det Alt derved bliver os klart og forstaaeligt i  \apage{64} dets sidste Grunde, saa at Ideen
...
her komme tilbage til (cfr.\ \S~5, Anm.~5, P.\ 18).\par} \apage{65} 
...
Philosophien \emph{bygge}  \apage{66} paa Tro, som om denne var dens egentlige Basis. Det hører
...
Givne,  \apage{67} saaledes som det ad Explicationens Vei kan kjendes, men det saa, at Hoved- og
...
hertil svarende Plads, det kommer til at indtage i Totaliteten af \apage{68}  vor Erkjenden, den
...
angaaende Dialektiken see sammesteds P.\ 387 ff., samt min Logik, \S~90.\par} \apage{69} 
...
sympathetiske eller hengivelsesfulde Erkjendelses Gebeet.\par} \apage{70} 
...
tillige vise sig som en Livets Dikaiosyne, en Livets Nemesis.\par} \apage{71} 
...
jeg finder ikke, at han oplyser denne sin Paastand, endsige retfærdiggjør den.\par} \apage{72} 
...
En Overveielse og Forfølgelse af Philosophiens subjective Hovedopgave vil
...
Den philosophiske Grundidee og den deraf fremgaaende Grundanskuelse skal
...
Virkelighedens Rationalitet).\par} \apage{77} 
...
%% ============================================================
\grouphead{Philosophien som Led og Moment i den hele aandelige Leven.} \apage{82} 
...
Videnskabelighed overhovedet, \apage{83}  atter kun i en Debat, som føres paa den hele Levens
...
\emph{Anm.~3.} Under den philosophiske Stræbens Fremtræden i den større
...
Sandhedens Rige skal være os Mere, end et Sandhedens Rige, det skal vorde,  \apage{86} os et
