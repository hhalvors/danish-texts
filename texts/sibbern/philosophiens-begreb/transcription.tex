...
\markboth{\S~12}{\S~12}
% [text to be added: pp. 42--42 (\S 12): Exposition af det givne Begreb om Philosophie: tre Hovedsynspuncter herved]

\begin{center}\large\S~13, a.\end{center}
\markboth{\S~13a}{\S~13a}
% [text to be added: pp. 42--46 (\S 13.a): Exposition af Begrebet Philosophie i første Hovedhenseende]

\begin{center}\large\S~13, b.\end{center}
\markboth{\S~13b}{\S~13b}
% [text to be added: pp. 47--55 (\S 13.b): Begrebets Exposition i anden Hovedhenseende]

\begin{center}\large\S~14.\end{center}
\markboth{\S~14}{\S~14}
% [text to be added: pp. 56--58 (\S 14): Begrebets Exposition i tredie Hovedhenseende]
...
\markboth{\S~15}{\S~15}
% [text to be added: pp. 59--62 (\S 15): Den philosophiske Grundidee]

\begin{center}\large\S~16.\end{center}
\markboth{\S~16}{\S~16}
% [text to be added: pp. 63--65 (\S 16): Hvori den philosophiske Grundidee har sit Grundlag]

\begin{center}\large\S~17.\end{center}
\markboth{\S~17}{\S~17}
% [text to be added: pp. 66--66 (\S 17): Hvorledes Philosophie kommer i Stand. a) Explication i speculativ Tendents]

\begin{center}\large\S~18.\end{center}
\markboth{\S~18}{\S~18}
% [text to be added: pp. 67--70 (\S 18): b) Speculation og Dialektik i væsentlig Eenhed]

\begin{center}\large\S~19.\end{center}
\markboth{\S~19}{\S~19}
% [text to be added: pp. 71--80 (\S 19): Philosophicus Udtræden i c) et philosophisk System]
...
\markboth{\S~20}{\S~20}
% [text to be added: pp. 81--81 (\S 20): Endelig Definition paa Philosophie]
...
\markboth{\S~21}{\S~21}
% [text to be added: pp. 82--86 (\S 21): Philosophie paa lige Linie med det Empiriske og det Suprarationale, --- med Poesie, Moral og Religion]

%% ============================================================
%%  RETTELSER (errata leaf, PDF 11). Transcribed faithfully.
%%  NB items are substantive; folded into the body as it is transcribed.
%% ============================================================
% [text to be added: Rettelser (errata list) -- transcribe from PDF 11 when
%  convenient; already summarized in the header + RESUME-NOTES.]
