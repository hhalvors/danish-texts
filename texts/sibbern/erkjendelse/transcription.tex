...
% ============================================================
%  ------------------------------------------------------------
%  ACCURACY — FULL COLLATION 2026-09-25 (REPAIR-PLAYBOOK §5C; pgtools/COLLATE-WORKFLOW.md)
%  Assessment: random sample of 6 pp. (seed v1: 64,155,180,142,90,79), 4 errors = 0.67/pg,
%    three of them stripped adverbial/neuter -t (aprioriskt, practiskt, fuldkomment).
%  Collation: title page, Fortale, Oversigt and all printed pp. 3-205 read at the image by
%    21 collators (10 pp. each, pre-cut bands of the native 600 ppi scan). Every word-level
%    change, restored misprint, paragraph change and emphasis call went to a blind second
%    reader on pre-cut crops (322 questions incl. 38 controls: 0 control false positives);
%    disputes and single-reader doubts to a blind third reader; majority of three decides.
%  Post re-sample 6 pp. (seed |post: 3,34,102,123,128,175): 1 error = 0.17/pg, a misprint
%    silently corrected (p.123 print "egentkigen", k for l) -- single reader, NOT applied.
%  Applied: printed pp. 97 and 101 were MISSING ENTIRELY and are restored (the collator's
%    text and an independent blind transcription agree token for token); 58 word and
%    punctuation corrections (-t endings, e.g. harmoniskt, empiriskt, systematiskt,
%    fuldkomment; wrong words Gransken>Granskning x2, Lys>Liv, Saul>Sand, haves>hæves x2,
%    Lederraad>Ledetraad, Afkomst>Adkomst ...); 38 silently corrected misprints restored as
%    printed with AS PRINTED comments, plus 17 AS PRINTED comments at sites already as
%    printed (incl. every errata site); 175 emphasis corrections (\emph 382 -> 480);
%    9 paragraph-break corrections; page markers 97, 101 added and about 90 moved to the first
%    word of their page; roman markers \opage{III}-\opage{XVI} added; tailpiece rule after
%    p.204. Accents printed over "en"/"det" (pp.43, 52: èn; p.75: dét) kept as printed.
%  The Rettelser (errata, p.205) are NOT applied to the body. Errata site p.13 l.13
%    ("læs: i os") could not be identified on the page. The errata line for p.29 prints
%    "udslettes begge (,)" (both commas), not "( )".
%  Held, not applied (disputed or single reader): p.123 egentkigen; p.51 "fuldendt" (print
%    damaged: fuldent/fuldenr); p.121 "tilbage," (comma or semicolon); p.138 mark after
%    "ene"; p.183 accent over "det" (grave or acute); p.202 "nødt" (blot; maybe "midt");
%    p.149 whether "en" before \emph{vis} is spaced; p.176 whether "at" in
%    \emph{at træde offentligen frem} is spaced; p.91 Greek printed "ἐις τȣ̀ς λόγȣς"
%    (breathing on epsilon, ου ligature; file keeps εἰς τοὺς λόγους); p.IX "Den er" (sense
%    wants Det; as printed). Rejected by two readers: p.9 inøde, p.46 semicolon, p.148
%    lower-case iagttagende, p.XII "sinden" (print has sinden), p.XVI gjeunem, p.182
%    \emph{Deels}, p.143 \emph{sin}.
%  Conventions confirmed: emphasis = letterspacing only (no Schwabacher); antiqua kept
%    plain (not collated for face); half-title (PDF 23) not transcribed.
%  ocrdiff against the Google Fraktur layer: 12 real of 671 candidates (and 0/15 in the
%    sample); per-batch OCRDIFF lines in .parts/collation.
%  Working files: texts/sibbern/erkjendelse/.parts/collation/ek-collation.tgz
%  ------------------------------------------------------------
...
\opage{III} Af Skrivter om Videnskabernes Studium i Almindelighed, om det akademiske
...
% AS PRINTED (collation 2026-09-25): «forvildes i deres Straben og Virken» — p.IV l.1: print has plain a for æ (crop: single-width a sort, no e-bowl; cf. Stræben with æ on p.III and p.VI); file silently corrected
istedetfor at fremmes, vilde opholdes og standses, ja \opage{IV} forvildes i deres
Straben og Virken, om de i høj Grad vilde tragte efter at trænge ind i deres
...
\opage{V} omtale denne Sag med nogle Ord, for at det Forhold, hvori denne Fremstilling
...
Indledning til det akademiske Studium ej heller forvexles. Imidlertid kan
denne sidste dog ikke andet end at komme i mangfoldig Berøring med alle disse
Undersøgelser. \opage{VI} Og saa spørges der da, hvad den dog egentligen skal være og
...
som Studerende stræbe \opage{VII} og bør stræbe, og hvad vi, midt i et Liv, hvori saa
...
ellers til større videnskabelige Systemer henhørende, Gjenstandes hele Natur
...
hjemme paa de forskjelligste Steder i andre Videnskaber, skulle \opage{VIII} her samle sig
...
Gjenstanden bestemmet ejendommelig Maade \opage{IX} og i et eget Lys, fremstiller og
...
tilegne sig og drage til sig, og kan \opage{X} dog være, og haandhæve sig som, et
...
% AS PRINTED (collation 2026-09-25): «almene Begrebers. Udvikling» — p.X: stray full stop printed after Begrebers (2nd+3rd readers)
...
langt under det \opage{XI} Ideal af en saadan Fremstilling, som foresvævede mig, har
...
% AS PRINTED (collation 2026-09-25): «til det philosopiske, saa» — p.XI: h dropped in print (crop: p followed directly by i, normal spacing); file silently corrected
omhandle de enkelte Hovedstudier, baade med Hensyn til det philosopiske, saa
...
intet Ord at udmærke, da er det skeet, \opage{XII} fordi jeg deri har troet at burde give
...
bedste Hæld har udført Beslutningen, og beder derfor Læseren, der dog
...
% AS PRINTED (collation 2026-09-25): «Sandheden, som deru der,» — print reads "deru·der," with a raised dot (misset; sense derude); 2nd+3rd readers
\opage{XIII} Al Erkjenden er væsentligen en Finden, Modtagen og Skuen. Sandheden, som deru
der,%
...
% AS PRINTED (collation 2026-09-25): «Affection er forbnnden.» — p.XIII: turned u (reads n) in print; file silently corrected
personlig Affection er forbnnden. §.~1. S.~1.
...
% AS PRINTED (collation 2026-09-25): «fremkaldte Tænkeu fører nu» — p.XIII: turned n (reads u) in print; file silently corrected
Den ved Reflectionen fremkaldte Tænkeu fører nu til en Erkjenden i Kraft af
...
\opage{XIV} Bestræbelsen efter at erkjende i Kraft af Grunde er en Bestræbelse efter at
...
% AS PRINTED (collation 2026-09-25): «som sidste Grnnd viser sig» — p.XIV: turned u (reads n) in print (crop clear); file silently corrected
Men som sidste Grnnd viser sig dog et altreelt virkende Første, der
...
% AS PRINTED (collation 2026-09-25): «er deraf klørt.» — p.XIV: ø printed for a (2nd+3rd readers)
levende virker denne Overeensstemmelse, er deraf klørt. §.~11. S.~112.

Ideen fremstiller sig for Erkjendelsen og kommer til ydre Leven og Bestaaen i
Videnskaben. §.~12. S.~116.

\opage{XV} Det første i al ægte Videnskab er Ideen selv, som Videnskabens Middelpunct og
...
\opage{XVI} Selvtænkningen fremkaldes ved en Spørgen. Mueligheden af at antage, men og
...
% AS PRINTED (collation 2026-09-25): «Dog i flere Heuseender er her» — p.XVI: turned n (reads u) in print (crop); file silently corrected; second eye wanted
Studium. Dog i flere Heuseender er her en Prøve at gjennemgaae, idet deels
...
% AS PRINTED (collation 2026-09-25): «tage Videnskaben med ind Livet» — already as printed, needs comment (p.XVI: print omits "i" -- "med ind [i] Livet")
...
\begin{center}\large\S.~1.\end{center} \apage{3} 
...
% AS PRINTED (collation 2026-09-25): «er i al Erkienden paa ethvert Punct» — i printed for j (2nd+3rd readers)
umiddelbare, ved sig selv visse, er i al Erkienden paa ethvert Punct, endog om
...
hvilken Følgen eller Conseqvents ligefrem maae indlyse ved sig selv, \apage{4} eller maae
skues, hvormed da tillige selve det, \emph{hvad} der saaledes følger, viser sig som
...
Som saadan er den altid og væsentligen forbunden med en \emph{Nødvendighed} til at
forestille saaledes, som der forestilles, og ikke anderledes. Den umiddelbare
Fornemmelse af denne Nødvendighed er \emph{Overbeviisningen}, der kun kan opstaae
...
Erkjendelsens forskjellige Kredse snart. Ikke blot, hvad der strax falder i  \apage{5}
...
en Bemærken og Sandsen. Ogsaa i \emph{sin Fremgang} til den højeste Fuldendthed bliver
...
der befindes i sig selv at være, saa \emph{befindes} dog ogsaa dette kun, og maae netop
...
Erkjenden, ja er just ved den højeste Erkjenden især i Øine faldende. Hvad \apage{6}  der
...
kan jeg udtænke mig, (dog at jeg ogsaa allerede heri \apage{7}  maae gaae frem efter visse
...
blive ret og godt, hvad jeg ifølge hiin Idee \emph{seer} at være ret og godt. Mit kan
...
Virksomheder \apage{8} erkjendes ganske saaledes, som de ligefrem forefindes, alt dette
...
Affectioner. Det erkjendes \apage{9}  som noget, der ej kan være anderledes; det erkjendes
...
Natur og Tilvær. Men i Overbeviisningen bliver den til en \apage{10} inderlig Tilegnelse,
...
% AS PRINTED (collation 2026-09-25): «Sindsbevægelse πάθος, til Modtagelsen» — already as printed, needs comment (errata: comma after Sindsbevægelse missing, p.10 l.17 confirmed as l.17)
...
Væsen det Sande villig og gjærne imøde. Hvorved Bestræbelsen efter at erkjende \apage{11} 
viser sig som en Sandhedens Cultus eller \emph{Dyrkelse}.
...
% AS PRINTED (collation 2026-09-25): «hen til er Ideal» — print has r for t (full r sort, same shape as r in "heri"/"Forhold" on the line; t in "et Forhold" two lines up has its stem and crossbar); file silently corrected
Gud. Men heri see vi hen til er Ideal, som Menneskets Videnskabelighed endnu er
langt fra at have nærmet sig til).

Med Ærefrygt for Sandhedens Stemme og inderlig
Lyst til at bringe den, og kun den allene, til at tale og leve i sin Gransken
maae Videnskabens Dyrker give sig hen til at være dens  \apage{12} Organ, dens Tjener og
...
% AS PRINTED (collation 2026-09-25): «dette er vort.. Kjerlighed til Sandhed» — doubled full stop (2nd+3rd readers)
...
\emph{ethvert} Studium vil den trolige Hengivenhed til den  \apage{13} Erkjendelse, som
former sig i os, bringe den Fylde, Kjerlighed giver. Synes i Granskningens
lavere Kredse \emph{hvad} vi erkjende, ikke at bringe os det Evige nærmere, saa vil dog
det, \emph{at} det virker fuldkommen Erkjendelse og levende Overbeviisning hos os,
...
saadant \apage{14} Tilknytningsforhold, der kan, og under en ægte Stræben ogsaa vil, blive
...
allerfuldest, naar den en Tid lang saaledes fængsler os og ligesom \apage{15}  tager vort
hele Sind i Besiddelse, at vi ganske ere fordybede i den. Paa denne Maade, det
er med denne kraftige Opmærksomhed og Hengivenhed, skal ethvert classiskt
Værk studeres.

Men ogsaa kun \emph{classiske Værker} fortjene og kunne ganske studeres
saaledes. Thi classiskt er et videnskabeligt Værk ikke ved den Samling af
...
classiskt især synes at tyde hen paa; thi det virker ei blot ved en Mangfoldighed
...
han ej behandler det blot som Middel til en Kundskabs \apage{16}  Erhvervelse, men som et
Værk, der har fuld Værd ved og i sig selv allene og derfor ogsaa virker til
selve Aandens Dannelse i det Hele.

Vi maae læse saaledes, at vi træde i \emph{et harmoniskt Vexelvirkningsforhold}
...
Fordybethed eller Grebethed kunne komme. En Tid lang lade vi da \emph{Værket hentage}
os og lade det gjøre med os og gjøre af os, hvad det vil. Derpaa begynder
\emph{Sandhedens egen Kraft} selv at tale i os \apage{17} og at vidne om den i Værket udtalte;
...
% AS PRINTED (collation 2026-09-25): «Formatiøner» — slashed ø printed for o (2nd+3rd readers)
Virkninger og Formatiøner i vort Indre, derved, at den kommer fra Sandheden
...
\apage{18} saaledes først levede i den Virksomhed, hvorved Værket kom i Stand. Men herved
...
% AS PRINTED (collation 2026-09-25): «det Sande viser sig, som» — already as printed, needs comment (errata p.18 l.14: comma after "viser sig" to delete)
...
Skal da nu det \apage{19} Sande optages i Personligheden, maa ogsaa det omfattes med af
...
Erkjendelsens Besiddelse viser sig derfor og som en Kunnen, en
Formaaen. Vi vide kun \apage{20} (tilstrækkeligen og tilfulde) det, hvad vi ere i
...
% AS PRINTED (collation 2026-09-25): «reproducerede Sandseanskuelser,. eller» — comma followed by a stray stop (2nd+3rd readers)
...
bemægtige os det, gjørende det til noget af vort eget, hvilket \apage{21}  vi nu paa vor
...
% AS PRINTED (collation 2026-09-25): «Erkjendelsens Kredse, Hvad» — silently corrected (errata p.21 l.11: print has comma, erratum says stop)
iagttagende Øje i enhver af Erkjendelsens Kredse, Hvad den simple \emph{lavere
% AS PRINTED (collation 2026-09-25): «Sandsning} angaaer henvise» — already as printed, needs comment (errata p.21 l.13: comma after "angaaer" missing)
...
logiske Undersøgelser heelt igjennem og overalt. Hvad enten concrete Gjenstande
begribes og deres Natur derved erkjendes i Kraft af Begreber, eller  \apage{22} Begreber
...
% AS PRINTED (collation 2026-09-25): «maae findes hos Gjenstandenr,» — stray r printed ("Gjenstandenr"), clear positive r; file silently corrected
Bestemmelser, der ifølge Begreberne maae findes hos Gjenstandenr,%
...
hvorved den Grundtanke, der bestemmer Begrebets \apage{23}  hele Gyldighed og Indhold
...
\begin{center}\large\S.~3.\end{center} \apage{24} 
...
kun i denne \apage{25} dets bestemmende Indflydelse, og Forestillingen antager ligeledes,
...
Residuum af \apage{26} Virksomheden; som noget, der nu blot haves og antages, fordi det
engang har været antaget, som \emph{staaende Resultat}, uden at det endnu oplives
ved den levende \emph{Virken}, hvorved det \emph{dannedes}. Men det skal ei mechaniseres
...
men, da dette er et  \apage{27} Indbegreb af Bestemmelser, der tillægges, ei Begrebet selv,
...
ligesom den i sine  \apage{28} Forestillinger danner et Materiale, hvori den udtrykker sin
...
\begin{center}\large\S.~4.\end{center} \apage{29} 
...
det saaledes erkjendte viser hen paa andet og mere, \emph{træde} formedelst en
...
% AS PRINTED (collation 2026-09-25): «viser sig, som saadan, med sin Nødvendighed» — already as printed (errata p.205 reads "udslettes begge (,)": delete both commas)
Indflydelse paa den anden Side viser sig, som saadan, med sin Nødvendighed.
Individet finder sig, som det, der selv maa arbeide paa formedelst Overvejelse og \apage{30} 
...
Selvbestemmelse og som den, der \emph{kan} virke anderledes; derfor ogsaa ifølge
...
1.~Den friblevne Productivitet kan nu ogsaa ytre sig \emph{i egne}, af det givne
uafhængige, Productioner. Men altid vil den dog ogsaa derunder, da den maa skee
paa bestemte Maader, bestemmes ved visse Normer eller Begreber, hvilke af \apage{31} sig
...
\apage{32} 2.~Saavidt den frie Productivitet kommer til Bevidsthed som saadan, kommer og
...
3.~Men hvorfor viser sig Tingenes sande fulde Væsen \emph{ikke strax} saaledes for det
...
fuldkomne Besvarelse vilde udfordres en almindelig \apage{33}  Eftertænkning over Grunden
...
\emph{Betydningen af} alt \emph{Endeligt}, at det skal være \emph{det Andet}, end det Evige,
\emph{hvori} dette skal komme til at træde frem og aabenbare sig. Men kun i en
...
der nu i Sandhed kan kaldes Guds Rige, \apage{34} som det Rige, hvori Gud selv aabenbarer
sig i sin Guddom, idet han aabenbarer sig i evig Kjerlighed. Men et Aandens og
Kjerlighedens Rige \emph{forudsætter nødvendigviis}, og fremkalder derfor
...
komme til at udtale sig \apage{35} i en Sphære (hiin foromtalte lavere Region), hvilken er
...
at referere sig til \emph{noget}, \emph{som nu hos Individet selv maa paafølge},
...
opererer eller trænger sig frem i Bevidstheden, Charakteren  \apage{36} af Tilskyndelse og
...
deri liggende Productivitet  \apage{37} komme til klar Bevidsthed; men dette kan den ikkun,
...
Erkjendelsen fremkommer nu som Resultat af en \emph{Undersøgelse} og \emph{Betænkning}.
...
udeelt virker. \apage{38} Men hos den frie Personlighed, der skal komme til fuldkommen
...
bemærkes, at  \apage{39} Tingene ofte ikke kunne eller skulle forestilles at være saaledes,
...
ifølge en Tænkning, der naturligviis heelt igjennem maa være ledet og  \apage{40} bestemmet
...
det skuede. Men saadan Vished og Tryghed, en i en \emph{saadan Skuen} til Ro og Fylde
...
betegne med det Udtryk at skue alle Ting i Gud. Det er den Erkjenden, \apage{41}  ved hvilken
...
evige Kilde, Aanden, paa en ganske anden (en anderledes reel) \apage{42} Maade bliver
...
erkjender, hvad den under sin Grunden finder, men i denne  \apage{43} Henseende har udstødt
...
det, saa længe vor Erkjenden er èn Erkjenden formedelst Tænkning, altid beheftet
med for os.
...
saaledes indtager da en, al Mangelfuldhed i Indsigten og i Tænkningens \apage{44} 
Udviklinger og Fastsættelser overvindende og opløsende \emph{Tro}, nemlig en
Tro \emph{paa Grunderkjendelsens Realitet} for os hiin fuldkomne Erkjendelses
...
gives, i \emph{Tro til den Givende}. Men netop det, hvad der gjør, at Erkjendelsen ikke
bliver en total Skuen, aabner nu ogsaa denne uendelige \apage{45}  \emph{Tillid} det Rum, hvori den
...
saa skal dog Erkjendelsen derfor ikke høre op paa den anden Side at være \apage{46} en
...
denne \apage{47} Grundbevidsthed om Gud (og om sit eget inderste Samfund med Gud) gjør
...
\begin{center}\large\S.~6.\end{center} \apage{48} 

% AS PRINTED (collation 2026-09-25): «I det Granskningen gaaer ud» — already as printed, needs comment (errata p.48 l.2: I det → Idet; l.1 is the §. 6. heading)
I det Granskningen gaaer ud paa en Erkjenden i Kraft af Grunde, tragter den efter
ej blot at erkjende det Sande, men og at erkjende det \emph{som det Sande} og ifølge
...
erkjende saaledes, der sætter den hele Granskning efter Grunde i Bevægelse; den er
...
% AS PRINTED (collation 2026-09-25): «kun da skye og have vi den» — print has y for u (2x crop: clear descender tail on the letter after k, unlike the u of "kun" on the same line); file silently corrected
at den indlyser for os ved sin Sandhed; kun da skye og have vi den, som den selv
...
tilfulde og i højeste \apage{49}  Maade, forsaavidt Erkjendelsen bliver en Erkjenden i Kraft
...
indtil de højeste og \emph{sidste Grunde}; saa at, hvad der erkjendes, erkjendes
...
den erkjendende Personlighed derved \apage{50}  stige til, \emph{Friheden hæves frem for desto
...
Søge vi  \apage{51} Stadfæstelse, saa er det, at det Sande ogsaa for vore Øjne maa stadfæste
...
Autoritet}, det er \emph{Sandhedens egen}. Ligesom det ellers hedder, at kun den skal
...
Studium, der først ret begynder med det \emph{akademiske Studium}, hæver
...
Menneskeexistents skal skee, vaagner og virker  \apage{52} ogsaa i videnskabelig Henseende
...
\emph{Læren}, om end vistnok èn tænksom Læren, Hovedsagen. Tilfredsstille sine
...
og højeste Grunde}; mod disse skal Studiets hele \emph{Retning} være stilet hen; og kan
ogsaa Granskningen endnu ej med Bestemthed og Klarhed fra et givet Punct af \apage{53} og
...
at gaae saavidt, han kan, baade ved at trænge \apage{54}  her saa vidt ind til Sandheden som
...
tilligemed det betragtes i sine større Forhold. Den  \apage{55} philosophiske Aand viser sig
...
Allerede en Grund kan kun erkjendes som Grund \apage{56}  og en Følge som Følge, idet hiin
...
\emph{En ægte og fuldkommen Erkjenden er altsaa en intelligent} Erkjenden. Ikkun
ved en saadan erkjendes Sandheden i dens Sandhed. Den empiriske Opfatten og
Anskuen maa derfor, naar  \apage{57} den skal vorde en ægte Erkjenden, omfattes saaledes af
...
aldeles bundet og bestemt, saa kan det dog, saa længe der ikke indsees, at det  \apage{58}
...
det erkjendte Hele, stilles nu og hen som Erkjendelsens første \apage{59} Bevæger, ved
...
det høieste. Først naar vi hæve os til dette, kan alt foregaaende sees i sin
...
til Intelligenthed, sees allerede snart, naar Bestræbelsen efter
fuldkommen Erkjendelse kommer i Bevægelse og bliver sig selv klar. Men hvorfor er
det saaledes? \emph{hvorfor} maa al ægte Erkjenden \emph{være intelligent}?%
% FLAG p.59: emphasis span (Sperrung) — question set letterspaced; extent approximate. Verify.

Fremdeles; hvorledes kan dog en \emph{udenfra given} Gjenstands Natur og
Beskaffenhed erkjendes ved en Erkjendelse, hvis ledende Grundnormer, hvis
bestemmende første Bevæger og bestemmende Maae, endog paa ethvert Punct, er \emph{af
indre Udspring},%
...
1.~At dette sidste --- vi ville tage det først i Betragtning --- \emph{er saa}, er
klart. Ethvert Exempel paa en Erkjendelse, som gaaer frem af en Betænkning, eller
hvorved Sammenhæng, Forhold, \apage{60}  Grund og Følge komme i Betragtning, kan tjene til at
...
bestemmes ifølge en Slutning, hvis Gyldighed og Conseqvents, ifølge Grunde, hvis
...
lavere  \apage{61} Sandseanskuelses Dannelse i hinanden, og hiin strækker sig heelt hen
...
empirisk Maade \apage{62}  kunde været fundne ved de bekjendte Experimenter, indsees at være
...
i sin Conseqvents af visse Forudsætninger, af hvilke Forstanden selv maa erkjende
dem at være en naturlig Følge, det er en Følge, hvis \emph{Følgen} eller Affølge er
...
Dele i denne deres  \apage{63} Sammenhæng, tilmed skue dem i deres Betydning og
...
Deductioner, overalt ud fra \emph{sine egne} Grundnormer og Principer. En ikke
af Erfaringen modtaget eller abstraheret, men paa en selvstændig Maade af  \apage{64}
...
% AS PRINTED (collation 2026-09-25): «strækker sig ind det mindste Detail» — already as printed, needs comment (errata p.64 l.5: → "i det mindste"; the print begins the line "det mindste" with a blank where the "i" should be)
...
indre aprioriskt Udspring, op med Krav paa objectiv Gyldighed, og kan ikke andet.
...
Tænkning eller Beregning, hvilket ikke stemmer med  \apage{65} Erfaringen, saa søge vi
...
fordi netop \emph{Intelligentsen} selv er et Udtryk af \emph{Naturens sidste
...
Naturen og i vor Tænken og Betragten, fremstillende sig, sig selv \apage{66}  lig, her og
...
% AS PRINTED (collation 2026-09-25): «saa at vi idet intelligente ikke» — already as printed, needs comment: print sets "idet" solid (checked on a crop) for "i det" (cf. "end i det empiriske" in the same sentence); not in the Rettelser
...
indtræder her hiint \emph{a priori};  \apage{67} hvilket nu viser sig for os i sin reale
...
men ogsaa, naar den skal erkjendes tilfulde, \emph{maa} erkjendes ved en Erkjenden,
...
fremgaaende Fordringer vise sig, med hvilke det givne maa findes at samstemme, \apage{68} 
...
et nøjagtigt og  \apage{69} omhyggeligt \emph{Studium af den givne Virkelighed} selv, d.\ e.\ af det
...
første Haand.
\apage{70} Men netop saaledes har det sig med Naturens Studium; hvad der i den selv
...
Forholdet imellem \emph{Empirisme} og \emph{Rationalisme}, en Modsætning, der især i
...
Almindelighed har disse eller hine Virkninger, uden at indsee, hvorledes \apage{71}  dog og
...
% AS PRINTED (collation 2026-09-25): «der førte ti disse» — silently corrected: the print has "ti" for "til"; on a crop there is no trace of an l and the gap before "disse" is an ordinary word space. Second eye please
Sætninger, uden at man er i Besiddelse af de Grunde og den Tænkning, der førte ti
disse Resultater, uden at man seer, hvad der ligger i de lærte Sætninger og
egentligen er udsagt i dem.

4.~Formedelst den frie Tænkning skeer en højere og inderligere \emph{Tilegnelse} af den
...
\apage{72} Bestræbelsen efter at erkjende Sandheden i dens Sandhed fører, idet det viser
...
% AS PRINTED (collation 2026-09-25): «Først dermed indtræder den intelligente Erkjenden» — already as printed, needs comment (errata p.72 l.16: "den intelligente" → "den fuldkomne intelligente"; l.16 when the "§. 8." heading line is counted; the only other "den
...
\apage{73} Kun da, naar vi skue Tingene i deres egen reale Nødvendighed, kunne vi ej
...
Forestillingen. \emph{Ere} Tingene det, de ere, ifølge et dem saaledes bestemmende
Noget, der som deres reale Grund constituerer dem, saa vilde Erkjendelsen være
ufuldkommen, naar de nu ikke ogsaa \emph{skuedes} som de, der just ifølge dette Noget
ere, som de ere, eller naar nu ikke ogsaa, tilligemed dem  \apage{74} selv, dette Noget
...
ligesom deres Tilvær og deres Adkomst til at tillægges en vis Betydenhed, idet
...
ringere \apage{75}  Realitet, jo mere eller mindre et saadant Skin viser sig som nødvendigt,
...
Tilforladelighed bestyrkes og fuldendes ved Indsigt i de \emph{reale Grunde}. See
...
stemmer dét, denne Forstandsmæssighed fordrer, \apage{76} sammen med det, hvad Iagttagelser
...
Nødvendigheden af at antage dette eller hiint. Dette falder ikke alene i Øjnene i
...
hvor en, fra det i sig selv første til det deraf følgende lige fremad  \apage{77} skridende,
...
Nødvendighed indsees, ikkun, \emph{at} Beskaffenheder og Forhold ere, som de ere; men
...
construeres, overhovedet i de Biconstructioner, der saa ofte gjøres, for \apage{78} Bevisets
...
Bestemmelse, ej paa deres indre Væsen og Sammenhæng med et høiere og højeste
...
ingenlunde er fuldkommen nok dertil, ingenlunde i Sandhed grundig (til Grunden \apage{79} 
...
følger, at ingen enkelt bestemt Sætning kan være fuldkomment evident i sig, uden
...
Sætningers Evidents ikke hviler i det \apage{80} hele Systems Udførelse, noget, som derimod i
...
og i Kraft af reale \apage{81} Grundes Erkjendelse ogsaa heri kan opnaaes, da er dette
...
Beviismaade gik det Udkast til en Geometrie efter \apage{82}  en genetisk Methode ud paa,
...
Grundformen i den derved frembragte mathematiske Anskuelse, overalt hæves saaledes
frem, at den overalt sees som Grunden til de Beskaffenheder og Forhold, \apage{83}  der
...
Sætningerne skulle foredrages, og det Lys, hvori \apage{84}  de derved skulle stilles, vil da
...
\emph{Debat}, som og for dialectisk Betragtning, noget, Mathematiken ifølge sin
...
f.~Ex.\ i Planeternes Gang, at eftergranske, hvorfor i Naturen netop paa
\emph{saadanne} Puncter \emph{saadanne} Former fremkomme. De mathematiske Former findes her
som \emph{givne} Gjenstande i \emph{Virkeligheden}, altsaa i en vis nødvendig
...
Fald en Forskjellighed i Henseende til Gangen i, \apage{85} og Maaden for, dens Bestemmelse
...
engang er Tale, da deres mathematiske Muelighed her er \apage{86} nok til deres Realitet,
...
\apage{87} gjelder det da tilsidst, om \emph{et højeste absolut fast Punct} kan findes,
...
støtte sig derpaa, at alt \emph{andet} netop saaledes \emph{viiste hen til} hiint,
...
hvis Realitet ogsaa maa \emph{vise sig ved sig selv allene}.

Og saa see vi da, hvor naturlig den allerede forhen i Betragtning tagne Tanke er,
som ligger  \apage{88} til Grund for det ontologiske Beviis for Guds Tilværelse, en Tanke,
...
er en Erkjendelse \emph{af et Begreb} og en Erkjendelse \emph{i Kraft af et
...
den selv, af hvilket \apage{89} den følger, med hvilket altsaa dens Tilvær er givet som
nødvendig. En Granskning efter Grunden til en Gjenstand gaaer altsaa, med mindre
...
ligesaa langt fra at være nok i sig selv, som den første) \emph{det}, der nærmest fører
...
Tingen selv med den ene kræver den anden, er her nærmest \apage{90}  den egentlige reale
...
hvilken de alle \apage{91}  vilde sees som væsentligen fornødne Led i et altomfattende stort
...
e.) kunde føle sig dreven til at gribe efter Anaxagoras's \emph{νοῦς}, og, for at komme
...
% AS PRINTED (collation 2026-09-25): «hen, til ej fortrænge» — already as printed, needs comment: print has "til" (clear t, confirmed on native crop) for "vil"
...
Imidlertid kunne og ville vi dog strax her, hvor den \apage{92}  indtræder, befæste os ganske
...
de komme frem. \apage{93} Men naar da nu indsees, at Varme f.~Ex.\ maa komme frem under
...
% AS PRINTED (collation 2026-09-25): «(ἄιτιυν» — the print sets the breathing and acute over the alpha of the diphthong, and the breathing is rough (reversed-comma shape [adjudicated]
Varmens egen indre Natur viser sig som det egentlige aarsagelige (ἄιτιυν
Phædon.\ 99, b),%
...
fordi Tingen antages og erkjendes som den, paa hvilken altid og efter en \apage{94} bestemt
Regel et saadant Factum \emph{følger}, men kun, naar det tillige indsees, at dette Factum
\emph{maa} følge paa den, fordi den nødvendigviis \emph{fører} et saadant Factum \emph{med sig}; og
...
deres reale Grund i Naturen, end netop det, at en  \apage{95} Kraft som Tyngden ej kan tænkes
...
i den hele Række, der \emph{kræver} en saadan Form med, som et integrerende Led i den
...
gives tilbage som  \apage{96} Grunden. Men skeer dette nu ikke ganske aabenbart, naar man med
...
fordi en saadan Tilstands, et saadant Factums Natur er den at \apage{97} indtræde under saadanne Betingelser, eller fordi en Forstandsnødvendighed kræver, at en saadan Tanke, et saadant Begreb, nødvendigviis maa komme til Realitet i disse Forhold. Ligeledes foraarsager Nordenvinden Frosten, kun forsaavidt den fører de Betingelser med sig, som have til Følge, at Chrystallisationstendentsen i Vandet kommer til saadan Yttring, at Vandet nu former sig som Iis, i Fasthedens Tilstand; men søge vi det egentlige aarsagelige op, saa er det den Nødvendighed, med hvilken under disse Betingelser en saadan Tilstand indtræder, fordi netop en saadan, og ingen anden end den, maa indtræde under saadanne Forhold, fordi altsaa et saadant Begreb nødvendigviis her maa komme til Realitet. Men dette Begreb er det særegne Begreb, det er, og fordi det er dette, kommer det til Realitet her; just en saadan Tanke indtræder i den hele Tankegang nødvendigviis paa dette Sted, og kun deraf, at den hele Tankegang ej kan føre til en anden end netop denne, begribe vi en saadan Tilstands Indtræden, men dermed er da og, og først dermed, dette Factum forklaret, eller skuet i sin fuldkomne Begrundethed. Hvad der altsaa udgjør dette Factums reale Grund, er ej dette eller hiint enkelte, ej heller det hele Indbegreb af foregaaende Enkeltheder, men er den Forstandsnødvendighed, som under deres Forudsætning kræver \apage{98} et saadant, og
...
Punct, hvor den egentlige Grund ligger, men \apage{99} dette er netop Tingens eget Begreb. I
...
netop Tingens Tilvær paa denne \apage{100} Maade, sees nu ogsaa tillige den hertil bestemmende
...
videre kan anføres som Svar, men kun \apage{101} den Nødvendighed, hvormed den anden, naar den antages først, fører den omspurgte med sig, viiste selve Forstandsnødvendigheden sig som den reale Grund. Den anden Gjenstand fremkalder det samme Hvorfor, og naar tilsidst et vist Indbegreb af slige Gjenstande (Ting, Beskaffenheder eller hvad det saa er, hvoraf en Mangfoldighed kan gives) sees som de, der i en i sig afrundet Samling ere Udtrykket af en vis Totalsammenhæng, saa spørges, hvorfor selve denne Sammenhæng, dette Begreb, er til, eller findes saaledes, som det findes. Det hele givne Indbegreb af Gjenstande maa da nu, sammenfattet til eet, som een Gjenstand, betragtes som Deel af et større Indbegreb af Gjenstande; og saa fremdeles.

En saadan Forklaringsmaade leder for det første til at føre flere Phænomener tilbage til \emph{et Grundphænomen} eller Grundfactum, hvoraf de alle saaledes følge eller gaae frem, at de blot vise sig som dette Grundfactums enkelte Yttringer eller enkelte Dele; som naar Planeternes tilsyneladende Stilstand og Tilbagegang forklares af Planetsystemets hele Beskaffenhed, efterat den først har maattet tjene til ratio cognoscendi for dette Planetsystems Erkjendelse. Vel sees da allerede en ratio essendi til et enkelt Phænomen, men, hvad derved kommer ud, er dog kun Erkjendelsen og Fastsættelsen af et Grundfactum, noget, der iøvrigt ofte allerede kan være vanskeligt  \apage{102} nok; det er ej altid let at bestemme, hvad
...
alle; \apage{103} som naar man i Forbrændingen, i Metallers Forrustning og saa videre,
...
andet}, \emph{end den hele Kjæde} med alle dens Led, noget, hvori den hele ligesom
...
\apage{104} Den Forstandsnødvendighed eller Forstandsmæssighed, der fordrer Tingenes Tilvær
...
saalænge ikkun den allene viser sig som \apage{105} Erkjendelsens sidste Grundlæg eller første
...
% AS PRINTED (collation 2026-09-25): «og giør, at hiint er udtrykt» — i printed for j (2nd+3rd readers)
bringer Begrebet ind i det umiddelbart virkelige (ind i Objectiviteten), og giør,
...
\emph{et virkende} Første, der viser sig som et Princip, \emph{hvorved} Tingene
...
enhver Deel af Organismen. Det er det sande \emph{Værende} og \apage{106} Væsen, det sande
...
Istedet for hiint Hvorfor viser sig her \emph{et Hvorved}, og det saaledes, at
...
Værende træde frem? Overhovedet kan det ikke tænkes som  \apage{107} Tilværelsesgrund til nogen
...
dette fordrer den, for fuldkomment at kunne aabenbare sin Væsenhed. Vi see altsaa,
hvorledes det indre alt begrundende \apage{108}  Værende medfører og fordrer, idet det tillige
...
som noget \emph{andet} end sig selv, \emph{hvori} det nu skal være som det altopfyldende,
...
denne Sammenhængs Række eller Kjæde, altsaa som begyndende første, \emph{som Led}. Dets
Betydning med Hensyn til det andet, dets Forhold dertil, maa nu bestemmes og
tilmed \emph{et Begreb} dannes derom. Men uagtet det saaledes staaer som første
...
skues i eet med den Form, \apage{109} under hvilken det træder frem, eller det Begreb,
...
ej blot som en Væren og Leven, men som et altreelt værende og levende \emph{Væsen}, som
...
uden samme? Hvorfor \emph{er} det ej blot, men \emph{aabenbarer} sig tillige? Vi svare:
for at det kan træde frem i uendelig \emph{Fylde}. Altsaa dog for at det kan end
mere fuldeligen være. Der maa være noget hos samme selv, som kræver dets
Aabenbarelse, saa at det ej kan og vil beroe i sig selv allene. Vi \apage{110} kunne ej tænke
...
Frihed være og et \emph{Frihedens Rige}, og for at dette kan være, maa
...
som den evige \apage{111} Selvaabenbarelses og Kjerligheds første og tillige altomfattende
...
% AS PRINTED (collation 2026-09-25): «væsentlige, iog med Hensyn til hiint,» — print has "iog" (a positive extra i before og); file silently corrected
væsentlige, iog med Hensyn til hiint,%
...
\begin{center}\large\S.~11.\end{center} \apage{112} 
...
foregaaende, \apage{113}  hvor vi have seet, at et Frihedens Rige maa komme frem, for at et
...
Bevidsthed, \apage{114}  Klarhed og et i indre Udtalelser og Productioner kraftigt Herredømme
...
det i sig selv dog virkelig  \apage{115} kommer. Fordi en Erkjendelse i sig selv gaaer frem af
% AS PRINTED (collation 2026-09-25): «erkjendes der endnn ikke strax» — print has "endnn" (n for u; 2x native crop shows the closed n-arch on both final letters, a positive stroke); file silently corrected. Second eye please
en Ideens Leven i os, derfor erkjendes der endnn ikke strax i Kraft af Ideens
...
som den denne Videnskab til Bevidsthed kaldende og bringende Tænkeu, Udtrykket af
% AS PRINTED (collation 2026-09-25): «Idee og en Ideeus Leven» — turned n printed as u (2nd+3rd readers)
en Idee og en Ideeus Leven i os. Men mathematisk Erkjenden er dog ej Erkjenden i
Kraft af Idee.
...
i det Indre ligefuldt tilstædeværende, og baade i hiint og i dette \apage{116} alt
...
som det dannende og ordnende Princip, i et \emph{Indbegreb af Erkjendelser}, der komme
...
\emph{Videnskaben}, den ægte, fuldkomne Videnskab. De enkelte Erkjendelser ere
...
dog saaledes, at alt i den skues baade i sit nærmere eller \apage{117} fjærnere Forhold til
...
% AS PRINTED (collation 2026-09-25): «ere nadskillelige» — turned u printed as n (2nd+3rd readers)
\emph{Detail} ere nadskillelige.
...
Eviges Idee, saa maa nu ogsaa denne Idee vise \apage{118} sig som det altoplysende og
...
der kun i en saadan Modsætning sees i sin Sandhed og  \apage{119} Betydning. Selv naar vi tale
...
% AS PRINTED (collation 2026-09-25): «træder frem undet Relation» — print has t for r ("undet"; 2x native crop: stem rising above x-height with crossbar, same shape as the t of "Relation" beside it); file silently corrected
den allerede forsaavidt strax træder frem undet Relation, og det endnu mere, fordi
...
\begin{center}\large\S.~13.\end{center} \apage{120} 
...
Ideen og det sande rationale i Erkjendelsen. \apage{121} 
...
Betragtning maa gaae ud og hvortil den maa gaae tilbage, viser sig \emph{det
philosophiske} i Erkjendelsen; og da alt skal saaledes henføres til det
...
\apage{122} Af Ideen gaaer vistnok nødvendigviis en Indseen og Begriben frem. Men Ideens
...
Led i en Kjæde. Imidlertid er \emph{Begreb} væsentligen forbunden med al Idee, og idet
...
mangfoldige empiriskt \apage{123}  opfattede eller gjennem Reflection udfundne \emph{Detail}
...
alsidige Overvejelse først hæves frem, er paa den ene Side lige saa vigtig i det
...
dog i den laveste Forstand, og nu derefter at opløse alle videnskabelige \apage{124} 
...
Totalitet,  \apage{125} som det eet og alt, hvorfra alt gaaer ud og hvortil alt gaaer tilbage,
er i videnskabelig Henseende, det er i blot personlig og individuel Henseende
det: at \emph{have et Ideal for Øje}, bære et Ideal i sig og være begejstret af og
...
4.~Men hvorledes er dog \emph{Begreb forskjelligt fra Idee}, hvad Maaden angaaer,
...
hvilket ligesom i Frihed \apage{126}  svæver over dem. Hvorledes er da Idee endnu noget andet
end Begreb?
...
bestemmende men og reelt \emph{virkende} Første, \apage{127}  som \emph{gjør}, at en saadan Tanke
...
føres vi allerede ind i et System og bringes nu og til at øjne det, hvorfra alt
System gaaer ud, hvori alt System hænger, og saa see vi allerede Ideen, som det,
der aabenbarer sig paa det enkelte Punct igjennem \apage{128} Begrebet, og den Erkjenden, der
...
en \emph{negativ} Maade som en Opløsning og \emph{Tilintetgjørelse} af alle de paa lavere
...
Begreber i deres relative Ugyldighed eller Intethed, eo ipso viser dem i
...
\apage{129} dialectiske, som det, der gaaer frem af Ideen, der skues og haves som det rene
...
% AS PRINTED (collation 2026-09-25): «er noget; der ej uden Grund» — print has a semicolon (clear dot over the comma on the 2x crop) before a restrictive relative clause; file silently normalised to comma
...
\apage{130} Tilintetgjørelseskonst}, der ej, som Skepsis, har et blot negativt Formaal, men
...
nødvendigviis og væsentligen gaae i eet med den philosophiske \emph{videnskabelige
Constructions Konst}.
...
Dyder har Realitet og ingen Realitet), saa have  \apage{131} vi dog det positivt gyldige i \emph{det,
...
speculativ Logik selv har dette højeste Sandes Erkjendelse til \apage{132}  Basis, det
...
\begin{center}\large\S.~15.\end{center} \apage{133} 
...
Grunderkjendelsens Gjenstand, Ideen, maa nu (som allerede forhen er bemærket) \apage{134} 
...
Fleerhed af Grundformer, i hvilke den selv hver Gang viser sig selv i en ny
Skikkelse, og at der nu kan tales om \emph{en Fleerhed af Ideer}. Hvorledes Ideen
...
constituerende Virkninger og Principer med ligesaa \apage{135} mange dertil svarende
...
1.~Kan end Ideen vistnok træde levende frem i det \emph{frie judiciøse}, saa maa
dog ogsaa allerede derunder et System, i det mindste visse Grundtræk dertil, haves
i \emph{Sinde og for Øje}; \apage{136}  og skal paa en nøjagtig Maade det Enkelte bestemmes og
...
Systemet og bane det Vejen. Letteligen fører ellers den systematiske \apage{137}  Tendents til,
...
hilde. Med et Systems Uddannelse maa derfor \emph{ikke hastes}.
...
nøjagtigen, saa at der ingen fast Holdning bliver i det Hele. Lyst til \apage{138} at skue
...
dette ene Systems \apage{139}  Lys, det nu ikke engang gaaer ind i de nye Betragtninger, der
...
hvorpaa alt kommer an, \emph{saavidt som}, eller i \emph{det Maal}, i hvilket vi see det
som eet og alt i det tilsvarende \emph{Hele}, saa maa Erkjendelsen ikke allene
...
henvisende, første Begyndelsespunct; saa at altsaa med Mangfoldigheden ogsaa
...
gaae forud for Systemet og \emph{berede til det}, saaledes og \emph{følge paa det}, naar
der nu gaaes fra Systemet til det mangfoldige Detail. Saa vigtigt et bestemt
System er, saa nødvendigt er det, indtil en vis Grad igjen at \apage{140} kunne \emph{befrie sig fra
...
Bestræbelsen for at bringe det erkjendte til andre, naar \apage{141} det bliver os ret
...
Videnskab sees i denne Klarhed og Sammenhæng, kan allerede et heelt System i sikkre
og mangfoldige til een Grundform henvisende Træk lyse frem af enkelte forekommende
Spørsmaals \apage{142}  Behandling og af Maaden at dømme og bestemme Begreberne paa i det Hele,
...
saaledes practiskt besiddes, have sine store Vanskeligheder. Især vil den Orden og
...
% AS PRINTED (collation 2026-09-25): «ved dem, hvormed de» — already as printed, needs comment (errata: p.142 l.6 from foot de → der)
...
Grunderkjendelsen, hvilken dog \apage{143} først maa staae op for vor Øje og begrunde sig som
...
anden, men at denne dog igjen maa være fremstillet, inden hiin kan sees i
...
fremstilles for sig i \emph{sin} Retning og i \emph{sin} Sphære, dog den ene ej kan, hverken
...
Det bliver da nødvendigt at \emph{tage fra en vis Side}, hvad der dog i sig selv ej
...
der kunne gjøre lige \apage{144} Fordring paa Grundethed og Værd, saa indlyser deraf ogsaa,
...
\emph{videnskabelige Gehalt} i det Hele hersker Overeensstemmelse.
...
\apage{145} Betragtning i Haanden. Jfr.\ §.~6. Anm.~2 i Slutningen.
...
% AS PRINTED (collation 2026-09-25): «Grunde som ellers fordre» — already as printed, needs comment (errata: comma before som, l.5 from foot)
Tider og paa deres Pladser. Saa at de samme Grunde som ellers fordre det
% AS PRINTED (collation 2026-09-25): «Erkjendelsen ogsaa klarligen» — already as printed, needs comment (errata: comma before ogsaa, l.4 from foot)
...
\begin{center}\large\S.~16.\end{center} \apage{146} 
...
Men skulde nu vel og et \emph{særligt} Studium af Detaillet for sig kunne tænkes,
...
specielle \apage{147}  Erkjendelser skulle være ægte videnskabelige, hvorved det Enkelte
...
dermed endnu ej strax er given \emph{som saadan}, fordi den endnu kun har fremstillet sig
i sine \apage{148} Følger, kan et særligt Iagttagende Studium af et givet Detail paa en mere
...
Modificationer eller i særlige Former, kan en \emph{vis} \apage{149} \emph{mathematisk Iagttagelsesaand} vise
...
af de nyeste Exempler: Chrystallographien.
...
Ethik, en Videnskab, hvis Sætninger, lige indtil de allermeest specielle,
...
tilbagevirkende Indflydelse af deslige, ved Agtsomhed paa empiriskt givne Forhold og
deres mangelunde Modificationer opstaaede, Betragtninger og Undersøgelser,
strækker sig endog tilbage til de første Principer eller til hele  \apage{150}
...
Allerede i denne Henseende kan altsaa en \emph{vis philosophisk Iagttagelsesaand}
...
og almeengyldige Idee i denne  \apage{151} umiddelbare, sig selv endnu ej aldeles klare,
...
Afledning og Slutning. Og saa er da heri et Detail, der kan blive Gjenstand
...
Naar vi spørge os, hvorledes dog en genial Maler af \apage{152} den nederlandske Skole har
...
% AS PRINTED (collation 2026-09-25): «Hoved med Sands, for det» — faint comma printed after Sands (2nd+3rd readers)
...
over en \apage{153} vidtomfattende Kreds. Ogsaa det meest sig begrændsende Studium, som vi i
...
% AS PRINTED (collation 2026-09-25): «saavidt, at, den kan fattes» — already as printed, needs comment (errata: p.153 l.7 from foot, comma after "at" to delete)
...
med en vis Grad af Bestemthed, denne Systemets foreløbige Udkastelse og det  \apage{154}
...
lægge Mærke til \emph{Methoden}. \emph{Deels} maa der være en vis Methode i det Studium,
hvorved vi selv arbejde os frem, \emph{deels} viser en saadan sig og i at udtale det
...
% AS PRINTED (collation 2026-09-25): «i et vis videnskabeligt Hele» — silently corrected (errata: p.155 top line "vis" -> "vist"); the page prints "vis"
Henseende til alle Delenes Betydenhed, Sammenhæng og deres Forhold \apage{155} i et vis
...
og afleder et systematisk Hele deraf, blive synthetisk; de samme
Betragtninger, der lede til at indsee Nødvendigheden af et System, vise ogsaa den
synthetiske Methodes Væsentlighed. Men \apage{156} til denne gjør først en indtrængende og
omfattende Betragtning af Detaillet, altsaa en Analyse, tilstrækkelig
...
Begreb, nu tilsidst \apage{157}  kun et Blik paa Erfaringsverdenen selv lære, i denne at finde
...
hvilken man dog først kan komme til \emph{dens} Aand, \emph{dens} Tanker. Men ligesom man
...
philosophiske Granskninger er Analysen egentligen selve Ideens Studium,
...
\apage{158} 2.~Bedst uddanner sig Methoden i en Videnskab af denne selv og dennes egen
...
fremtræder, maa den \apage{159} Virksomhed, hvorved den skal formaae dette gjennem Individernes
...
Opstaaen. Og saaledes bliver i enhver Videnskab \emph{et Studium af Videnskabens
...
Videnskaben kommer den tillige til at leve i og for en \emph{Bevidsthed} og \emph{i personlige}
...
paa det at  \apage{160} det kan komme til et Rige i Menneskeheden. Og derfor forkynder det sig
...
Overbeviisningen væsentligen en \emph{uimodstaaelig} Grebethed, saa er den dog \apage{161}  ogsaa en
\emph{villig} og den er kun en ægte Overbeviisning, naar den er begge Dele i eet. Vi maae
\emph{selv} see Sandheden i dens Sandhed, naar en sand Erkjendelse skal indtræde.

Ideen refererer sig altsaa nødvendigviis til en \emph{Selvbevidsthed og Frihed} og
% AS PRINTED (collation 2026-09-25): «igjennem dennem at komme» — already as printed, needs comment (errata: p.161 l.8 "dennem" -> "denne")
...
Bevidstheden, men og i en \emph{Drivt} og \emph{Tilskyndelse}, nemlig en Tilskyndelse til
...
aabenbare sig i sin Sandhed, \emph{den selvbevidste personlige Leven}, til at
yttre sig som saadan og nu at træde Ideens egen sig fremarbejdende Indflydelse
imøde.

\apage{162} \emph{Anm.} Hvad der her allerede kunde paatrænge sig os til nærmere Overvejelse
...
Selvtænkningen sættes i Bevægelse ved \emph{en Spørgen}, og det --- eftersom
...
\emph{søges}, sætter ind imellem Tvende, af hvilke Eet skal
foretrækkes, medfører altsaa Mueligheden af \emph{Tvivl}, og, idet Individet
...
En Antagelse og Ikke-Antagelse, eller, saafremt det virkelig er det Sande,
som forkyndte sig, (hvilket Individet dog først skal komme til Forvisning om), en
Erkjendelse og Ikke-Erkjendelse træde nu imod hinanden. Men kommer det da
nu til Erkjendelse, saa faaer denne en ganske \apage{163}  anden Charakteer, Kraft og
...
erkjende gaaer ud) opstaaer \emph{af sig selv}, fordi det højere Liv, der \emph{skal}
frem, nu ogsaa \emph{vil} frem, og derfor i sin Tids Fylde, ogsaa virkelig \emph{forkynder sig}
og stræber frem i det Individ, der \apage{164} jo overhovedet kun er til, for at vorde dette
...
egen Stræben og Gransken. \emph{Hvorfor}, er klart nok af det foregaaende (§.~4. Anm.~3.
og flere Steder). Drivten viser sig, som al Drivt, baade som det Universelles
...
bringe Erkjendelsen  \apage{165} i Stand, derfor kunne vi gjøre andre Bestemmelser og danne os
...
Individet \emph{virkelig kommer} til at \emph{erkjende} d.\ e.\ ej blot at erfare og
...
Bildungs- oder Begründungslehre des Lebens, \apage{166} Anmærkningen til 6). Fordi Ideen skal
...
hvad der, constituerende Fornuftvæsenets hele Tilvær, \emph{er} i ethvert, kunne vi; men
...
\apage{167} Er her da paa den ene Side noget, som staaer til os eller er sat i \emph{vor Magt}
(ἐστιν ἐφ' ἡμῖν, Epict.), med Hensyn til hvilket vi maae vise \emph{moralsk Kraft}
i Flid og Udholdenhed, redelig Sandhedskjerlighed og omhyggelig Aarvaagenhed, saa
...
1.~\emph{Ved os selv} skulle vi søge at erkjende, hvad der er at erkjende. Det nok saa
...
selv. Heraf bliver en Følge, at \apage{168} vi ligesom \emph{oversætte det for os i vort eget Sprog},
...
vi komme, saa er hele Bestræbelsen intet; men Sandheden er kun en \emph{eneste}. Det
forholder sig her ligesom ved Dyden, som viser sig i, at vi med \emph{villig} Hu og
levende Tilbøjelighed (Kjerlighed) deels bestemme os til, deels finde os i, det
\emph{nødvendige}. Vi skulle arbejde fremad, som om det var os ligegyldigt, til hvad Maal
vi kom, naar det kun var et Maal, hvortil klar Indsigt og virkelig Overbeviisning
havde ført os; \apage{169} men dog kan det ej være os ligegyldigt, om nu og vor Overbeviisning
...
denne sidste tilbage. \apage{170}  Er ikke Christendommens, ja Kirkens Lære, i det mindste i
...
Undertrykkelse \apage{171}  af Selvtænkningen skulde beqvemme eller accommodere sin hele
...
frem og grundfæste sig. Det har kun kunnet være den sælsomste Tankeforvirring, som nogensinde har kunnet
...
% AS PRINTED (collation 2026-09-25): «Fordølgelse af egen Sandhedsfelelse» — e printed for ø (2nd+3rd readers)
tvertimod eller med Fordølgelse af egen Sandhedsfelelse%
...
Stræbens Resultat. \apage{172}  Kun ved at gjennemgaae en saadan Ildprøve viser det sig, om
...
% AS PRINTED (collation 2026-09-25): «Udspring, eller Herkomst end» — already as printed, needs comment (errata: p.172 l.14, comma after Udspring belongs after Herkomst)
...
gaaende Tænker, som vil grundigen indlade sig med den, nok maa komme til at sande
den.
...
Sandheden, og om den griber os saaledes, at den  \apage{173} Selvtænkning og Selvvirksomhed,
...
gives visse Erkjendelser, der kunne antages at være saa stadfæstede og afgjorte,
...
% AS PRINTED (collation 2026-09-25): «Ingen kan forud vide om Tingenes Væsen» — already as printed, needs comment (errata: comma after vide missing, l.5 from foot)
...
% AS PRINTED (collation 2026-09-25): «saa ot han kan sige sig» — wrong sort: round-backed o for a in "at" (crop checked; second eye advised)
med det sikkre Omdømme og den fornødne  \apage{174} Færdighed, saa ot han kan sige sig at have
fundet, hvad der var Formaalet for hans Stræben. Aanden giver sig, til hvem den
vil, og i det Maal, hvori den vil. Og \emph{vi}? ville vi vinde Livet, saa maae vi vove
...
med den \emph{Retskaffenhed}, som han ogsaa i sit Studium skal vise, og med det
tillidsfulde \emph{Mod}, som ogsaa hører herhen, arbejde og stræbe, som om han havde
...
vi maae dog række os efter det, som er fore, og jage efter Maalet (Phil. 3, 14).
...
\apage{175} 2.~Men endnu i ganske andre Henseender er her \emph{en Prøve at gjennemgaae}, ofte en
vovelig Prøve, og det viser sig, at Studiet ogsaa kan have sin \emph{Mislighed}, og
sin \emph{Fare}. Forsaavidt nemlig \emph{deels} Egoismen kan „tage Anledning“ af den højere
Erkjendelse, til hvilken Vejen skal aabne sig for os, og faae en desto
fordærveligere Indflydelse, jo højere Formaalene ere, \emph{deels} selve Bestræbelsen
...
udfundet eller udtænkt \emph{af os selv}, \apage{176}  kommer nu let til umærkeligen at bidrage med
til at give det Betydning for os. Større blive Faren, naar vi nu endog lade os
bringe til, før Modenhedens Tid, \emph{at træde offentligen frem} med vore
Betragtningsmaader --- noget, der allerede, fordi det begrændser Granskningen til et
vist Enkelt og standser det alsidige, hensynsfrie, blot efter at \emph{naae} Erkjendelse
...
paastaaede fastholdes let ivrigen, fordi det \emph{eengang er paastaaet}, især naar det
er skeet paa en offentlig Maade. Især hvis \emph{Polemik}, der overhovedet saa let, for
...
at tage det Partie, man tager, \emph{som Partie}, saa at en \emph{Partiaand}
...
uægte, endog lave og slette Motiver have vi ej sjeldent seet, at faae Overhaand
i den videnskabelige Stræben. Hvor megen moralsk Slethed der ogsaa hos Skribenten,
som \apage{177} Skribent, kan lægge sig for Dagen, derom afgiver vore Tiders Literatur
Vidnesbyrd, som vække Forfærdelse. Nu da Afvigelse har viist sig som muelig, maa der
derfor udtrykkeligen vaages over, at reen Sandhedskjerlighed \emph{allene} raader og
...
eet snart et andet \emph{synes} og antages efter øjenblikkeligt Godtbefindende, og blotte
\emph{Indfald} bestemme Antagelse og Dom. Være det nu, at en Higen efter det nye, det
usædvanlige, det glimrende og stærkt i Øjne faldende eller anden forfængelig Lyst
fører til et, maaskee endog tøjlesløst og \emph{frivolt Spil} med Erkjendelsens
...
Indfald og Udtryk vare det, hvorpaa det kom an. Eller ogsaa, at \emph{mat Ligegyldighed},
en sig selv bevidst  \apage{178} Mangel af sand Overbeviisning om nogetsomhelst, saaledes
opkommer, at alt kun antages og beholdes efter øjenblikkeligt Tilsyneladende som
en blot \emph{Mening}, der kan slippes igjen, og hvori man ikke føler sig at eje noget,
...
han \emph{vil leve og døe paa dets Sandhed}. Kun af en saadan Overbeviisning kan et
...
Intolerance, der gjærne vilde paatvinge andre sin Erkjendelse eller
overhovedet før at gjøre den gjeldende bruge andre Vaaben og Midler, end Sandhedens
...
saakaldte \apage{179} Antagelse uden denne levende Overbeviisning virkelig var en Sandhedens
...
Foretagende af denne Art gjør (ligesom det Snigmord,%
% FLAG p.179: "Enigmord, Saul begik" (OCR); word uncertain (Saul's sacrilege, 1 Sam) -- verify against scan.
 Sand begik) et Rov paa det, der hører Sandheden til. Hvoraf da indlyser, at
...
3.~Dog ogsaa uden at uægte og lave Bevæggrunde spille ind med, eller en
forkastelig Tænkemaade ligger til Grund, kan Eftergranskning føre til Vildfarelse;
endog hos den ivrigt stræbende. Den i Bevægelse værende Stræben driver fremad, \apage{180} men
...
selv. Dog maa det ikke glemmes, at vi, som ej  \apage{181} kunne beherske den højere Virken,
hvorved Erkjendelsen gives os, ikke bør \emph{haste fremad} paa egen Haand ud over det,
...
% AS PRINTED (collation 2026-09-25): «og følgende Overhovedet» — no full stop printed at paragraph end (2nd+3rd readers)
dertil. See §.~15. Anm.~2. og følgende

Overhovedet gjelder om den enkelte
...
% AS PRINTED (collation 2026-09-25): «Alsidighed}, hvorl» — wrong sort: ascender-height l for i in "hvori" (crop checked)
tilsigtes da den  \apage{182} fuldkomment \emph{Alsidighed}, hvorl \emph{alt} kommer til i alle
Henseender at vise sig retteligen i sit Lys og med sin relative Gyldighed, \emph{igjennem
en Række af Eensidigheder}. Deels tage vi efterhaanden det, der skal
erkjendes i sin Sammenhæng og Heelhed, \emph{fra forskjellige Sider}, (vi have omtalt
dette forhen §.~15. Anm.~4.), \emph{deels} trænge vi under Betragtningen og Undersøgelsen
...
tilligemed en \emph{vis anden}, der maaskee ogsaa for sig allerede er undersøgt, og nu at
...
vi kunne komme \apage{183}  til at skue den dybere Eenhed i dem alle; thi just det inderste i
...
vise \emph{alt} i et nyt Lys, og det til en vis Grad af fast Bestaaen komne maa da løsne
...
Overgangstider, hvori \apage{184}  Brudstykker af en tidligere Formation findes ved et aldeles
...
Ogsaa den videnskabelige Udviklingsgang er en \emph{undulatorisk}; Stigen og Synken
...
Bestræbelsens Kjærne, er en fast Overbeviisning om \emph{Grunderkjendelsens}, og tilmed
% AS PRINTED (collation 2026-09-25): «den derve fremkaldte» — final d not printed ("derve"; 2nd+3rd readers)
selve den derve fremkaldte \emph{Stræbens}, Realitet, Overbeviisningen om, at der er
...
Hvad i Særdeleshed den til al ægte Videnskabelighed fornødne \emph{philosophiske} Grunden
angaaer, saa har enhver, længe førend han kan  \apage{185} være moden til philosophiskt
...
gaaer i eet med en højere Læren. Det ham saaledes paa en \apage{186} livfuld Maade, igjennem
...
% AS PRINTED (collation 2026-09-25): «(ὠδὶς, for at» — the page prints a grave on the iota (ὶ), not the acute, before the comma; accent as printed
Braaden deri eller Veerne derved (ὠδὶς, for at tage et Udtryk af det andet af de
...
vi nu i et andet Lys. Hvad den allerede \apage{187}  modnede Tænker maaskee strax havde fundet,
...
umiddelbar, vistnok ej altid ubedragelig, \emph{Sandhedsfølelse}, som, uden at
...
Der er mangen ny Lære, mangen ny Tanke eller ny \apage{188} Fremstillingsmaade, hvorom der med
...
Studiet fremkalder overhovedet en \emph{Vexelkamp} imellem en i en bestemt Form udtalt og
...
kunne gaae herskende ind i os, som vi nu eengang ere, naar vi kun ej fattes
...
og fra den faste Form gaae over i en vis Fluiditet, for at kunne \apage{189} gaae ind i os; thi
...
Men heraf opkommer da let \emph{en Gjæring}, hvilken den kraftigt stræbende kan have at
...
af den til Grund for denne Bestræbelse liggende Grunderkjendelse, der nu ej \apage{190} synes
...
% AS PRINTED (collation 2026-09-25): «den klare og bestemt» — misprint: "bestemt" for definite "bestemte" (no e, normal word space before "Fremstilling", confirmed on crop); the file silently corrected it
førend Evidentsen og Forvisningen kan komme. Productet, den klare og bestemt
...
egen Arbejden refererer sig, og hvorved der nu \emph{af sig selv} maa \emph{gaae et Lys op for
os}. Men dette af sig selv arbejdende Liv \apage{191} i os kræver sin Tid og har sine Stadier,
ligesom sine Kriser.
...
Kraft og Betydenhed allerede har viist sig og vidnet om sig selv, skjønt dets Fylde
ej er kommet endnu, maa finde Rum. Ja ligesom der nu kan behøves Taalmod og Tillid
til ej at overvældes af Uroen, saaledes er og en vis Respect for et \emph{αὐτὸς ἔφα}
fornøden.%
% FLAG p.191: Greek "αὐτὸς ἔφα" (ipse dixit) and "φύσις" p.190, "ὠδίς" p.186 -- verify accents against scan.
 Skulle vi end ikke antage \emph{paa Autoritet}, saa kunne vi dog ikke undslaae os for at
have \emph{Agtelse for Autoritet}, for grundige Tænkeres, ja overhovedet for tænkende
...
modstridende Antagelser og Domme in suspenso. \apage{192}  Som jo overhovedet den fremad
...
Kjerlighed og Dyd ere højere end Philosophie, og \apage{193} (Poesien kan stille sig ved Siden
af den). \emph{Eet} er det, under en levende Receptivitet og Productivitet at besjæles af
Idee, \emph{et andet}, at stræbe at udgrunde Beskaffenheden af det, der saaledes ligger
...
% AS PRINTED (collation 2026-09-25): «vor practisk Virksomhed» — print has "practiſk" with no final -e and a normal word gap (checked on a 1.5x crop); ungrammatical after "vor", so a misprint that the file silently corrected
til Syne kommende Sjæl i vor practisk Virksomhed, og det gjelder nu om den
...
\begin{center}\large\S.~22.\end{center} \apage{194} 
...
dens Fordringer i en saadan udadgaaende Virksomhed. I blot videnskabelig Henseende gaaer denne Realisationstendents ud paa at
\emph{fremstille} Ideen i et paa en ydre Maade udtalt, og derved til udvortes Realitet
...
Menneskelivet mere umiddelbart indgribende Praxis eller \emph{practisk Udøvelse}.

Denne Stræben knytter nu Individet nødvendigviis til \emph{et Menneskesamfund}, og
...
\apage{195} Tendents til \emph{Meddelelse} og en Stræben efter at finde \emph{Deeltagelse}. Vi have
...
levende Tankemeddelelse og \emph{Vexelvirkning med andre}. Det højere Liv, der vil leve i den Enkelte og komme til Skikkelse i ham, vil
...
Sag, \emph{et Menneskehedens Anliggende}. Interessen bliver en Almeeninteresse.

\apage{196} Men skal
den Enkelte fuldkomment kunne arbejde herfor, saa maa han \emph{begrændse sig}, det er
...
opfyldes af det Heles Aand, og gjøre Studiet af det valgte Enkelte til \emph{Middelpunct
...
meest afgjorte Maade viser Naturen selv hen paa et saadant ved bestemte \emph{Talenter},
...
befrier for dettes mangelunde Misligheder; thi hvor Naturen saa \apage{197} bestemt har talt,
...
en bestemt Drivt, hvad han bør ansee for \emph{sit Livs Opgave}. Og da kunne Forhold og
...
Ledetraad, som egen Lyst eller Forkjerlighed. Med afgjort Ulyst til et Fag bør
...
eget. Men Lyst er endnu ej strax Trang eller Drivt, og hvor \apage{198} Lysten ej har en
...
% AS PRINTED (collation 2026-09-25): «en practiskt Læges» — print clearly has "practiſkt" (checked on a crop); the -t is ungrammatical before a common-gender genitive, so probably a misprint that the file silently corrected
Landsbypræstes eller en practiskt Læges Stilling og Virkekreds saaledes, at man
...
Menneskesindet for at udgranske, hvad det i de forskjelligste Stillinger og \apage{199} Forhold
...
saa fremdeles: kun da bevæges han af den Lyst til \emph{selve Videnskaben} og
Granskningen, der først lærer, at hiin Lyst til \emph{Virkesphæren} var et sandt Kald til
den.

3.~\emph{Hensynet til en Praxis}, hvortil man vil gjøre sig duelig er vistnok allerede
...
systematiskt Hele, skulde tilsidesættes, fordi det ej synes vigtigt for det senere
...
enkelte Puncter. Den bedste \apage{200} \emph{Beredelse til Praxis} er et grundigt Studium af
Videnskaben selv saaledes, som den er; thi til en solid Praxis udfordres at være
aldeles \emph{hjemme i Videnskaben} og at have tilegnet sig dens Aand, dens Principer og
...
rette practiske er dog Besiddelsen af det, hvorfra dette Details sande \emph{Erkjendelse}
gaaer ud. Hvor lidet gives der vel af den egentlige, dybere gaaende Philosophie,
som kan anvendes ligefrem \apage{201}  i en ydre Virkekreds? Og dog er, næst Religionen, intet
mere practiskt end Philosophien, der, idet den bringer det, hvorpaa hele Livet
...
i den. Vi maae overhovedet ikke glemme \emph{at tage Videnskaben med ind i Livet},
...
\apage{202} sees da nu og let, hvor misligt det ogsaa i Videnskaben er at ville \emph{tjene
...
\apage{203} Saa stort det er, den Erkjendende i sin Indsigt og Videnskab besidder, saa maae vi
dog ikke glemme, at det ej er dette, hvorpaa alt kommer an, det ene, som er
% AS PRINTED (collation 2026-09-25): «talte mod Menneskenes» — the vowel is a closed round o, the same as "om" on that line (checked on a crop); probably a misprint for "med" (1 Cor. 13), silently corrected; second eye advised
fornødent. Som da Paulus siger: at, om vi talte mod Menneskenes og Englenes
Tungemaal og havde ikke Kjerlighed, saa vilde vi være et skingrende Malm og en
klingende Bjelde; og om vi havde al Prophetie og vidste alle Hemmeligheder og al
...
formaae med det dybere Blik at skue og udtale, er det, hvorpaa alt kommer an, saa
lidet som det er det, vi ere blevne satte i Stand til at fremvirke og udrette.
Hvad vi \emph{ere}, er det, hvorpaa alt kommer an, og det ej, hvad vi ere \apage{204} i Henseende til
...
\bigskip
\apage{205} \begin{center}\large Rettelser.\end{center}

\noindent
Side 10 Linie 17 efter \emph{Sindsbevægelse} sættes (,)\\
-- 13 -- 13 læs: i os.\\
-- 18 -- 14 efter \emph{viser sig} udslettes (,)\\
-- 21 -- 11 istedetfor (,) sættes (.)\\
-- 21 -- 13 efter angaaer sættes (,)\\
-- 29 -- 3 fra neden udslettes begge (,)\\
-- 48 -- 2. \emph{I det} læs: \emph{Idet}.\\
-- 64 -- 5 læs: \emph{i det mindste}.\\
-- 72 -- 16 \emph{den intelligente} l. \emph{den fuldkomne intelligente}.\\
-- 142 -- 6 fra neden: \emph{de} l. \emph{der}.\\
-- 145 -- 5 fra neden foran \emph{som} sættes (,)\\
\hspace*{3em}-- 4 \hspace{2em}-- \hspace{2em}foran \emph{ogsaa} (,)\\
-- 153 -- 7 fra neden udslettes (,) efter \emph{at}.\\
-- 155 øverste Linie \emph{vis} l. \emph{vist}.\\
-- 161 -- 8 \emph{dennem} l. \emph{denne}.\\
-- 172 -- 14 efter \emph{Udspring} udslettes (,) og sættes efter \emph{Herkomst},\\
-- 173 -- 5 fra neden sættes (,) efter \emph{vide}.

\medskip
Endnu bemærkes, at der især i de første Ark ofte staaer \emph{maae} istedetfor
\emph{maa}, og et eller andet Sted igjen \emph{maa} (i Singularis) istedetfor \emph{maae}
(i Pluralis).
