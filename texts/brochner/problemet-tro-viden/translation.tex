...
the determinations Νοῦς and φρόνησις. In Aristotle
...
relation to faith. When we speak of faith, πίστις, we must make a definite
distinction between the concept's application in the earlier period and
in a later one. In Plato, πίστις is placed alongside
εἰκασία and stands as something lower in opposition to the true
form of knowledge; in Aristotle, πίστεις (in the
...
drawn from the different relation in which cognition and will stand to the working upon the
real and to the calling-forth of action. As regards the first, there seems to be present an
...
himself more indeterminately: ``the actual praxis cannot directly be derived from the theory.''
...
ethically right, of duty and law as \emph{essence-determination, essence-demand}, united with the
...
both cases must draw determinations in itself, this points back to a distinctive will-principle,
from which then follows the will's and cognition's absolute heterogeneity and mutual independence.
What validity this argumentation has will become clear from the following. As regards the first of
...
will, and particularly the ethical willing. ---As regards \emph{the second point}: that the will can
...
nature not yet worked together into unity, which also makes its working felt \emph{within the
practical's sphere, taken by itself alone}. With respect to the latter it holds that when the
...
works with necessity, corrects his own theory's one-sidedness; as e.g. Hume, inasmuch as he denies
the concept of causality's validity for cognition, affirms it by preserving the category: impression,
in which a relation of causality is included. And the practical sense will, when one does not in
general want to deny a working of cognition upon will, from one side be apprehended as the application
of a theoretical corrective, in relation to the cognition that is to be applied.

When the ethical individual acts indifferently to or even in opposition to one-sided theories, this
...
quickly running through the intermediate links. When thus the \emph{practical thinking in its
essence}---for the essence is determined by the \emph{form}---becomes equal to the theoretical,
which is presupposed through and in the practical, then the same holds of the ``practical
...
the practical cognition (cognition ``for practical use'') is taken in the Kantian meaning of \emph{that
postulated out of a subject's urge}, which is not justified by the theoretical cognition\footnote{Of
the God of faith there is thus to be given only a practical cognition, cf. Afhandl. om theor. og
prakt. Erkjendelse. p. 72.}. But such a postulate, which, in order to have validity, must have its
ground in the subject's essence-determination, in the a priori in the ethical, has its truth only by
...
of philosophy offer countless examples. In Nielsen, however, there is set an absolute opposition
between theoretical and practical cognition. It is said that freedom of choice, choice, decision, can
...
consciousness}, that is, with the immediate consciousness of the subject's practical determinateness: a
consciousness that naturally in its immediacy distinguishes itself from the cognizing resting on
reflection, but in which the relation is the same as in general in the experiential relation to the
object. Does the practical consciousness include not only the consciousness of its object's being, but
of its object's validity, then this shows only that it in the object relates itself to an a priori, but
not that this a priori is something inaccessible to the theoretical cognition. Is the practical
consciousness's content essence-determination in the subject, it must be able to become transparent in
theoretical cognition, comprehended out of the essence-cognition. In this relation Nielsen yet concedes
only a ``reflection,'' not an actual comprehension, an appropriating cognizing of the object according
...
relation becomes only that of reflection. But this designation: reflection, is not a category, but only
an unfortunate metaphor, which, however we look at the matter, leads into contradictions. By this image
...
to be no question. But this apprehension of the relation easily shows itself as untenable. If \emph{the
reflected's absolute heterogeneity} is held fast, not even a reflection will be able to be thought as
...
be able to get anything corresponding to Spinoza's \textit{idea corporis}: a determination that in him,
inasmuch as it makes the with thought absolutely heterogeneous corporeal into thought's content, is only a
postulate, since thought's concept contains nothing that points to body. The possibility of reflection is
...
mirror-surface's faithful imaging of that which is reflected, i.e. of a corporeal object's surface. By such
a one there is a \emph{real likeness}, a \emph{real correspondence} between the mirror-image and the
immediately existing for sight. But when the determination of reflection is applied to the relation between
knowledge and will, to the former's ideal reproduction of the latter's determinations, then there is no
...
form} from the received. For if one sets the reflecting knowledge as working during the reflection according
to its distinctiveness, then the ``reflected'' is in reality not reflected, but absolutely transformed by the
receiving medium's heterogeneous nature. Were one to avoid this by letting knowledge, in spite of the
self-activity, not transform the reflected, this would imply that it, against the presupposition, was
homogeneous with it, and then the relation became more than a reflection. Were one to ground the
non-transformation by knowledge's relating itself absolutely passively, then such a passivity would be
...
hence activity. \emph{As a working from the reflected} the reflection's coming-into-being would in any case
have to be explained; for one cannot by an immanent development out of knowledge itself with logical necessity
reach the reflected, since this is the absolutely foreign that cannot come forward in connection with
knowledge's determinations. But the working points indeed, through the relation of interaction it
presupposes, to the likeness in essence, to essence-unity; it abolishes accordingly the presupposition on
which the representation of a mere reflection rests. However, then, one seeks to apprehend the relation, the
...
interpretation of these, there could then be set up a proof built on an analogical inference
from the relation between the artistic fantasy's working and the cognition of its productions,
...
from cognition has an essential likeness, and next, how the artistic production's relation to
cognition is to be apprehended. ---As regards the first point, there shows itself in the
...
than in the will: it is an immediacy of nature-determinateness in which the spiritual activity
comes forward in the geniusly creating fantasy; it is an immediacy of spirit-determinateness
that makes itself felt in the will as will, i.e. in the conscious will raised above the mere
...
respect to the will's and knowledge's relation. But that it does not point to such a heterogeneity
becomes clear by the consideration of the second relation emphasized above. With respect to this
...
That there arises a nuance in the relation between the nature-determinateness and the
...
regards cognition's relation as receptively apprehending the artistically produced, the
appropriation indeed becomes, as in general the appropriation of the concretely given, an
approximating appropriation, though not determined by fixed boundaries, but during this
...
\noindent 4.~\emph{The decisive proof} against the psychological theory developed above and the
\emph{decisive grounding} of the posited absolute heterogeneity are finally sought in the
...
as well as in the on metaphysical presuppositions resting determination of knowledge's boundary
...
of departure, when the Absolute is to be determined, is the psychological relation; from this the
movement of thought goes to the ontological, and thence, grounding, back to the psychological. But
...
determinations' justification---\emph{the idea of knowledge, of power, and of truth} as
fundamental ideas, and these fundamental ideas then function in the developments that fill out
...
new threeness of fundamental ideas: the \emph{cosmological, geological, and biological idea},
which as \emph{real fundamental ideas} are set in opposition to those---also to \emph{the idea
of power}---as \emph{ideal fundamental ideas} (p. 449). And \emph{above the fundamental ideas
there then stands the absolute idea}, whereas before \emph{the idea of truth}, as the concrete
...
there now appears, in the second volume of the Logic of the Fundamental Ideas, suddenly as it were
...
of the \emph{true} is preserved from the preceding threeness, the ideas of the \emph{beautiful}
and the \emph{good} are new and their relation to that of truth is another than that of knowledge
and power. And truth has now changed function. In the first volume it corresponded to \emph{the
moment of particularity} in the concept, as the concrete unity of the single and the universal.
Now it corresponds to \emph{the moment of the universal} and acquires for its opposite the
\emph{the moment of the particular} representing \emph{idea of beauty} (II. 376). The new ideas
...
transforms itself---while admittedly long since the determination of will has been used, but without
being deduced---into that of the will, in accordance with the postulate that only the willing
subjectivity can be said in the proper sense to be the absolute single.

To these various generations of fundamental ideas, which are occasionally augmented with \emph{the
idea of the world and the Godhead}, of which the former is absolute, but the latter still more
absolute, the will is now set in relation in such a way that it is now, as indicated above, set in
connection with the \emph{idea of the good}, now with the \emph{idea of power}; but inasmuch as the
...
that in the will, and more determinately: in every form of the anti-rational, the with thought
...
universal determination, which belongs to thought because it is thought, is transformed into the
...
decisive for the apprehension of the concept of the antilogical: \emph{the concept of matter}, is
...
emphasizes---to know of something that it absolutely falls outside knowledge. But the antilogical as
...
the logical'' (I. 190 f.), or because it is asserted that every determination of the object by which
...
antilogical as such would just as fully fall outside knowledge because something \emph{parallel
heterogeneous} with it became a content of knowledge. But this relation leads us to the question about
\emph{knowledge's boundary}.
...
\emph{the human knowledge's boundary} is accentuated, partly by the emphasis on the antilogical, partly
by the comparison with the \emph{divine knowledge's ideal}. There is pointed to the antilogical as the
...
show themselves decisive difficulties. Thought by itself as thought cannot cognize its own absolute
...
consciousness, then such a cognizing of knowledge's boundary would precisely presuppose what was here
...
connection with the will, whose impotence for immediate working upon the external is precisely the very
...
relations; but as a \emph{constantly mobile boundary}. If we see existence as an organized unity, governed
...
Before we proceed to demonstrate the consequences of the psychological theory set up by Nielsen, and
particularly to demonstrate that the posited absolute heterogeneity between the principles includes a
\emph{break on the unity of consciousness}, we first consider the psychological theory's reflex in the
...
\emph{revealed religion and the supernatural} acquire their significance: ``the revealed religion,'' it
is said, ``is manifestly a power of spirit.'' ---Inasmuch as the Absolute, seen from religion's
standpoint, is determined as \emph{will-ideal}, \emph{faith becomes exclusively referred to the will}
and \emph{man's faith-relation determined as a will-relation}. The will is accordingly set in a
...
positing a factual dualism in the human, then there follows from this firstly with respect to ethics
...
essential significance \emph{only not for the ethical}. Cognition must acquire an essential and decisive
significance for the ethical acting, as condition for the consciousness of the latter's essence, goal,
content, and conditions. ---There follows next from this that only a \emph{rational ethics}---such a one
...
``ethics of absurdity.'' As regards a religious ethics, it will in the continuation of this work be
...
forth where the ethical acting is seen as expressing man's essence according to its concrete ideal-real
determinateness.

With respect to the religious the results of what was earlier developed include consequences that
...
The connection between the ethical and the religious is brought about in Nielsen by the fact that
\emph{the will's ideal is determined as the ideal of the absolute willing of the good}, and as such as
equal to the divine will, the good (one)'s will, and the religious's relation to knowledge becomes the
same as the ethical's. Inasmuch as God, seen from the ethical's standpoint, reveals himself to
consciousness exclusively under the determination: the Good, there arises an \emph{absolute heterogeneity
between the will-law, the divine will's demand, and cognition's essence-determinations}, and inasmuch as
the divine unconditioned will becomes the divine subjectivity's absolute expression, and the will is the
expression for the divine absolute freedom which the idea of the good demands, then the by will determined
...
out of nothing.'' Revelation's God is to be a \emph{God of arbitrariness} and as such not be able to be an
\emph{object for theoretical cognition}, but only for faith, and more determinately not for a rational
faith, but for a faith that relates itself to the paradox. The God of arbitrariness enters into relation
with man through unconditioned commandments, and man's relation to these is unconditioned obedience, a
\emph{will-relation}, just as faith is a \emph{will-act}. The concept of God that philosophy has developed
...
out of the same false concept of will that was posited within the ethical-human's sphere. The isolated will,
...
which \emph{the essence-utterance will transcends the essence}, i.e. itself. If one lets the representational
...
and knowledge, becoming untrue, precisely because they absolutely separated what is only true as being in unity.

The apprehension of the will that Nielsen asserts leads him, without any proof of the linking's justification,
to set \emph{God's holiness} as conditioned by \emph{God's miracle-working power}, hence to lay a decisive
emphasis on the representation of the miracle. Science is indeed not to be able to furnish a proof for this
...
all real conditions, and accordingly must be denied out of every concept of God that sets God in an
...
harmony with knowledge expressing the divine essence, and as cognized in this harmony by human thought.

The apprehension that Nielsen asserts of the concept of God leads, as regards the concept of faith, as already
...
religion was by the old dogmaticians determined as a \textit{modus cognoscendi colendique Deum}, then there is
...
content---a determining in which the will is a stuff with which something is done---purifies cognition to be able
to apprehend it. But just as little does that apprehension satisfy the scientific consciousness. From the latter's
standpoint it must be held fast that the will as essence-utterance of human nature can just as little essentially
hold itself to the ``supernatural'' as any other whatever of this nature's essence-utterances, and such a relation
is also only postulated. That linking of will and faith has practically shown itself in its consequences in all
persecutions of heretics and in the Inquisition's raging against the \emph{non-believing}, who, in accordance with
...
cognition's and will's demand, that in which \emph{the whole of human nature comes to rest}. Also thus apprehended
...
The opposition in the psychological between cognition and will pointed, according to what was
already earlier developed, back to an opposition on the metaphysical's domain, by which it was
...
partly apprehended as constituted by the opposition between \emph{the idea of the true} and
\emph{the idea of the good}: an opposition that was indeed eternally to be abolished in the
...
psychological opposition was traced back to the opposition between the idea of knowledge and the
idea of power.
...
dualism first comes forward as a \emph{dualism between knowledge and power}, in accordance with the
...
for the antilogical as antilogical cannot be assimilated by knowledge, and inasmuch as it is not merely
...
\emph{Now in order to remove this dualism} there is given in \emph{the concept of power a doubling}.
...
double determinateness in power, which is only set by a postulate, only transfers the dualistic
...
becomes unclear by this doubling, the dualism is thus \emph{abiding in the unexplained doubleness}. The
...
inasmuch as \emph{the dualism in power is not abolished}, it exercises a \emph{reaction upon knowledge},
...
knowledge\footnote{Were ``reflection'' an essential determination in knowledge, an essence-necessary form
of knowledge, the ``reflected'' would have to be reached by an immanent development; but this is an
impossibility on account of its absolute heterogeneity with the comprehended content of knowledge.
...
its proper meaning, it designates the abstractly ideal's arbitrary working with negation of every real, of
all real conditions: the same working that is set in the representation of creation. The possibility of the
miracle in this meaning Nielsen seeks to assert by his after the religious representation accommodated
determination of the absolute subjectivity, which is freely to be able to transcend all conditions. But
...
representation of an almighty, i.e. absolutely arbitrary, creating will, which in unconditioned freedom raises
...
When \emph{the dualism is unconquered in the metaphysical}, this must influence \emph{the form of the
...
\emph{objective being}: into \emph{knowledge}, and inasmuch as the objective, real being's determination is
...
inferences rests, first \emph{the moments of universality and singularity} are so determined that their
...
representation of the single there is taken up \emph{the determination of individuality}, and this individual
being, which in its immediacy is the universal's opposite, is slipped in under the concept of singularity, so
that now this, which originally was identical with the universal's, is at once in a relation of unity and of
opposition to it. When thus the opposition is brought into the unity, then it is natural that \emph{the moment
of particularity} as the mediating must express the concrete unity of the unity and the opposition, and when
...
the demand of unity, it is postulated that the representation-opposition's dualism goes in under the unity: there
...
existence and its principle, there follows as a consequence an abiding, \emph{irreconcilable
split in the human consciousness}, consciousness's inner insoluble contradiction; and from
that absolute opposition there follows further that \emph{the as absolutely heterogeneous
...
standpoint to be warded off, and, in opposition to it, the proposition asserted that faith and
knowledge, precisely on account of \emph{the absolute difference of sphere, the absolute
...
faith's and knowledge's relation to their object the relation is on both sides a relation to
...
\emph{opposite determination of that set as the true reality} is that on which our assertion of
the conflict's unavoidability rests.

Of greater interest than this mistaken analogy is the attempt Nielsen himself\footnote{Nielsen:
...
knowledge, between our knowledge and our (our!) knowledge's ideal.}), and that knowledge's
...
and knowledge. ``Had the human knowledge only relative boundaries, then there would---it is
said---of course always have to be able to be given «plus ultra», then all our cognitions without
...
never come to know: then here is a mystery, an enigma of existence, whose solution in science must
...
something that \emph{must be believed because it cannot be known}. When now that hidden in the
...
shall be scientifically comprehended---and it then necessarily comes to contradictory concepts. But
what can only be expressed in contradictory concepts must be untrue: faith's mysteries let
themselves only be expressed in contradictory concepts, hence they are untrue. That something can be
\emph{true in faith and untrue in science} now follows directly from the fact that science, by
wanting to comprehend what lies outside its boundary, itself becomes untrue.'' In a corresponding
way something that \emph{really is true in science} can be untrue in faith. ``For it is not only
...
engaged itself in something it cannot manage, itself becomes untrue.'' ---``That faith and knowledge
let themselves be united in one consciousness, not although, but because they are absolutely
heterogeneous principles, then in other words means that they only let themselves be united in an
\emph{absolute mystery}. The absolute mystery is at once \emph{exclusive boundary} and \emph{negative
middle}. As exclusive boundary the mystery sets a separation between faith and knowledge as between
...
reason-necessity identical laws of nature, but with the laws' immutability there can indeed, when the
in the mystery hidden \emph{intermediate determinations} are understood, the revelation of will's,
wisdom's, and love's power, in which the Believing one sees the miracle, very well be thought to
consist. \emph{Seen from faith's standpoint} the reason-necessity with the immutable laws of nature can
be united with the presupposition of the miracle. For it is indeed impossible that necessity should be
able to hamper freedom, and nature's laws restrict God's unconditioned will, but when the in the mystery
hidden \emph{intermediate determinations} are understood, it indeed lets itself be thought that the laws
of nature, far from being broken, on the contrary in the very highest sense are fulfilled, every time a
divine will-act is accomplished''\footnote{The concept of ``the absolute mystery'' is in the work: Om
den gode Villie, by Nielsen applied at several points in order to abolish the conflict. Thus (p. 89 f.)
with respect to the Incarnation. ``The unity [of divine and human nature] is and remains an absolute
...
solved, but not by its itself thinking the solution, but by its believing that the solution is thought in
the mystery.''}.
...
external and finite way restricted each other, which they could only do under the presupposition that
their limitation was one coming from outside. ``But faith and knowledge can---on account of the
mystery---impossibly restrict each other. There is indeed in faith a boundary for knowledge, in so far
as that which can be believed cannot be known; but this boundary is one with knowledge's own, inherent
boundary. With its absolute boundary, its inner limitation, knowledge is over against faith entirely
unrestricted, as unrestricted as if there were no faith; likewise faith is with its inherent
knowledge-limitation unrestricted over against knowledge, as unrestricted as if there were no knowledge
...
That the separation between faith and knowledge cannot halve the human consciousness is to lie in this,
...
We have reproduced these developments, also the toward the end placed «lazzi», so completely, because only
...
set forth with respect to the heterogeneity between \emph{thinking and sensation}, the \emph{thinkable}
and the \emph{sensible}, is by a leap carried over onto the relation between \emph{thought (knowledge)}
...
set in the same consciousness---this seems to have to abolish the determination of their \emph{absolute
heterogeneity}, since only that which falls within an essential unity can limit each other. But when the
absolute heterogeneity is abolished, then the defense against a disturbing conflict, which was precisely to
...
limitation. But this determination, which presupposes \emph{the absolute heterogeneity}, in no way helps out
...
mystery becomes a third, a \emph{transit-medium}, through which the way goes from faith to knowledge, from
...
in not only an ambiguity, but \emph{homogeneity supersedes the absolute heterogeneity}. The ambiguity runs in
inasmuch as the unconditionally separating mystery's reconciling significance is to be demonstrated with respect
to the miracle. Knowledge is, by understanding the in the mystery hidden intermediate determinations, to be
able to think the power-revelation, ``in which the Believing one sees the miracle,'' as subsisting with the
laws' immutability, but this it can only when it, while \emph{the miracle's name} is preserved, lets \emph{the
miracle as miracle vanish in a supposed rational}. And the homogeneity then comes in at the same time, inasmuch
as faith by a similar presupposition of intermediate determinations is to unite the presupposition of the
...
to the mystery and the in it hidden intermediate determinations, as it were exchange roles, so that
\emph{knowledge becomes believing, faith thinking}. Knowledge, which builds possibilities on hidden
intermediate determinations---intermediate determinations \emph{between something and nothing}; for thus the
intermediate determinations with respect to the miracle, the partial creation, must be apprehended---and on
intermediate determinations \emph{in the absolute mystery, about which nothing can be known, nothing supposed},
relates itself in reality believingly to the supposed, and faith is indeed to ``be able to think'' the
...
in \emph{the human self's}, in \emph{the human consciousness's nature}. The essence's and consciousness's unity
...
And just as little as the mystery could assert the absolute heterogeneity, just as little can it, even when the
...
inasmuch as it posited the mystery, posited it as a possibility \emph{of knowledge}, and that not as a with our
knowledge absolutely incommensurable knowledge's possibility, but as a with our knowledge \emph{essentially
...
with respect to knowledge, which, inasmuch as it, in accordance with its nature, reflected the opposition, by
...
make \emph{claim to the whole spirit}; they both relate themselves to \emph{reality as a whole and to this
reality's principle}, hence to \emph{the same object}, and inasmuch as they are to do it \emph{as absolutely
heterogeneous}, there lies herein \emph{the contradiction's and the division's unavoidability}. Nielsen's
...
them\footnote{Nielsen: Om den gode Villie, p. 58 ff.}, to prevent the conflict between the spheres. He sets it as
...
the Gospel accounts for example can already for the reason not assail it, that it never comes to know them, ``for in
...
cognize both faith's and knowledge's principle, the two absolutely heterogeneous principles, can be set and meet and
...
world? Yes, about that there are different opinions.''\footnote{Nielsen: ``Den gode Villie,'' p. 62--64.}
...
about a \emph{doubling of reality}, by which it was prevented that faith and knowledge, by meeting within \emph{the same}
reality's domain, should come into conflict, and by seeking this doubling one would then concede that faith's and
knowledge's opposite apprehension of \emph{the same} object yet had to lead to contradiction, although faith and knowledge
...
e.g. the account of Paradise ``with all character-traits contained therein'' is said to have essential and true reality,
then for knowledge an ``inner'' reality, a ``higher reality,'' in which all in that account contained character-traits are
...
sense actual water\footnote{Cf. 4 Moses XX, 11: and they drank thereof, and their cattle.}, which faith still seeks in an
...
postulate principled oppositions, which in absolute heterogeneity each unfolds itself into an in itself concluded
...
dividedness into two absolutely heterogeneous \emph{existence-wholes}.

The second psychological consequence of the theory, which was emphasized above, was this, that the two functions of spirit:
knowledge and will, which were true only in their unity and harmony, were in the abstract opposition distorted. This shows
itself with respect to knowledge in the doubling of its concept which is demonstrated above, and whose effect will be
developed in what most nearly follows. With respect to the will the consequence becomes that it is reduced to \emph{blind,
egoistic drive}, because the will in its opposition to cognition, the universally rational, is only the \emph{will's natural
foundation that comes forward in the drive}, in the alogical in human nature. The opaque nature-singularity's determination,
...
The with respect to knowledge and will drawn consequence can also acquire another expression that already more determinately
touches the ethical and the religious, namely, that knowledge and faith, inasmuch as each of them acquires an opposition that
...
undisturbed in the free, complete unfolding. As regards knowledge, the restriction by faith, which takes place despite all
...
With respect to faith the limitation acquires the same consequence as with respect to knowledge: faith loses by the collision
...
cognition, immediately entails consequences for the ethical, whose true determination cannot be
...
in Kierkegaard, by the choice and the faith-relation, an emphasis is laid on the will-moment as the
...
as changing the content.}; the egoistic and absurd becomes \emph{the action's principle}. \emph{The
...
As the rational ethics' task we determine the realization of the undivided human essence by the free
...
is seen in unity with essence-necessity, let go the ethical demand's unconditionedness. As unconditioned
...
unconditioned by the relation to the essence's divine ground.

A rational ethics is also acknowledged according to the name in the Nielsenian theory, but the closer
determinations that are given with respect to it lead, when the unclarities and ambiguities in the
expressions are removed, to denying its possibility at this standpoint. The rational ethics is to ``stand
under science's influence,'' while the religious ethics stands under faith's. Hereby it seems, since the
religious ethics too as ethics must have science's form, to have to be understood that knowledge's law
becomes determining with respect to the rational ethics' object. But in reality it is not so. The will is
...
rational.}, acquires therefore no other significance than in the composition ``rational paradox,'' that is,
\emph{it acquires no significance}. When the rational ``in principle indicates knowledge's boundary,'' there
can be no other determination for the with knowledge absolutely heterogeneous than the anti-rational: all
ethical must, as expression for the will-principle, become an \emph{anti-rational}\footnote{At the ``rational
ethics' maximum'' subjectivity is to ``turn its back on the theory.'' Heegaard: Indledn. til den rat. Ethik.
...
rational ethical and a rational ethics are in the presentations of Nielsen's theory in an unclear way used
indiscriminately.} therefore unavoidably vanishes\footnote{This shows itself also in the uncertainty in the
determination of the concept of God in the rational ethics. Cf. Heegaard: Indledn. til den rat. Ethik. p. 442
ff.}. And when it is asserted: ``the wide gulf between philosophy and religion is filled out by ethics,'' in
which ``the life-thoughts meet with the scientific fundamental thoughts,'' then this ``meet'' is only an
...
determined will is set to faith, there follows first as a consequence \emph{the religious
...
that which has all marks corresponding to revelation's essence, from the non-genuine. This task the
...
regulating with respect to the religious is accordingly to be sought in the \emph{absolute will-idea},
faith's ideal. But the ``absolute will-idea'' becomes, \emph{when cognition and will are set as absolute
...
because the ``God of arbitrariness'' can make everything into its expression. And this ``God of
arbitrariness''\footnote{Cf. Nielsen: Om theor. og prakt. Erkj. p. 74.}, into which the will-idea is
transformed by the abstract opposition between knowledge and will, becomes equal to the \emph{almighty,
miracle-working God in the religious representation's meaning}. The faith-critique, which acquires ``the
...
that shows everything as possible, inasmuch as everything can become an expression for the incalculable
...
religious, taken in the sense in which Nielsen apprehends it\footnote{With respect to the heathen religions
...
denied that this thought's God really has been believed by the heathens.}.

Both the regulative for the in-truth religious and the law for the religions' developmental course, as well
as the inner connection in the ``faith-concepts,'' the \emph{philosophy of religion}\footnote{Cf. Nielsen:
...
midpoint, its point of departure, and its point of rest in the divine will (bonum est quia Deus vult),''---needs
...
determinations}, which can only be given by the \emph{theoretical cognition of the will's essence} and
...
more determinate form that it is to be developed \emph{systematically on the basis of the knowledge-concepts, so
that under the absolute heterogeneity an all-sidedly articulated reciprocal determination between the
faith-concepts and the knowledge-concepts is demonstrated}, then the solution of this task would, even if the
essentially religious were secured as such, likewise founder on the determination of the \emph{absolute
...
correspond to the knowledge-concepts' systematics. But \emph{the parallelism must become impossible, on account
of the fundamental form's difference}, which does not even let a ``reflection'' be thinkable, and what is said
about the concepts' ``formal homogeneity'' is only an empty word. The examples that are given of concepts that
become absolutely heterogeneous in knowledge's and in faith's sphere are chosen in such a way that the
...
investigate the way in which its task is grounded, and the means that are intimated for the task's solution.

In order to determine the philosophy of religion's essence and task there is a setting out from the concept of an
\emph{absolute boundary for our knowledge}, which boundary is now sought to be grounded by the difference between
our human knowledge and the divine knowledge, our knowledge's ideal. With the absolute knowledge-boundary the
mystery is then to be set and with it a with the knowledge-principle absolutely heterogeneous faith-principle, and
...
one shape can have character-marks that exactly correspond to the character-marks in the other. On the contrary it
...
mediately, is to be able to acquire influence on philosophy as autonomous science, that a glance toward the
\emph{faith-theism} can be guiding in a strict scientific development of the \emph{knowledge-theism}; that e.g. the
...
The philosophy of religion is then determined as ``boundary-science,'' inasmuch as it as science belongs under
knowledge's sphere, but, as having religion for content, must orient us in faith's, the positively religious's
sphere. ``The philosophizing consciousness is, what is self-evident, the subjective medium in which the
heterogeneous concepts meet; from this it follows that the consciousness-unity must presuppose \emph{a formal to
the boundary-determination corresponding concept-unity}, that, in other words, \emph{the absolutely heterogeneous
concepts must in the boundary itself become formally homogeneous}. What such a formal homogeneity has to signify
can easily be demonstrated. We speak of \emph{absolutely heterogeneous principles}, but principle is indeed
\textit{in abstracto} always principle. We speak of heterogeneous (why not: absolutely heterogeneous?) cognitions,
...
a nothing, and on the basis of this nothing the ``philosophy of religion,'' the ``inverted science,'' is then to
operate.

As boundary-science the philosophy of religion is now to acquire its \emph{faith-concepts} from the faith-life and
its \emph{knowledge-concepts} from science. In the latter respect it is to show itself what ``a logical theism''
...
religion on the set-up conditions must become a science that treats both of that which falls outside, and that
which falls inside science, is to be easy to abolish. ``Will anyone assert that there can impossibly be a knowledge
about a faith-cognition, when the faith-cognition by its nature is to fall \emph{outside knowledge}, let him then
begin with the beginning and assert the impossibility of there being a consciousness (!) about the earth when the
actual earth by its nature is to fall \emph{outside consciousness}\footnote{With respect to this little adroit
sophism I refer to Dr. Heegaard's clear and patient analysis: Prof. Nielsens Lære om Tro og Viden. p. 36 ff.}. An
...
``As boundary-science the philosophy of religion must show us how \emph{one and the same concept can become
heterogeneous (absolutely heterogeneous?) with itself, according as it is developed into knowledge- or
...
Kierkegaard.'' (What is the knowledge-concept: God-man---not God-manhood---to mean? and what should a
knowledge-concept: creation, or, what we can substitute: a knowledge-concept: \emph{the miracle}, signify? They are
empty ambiguities or direct absurdities.) ---The philosophy of religion is then to demonstrate an ``\emph{all-sidedly
articulated reciprocal determination}'' between the heterogeneous (absolutely heterogeneous?) concepts; which is to
take place in such a way that the knowledge-concepts serve as \emph{intellectual substratum}, \emph{the faith-concepts,
on the contrary, step into the foreground and are developed systematically}. From the reciprocal relation between the
concepts from the two spheres there is then to come to light the reciprocal relation between the two kinds of theism,
...
Inasmuch as these demands are set, it becomes entirely unclear in what relation faith's ``concept-system'' stands to
knowledge's concept-system. The principled determination of the faith-concepts must, just as it excludes the
...
becomes striking in the determination of the relation between the ethical and the logical concept of God. ``A
development of the logical concept of God,'' it is said, ``is so far from resting on any denial of the ethical, that it
on the contrary contains all moments necessary for the ethical concept of God. Logic is indeed not ethics and the
logical concepts not ethical; but therefore ethics must just as fully have its logic and the ethical concepts reflect
...
shows itself immediately as impossible, and its impossibility is perhaps also acknowledged when it is said: ``Logic can,
...
reached in the deduction from the one of the opposites to the other, and the opposition's absoluteness is thereby
...
The task that is set the philosophy of religion \emph{shows itself then as insoluble, and the scientific character}
...
is explained (!?) in consequence of the principle, expressly from the fact that \emph{the lacking intermediate determinations
lie hidden in the absolute mystery}. Since here accordingly there can just as little be a question of pressing the
...
knowledge'': such a one is not only superfluous, but impossible. ---But the necessity of the consciousness-content's
...
We can now extract the positive result of the critique of the Nielsenian theory. It can be summarized in the following
determinations:

\section{Result of the Critique of Nielsen's Theory}
\label{sec:nielsen-result}

1.~\emph{With Respect to the Psychological:} The human essence's in self-consciousness manifest
...
2.~\emph{With Respect to the Ethical:} No true ethics can be given except as rational ethics. When the
...
3.~\emph{With Respect to the Religious:} The true religious relation: the absolute relation to the
...
The ``gulf'' between the absolutely heterogeneous, between philosophy and religion, is to be filled out
...
The distinctive comes forward next, as already earlier indicated, in the grounding, in the demonstration
of the fundamental relation by which knowledge's self-limitation is to become a necessity. In
\emph{existence's fundamental relation}, in the existing one's relation to the eternal, the necessity is
...
certainty and momentarily give continuousness\footnote{Cf. Kierkegaard: Afsluttende Efterskrift.}.
...
relate oneself absolutely to the absolute τέλος is always to relate oneself thus to it, then this absolute
...
Man is, in favor of the absolute τέλος, to be able to renounce all the relative ones. But such a renunciation is
...
When the decisive Christian determination original sin is brought forward, and when it is apprehended as including
...
of religiousness which Kierkegaard in Afsl. Efterskrift designates as Religiousness A, and which, without
...
which as religion must include a relation to the eternal, it is said that it at least could be found in heathendom,
...
In this unity with itself the spirit can be inasmuch as knowledge is chosen. For inasmuch as
...
absolutely heterogeneous will- and faith-principle. In this work, then, the negative result of the
