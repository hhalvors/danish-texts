...
%  TRANSLATION (English)
%  Translator: [HH]
%  Source: the diplomatic transcription transcription.tex of the
%  1855 printing (public domain), Fædrelandet nr. 281, 1 December
%  1855, pp. 1179--1180.
%  An earlier version of this translation had been made from the
%  article as reprinted in C.H. Koch (ed.), Brøchner og Kierkegaard;
%  it has now been conformed to the print, sentence by sentence,
%  against transcription.tex (2026-09-23). Koch's edition was not
%  used.
%  Kierkegaard's work titles are given in their standard English
%  forms.
%  Printer's errors kept as printed in the Danish are translated by their
%  evident sense: e.g. p. 1180 prints a full stop and a lowercase "det"
%  after "Overdrivelse", which is rendered here as the comma it evidently is.
%  The English was checked against the page image at one point where it
%  disagreed with the transcription (p. 1180, „afmægtig"): the print reads
%  afmægtig, "impotent", and the transcription has been corrected to match.
% ============================================================
...
\begin{center}
{\large On Søren Kierkegaard's Work\\
...
first part of Either/Or appears in personal existence and in the second
...
its decisive point in ``\emph{Concluding Unscientific Postscript}'' (February 1846), its
provisional conclusion in ``\emph{Two Discourses at the Communion on Fridays}'' (late
summer 1851; cf.\ the preface to these), and its final conclusion only at the
author's death. ``\emph{Concluding Postscript}''---which, if any single one of K.'s
...
authorship, regarded \emph{as a totality}, is religious from first to last.'' ---
``The problem, the problem of the whole authorship, is: \emph{becoming a Christian}.''
--- ``To this authorship there corresponds, as its source, one who qua
author has willed only one thing.'' --- More precisely, this that he has willed is
determined thus: ``\emph{Without authority}, to \textbf{call attention} to the religious, the
...
being so.'' The task was then not in the first instance \emph{to give}, but first, as it
were, \emph{to take away}, to remove what favored the illusion, and thus, by the
...
``forgotten to \emph{exist} and what \emph{inwardness} is''; that it, impersonally
...
\emph{personally, by himself}. He is ``made aware''; the rest is left to himself; the
\emph{indirect} communication conceals the communicator from him, makes him as it were
unrecognizable; he must now help himself in the appropriation, and in the
appropriation of that which, by being presented in existence, is only \emph{indirectly}
communicated, he is \emph{personally to experience} where the stumbling-block of the
...
individualities, the first series of writings had to \emph{be pseudonymous}. The
...
The pseudonyms are thus \emph{poetically created} authors, like dramatic characters, who
\emph{live} in their views and express these in their whole ideal consistency.
...
personalities. ``The aesthetic in a person is that by which he \emph{immediately} is what
he is; whoever lives in and by and of and for this lives aesthetically''; his
watchword is \emph{enjoyment}, his goal perdition. The first part presents such an
...
himself again in his eternal validity, has \emph{chosen} himself, who in this choice has
become \emph{manifest} in the universal, and through this has gained the possibility of
...
After Either/Or there followed three smaller pseudonymous writings:
\emph{Fear and Trembling, Repetition} (1843) and \emph{The Concept of
Anxiety} (1844), which successively bring forward the \emph{religious} determinations,
whereas Either/Or had given the aesthetic and ethical ones. They present in
...
determination of the religious: \emph{sin}, which posits the individual as heterogeneous
with the ethical, so that he cannot in despair assert himself \emph{by himself}, win
...
little book, full of sparkling wit and biting satire: ``\emph{Prefaces}, Light Reading
...
determination of \emph{sin}. This was not developed by way of doctrine---``for sin, like
faith, the paradox, and the like, has no place in the System''---but brought
forward in its psychological existence in the individual as \emph{anxiety}. Now it was
certain that the Christian was not confused with anything lower, and
``\emph{Philosophical Fragments}'' (1844) now set it forth in the form of a hypothesis,
experimentally. The \emph{form} here conditioned pseudonymity, the \emph{subject-matter} naming;
hence K.'s name appears on this writing as \emph{editor}. The problem in this writing is:
...
happiness upon a historical knowledge?'' The hypothesis in it is: ``\emph{if} one is to
...
becomes merely the \emph{occasion} for the learner, because the latter eternally \emph{has} the
truth; in which the very consciousness of \emph{guilt} does not reach beyond death,
because the finite personality does not reach beyond it. ``If, then, one \emph{is to} go
...
\emph{faith}; a new presupposition: \emph{the consciousness of sin}; a new decision: \emph{the moment};
a new teacher: \emph{God in time}.''

Simultaneously with these pseudonymous writings, K. had, under his own name,
published six small collections of \emph{upbuilding discourses} (1843--1844), with constant aim at the
category of religion: ``\emph{the single individual},''\footnote{``It is Christian
heroism --- to venture wholly to become oneself, a \emph{single} human being, this
definite \emph{single} human being, alone before God, alone in this enormous exertion and
this enormous responsibility.'' The Sickness unto Death, Preface. --- It was to
this ``\emph{single individual}, whom with joy and gratitude I call my reader,'' that the
...
At the conclusion of \emph{Philosophical Fragments} another writing had been intimated,
in which ``the problem was to be clothed in historical costume.'' But before this
there appeared ``\emph{Stages on Life's Way}'' (1845), in which the three stages of
existence---the aesthetic, the ethical, and the religious---were more definitely
delineated, and the fundamental determination of the religious life, \emph{suffering},
was sharply accentuated. The year after there appeared ``\emph{Concluding Unscientific
Postscript to the Philosophical Fragments},'' like the ``Fragments'' with K.'s name
as \emph{editor}. Here the problem of the subject's relation to Christianity, or:
\emph{becoming a Christian}, is decisively posed; subjectivity as the truth for the
...
determined as the confinium between the aesthetic and the ethical, humor as
the confinium between the ethical and the religious; the religious sphere is
...
in \emph{time} the question of the individual's eternal happiness is decided, and decided
...
With this writing one had decisively come \emph{up to} the goal, to the Christian; it had
...
knowledge, the stumbling-block of offense. The \opage{1180}religious had been the goal; it had
...
traversed had been ``\emph{to attain, to come to} simplicity''; the task ``not to reflect
oneself into Christianity, but to reflect oneself out of something else and become,
more and more simply, a Christian.''

After the series of pseudonymous writings there followed the series of \emph{upbuilding}
ones: first ``\emph{Upbuilding Discourses in Various Spirits}'' (1847), in which, as the
...
the author, personally himself best conscious of his own imperfection and guilt, by no means
...
in the higher's place, --- go further, make the higher into fantasy and
...
Awakening (1849), the sickness unto death---that is, \emph{despair}---is conceived as
sin, and this as the opposite of \emph{faith}, whose object is the paradox, the absurd
for thought; the possibility of \emph{offense} is held fast as the dialectical moment in
...
of \emph{contemporaneity} to the prototype, of making the prototype's life present in our
...
in the \emph{enjoyment} of well-being proclaims the religion of \emph{suffering}. What was later
...
245, 268 in the new edition). But, disinclined as K. was to work toward a change in
...
cf.\ the Editor's Preface to \emph{Practice in Christianity}, and: On My Work as an
...
him, he would have to do one of two things: \emph{either} decidedly declare himself for
...
it is an optical illusion, `not worth a rotten herring,' \emph{or} else as decidedly as
...
him to, after it had been reported to me, with his consent, what he was
...
Literary Review.'' 1846. pp.\ 107 ff.\ and the article in ``Fædrelandet'' for
31 January 1851)---his piety toward Mynster, preserved from
...
against Christendom and its \emph{silent} representative, the clergy. It was now declared:
...
every way out by which one might evade \emph{seeing} the Christian; it was the task in
...
have, among thousands, opened the eye and awakened serious thoughts that will
not be forgotten now that he is dead, but find new nourishment in the writings he
has left behind, in the life he has awakened in so many souls. \hfill ---r.
