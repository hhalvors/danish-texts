...
% ⚠ NO PARAGRAPH BREAK HERE. „Villien i Prof. N.'s Opfattelse bliver nemlig …“
% continues the same paragraph in the print. A break was introduced here in
% drafting, because this is where the pp. 3--12 batch stopped, and removed.
...
common determination, concept, comprise two absolutely heterogeneous
subspecies,
% NB: the Danish sets „Fælledsbestemmelsen: Begreb“ with NEITHER emphasis nor
% quotation marks --- the colon does the work. Drafted here first with \emph{}
% and then with ``…'', both of which put this file out of step with the Danish
% counts; the bare comma pair is punctuation and matches. as the subspecies of Prof.\ N.'s concept of creation and concept of
...
determination essence-universality and of the designation the liberated
universality, and in virtue of these misunderstandings
% NB: neither term is emphasized in the print --- both simply follow a colon
% („Betydningen af Bestemmelsen: Væsensuniversalitet, og af Betegnelsen: den
% frigjorte Almindelighed“). Drafted with \emph{} and corrected. he draws a
...
that is only to make the determination cognition and thinking an
empty word.
% NB: „Bestemmelsen Erkjendelse og Tænkning“ is NOT emphasized in the print.
% Drafted with \emph{} on both nouns and corrected. So here there is no misunderstanding on my side; it is only that
...
if the same measure is to be kept. An unclear feeling of his lack of capacity
% --- p. 23 ---
for productivity in the sense stated above Prof.\ N. has had, and it has led him,
at his many stages of development --- or rather, during his many
transformations --- always to lean on more considerable personalities: first on
Hegel, then on Martensen, then on Kierkegaard, just as he now, at his
% Hegel, Martensen, Kierkegaard, Grundtvig are all set in ordinary tight Fraktur
% in the print -- no letterspacing. Proper names are never antiqua in this book.
``supra-scientific'' stage, leans on Grundtvig. In such a relation of
subordination Prof.\ N. would be able, in the field of particular
investigations, to accomplish something good and useful, as he has come nearest
to doing in his Propædeutiske Forelæsninger of 1860---61. But when Prof.\ N.
wishes to be independent, and especially when he wishes to be the epoch-making
reformer of science, then he makes a fiasco --- as when he invented ``the
absolute heterogeneity'' and when he wrote ``Grundideernes Logik.''

There is then only one more of Prof.\ N.'s charges that I will discuss, in order
at the same time to fulfil the promise I lately made him: the promise of a usable
% NO PUNCTUATION after „omtale“ in the Danish print, although the sense wants a
% comma; what stands there is a speck of dirt, not a sort, and is not
% transcribed. The English supplies the ordinary comma.
citation from Erasmus Montanus. By my unseemly treatment of the 60 sheets I am
supposed to have shown not only a lack of \emph{respect} for science, but also a
lack of \emph{sense} for
% LETTERSPACED in the print, both confirmed by measurement and by spacing.py;
% their neighbours („Mangel“, „for“, „det rette“) are set tight.
what is truly scientific. Properly, the fault is supposed to lie in my not having
raised myself to insight into ``the relation between system and schema.'' Here I
shall now willingly concede --- for one ought in fairness to concede something
--- that I have really not been able to attain to an appropriation of Prof.\ N.'s
systematics. But Prof.\ N. has also evidently developed the systematic to a height
unknown in any earlier philosophy. For Prof.\ N.'s philosophical writings are to
so astonishing a degree penetrated by the systematic that one can cut them up
into larger and smaller pieces, and when one then puts the pieces of the various
books together by page number and binds them, there is at once a system. All that
was still wanting, for Prof.\ N. to reach the ``absolute limit'' of the
systematic, was that he should arrange his writings so that they, like certain
cabbalistic formulas of the Middle Ages, could be read equally well backwards
% --- p. 24 ---
\setcounter{footnote}{0}
and forwards. Now, so that the reader shall not think I am jesting, and so that
Prof.\ N. shall not again reproach me with speaking generally in all generality
about the general, I shall now give a ``development of the case'' so ``punctual''
that Prof.\ N. can hardly wish it more punctual.
% Again specks, not stops, after „kan“, „til“ and „Parti“ on this page in the
% Danish; none is transcribed.

Prof.\ N. has, in the last 3 years, during which he has given philosophical
lectures for the youngest students, issued courses of lectures through the book
trade, different ones for each year. In 1865---66 a first and a second course
appeared, one for each half-year. The one of these courses was formed thus: that
``Forel.\ over phil.\ Propædeutik fra 1860---61'' was cut through at p.\ 177 and
the severed front portion replaced by ``Forel.\ over phil.\ Propæd.\ fra
1861---62.'' But now this latter book had only 164 pages, and 176 were needed. A
whole sheet was therefore written, which was found suitable to give room
% The comma after „fandtes“ is in the print, although the sense would rather
% have „der fandtes passende at kunne give Plads“. Kept as printed there.
for a raid against theology; it was shoved in\footnote{% printed *)
  In this interpolated portion Prof.\ N.'s peculiar wit culminates: the wit that
  must \emph{not} have anything \emph{burlesque} about it. An elegant sample may
  % LETTERSPACED, in the smaller footnote type, and DISCONTINUOUS: „ikke“ and
  % „Burlesk.“ are spaced, the words between them („maa have noget“) tight.
  be found on p.\ 174, where Prof.\ N., mocking speculative dogmatics' doctrine
  of creation, makes a table with the ``wholly created'' Adam, the ``almost
  wholly created and exceedingly well created'' Eve, the ``half created but not
  misshapen'' everyday people, the ``more than half created'' heroes and
  geniuses, and the ``half over-created and precisely therefore often
  misshapen'' dogmatic talents. Tasteful witticisms, offered to young students
  by the teacher who is to represent for them ``the science of the sciences!''},
two leaves reprinted, and then one had a ``systematic'' work. What had been cut
from the larger book then became, after the last leaf had been reprinted, the
second course --- and was just as systematic as before. To the two courses were
added a couple of short prefaces, together 11 pages, for the most part put
together out of fragments from Prof.\ N.'s philosophical Propædeutik of 1857 and
from the preface to Grundideernes Logik, part 1. It must be on account of these
prefaces that Prof.\ N.\footnote{% printed **)
  Cf.\ the preface to the one course, p.\ III.}
% NO full stop closes this note in the print; the English supplies it.
speaks of the whole course as ``these \emph{extracts}, among
% --- p. 25 ---
which are also found larger and smaller pieces of philos.\ Propædeutik,
Grundideernes Logik, and so on.'' --- For the university year 1866---67 a new
course was issued, which received the title ``Propædeutik og Psychologie.'' It
was manufactured thus. The propaedeutic lectures of 1860---61 were again divided
at the same place as before, at page 177; but the severed part was this time
replaced by the philos.\ Propædeutik of 1857. Here there arose the difficulty
that this book had 204 pages, and only 176 could be used. Prof.\ N. knew,
however, how to help himself in an easy and ``systematic'' way: he clipped off
the end of the book, and although it was the concluding and most essential
portions that were clipped away, the ``system'' was just as good after two leaves
at the book's beginning and two at the junction had been reprinted. As a
supplement to this new work the students then got part 2 of Grundideernes Logik,
and in the fact that they had to read it although they had never seen part 1
there was of course also ``system.'' But the systematic attains its true height
only in the two courses for 1867---68. The one, \emph{Logik og Psychologie}, is
simpler in composition.
% The two Cursus titles on this page are letterspaced and the „Det ene:“ /
% „Det andet Cursus:“ that introduce them are not; measured at 600 dpi.
Pages 1---262 are cut out of Grundideernes Logik part 1, pages 279---482 out of
the propæd.\ Forelæsninger of 1860---61. New is what has been set in front of the
book with separate pagination (pp.\ 3---5), and pages 264---78, which are
entitled Psychologie and contain among other things a short and thorough survey
of the \emph{human}
% LETTERSPACED, and alone: „menneskelige“ is spaced while „Sjæleliv,“ beside it
% is tight. The irony is on the one word -- the whole of the HUMAN soul-life in
% two and a half pages.
soul-life, in 2½ pages, of which, however, a portion is taken up by a treatise on
the soul's immortality. Reprinted are only the leaves where the junction has been
made. It is interesting that the \emph{very same thing} which in 1860 was
\emph{propaedeutic} represents in 1866 \emph{psychology}, in 1867 \emph{biology
and psychology}
% The letterspacing here is DISCONTINUOUS and is set as measured: „Selvsamme“
% (broken across the line, both halves spaced), „Propædeutik,“, „Psychologie,“,
% „Biologie“, „Psychologie,“ are spaced; „der“, „var“, „forestiller“ and the
% year figures are tight.
--- but that is of course in accordance with a higher ``systematics''! --- The
other course, \emph{Logik og Propædeutik}, is more combined. Here pp.\ 3---80 are
cut from the propæd.\ Forelæsninger of 1861---62, pp.\ 82---177 from those of
1860---61, pp.\ 177---204 from the phil.\ Propædeutik of 1857, and then again pp.\
204---274 from the lectures of 1860---61.
% --- p. 26 ---
New is a ``\emph{Grundrids af den formelle Logik}'' in 2 (in words: two) pages,
% LETTERSPACED -- a third Cursus title spaced like the two on p. 25. The
% quotation marks are left outside the \emph{} in both files.
set in front; reprinted are the 3 leaves where the junction has been made. One is
much surprised, in the middle of a development that is not divided into
paragraphs, suddenly to come upon § 35 on p.\ 184 and § 36 on p.\ 190, and then
to see the division into paragraphs cease again. The surprise is removed,
however, when one recalls that in the previous year a stump had been cut from the
little phil.\ Propædeutik, and it would have been ``unsystematic'' not to use it
for the sake of those paragraphs. It must also have awakened a fond memory in the
author of the little system that began with §.\ 11. --- The reader will now, if he
% THE BOOK'S OWN INCONSISTENCY, kept in both files: „§ 35“ and „§ 36“ above carry
% no full stop after the section sign, „§. 11“ here does. All three stand in one
% paragraph. (p. 22 has „§ 11“, without the stop.)
has a sense for the ``systematic,'' be able to sketch the plan for the system in
Prof.\ N.'s next course. For there are in reserve: of the propæd.\ Forelæsn.\ of
1860---61, pp.\ 1---82 and pp.\ 177---204; of those of 1861---62, pp.\ 81---164;
and of Grundideernes Logik vol.\ 1, pp.\ 263 to the end. Here, then, only a couple
of small gaps need to be filled; and if these were evenly applied to the ``half
over-created and precisely therefore often misshapen'' dogmatic talents, to the
stilted ``metaphysics-people,'' and to the ``philosophical bullfinches,'' it might
well turn out very ``systematic.'' Prof.\ N.'s polemic would serve excellently to
cement the pieces into a system; for it is very sticky. It was for this new course
that I wished to recommend to the Professor the promised citation from Holberg.
What does Prof.\ N. say to putting the following motto on his new course:
``\emph{When this book is bound in a Turkish binding it is called \textit{Donat};
% The Erasmus Montanus motto is NOT displayed and NOT indented in the print: it
% runs straight on from „Cursus:“ and the paragraph ends in the middle of a line.
% It is marked by letterspacing alone, uniform over the whole quotation, the
% three antiqua words included. It fills five printed lines.
but when one binds it in white parchment it is called \textit{Grammatica} and is
declined like \textit{ala}}.'' (Erasmus Montanus, Act 1, Scene 4.)
% ANTIQUA: „Donat“, „Grammatica“ and „ala“ stand in upright antiqua against the
% Fraktur and carry no guillemets. All three fall inside the letterspaced motto,
% so all three are spaced antiqua; the enclosing \emph{} carries that.

% Centred rule: a single hairline standing between the motto and the next
% paragraph. Text, not a footnote separator; there is no note on this page.
\begin{center}\rule{2cm}{0.4pt}\end{center}

I am now done with what one may, if one will take science in a ``wider sense,''
call the ``scientific'' side of Prof.\ N.'s polemic; I now pass over
% --- p. 27 ---
to another side of this polemic, and here I must speak a somewhat different
language. So long as we had to do with Prof.\ N.'s scientific and literary
conduct, we have not always been able to remain within the bounds of the serious:
the object lay too far within the territory of the ludicrous. Here it truly held:
\textit{difficile est satiram non scribere}. But I now come with Prof.\ N. onto
% ANTIQUA, upright, no guillemets. „non“ is NOT letterspaced here, unlike
% p. 12's „lucus a n o n lucendo“.
the territory of the ethical, and here one must speak seriously. It is of Prof.\
N.'s insinuation concerning the motives for my conduct that I shall now say a
word.

There has in recent years been frequent complaint about the form in which
scientific polemic is often conducted among us, and rightly. Complaint has
rightly been made about the coarse tone which showed that our men of science were
not always at the same time cultivated men. But polemic has of late not seldom
taken on an incomparably worse character, in that it has taken to imputing
reprehensible motives to opponents; and against this species of polemic, which
has been particularly often used against Prof.\ N.'s opponents, a serious protest
must be lodged. When Cand.\ \emph{Larsen} in his day wrote against Prof.\ N., it
was anonymously insinuated in a journal that the motive had been --- a university
stipend. When Dr.\ \emph{Heegaard} recently wrote his book on Prof.\ N.'s
doctrine of faith and knowledge,
% LETTERSPACED, and Fraktur, not antiqua. No proper name in this book is set in
% antiqua; these two are spaced instead.
something similar was coarsely hinted in an anonymous piece. And now that I have
come forward with my criticism, Prof.\ N. puts forward in his piece an
insinuation of another content than those, but no less offensive. Prof.\ N. will,
after the well-known turn, \emph{not} say that it is not love of science but a
smouldering hatred of positive Christianity that has guided my attack on him; no,
% Only the FIRST „ikke“ is spaced in the print; the second, four words later, is
% tight. The English reproduces the same distribution.
on the contrary! he will find it right that a vigorous rejoinder be made if such
a thing is said. Prof.\ N. will \emph{only} --- in other words say
% PRINTER'S DEFECT, p. 27: the Danish print reads „Prof. N.'s vil kun“, where the
% sense plainly wants „Prof. N. vil kun“. Kept as printed there; the English has
% the correct form.
% „kun“ IS letterspaced here (and the „kun“ in the next sentence is not);
% dropped in drafting and restored.
\emph{the very same thing}! He will only say that it is probably \emph{not} from
\emph{scientific} motives, but from an impatiently hurrying zeal to
``\emph{come to grips with the faith of
% --- p. 28 ---
% „Aabenbaringstroen“ is broken by the compositor at the foot of p. 27 and
% rejoined in the Danish with \-%. The letterspacing and the quotation both run
% across the page break.
\setcounter{footnote}{0}%
revelation}'', that I have come forward\footnote{% printed *)
  Might the peculiar inference that Prof.\ N. (p.\ 11) draws from my words
  perhaps point in the same direction? I had developed in my book that the form
  of consciousness peculiar to the stage of the positive religions let a remnant
  of egoism remain even in the religious relation of love. This becomes in Prof.\
  N. the claim that the Gospel is supposed to be a ``product of hidden egoism''
  and ``the Hero of Gethsemane the greatest egoist who has lived on earth.'' I
  have taken Prof.\ N.'s inference for a great thoughtlessness; I should be
  reluctant to consider it something worse.}. Prof.\ N., who has so often clearly
depicted the evil instincts of fanaticism, does not scruple to awaken all these
evil instincts by throwing out an insinuation in whose truth he cannot himself
believe! Let us, when we would bear the honorable name of men of science, first
and foremost remember the obligation it lays upon us: to act as befits men of
science; but a throwing out of that species of insinuation I at least cannot
acknowledge to be befitting.

But Prof.\ N. does after all furnish a proof, ``a proof from circumstantial
evidence,'' for his charge. If it had really been science's right that lay on my
mind, then I should merely --- have discussed with Prof.\ N. the problems in
Grundideernes Logik! So then! if I had wished to maintain the right of knowledge
and of science over against theology, and over against a ``theory of faith''
which in equal measure corrupts knowledge
% The hyphen of „Troes-Theorie“ falls at the end of a printed line, so it is both
% the compound's hyphen and the break. It is kept in the Danish, because the
% second half is capitalised.
and faith, then I should have immersed myself in endless logical investigations
with this theory's representative, while he unhindered spread confusion and
violated science's right; --- I should thus, in a word, have maintained science's
right by \emph{not} maintaining it. This whole insane ``proof from circumstantial
evidence'' acquires sense only when an intermediate premise is supplied, which
must surely have hovered before Prof.\ Nielsen. With it the proof would run thus:
if it had been Prof.\ Brøchner's intention to assert science's right, then he
would have had --- \emph{since Prof.\ N. is one with science, is its incarnation}
--- to immerse himself in those investigations in fundamental logic, and to let
% LETTERSPACED over the whole parenthesis in the print.
personified science
% --- p. 29 ---
speak science's cause alone. In this way a kind of sense came into the proof;
but, Prof.\ N. forgive me! I cannot see it otherwise than that it came in only
through that in which there was \emph{no} trace of sense.

With this objection to Prof.\ N.'s unwarranted insinuation I part from him. When
I wrote against him, I knew beforehand of what kind his answer would be if such a
thing came; I had ``circumstantial evidence'' enough. To Prof.\ N.'s address he
has now received a reply; and even should he, in the need to keep the last word,
write a new piece, I shall be excused from taking any account whatsoever of it,
unless it is wholly different, both in form and in content, from the last.

% Centred rule: a single hairline with white space above and below. Text, not a
% footnote separator; this page carries no note.
\begin{center}\rule{2cm}{0.4pt}\end{center}

Only a few words more to my readers will I add about my personal relation to the
problem I have treated. It is almost 30 years ago, when I was still quite young,
that the problem of faith's relation to knowledge first showed itself to me in
its whole significance and became an object of my serious and constant
reflection. I was soon led to a conception not far removed from the one I have
expressed in my book, and there came a moment when it became my duty openly to
acknowledge my conviction. It was then expressed unreservedly and without
timidity, although this utterance had to cut deep into all my personal
circumstances and to lay perhaps insurmountable obstacles in the way of a future
activity for me. It was at the end of 1841; in 1843, just at this time 25 years
ago, I then wrote a little book against Martensen on the occasion of his treatise
on baptism. From that time until, a few months ago, I published my book, I have
written nothing touching the problem that has occupied me without interruption;
and in my now already many years of university activity I have treated it in only
one lecture course (in 1858---59), and there from the historical side. I
% No full stop after the closing parenthesis in the print: the sentence runs on.
had therefore no ``haste''; I calmly let my conviction ripen in
% --- p. 30 ---
me until it became certain to me that it was not only scientifically tenable, but
that it could sustain a personality's life. And I would not venture to take upon
myself the responsibility of merely tearing down, by an untimely communication,
where I could build nothing up. But there came again a moment when I held it to
be my duty not to keep silent. It was when what was scientifically worthless and
personally untrustworthy pressed presumptuously forward, spreading confusion, and
when it was proclaimed by thoughtless ignorance, in the manner of a
market-crier, as the only truth. I then made the problem the object of the
university lecture course that now lies before the public. In what spirit and
tone it has been treated the reader now has the opportunity to judge for himself;
and I dare confidently rely on it that no one shall be able to point out a trace
of hatred or of want of reverence for that which is holiest to so many. I dare
rely on it; for from serious and noble men, inwardly attached to the positively
religious, I have received utterances full of goodwill and appreciation. And I
dare calmly direct this question to all those who through the many years have
been my hearers --- also to those who have most passionately attached themselves
to a conviction opposed to mine: whether I have ever as a university teacher
uttered a word that could wound their feelings; whether I have not on the
contrary constantly spoken with reverence of Christianity; whether I have not
honestly striven to show its superior significance in relation to those phenomena
of spirit which at its appearance proceeded from a similar striving of the
spirit. Because I seek truth not in that which has now for centuries sustained
the life of so many generations of men, but in that which \emph{eternally}
sustains
% The one letterspaced word on the page; its neighbours are tight.
the life of the human spirit and binds it together in unity with its divine
origin --- should I therefore not know how to respect the forms through which
the human spirit strove toward this unity, and above all the purest and most
spiritual of these forms? Assuredly! no one can think so, and even my opponent
cannot believe it; for we have often enough exchanged our thoughts on this matter.

My task lies clear before me, and undisturbed by
% --- p. 31 ---
% „Angreb“ is broken by the compositor at the foot of p. 30 and rejoined in the
% Danish with \-%.
attacks I shall strive to solve it. It is: to find, by the way of knowledge, that
which brings unity and reconciliation into the life of the human spirit ---
reconciliation between man and his origin. On the solution of this task I shall
work now as before, without passion and without hatred, rejoicing in the sympathy
of those who strive seriously and honestly, with truth as my only norm, always
open to clear reasons, but undaunted by the clamor of fanaticism and with calm
superiority in the face of what is base.

% Ornamental tailpiece closing the book: a centred printer's flower -- a swelled
% rule tapering to a point at each end, with a chain of about a dozen lozenge
% beads through the middle. Set here as a plain rule, as in the Danish, since the
% repo has no ornament stock. Nothing follows it on the leaf; there is no
% colophon.
\begin{center}\rule{2cm}{0.4pt}\end{center}

% =====================================================================
%  RETTELSE / ERRATUM  (printed on a leaf at the back, PDF 37)
%  Fraktur. The heading is letterspaced and centred; the line below it is
%  centred and not spaced. Translated as printed; NOT applied to p. 11.
%  Brøchner is RIGHT -- the sense at p. 11 wants "subjective" -- but the
%  printed reading stands in both files and this leaf records the correction,
%  exactly as the Danish does.
% =====================================================================
\bigskip
\begin{center}
  \emph{Erratum.}
  ...
  \smallskip
  Page 11, line 2: videnskabelige [scientific], read: subjective.
\end{center}
% NB: in the print only the heading „Rettelse.“ is letterspaced; the line below
% it is set tight. Drafted with \emph{} on the two readings and corrected --- the
% Danish words are kept as Brøchner wrote them, with a bracketed gloss on the
% first, since the erratum is about a Danish word and not about the English.
