...
Henseender, samtidigt med, at det paa nogle Punkter har vist sig \apage{6}  umuligt
...
medfører en helt ny Retning i  \apage{7} Tankearbejdet. Spørgsmaalet bliver da
...
Vækkelsens \apage{8}  Tidspunkt ser jeg et Bevis paa Kontinuiteten i Kants
...
vi inden \apage{9}  for hvert af disse undersøge Forholdet mellem det tidligere og
...
sammen \apage{10}  med en filosofisk Tankegang, der allerede paa den Tid udviklede
...
Formedelst den gensidige \apage{11}  Sammenhæng mellem alle Ting i Verden, kan man
...
Kants Øjne. Allerede i Habilitationsskriftet \apage{12}  havde han sluttet sig til
...
dem. For at Vexelvirkning skal være mulig, maa Tingene fra først \apage{13}  af
...
5.\ En Tanke af saadan Dybde og Interesse kunde man ikke tænke sig at  \apage{14}
...
\ldots\ ikke paa det blotte Fænomen, men er en Forestilling  \apage{15} om den
...
\textit{Lose Blätter} I.\ p.\ 274.} \apage{16} .
...
Erscheinung die gesuchte Stetigkeit finde.»}. \apage{17} 
...
Visdom viser sig her ingenlunde at være opgiven, skønt den  \apage{18} træder frem
...
de  \apage{19}t\footnote{«Etwas als ein Merkmal mit einem Dinge vergleichen heisst
...
Skrift \apage{20}  indskærper den af alle Tiders spekulative Filosofer saa ofte
...
Udtalelsen i «Träume  \apage{21} eines Geistersehers» (i Slutningskapitlet). Her
...
Brud med den foregaaende Tids Filosofi. Kant fordrer et  \apage{22} helt nyt Grundlag
...
den fuldstændige Overgang til den kritiske  \apage{23} Filosofi, saa passer det ikke
...
Usikkerheden om dette \apage{24}  Spørgsmaal et Vidnesbyrd om Kontinuiteten i Kants
Udvikling.
...
Diederichs.})} \apage{25} . Det var efter Herders hele Naturel og aandelige Retning
...
finde Sted. Han nærmer sig dertil i den mærkelige Udtalelse (Brev  \apage{26} til
...
Urbillede for enhver mulig Syntese», som kan  \apage{27} erkendes afset fra eller
...
vor Erkendelse. Denne \apage{28}  Del af Analysen gik Haand i Haand med Paavisningen
...
Men den skarpe Modsætning mellem Matematikens og Filosofiens Metode,  \apage{29} som
...
videre  \apage{30} end han var 1762. Han har ikke paavist Muligheden af at bestemme
...
den videre og paa anden Maade end han gjorde.}. \apage{31} 
...
have  \apage{32} derfor, som vi allerede have vist (§\ 5 Slutn.; §\ 12), i Begrebet
...
for  \apage{33} ham som et fjernt Maal. Fra Urbilledet og Præsumtionen gik han uden
...
iøvrigt er given, blot ikke gennemskuet» (2.\ Udg.\ p.\ 585; 631  \apage{34} f.). ---
...
Erkendelsesteori, hører \apage{35}  Mere end de subjektive Betingelser. Herved
...
hvad  \apage{36} Spekulationen angik, nemlig om megen formentlig Videnskabs
...
Rousseau, fordi han havde fremdraget Menneskets \apage{37}  dybt skjulte Natur under
...
s.\ om det, der træffes i Erkendelsens Genstande i og for  \apage{38} sig betragtede,
...
anden Verden, maa vente, til de komme derhen. Foreløbigt \apage{39}  vide de, at de
...
Sansning  \apage{40} og mellem Form og Stof. Det synes endog, som denne Distinktion
...
erkendes \apage{42}  ved Erfaring, men ved den rene Fornuft, og Moralfilosofien
...
intelligible Karakter.} \apage{43} 
...
Den skarpere \apage{44}  Form, i hvilken denne Modsætning fremtræder i Kants
...
hverandre indbyrdes; den er egentlig talt en Idealisation af de Love for  \apage{45}
...
opfatter ved sin Fornuft og derefter bøjer sig \apage{46}  for. Fornuften som
...
psykologiske Grundlag er skudt til  \apage{47} Side.
...
ersten \apage{48}  Grunde des Unterschiedes der Gegenden im Raume». Han forsvarer her
...
bliver \apage{49}  os bevidst ved successiv Sammenfatten af Delene, ved Syntese. Et
...
altsaa kun viser os Tingene som  \apage{50} Fænomener, d.\ v.\ s.\ saaledes som de
...
Stof for vor Erkendelse faas ved Sansning. Og Forstandsbegreberne \apage{51}  opfattes
...
Udtrykket Vækkelse \apage{52}  passer ikke paa den, hvorimod det godt passer paa en
...
af Forstandsvirksomhed. Allerede i det anførte Brev til Hertz \apage{53}  omtaler han
...
for al vor Erkendelse, at den dels af givne Elementer \apage{54}  danner et Hele,
...
Grundbegreb, \apage{55}  før det kunde ses, at al Dømmen falder ind under det.
...
Med  \apage{56} Rette klagede han over, at han paa dette Punkt blev saa grovt
...
Meningsløse; den anden Vej fører \apage{57}  til at stille os det sidste Problem,
...
udtrykker Grundform og Grundlov for det aandelige Liv, saa vidt  \apage{58} vi kunne
