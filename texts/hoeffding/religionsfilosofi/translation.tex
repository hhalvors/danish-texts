...
\begin{flushright}
\textit{So wie die Völker sich bessern, bessern sich auch ihre Götter.}\\[2pt]
\textsc{Lichtenberg}.\\[6pt]
\textit{Mit ihren Gemeinden wachsen die Götter.}\\[2pt]
\textsc{Erwin Rohde}.\\[4pt]
\textit{(As peoples improve, so do their gods.---}\\
\textit{With their congregations the gods grow.)}
\end{flushright}

\bigskip

\noindent\textbf{92.} Just as religion in its classical times affords the human being his whole
conception and understanding of existence, so it also affords him his ethics---that is, states the
highest ends for willing and acting, sets up models, gives commandments and laws. And just as the
explanation of nature is built on the operation of supernatural powers, so ethics is built on
revelations of the human being's dependence on supernatural powers that determine his fate in this
and perhaps also in another world. Ethics rests here, then, on a supernatural history. On the human
being's relation to the supernatural world it depends whether he can live rightly in the natural
world. This was consistent, for in religion's classical times the human being knows better where he
is with the supernatural world than with the natural, and life here in this world is properly only
a means for life in another world.

Yet the relation is more complicated than it might seem at first glance.---I have spoken only of
religion in its classical times. But the manner in which the relation between religion and ethics
appears in such times has a long prehistory.

And if we look at the relation between religion and ethics in its \emph{historical development,} we
find a constant reciprocal relation between them, so that it is not merely religion that acquires
influence on ethics, but conversely also the human being's ethical development that acquires
influence on religion's character and content.---And besides, when the question is of
\emph{grounding and justification,} it is nevertheless at last---though indirectly and
unconsciously---religion that supports itself on ethical ideas, not conversely, even in the classical
times. The value and significance ascribed to religion has as its logical presupposition certain
ethical ideas which the religious consciousness feels no need to formulate specially.---

\medskip

\noindent\textbf{93.} Nature-religion already has its ethics, in so far as it makes definite demands
on the human being. The divine powers are honoured and obeyed. They demand worship through ceremonies
and sacrifices. Human beings' thoughts are to be turned again and again upon them. It is a course in
obedience and self-control that human beings here go through: they learn to subordinate themselves,
and they acquire at the same time a wider horizon for their life. Since the worship is common to the
family, the clan, or the people, it contributes to nourishing a feeling of community that can acquire
ethical significance. And since the forms of worship are transmitted from generation to generation,
and their observance stands as a sacred duty, there is nourished the feeling of a historical connection
that is to be continued. The consciousness of continuity is developed through the inward adherence to
``the gods of the fathers.'' Here in nature-religion already, then, religion exercises its discipline,
and here preparatory work can be done that may be of importance for ethical development.

Between nature-religion and ethical religion there are a mass of transitional forms.---Even if the gods
are represented as upholders of what is ethically good, it is not thereby said that they themselves
follow the law they inculcate. They often uphold the good without being good themselves. This opposition
often appears in the popular religions in a very naive manner. It does not occur to the human being to
demand the same of his gods as he demands of himself or of other human beings.---Besides, different
stages of ethical development struggle with one another within the popular religions, since these on
account of their conservative character are reluctant to let go old forms because they have taken up new
ideas. When the gods in earlier times demanded bloody sacrifices, perhaps even human sacrifices, it was
because they acted according to the tribe's barbaric ethics. With higher development, human beings turn
away in their own life from this bloody practice, and one then gives an allegorical interpretation of the
old commandments, or one contents oneself with symbolic imitations of the bloody acts. Perhaps one even
denies that the god ever demanded bloody sacrifices (thus the prophet Jeremiah VII, 22--23). There takes
place here a characteristic transition from the ritual to the ethical, in analogy with the transition from
liturgy to religious speculation that we have discussed in another connection. The religious customs of
purification (for example in the Persian and Jewish religion and among the Greek Orphics) come later to
stand as symbols of the soul's purification. The Vedanta doctrine (in the Upanishad) is a thoroughgoing
symbolic interpretation of the old Brahmanic customs. As the Vedanta philosophers explain the old
Brahmanic customs, Plato explains the Orphic customs. Martensen explains the Mosaic prohibition against
sowing one's field with two kinds of seed and wearing clothes of two kinds of yarn as aiming at an
inculcation of the great difference between the holy and the unholy, an exercise in ethical distinction.

Sometimes the struggle between lower and higher ethical ideas that has taken place in the people's mind is
traced in ethical oppositions within the world of the gods. In Babylonian mythology there occurs a
characteristic example of this. The god Bel has brought a flood over the human race. But the god Ea has
warned a pious man, who with his family has saved himself on a ship. Bel is furious at this, especially
since he is not invited to the sacrificial feast the saved ones hold. A dispute then takes place between
Bel and Ea: the latter declares it unjust to destroy the good together with the bad, and Bel must at last
concede that he is right in this. In monotheistic clothing we have the same trait when Jahveh repents that
he has let the Flood come, and declares that he will not do such a thing again. In Nordic mythology
``Ægir's Banquet'' presents an example of ethical oppositions within the world of the gods and of ethical
criticism of gods by gods.---There is a natural transition from ideas such as these to the idea that the
evil in the world, which was formerly derived from the gods just as well as the good, stems from gods of
lower rank or from the gods' antipodes. The older forms of faith do not know the sharp delineation of the
opposition between good and evil. \textsc{Oldenberg}\textsuperscript{103} remarks on this as regards India:
``Ancient India's religious documents teach us, with the completeness and transparency that are peculiar to
them, that an embodiment of the opposition between good and evil [such as the one appearing in the
opposition between Buddha and Mara] is alien to the oldest forms of faith and must be so, but that it
delineates itself ever more sharply in the course of a slow development. The faith of the Rigveda stands
close to the pre-ethical period in religious development. And the Vedic gods are indeed predominantly
gracious and good, but far from raised above wickedness and cunning\ldots\ The deepening of the inner life,
religion's progressive ethicization, must work ever more powerfully in the direction of abolishing this
indefinite position, so that a distinction is drawn between the positive and the negative among the great
powers of existence.'' Within Parsism this opposition was, as is well known, sharply emphasized. In Greece
Plato saw---so far as one can judge from the work of his old age---in the assumption of an evil
world-principle alongside the good the only possibility of asserting the divinity's goodness in the face of
experience of the disharmonious in the world.

Right up into high-flying philosophical and theological speculations the great opposition between
nature-religion and ethical religion can be traced. It is in reality an opposition between power and
goodness, and every attempt to set up a concept of God works with difficulties that stem from this
opposition. It comes forward in the question already discussed by Plato (in ``Euthyphro''), whether the good
is good because God (or the gods) wills it, or whether God wills the good because it is good. In the Middle
Ages this opposition was sharpened in the struggle between the two schools within Scholasticism: Thomas
Aquinas taught that God wills the good because it is good, Duns Scotus that the good is good only because
God wills it. There power is conditioned by goodness, here goodness by power.

The road that the religious life of ideas thus runs through under the influence of ethical feeling and
ethical ideas will naturally lead to the acknowledgement of ethics' independence in relation to religion.

He who is just because the God he believes in is just must indeed ascribe value to justice itself. Here
religion has independent ethics as its logical presupposition, whether it consciously brings out this
presupposition or not. Logical presuppositions of our thoughts and actions are brought out only by an
express attention and analysis, which appears only when critical self-collection becomes possible. When the
question is raised why precisely these definite predicates are ascribed to the divinity, self-collection
leads through more or fewer intermediate links over into independent evaluation and thinking, for without
such, those predicates will at last have no meaning for consciousness.---

In the world of experience the values must be discovered and produced before their persistence in a higher
world can be thought and assumed. The Beyond is always derived in relation to the Here; it is no primary
concept. It changes when the Here changes. It is now a continuation, now an elevation of the Here, now
determined by an opposition to it. Religion's content always points back to life in the world of experience
and cannot be understood without acquaintance with this life. The discussion will always with inexorable
logic lead back to ethics' conceptual priority in relation to religion.
...
\begin{flushright}
Ἐὰν μὴ ἔλπηται ἀνέλπιστον, οὐκ ἐξευρήσει.\\[2pt]
\textsc{Heraclitus}.\\[2pt]
\textit{(If thou hopest not, thou wilt not find out what surpasses all hope.)}\\[6pt]
\textit{There are cases, where faith creates its own verification.}\\[2pt]
\textsc{William James}.
\end{flushright}
% The e-book sets the Heraclitus fragment (B 18) without word spaces and with
% Latin/Greek letterforms confused ("Έάνμήἒλπεαι, ἀνέλπιοτονοὐϰἐξευρήοει", and the
% name as "Herakleiłos"). Word division and letters restored; same defect class as
% the ch. I epigraph and the Ζεύς of §8. See RESUME-NOTES.

\bigskip

\noindent\textbf{94.} It is characteristic of the position of the religious problem in the most recent time
that the discussion comes more and more to concern religion's \emph{value} instead of the truth of the
individual religious doctrines. Thereby there lies at the foundation the presupposition that the essential
thing in religion does not rest on its doctrine's being able to solve the riddles of life and existence, but
on its practical influence on human life---on the significance it has as a distinctive form of spiritual
culture.

In the eighteenth century's violent religious polemic what was at stake was a struggle against dogmatics and
hierarchy. It was especially the Church as a civil authority that one wished to break and crush. One was
inclined to regard the dogmas as arbitrarily produced or employed means of procuring for the priests power
over human beings' thoughts and thereby over human beings themselves. The polemic of Voltaire, Diderot, and
Holbach is borne by this conception. In the nineteenth century---which philosophically regarded already began
with Rousseau, Lessing, and Kant---one went back from religion's intellectual expression and outer
organization to the inner, generating and moving forces. One distinguished between these original forces and
the products they find expression in at a given time and place. But thereby the question had naturally to come
forward whether the intellectual forms and outer organizations in which religion has hitherto appeared in
history might not fall away and be succeeded by others, without the essential thing in religion needing thereby
to fall away. One then took up in various ways the idea of ``a third kingdom,'' in that one saw the possibility
of a view of life that lay beyond the oppositions that had hitherto stood so sharply over against one another.

The standard of religion's worth and significance as an expression of spiritual culture must at last be
ethical. When one does not start from an all too narrow concept of ethics, the final evaluation of all forms of
spiritual development falls under ethics. There is a free cultural community in which the work for material
culture and for aesthetic, intellectual, and religious culture, as well as philanthropic work, has its
place---a community that has its significant place alongside and in reciprocal action with family and state. It
belongs to ethics' tasks to discuss the value of spiritual and material culture. It is in this connection that
religion too, even if it is not the final foundation of ethics, can nevertheless acquire ethical significance.
This point must be investigated partly from the psychological, partly from the sociological side.

\subsection{Psychological Considerations}
\label{ssec:psych-considerations}

\noindent\textbf{95.} It has shown itself that religion with respect to the \emph{motive of
evaluation} is at last dependent on ethics. Religion commends itself to the human being's
conscience;---hereby it presupposes that the human being---consciously or unconsciously---has a
standard by which he can judge the values religion would uphold. But thereby it is not excluded
that religion can be of great importance as a \emph{motive of action,} that is to say, when it is
a matter of procuring for the acknowledged values power over the will in the individual moment and
in the individual situation.

The distinction between motive of evaluation and motive of action is in my view of great importance
for ethics. By the motive of evaluation, ethics' content is determined, the principles and rules
that lie at the foundation of our evaluating and our striving. The motive of action, the moving
force which in the individual case and in the individual domain leads us to will and to act, need
not coincide with the fundamental motive of evaluation. There are many different motives of action
that can lead in the direction the motive of evaluation requires be struck out on. Therefore the
motive of evaluation need not come into force on every single occasion; one discovers it and goes
back to it in doubtful cases, and when out of psychological interest one wishes to make clear to
oneself the whole direction of the life of will; but it may even be a sign of perfection that the
motive of evaluation is not the immediate motive of action. Popularly this can be expressed by
saying that it may be a bad sign when one has to consult one's conscience before acting. The more
special motives are as a rule the healthiest and the best. Such special motives are family feeling,
friendship, patriotism, joy in work, artistic and scientific enthusiasm. These motives are tested
and acknowledged by the original motive of evaluation,\textsuperscript{104} but this cannot in all
cases step into their place, if life is not to be robbed of its living, manifold content. The
character's perfection will show itself in the motive of evaluation's being hiddenly or potentially
present, without pressing forward at every moment between the motives of action that the solution of
the special tasks requires.

In the difference between motive of evaluation and motive of action lies the possibility of an
ethical significance of religious motives, even if the sovereign decision of what is right and good,
thus the determination of ethics' content, is not sought in religion. Where religious motives are
present, they will provisionally be to be acknowledged. Possibly they will not be able to be replaced
by other motives at all, and attempts to counteract them will perhaps only lead to putting uncertainty
and lack of bearing in place of the strength and harmony that were formerly present. Every human being
must be taken where he once for all stands, and it then depends on how far he can get in growth from
this standpoint. The burden of proof will here naturally rest on him who intervenes in another's inner
life in order to alter the motives. What matters first and foremost is not to inhibit the forces that
have hitherto driven the work, when one cannot put other forces in their place. All too often criticism
abolishes the capacity and the courage to venture, to endure, and to suffer. Religious motives that are
able to develop this capacity and this courage thereby establish their justification and procure their
own verification.

Very often---if not most often---religious motives have nevertheless only a provisional, pedagogical
significance. They have then the significance that bowing to authorities and models has in general---that
they lead one into a relation to a matter that can only by this road acquire independent and immediate
value. Countless displacements of motive take place in the course of human development, and motives that
do not themselves have direct and immediate value can acquire value as intermediate links in the
development. Everything that---indirectly or directly---can make life great, firm, and rich has its
value, and ethics ought not to imitate dogmatics in anxiously asking after the confession.

\medskip

\noindent\textbf{96.} The investigation of the religious motives of action's value must be undertaken
from a purely ethical point of view. And since the religious motives show themselves to have highly
different timbre, they must also have highly different value. Where, for example, regard for reward and
punishment from the divinity in this or in another life plays an all-preponderant role, we have a very
low-standing motive before us, even if the direction in which it works in the individual cases is
otherwise to be recognized. Where faith stands above love, or where faith and love come into conflict
with one another, there is as a rule a conflict between religion and ethics. Faith separates; love of
humanity unites. Among the differences that love of humanity has to struggle with and to overcome are,
among others, the differences of faith. How akin religion and ethics are in their essence is seen from
the fact that it is the relation between self-assertion and devotion that gives both a religious and an
ethical standpoint its distinctive character. Faith is more the expression of self-assertion, love of
devotion. A standpoint of faith that pushes love aside at the most decisive points therefore tends more
or less pronouncedly towards egoism. Does the human being seek in his religion only himself---is it for
him only a matter of winning security, peace, and salvation for his own I, however it may go with the
rest of existence---or does he seek a great harmony, a kingdom of values, so that it depends entirely on
this kingdom's law and conditions how it goes with the human being's own I? The religious motives will
shape themselves differently according to the answer given to this question. It is characteristic that
within the Church one has as a rule had misgivings about unconditional devotion's being emphasized with
disregard of all self-regard. Fénelon was in his time compelled by the Church to retract his doctrine of
``the disinterested love of God.'' If the selfish element is emphasized in its independence and
predominance, then the result is a supernatural morality of prudence, an ``other-worldliness.'' Ethically
regarded, one must on the contrary sympathize with the Saracen woman whom Joinville mentions in his
biography of Louis the Saint: she went along the street in Damascus with a pot of fire in one hand and a
bucket of water in the other, and when a monk asked her what she wanted with these things, she answered:
``To burn up Paradise and quench the fire of Hell, so that human beings may do the good out of love of
God.'' The Church has for pedagogical reasons kept up the selfish element in religious feeling. It is
possible that it often cannot be dispensed with; but it is unjustified to ascribe to it a particularly
high value, while one condemns the noblest human endeavours as ``splendid vices.'' For similar pedagogical
reasons the Lutheran Church has maintained that the threat of the law's severity and God's wrath is to
call forth a feeling of sinfulness and anguish of soul, in order that thereby the way may be paved for a
fleeing to grace. The question whether true repentance does not arise through the ideal's appearing before
the human being's consciousness in all its glory, so that hope of reaching it is awakened rather than fear
of the judgment---which presupposes that the Gospel be preached before the Law---came up already at the
time of the Reformation, but Luther and Melanchthon rejected it, because one had to accommodate oneself to
``the people's,'' ``the ignorant's'' powers of comprehension and not enter upon ``subtleties''
(!).\textsuperscript{105} Ethically regarded there is no doubt that the ideal's attraction and hope's
bright prospect are healthier and more justified motives than the anguish that the preaching of the Law was
supposed to awaken.

Quite apart from the religious motives' timbre, it must besides be maintained that they have ethical value
only where they stir in the mind with involuntary power, are not forced on, not arbitrarily made or
postulated. Voltaire thought that if God did not exist, one would have to invent him. But such an invented
God would hardly even be suited to the police service Voltaire chiefly had in mind. Religious feeling
represents a real spiritual capital only where it springs involuntarily from the mind's inner need. Like all
immediate and involuntary feelings it can only be called forth and determined indirectly, and when the sense
for personal distinctiveness has at some time grown sufficiently, delicacy in this respect will succeed the
spiritual coarseness with which one now so often handles this matter.

Closely akin to the demand for personal truth is the demand for intellectual honesty. Not merely must a
religious motive, in order to be justified, be an expression of the human being's personality; but it must
also be presupposed that what the individual according to his capacities and his circumstances can do to
discuss the validity of the religious ideas that co-operate in the religious motives has been done. Motives
that can only thrive at the expense of the love of truth cannot preserve any ethical value. And yet one can
to this very day find praise of the religious motives and their social significance without the duty of
intellectual honesty being mentioned with a single word.---There lies here a cause of tragic conflict for
many natures. There are those who by their inward love of humanity and free sense for personal life's needs
are excellently suited to be ethical-religious teachers of the people, but who are hindered from becoming so
by the dogmatically stiffened form of ecclesiastical popular life. On the other hand this dogmatic form does
not hinder others, who are intellectually thick-skinned and whose life of feeling moves on the surface, from
spreading themselves over ecclesiastical posts of dignity.

\medskip

\noindent\textbf{97.} Apart from the influence on special actions, the religious conception that holds fast
the persistence of value in existence will have its great significance by affording a bright and great
horizon for human striving and activity. I here disregard the special forms in which such an ethical idealism
can appear. It is not the philosophy of religion's task to construct religion, but to discuss the significance
of what is fundamental in all religion.

Faith in the persistence of value lets us---even if we cannot in detail follow the metamorphoses of
value---view existence as the home of potential values, which in part through human work as an intermediate
link can be converted into actual values. Through its inmost root, which is the feeling of a highest value
that is to be asserted, the ethical consciousness here hangs together with the religious. Religion can here
appeal to the fact that however existence's inmost nature and unsurveyable connection may otherwise be
constituted, it must nevertheless contain in itself the possibility of the values the human being has come to
know or has been able to produce. No proof can be given that the coming-into-being of the valuable in the
world is due to an accident. Perhaps it is the case that existence's inmost essence reveals itself precisely
only at those points where something valuable appears, however difficult it may be for us to bring these
points into agreement with other points where the opposite of what we can call valuable appears. If we
interpret those revelations of value as symptoms that through existence's great process of development a
divine work is taking place, then we can conceive our work as a part of this divine work, a part that both in
quality and in quantity is determined by our standpoint in existence and by our nature. Light then falls into
our workroom. The barriers to our capacity and our drive we then see as the limits within which the work
falling to us lies---in so far as they are real barriers, and not merely hindrances that are to be cleared away
and so precisely set tasks for our striving. We see ourselves at once in our distinctiveness and independence
and in inner connection with a comprehensive order of things.

Such a faith acquires in ethics the same significance that ideas, anticipations, and hypotheses have in the
theoretical domain. By anxious clinging to experience one is easily blinded and dulled to the new
possibilities: this holds both in the practical and in the theoretical domain. Where there is desire and
courage, a great deal becomes possible that would otherwise for ever, or at any rate as regards the
individual, continue to be unreal. Here holds the proposition maintained by James, that there are cases where
faith can bring about its own verification.

Faith and wish are closely akin. The faith that cannot be proved is a wish that what one believes may be true.
But precisely this wish can lead to truth's being found. The wish is on the whole of such great importance in
our spiritual economy because it is a form of holding fast something valuable, even if it cannot be realized
at once or provisionally or within a surveyable time. Such a wish can have both negative and positive
significance. It can keep away ends and actions that conflict with the valuable thing that lives in the wish.
And it can sharpen attention to every possibility that presents itself for taking a step in the direction of
the valuable's realization. When the wish is held fast, more values can be released, discovered, and produced
than when wishless resignation has set in, let alone when pure blaséness spreads.

Faith in the persistence of value then has undoubted value when it comes forward as a practical faith that
drives to deeds through the attempt to verify itself. It also contains consolation, in that it raises the mind
out beyond the limited and finite. But it is a sign of religion's altered position in spiritual life that it
acquires more and more the significance of consolation, and that this point of view is so strongly emphasized.
Religion was once the pillar of fire that went before the human race on its great expedition through history
and showed it the way. Now it becomes more and more the ambulance that follows after the column and picks up
the weary and the wounded. This too is great. But it is not enough; and when religion is one day rid of its
dead values, it will again---in close connection with ethics---be able to become a forward-leading power.

\medskip

\noindent\textbf{98.} When there is talk of religion's ethical significance, one must think not merely of its
\emph{motivating force} and of its \emph{capacity to raise and widen the gaze,} but also, and not least, of the
\emph{co-operation and concentration of all spiritual forces} which it partly presupposes, partly entails. In
the characterization of the great founders of religions it was emphasized that their originality showed itself
not so much in individual new ideas as in the deep and inward concentration of all the mind's forces. And this
hangs together with religion's psychological essence as a whole, as I have earlier sought to describe it. In
religious feeling and faith, aesthetic, ethical, and intellectual elements co-operate with the human being's
fundamental drive for self-preservation. It is a central reckoning that the human being involuntarily undertakes
through his religious experience. All life's sides and directions are compressed into the living-through of
individual moments and deposit their combined result in a prevailing fundamental mood, which in turn, in order
to win form and expression, summons up all sides and directions of the life of the soul. Thereby religion in its
classical times becomes a form of unity in which imagination and thought, self-assertion and devotion,
involuntary and voluntary striving work together---a unique interplay of all faculties and drives. This
concentration naturally assumes a different character in the two different classical periods a great religion can
have (§1). In the time of beginnings all interests other than the religious itself fall away; here all faculties
and drives then co-operate in the passionate striving to hold fast faith's object and to immerse oneself in it.
In the period of organization the religious interest does not stand alone, but it decides the manner in which
all other interests are satisfied; here work is then done in the special domains in such a way that faith's
object immediately determines direction and position towards the individual questions.

The religious problem arises by reason of the division of labour, which also entails a dividedness of the soul's
faculties and drives. In place of concentration there then easily enters one-sidedness, dividedness, and
disharmony. It now becomes not so easy to find a point of unity where all endeavours meet. Religion itself can
now in its transmitted form no longer satisfy the need for spiritual concentration; it has led to a system of
dogmas and ceremonies that stands outside life, instead of being life's combined expression. It is then of no
use to want to remedy the dividedness by demanding a return to orthodox dogmatics. Yes, give us back the
spiritual conditions of life of primitive Christianity and the Middle Ages, so that with the old dogmas we may
also get the old harmony! It is a remarkable blindness to the conditions of spiritual life when one thinks that
the one can here be separated from the other.---But many freethinkers too show by their attitude to the religious
problem how little sense they have for the deepest human requirements. They believe that such a form of spiritual
life as religion was in its classical times, with concentrated interplay of all faculties and drives, can be
taken out of life without life's suffering under it. It must be felt in the whole of spiritual life when such a
form is lost.

We cannot live on remnants. Protestantism already is a remnant, Pietism and Rationalism still more. But neither
can we live on surrogates. What is required are equivalents. And the great question is whether equivalents are
here possible.

If one holds fast the proposition of the persistence of value, one must also hold fast the possibility that new
forms of concentration in the domain of spiritual life can form themselves, without the gain that the division of
labour has brought being lost. It is possible to preserve the hope of this. History shows us a rhythm of critical
and organic periods, and for one who lives in a critical age it may easily look as though a new organic period
could never come. But it might indeed be that through the forces' dividedness and dispersion we were working our
way towards a more perfect concentration than had formerly been known. The ``higher unity'' of which Hegel spoke
so much, and which it fell all too easy to him to find, we can believe in and expect, although we cannot prove its
necessity or construct its constitution.

\medskip

\noindent\textbf{99.} In irreconcilable conflict with ethics stand all kinds of religion that make human beings
passive and impotent and let them revel in feelings and fantasies without contact with actual life---whether these
fantasies are bright, like the chiliastic expectations and ecstasies of the Beyond, or dark, like mania about
sinfulness, brooding repentance, and fear of hell. Then marrow and strength are taken from work and life in the
world of experience. One then looks merely forward or merely backward, without looking at what lies immediately
before one, that which sets life its tasks and causes its happiness. Our view of life can be built neither on a
past that cannot be altered, nor on a future that comes only at the end of days---neither on the death that goes
before our life, nor on the death that follows after our life. The true religious watchword is here: let the dead
bury their dead, and take no thought for the morrow! Our view of life shall be an inquiry into life, a search for
values of life that can be found or produced in the present life, and in whose persistence it is worth believing
and fighting. We live on realities, not on mere possibilities---let alone on impossibilities.---

However different a view of life from the one here indicated may be from the old religions, it nevertheless
preserves the continuity with these. In spite of the sharp opposition there is a spiritual kinship. Religion's
significance does not fall away because it has shown itself that the great riddles are as little solved by it as
by science. The foundation consists in inward experience of the relation between value and reality, combined with
the need for a mood-filled and imaginative utterance of this experience's content. There will constantly be room
and need for a poetry of life in which human life's great experiences find expression. Such a poetry of life is
for us the most important thing in the old religions. Such a poetry of life great poets (Aeschylus, Dante,
Shakespeare, Goethe) have been able to shape, and every new and great epoch in the history of poetry will bring
new forms of it. Our own time's literature cannot satisfy this need; its significance does not lie at this point.
But even if we must for the present---besides living with the great ones of the past---content ourselves with
humming in our own quiet minds the melody that the experience of life calls forth in us, we need not give up the
hope that the old forces will produce new forms.

\subsection{Sociological Considerations}
\label{ssec:sociol-considerations}

\noindent\textbf{100.} The Church's significance in a social respect consists first and foremost in
this, that in its best forms it has been and in part is the representative of a high idealism in the
midst of the finite, prosaic, narrow world, where many are able only by its help to raise their
heads and catch sight of the stars. It has opened the world of thought and poetry to great throngs
who would otherwise have sunk down in life's struggle or gone dully through life without coming into
contact with ideal powers. It is religion's concentrated and concentrating force that has enabled the
Church to work as comprehensively and deeply as no other community has worked. Thought and poetry
went here together with the highest seriousness and the greatest ethical decisions.---I am thinking
here particularly of the Christian Church, the one that lies nearest to us, and whose influence can
best be followed.

This influence would not be possible if there were not within the Church a certain consciousness that
the essential thing in religion is not the dogmas formulated once and for all. These can be pushed
aside. It is not necessary directly to abolish them; that has its dangers from the standpoint of
ecclesiastical politics or pedagogy; but attention dwells on the central content of life that lies
behind. The Church stands as the bearer of a great tradition, of a circle of images in which countless
generations have laid down their deepest experiences of life, everything they have felt, suffered, and
thought during fate's course in great and in small circumstances. Especially in the church hymns it
surges to meet us as the exclamation of thousands, of fear and hope, of sorrow and thanks, of falling
and being raised, during the race's long course of life. The individual feels himself here standing
before humanity's great, common memories from the domain of inner experience. He finds here fundamental
thoughts by whose help he can find his way better in his own experience. In the ecclesiastical cult the
race's great drama is presented, and the individual here obtains a great horizon for the consideration
and evaluation of his own life. By participation in cult he lives through in an ideal manner life's
great fundamental oppositions, and his feelings are purified and idealized by being attached to the
thought of the exemplary events whose memory the Church celebrates.

\medskip

\noindent\textbf{101.} Philosophical ethics sets up a different series of valuable qualities of
character (virtues) from theological ethics. The opposition between the two evaluations comes out
especially at two points that stand in mutual connection: namely in the place assigned to
self-assertion, and in the place assigned to justice. In the closer illumination of this we must within
philosophical ethics distinguish between Greek and modern ethics.\textsuperscript{106}

For Greek ethics the task was to bring harmony between the elements of the life of the soul.
Self-assertion stands here in the first line. In order that the human being may be able to subsist as a
human being, an inner order must be brought about, so that the one element does not encroach upon the
others, but each element comes to function in the right way in the great harmony of the life of the
soul. And when now the individual can place himself in a similar harmonious relation to the human
community he lives in as his elements stand in to his own life of the soul as a whole---thus when he can
subordinate himself as a distinctive member in the greater whole---then he is just.

For Christian ethics obedience, the obedience of faith, became the chief virtue---a natural consequence
of the principle of authority. Love became subordinate in relation to it. The greatest sin became pride,
which refuses to obey. When egoistic self-assertion is condemned, it is quite as much because it
conflicts with obedience as because it conflicts with love. The demand for obedience becomes a demand
for unconditional submission to the infinite power, an oriental trait, a reminder that the great religions
stem from the East. The free Greek's upright posture, even during prayer, stands in opposition to this
orientalism, which also sets its stamp on the feeling of sinfulness and makes this different from the
ethical feeling of repentance. Love does indeed press forward again and again in Christian ethics, but
with a tendency to ascetic opposition to self-assertion, both others' and the agent's own. The Greek
doctrine of harmony stands as sinful egoism.

Modern ethics is a taking up again and an extension of the Greek. Self-assertion stands as loftiness of
spirit in the first line. But it has a more active form than among the Greeks. Its opposite is not so
much the chaotic in the elements as the sluggishness that resists extension and development.
Self-assertion here does not stand in opposition to love. For high-mindedness has strength enough not
merely to bear the individual's own life, but also others'. And the highest virtue becomes justice,
within which both devotion and self-assertion come into their own. The ideal is a kingdom of
personalities where each individual unfolds his personality in such a way that he precisely thereby helps
the others to unfold theirs.---This conception is able to let the ethical elements of abiding value that
Christianity has put into the world come into their full right. But so long as obedience is the chief
virtue, and so long as love of humanity is limited by dogmatic conditions, so long is there standing
conflict between philosophical and ecclesiastical ethics.
...
\begin{flushright}
\textit{But the greatest of these is love.}\\[2pt]
\textsc{Paul}.
\end{flushright}

\bigskip

\noindent\textbf{102.} Christian ethics is not the same at all times. From this springs a difficulty for
the philosophy-of-religion discussion of the relation between religion and ethics. Christianity, the
popular religion lying nearest to us, we naturally hold to in such a discussion. The other great popular
religion, Buddhism, could in this respect only be investigated more closely by one who himself lives
along with East Asian cultural life. If we will then hold to Christianity, we must investigate how the
relation between religion and ethics varies in the different chief periods of Christianity's history,
according to the different relations in which it has stood to culture. For the valuation of Christianity
and for the grounding of what is the abiding thing in it, it is then necessary to attempt a
characterization of what in the different periods of Christianity's history has appeared as a Christian
view of life.

There are three great periods or chief forms of Christianity: primitive Christianity, Catholicism, and
Protestantism. It is not difficult to institute a comparison between these forms with respect to their
dogmas. But it is difficult to compare the corresponding views of life. For a view of life is not always
formulated in definite words; it manifests itself in the whole bearing towards goods and tasks, in the
practical relation to the course of culture and history.

\medskip

\noindent\textbf{103.} \emph{Primitive Christianity's} ethics is determined by the living expectation of
Jesus's speedy return. In the faith that he would soon come to establish the supernatural messianic
kingdom, which was to be history's conclusion, the apostles and their nearest successors overcame the
contradiction that lay for them in the fact that Jesus was the Messiah and that he had nevertheless had to
suffer and die. The national messianic expectations furnished form and frame for this faith and made it
possible to find testimony to it in the old writings.

The consequence was that the gaze turned away from earthly and human conditions. Culture and historical
work, life in family and state, in art and science, could not acquire immediate value and positive
significance. Quiet but strained expectation was the fundamental mood. ``God's kingdom'' was not to be
realized through long historical work on the firm ground of nature and human life, through the discovery
and production of values. One had only to prepare oneself to receive it when it---still within ``this
generation''---broke forth in supernatural fashion from heaven. This preparation was the one thing needful.
Therefore no alteration in the given circumstances! Preferably one ought to abstain from marriage and not
marry off one's daughters either; and if one is a slave, one should not seek to become free. As little
thought as possible is to be sacrificed on such things, which belong indeed to what is soon to disappear.
When it was prayed ``Thy kingdom come!'' there was not thereby thought, in all indefiniteness, of a share
in spiritual goods, but quite definitely of the messianic kingdom's supernatural coming, and the prayer was
an inward wish that its coming might be hastened.

It was nevertheless not a life in suffering and cowedness, not asceticism in the sense of self-torment, that
this foundation for the whole conduct of life led to. It was not a funeral march, but a march of victory.
For the living expectation set all the mind's forces in motion. Great images were shaped for the
imagination, and feeling broke through with such force that words often failed, so that there was ``speaking
in tongues,'' without the individual himself being able to give an account of what had moved in him.
Revelation was not concluded at Jesus's departure, but was continued in the supernatural Spirit's stirrings
in individuals' inner life. Alongside the living expectation, chiliasm (the faith in the speedy coming of
``the thousand-year kingdom''), enthusiasm is an essential characteristic of the primitive Christian conduct
of life. Enthusiasm had the word, and a thoroughgoing ecclesiastical organization was therefore neither
possible nor necessary, any more than positive participation in culture and communal life.

Cultural-historical tasks and points of view did not exist at all for the primitive Christian consciousness,
which was borne by unusual forces in a single direction. The virtues and tasks that primitive Christian
ethics inculcated had essentially to be those conditioned by expectation and enthusiasm. On this rests its
great exemplary and symbolic significance. All human life that is worth anything is led in expectation and
can learn from that heroic age of Christianity. And nothing great is performed without enthusiasm. Immersion
in the primitive Christian conduct of life and view of life can help to make the soul great. But the
positive, real tasks and goods that condition the cultural-historical work, for which our ethical points of
view now hold, one seeks in vain in primitive Christian ethics. This lets everything remain as it was, if
only it does not hinder the undivided expectation of the Beyond's breaking through.

The primitive Christian standpoint subsisted essentially in the first two centuries. The post-apostolic age
held to it decidedly, both as regards chiliasm and as regards enthusiasm,\textsuperscript{107} and
Tertullian and Origen testify to its subsistence at the end of the second century. As time went on, it was
displaced by the speculative development of dogma and by the Church's firmer organization. By the damming in
and cooling of the ecstatic expectations and the individual enthusiasm, a more positive relation to culture
gradually became possible. But Augustine still had more the feeling of living in the world's old age than at
the beginning of a new cultural period. He is inclined to find the description in the Revelation of John of
those who sit on the judgment seat in the thousand-year kingdom fulfilled in his own time's prelates
(\textit{præpositi intellegendi sunt, per qvos ecclesia nunc gubernatur}).\textsuperscript{108} A
characteristic example of ecclesiastical reinterpretation of primitive Christian ideas! But in the face of
the earthly state and purely human ethics he pointed to the kingdom of the Beyond, coming by a supernatural
road, as life's only right goal. It then matters nothing in his eyes that asceticism spreads, and that the
human race dies out through the increase of the unmarried state. When we thus find in Augustine a wavering
between reinterpretation of and holding fast to the primitive Christian ideas, it hangs together with the
conflict in him between two different types of religious faith, which I have already earlier discussed. The
opposition between the unchangeable and the changeable comes decidedly into the foreground in him and tends
to displace the opposition between the present and the supernatural future. The influence of Platonism here
works together with the weakening of the enthusiastic expectation. Augustine's chief thought is not so much
that all present goods pale in relation to the future goods, as that the finite goods pale in relation to the
eternal and infinite good, which is one with God himself. By this last opposition the line of thought in the
\emph{Confessiones} is borne.

\medskip

\noindent\textbf{104.} The unsolved problem that primitive Christianity left to the later Church was solved in
Catholicism in a manner that testifies to a strong historical instinct in the Church's leaders. The
circumstances of the time made a practical solution compellingly necessary. ``One can,'' says Harnack in his
history of dogma,\textsuperscript{109} ``nowadays in Protestantism hardly form a conception of what significance
asceticism had in minds in the fourth and fifth centuries, and to what degree it determined the imagination,
thought, and the whole sphere of life.'' It threatened to burst the Church. And now on the other hand the
great, fresh masses of people pressed into the Church, and there was set for it the great task of working as an
educating, softening, and organizing power. It had then to adopt a broader way of seeing than the enthusiastic
time of beginnings needed to apply; it had to tolerate much that it could not prevent, and to take up elements
that did not in themselves lie in its original ideal. Both the ``perfect,'' who saw the standard in the
primitive Christian ideal, and the imperfect, who were to have norm and consolation without leaving the ordinary
human life, were to belong to the Church. Both the connection with primitive Christianity's ideals and the
connection with the present time's realities were to be preserved. One was at once to break with the world and
to govern the world.

The solution became, in \emph{Catholicism,} that a distinction was drawn between different degrees of
perfection. The monk, the priest, and the layman each denotes his own degree or form of Christianity, and the
Church acknowledges them all. The same pedagogical and psychological sense that led the Catholic Church to
acknowledge charcoal-burner's faith led it here to the distinction between duty and merit.

The monk satisfies the primitive Christian type. If it is asked where the ideals from the Church's great time of
beginnings have gone, Catholicism points to its monks and nuns, who in unconditional absorption in the one thing
needful have burst the bonds that most strongly bind human beings' minds to this world. The monk and the nun do
more than their duty as human beings would require; they fulfil not merely the general commandments, but also the
Apostle's counsels (1~Cor.\ VII).---The priest stands as an intermediate form between the monk and the layman. By
giving up family life he has followed one of the apostolic counsels, while he otherwise lives along in the human
world, follows its doings, and intervenes helpingly and consolingly.---The layman lives human life along in its
different sides, but preserves himself by the Church's help from being lost in it.

This is the most magnificent solution that has been given of the problem: to assert the primitive Christian ideal
and yet to work as a cultural power in a world whose continued subsistence was not foreseen or presupposed when
this ideal was set up. Rightly this solution starts from the assumption that if the New Testament is constantly to
contain the highest rule of life for human beings, then the spiritual conditions of life it presupposes must also
constantly be assumed to be present. Cardinal Newman has thus declared: ``If the present distress of which Paul
speaks [1~Cor.\ VII] does not state the Christian Church's constant condition, \emph{then the New Testament is not
written for us,} but must be recast before it can be applied.'' This was already in Newman's Protestant time a
chief point for him. He could not within Protestantism find a satisfactory answer to the question: what have we
done for Christ?

---His thoughts moved in a similar direction to \emph{Saint Teresa's,} when she says: ``Will you know what gave the
apostles the divine fire in their words? It was that they had a loathing for the present life and trod the world's
honour under foot\ldots. They had ventured everything for God.'' And in a vision she heard the Saviour say: ``What
would the world become if there were no monks!''\textsuperscript{110}

All the same, this solution rests on a compromise. Søren Kierkegaard has rightly said that the meaning in
Christianity broke when different classes of Christians were set up. A way out had been opened for withdrawing
oneself from the ideal, and it was amply used.

\medskip

\noindent\textbf{105.} \emph{Protestantism} did not from the first make clear to itself the great problem of the
relation to primitive Christianity. It was a movement called forth by the need to assert the free conscience's
right. Since one found a great deal in the New Testament that Catholicism, on account of its hierarchical system
and its entanglement in the world, did not let hold and work, the assumption was not unnatural that it was
primitive Christianity that was now coming back. Meanwhile Protestantism came to mean not merely a liberation of
religious life and an attempt to go back to Christianity's sources, but at the same time---more or less
consciously---a liberation of life as a whole from ecclesiastical authority. Life in the world was no longer to be
regarded as lower than the monastic life. It was not by self-made asceticism, but by the mind's inward devotion and
trust in God, that the highest could be reached. Life in the world was not merely to be tolerated but tended and
developed, and the individual should and could find his calling in working along at this development.

The relation to the primitive Christian ideals and expectations the Reformers properly left standing. A definite
guidance for, say, applying the Sermon on the Mount's commandments in the midst of modern human life with its
conditions and tasks one did not get. Later, especially the high-church and speculative-theological tendency in the
Protestant Church has conceived the matter thus, that primitive Christianity was the ideal leaven that through the
long historical process of development was to permeate the life of the world, produce Christian family and state
life, Christian art and science, and thus bring ``God's kingdom'' to unfolding. In a distant and dawning background---
like the blue mountains far out on the horizon---there then stands the primitive Christian idea of the ``return'' and
the last day. As one has on the whole now learned and experienced much that the New Testament's authors did not know,
so one has in particular seen that it was a mistake when they expected the ``return'' so soon. But this mistake one
regards as inessential, in so far as one does not seek to explain it away. One thinks---like Catholicism---to stand in
ethical continuity with primitive Christianity. One will not admit that one has kept of primitive Christianity only
what one can use under the new cultural conditions, or rather under the new relation to culture in which one has tried
to place oneself. One thinks one is practising New Testament ethics because one clothes one's ethical principles in
the biblical formulas. One overlooks that the relation to culture is in principle a different one from the primitive
Christian.

\medskip

\noindent\textbf{106.} In the most recent time, however, there has begun to come greater clarity within Protestant
theology about this relation. Penetrating historical studies and a sharper understanding of ethical and cultural
conditions have led a series of theological investigators beyond the standpoint that ecclesiastical Protestantism's
spokesmen have otherwise taken up here. In the first rank there are here to be named \textsc{Albrecht Ritschl} (in his
\emph{Geschichte des Pietismus}) and \textsc{Adolf Harnack} (in his \emph{Lehrbuch der Dogmengeschichte}).

Ritschl sees Protestantism's distinctive character in this, that Christians stand as those who are to rule over the
world in trust in God, not withdraw from the world as the old Church's ascetics, the Middle Ages' mystics, and the
modern pietists will. Pietism has according to Ritschl hindered the full unfolding of the Protestant programme---%
especially because it (particularly Reformed Pietism) wished to renew primitive Christianity. As Ritschl conceives
Lutheran Protestantism, all its fundamental propositions are indeed to agree with the New Testament, but conversely
faith in the validity of all New Testament ideas is not necessary to salvation. And among the biblical ideas that do
not oblige to faith, Ritschl expressly reckons ``\textit{das Detail urchristlicher Hoffnungen}.''

According to Harnack's conception, primitive Christianity contained other and more than the real ``Gospel,'' and only
when this other and more has been separated out will the ``Gospel'' be able to appear in its purity. Luther paved the
way for this; but just as little as he separated out the speculative dogmas the Church Fathers had shaped, just as
little did he separate out the primitive Christian expectation of the speedy return, which had called forth the flight
from the world. The excellent historian of dogma sees clearly that primitive Christian ethics is determined by the
expectation of the last day, and he therefore declares that the ``Gospel,'' which he finds expressed especially in the
eighth chapter of Romans and the thirteenth of 1~Corinthians, must be supplemented with human ethics: ``If one
could---both in science and in the life of feeling---combine Augustine's piety, inwardness, and absorption with
antiquity's openness towards the world, with its calm, vigorous activity and its clear and bright mood, then the
highest would be reached\ldots. Has not Goethe in his period of consummation declared this ideal to be his own and
attempted to present it in himself? Does not the significance of evangelical-reformatory Christianity---when it really
is something other than Catholicism---lie enclosed in this ideal?''\textsuperscript{111}

It is clear that a view of life that takes up essential elements from the Greeks and from Goethe must be a wholly
different view of life from the primitive Christian. Goethe comes at last to stand as the one who first brings the full
Gospel. Full clarity is not reached at a standpoint like Ritschl's and Harnack's. But these men have the great
merit---besides the rich instruction their inquiry otherwise brings---that the decisive problem comes forward clearly
and definitely, and that the ambiguities in Catholicism's and ecclesiastical Protestantism's relation to culture and
humanity are exposed.

\medskip

\noindent\textbf{107.} In opposition to all these different standpoints I place what may be called \emph{the
ethical-historical standpoint.} According to this, Christianity is a spiritual power that has intervened, and constantly
intervenes, deeply in human life. As it goes with so many of the greatest human movements, many traits in its origin and
its first development will probably remain standing as psychological and historical riddles, without our having,
however, other means and roads to understand these than precisely psychology and history. But there are indeed many
other psychological and historical riddles besides these. And what is here of greatest importance for us appears clearly
and distinctly enough, namely that Christianity bears in itself the marks of the definite historical conditions under
which it came into being. It is an oriental movement; it bears particularly the stamp of Jewish origin, perhaps through
that of Persian influence; during its further dogmatic development it has been determined by Greek thoughts, at any rate
by Greek conceptual forms. Its later development has taken place under the influence of cultural conditions
(intellectual, aesthetic, ethical, and social) that it has not itself produced, and that were not presupposed at its
coming-into-being. Therefore it is impossible that it can without more ado be laid at the foundation of a view of life
and a conduct of life at all times. It can do so as little as Greek ethics can. But its great significance does not
therefore fall away. It stands as a spring of life from which later ages draw what they under their conditions have use
for. Thus in reality Catholicism and the different Protestant tendencies have placed themselves towards it, only that
one has for the most part silently pushed aside and drawn forth. What one made use of, one always regarded as ``the
essential.'' And thus human ethics too places itself towards it. It acknowledges the inwardization and deepening of
spiritual life that Christianity has brought, and the significance it has had by having through its great model
proclaimed the doctrine of love of humanity over the whole earth.

We take from the New Testament---as from all works of the spirit---what we can use in our spiritual economy. There are
thoughts, moods, and models that will continue to accompany the race on its way. But \emph{what} we use, and \emph{how}
we use it, is determined by our own independent experience of life and by our conditions of life, which both set tasks
and afford goods of which at the primitive Christian standpoint there could be no question, partly because they were not
known at all, partly because they were incompatible with the only end that was known. Just as little as the Bible
teaches us astronomy or natural history, just as little does it give us an ethics, although it contains many significant
elements that every ethics can and must take up.

We stand towards Christianity as we stand towards the Greek conception of life. And, of two things one, our conception of
life is more closely akin to the Greek than to the primitive Christian. For we would discover and produce the values in
whose persistence we believe, in the world of reality itself. The ethical task is an unfolding and a harmonizing of
human life, the individual's and society's. This task the Greeks already set. Christianity has made it possible to deepen
this task. But instead of supplementing the ``Gospel'' with Greek thoughts, it is rather the Greek thoughts---the first
human thoughts about life that European spiritual life has produced---that are deepened and extended by what Christianity
has put into the world.

Not merely by this---for to the Greek and the Christian there comes yet a third element or a group of elements: the last
centuries' empirical science and the whole modern ideal and material culture. It is ethics', not the philosophy of
religion's business to discuss more closely the connection between all these elements in human spiritual life, as this
now can and must be lived.
...
\begin{flushright}
\textit{Homo liber de nulla re minus qvam de morte cogitat, et ejus}\\
\textit{sapientia non mortis sed vitæ meditatio est.}\\[2pt]
\textsc{Spinoza}.\\[4pt]
\textit{(The free man thinks of nothing less than of death, and his}\\
\textit{wisdom is a meditation upon life, not upon death.)}
\end{flushright}

\bigskip

\noindent\textbf{108.} In accordance with the preceding investigation, the relation between
religion and ethics presents itself in a very simple manner: religion is faith in the persistence
of value, and ethics investigates the principles according to which the discovery and production
of values takes place. On this conception both the difference and the connection between religion
and ethics appear clearly at once.

At the question which values it then is that are believed in, and from what one knows that what is
discovered and produced is valuable, we are referred back from religion to ethics. Within religion's
own history this shows itself clearly in the fact that the most important opposition is that between
nature-religion and ethical religion. It will thus depend on the ethical standpoint what kind of
religion it becomes. I for my part must here refer to the presentation I have given of ethics, and
shall now only briefly give an account of some points of view that are of special
philosophy-of-religion significance.

Life shall, according to the conception made good in the presentation of ethics mentioned, be shaped
as a personal work of art, in that the individual moments and the individual elements (the faculties
and drives) are brought into harmony in the individual human being, and in that individual
personalities are at the same time---precisely through the individual harmony in individuals' inner
life---brought into harmony with one another. The problem is how the individual's self-development can
pave the way for the others' self-development, or in other words, how the individual's standing as an
end can become a means to the others' end being reached. Under this point of view all cultural work
falls, as soon as it is more than mechanical or restless activity. All spiritual and material culture,
all individual and social striving finds its place within the ideal that is herewith given. Greek,
Christian, and modern spiritual development have each given their contribution to the setting up of
this idea. A great horizon opens here: we look back to the spiritual struggles of the past, but we
also look forward to spiritual and material work for the deepening and progressive unfolding of what
has been won. In the work for this idea's shaping and application, ethics itself becomes religion: for
it is a work for the holiest thing there is, and everything that one has called and calls holy must at
last be tested by the standard this idea affords.

The concept of the holy reflects in its different applications the stages of religious development. In
the most elementary sense the holy is that on which an exalted power has laid claim. It may be the
earth, or its crop, or human beings. But what is thus regarded as drawn under and shielded by an exalted
power will, when the transition has been made from nature-religion to ethical religion, more and more
become that which is required by the highest ethical ideas the human being is able to form. The holy
becomes then at last a concept in which religion and ethics meet. And thus we come to Goethe's
definition:

\begin{quote}
\textit{Was ist das Heiligste?---Das, was heut und ewig die Geister,}\\
\textit{Tiefer und tiefer gefühlt, immer nur einiger macht.}\\[4pt]
(What is the holiest?---That which today and eternally, felt more\\
and more deeply, makes spirits ever more at one.)
\end{quote}

What can at once be appropriated in the most inward manner by the individual and produce the most inward
community between individuals---that is the holiest. We are directed out beyond life's externality and out
beyond all that divides, to the highest values. The greatest difference and fullness and the highest degree
of unity are here united.

There are many great questions to raise with respect to how this idea is to be applied in the particular
case. But in the philosophy of religion it is especially of importance that an ideal such as the one
expressed in Goethe's lines has been able to work its way forward and win acknowledgement at all. Existence
with all its disharmonies has nevertheless also had room for a development in this direction. It is one of
the realities we hold fast and seek to carry further---one of the things that make it possible for our
wisdom to become a meditation upon life, not upon death.

\medskip

\noindent\textbf{109.} But how will it go at last? Whence comes the valuable, and whither does it go? How
does that which we fight for, and that which makes it possible for us to fight for it, hang together with
existence's inmost essence?

Here the ways part---not merely on account of the different answers that are given to these questions, but
also on account of the different weight one lays on getting an answer to them at all. I for my part see no
reason to demand at any price an answer beyond what science can teach through its ultimate hypotheses. Above
all I see no reason to take reason captive for the sake of supposed solutions that in reality only give us
the riddles back again in larger dimensions and perhaps even increased by logical and ethical misgivings.

All answers to those questions beyond science's ultimate hypotheses can only have a poetic character, which
does not prevent their being able to have religious significance as the most living expressions that can be
found for the relation we experience between value and reality. To say that they have ``only'' poetic value
is properly incorrect. For perhaps it is the case that poetry is a more perfect expression for the highest
than any scientific concept would be able to be. By poetry one must not here think of loose moods and
fantasies, but of the involuntary and lively form that what is really lived through clothes itself in during
strongly moved moments. It is such a process of clothing that lies at the foundation of all myths and
legends, all dogmas and symbols, when they are taken in their state of coming-into-being (\textit{in statu
nascendi}). There is a poetry of life that springs forth like a spark during the work itself, and that is
struck only by the will's collision with reality's hard flint. I have once earlier pointed to this in my
criticism of Søren Kierkegaard's conception of the opposition between an aesthetic-poetic and an
ethical-religious view of life. It is a poetry that stands in opposition neither to will nor to thought, even
though it especially comes into being where thought and will strike against barriers---barriers of which it
is only through attempts to be decided whether they denote a resistance that can and shall be overcome, or
whether they denote the firm banks between which life's river is to flow. All high art presupposes such a
poetry of life and is its conversion into clear forms. If it has nowadays especially unfavourable conditions
of life, the old dogmas have quite as much blame for it as the new doubts.

The philosophy of religion ends with a pointing to this spring, whose preservation and liberation is the most
important condition for spiritual life's future. The epistemological, the psychological, and the ethical
investigation meet here in the same result.---It is not, on the other hand, the philosophy of religion's task
to construct a distinctive circle of symbols that should be the one right one. The philosophy of religion
interests itself more in the forces that work than in the fixed forms that are deposited during the forces'
working. Thereby the comparison of the forms does not lose its significance; it serves to discover the
forces' kind. More than in the individual symbols or dogmas, the philosophy of religion interests itself in
the personal need, the inward feeling, the trustworthy experience, that finds expression in them, and that
determines both the choice of symbols and the degree of literalness ascribed to them. When a great religion
like Christianity arises, the philosophy of religion sees in it a testimony that love, inwardness, and purity
are living powers in human nature.

When the inner forces seem to have vanished, it comes certainly from the fact that trust in the shaping,
symbolizing capacity has been weakened by the dominion of dogmatism and scepticism, which so often was a
dominion of violence. For the attentive observer these forces stir in secret, in the personal sanctuaries that
are closed both to importunate converters and to wanton mockers.

We live in a time of transition. There is lacking harmony between our faith, our knowledge, and our life. It is
an inescapable task that free knowledge and free unfolding of life be brought into harmony with what is for us
the highest valuable thing. By the road of speculation and construction this task cannot be solved. There must
form a new type of life that neither fears criticism nor expresses its freedom by ``mocking its chains,'' but
which with bold confidence utters its deepest experiences in a ``psalm of life.'' So long as such a type of life
is not reached, many will suffer harm to their souls---now by clinging in morbid overstrain to what does not
after all agree with their personal life, or with what intellectual honesty requires---now by being driven by
their own secret anguish to fanatical hatred of those who believe otherwise---now by being dried up and dulled
by hypercriticism and blaséness---now by dissolving in restless reflection. It is not said that those who suffer
the greatest harm feel the greatest suffering.

Life once for all works its way forward through the conflict of opposed forces, and the relation of conflict is
different in every single soul. Therefore the art of life, like all art, must be one-sided. And therefore each
must seek his place and fight for the part of the truth he can catch sight of. Only through a firm grip can the
``higher unity'' be won which cannot be dispensed with, although it is not so easy to win as romantic philosophy
supposed.

\medskip

\noindent\textbf{110.} Every view of life is at last determined by the values one finds or produces in actual
life. Every idea of a world beyond (an over-world) is formed of elements drawn from \emph{this} world. Life
needs discipline and rule, but the fundamental thoughts that determine the discipline and the rule must at last
be drawn from life itself. Here is a constant circulation which does not exclude a progress, for even an
imperfect ideal can make life more perfect than it was before, and the more perfect life will then give rise to
still higher ideals. Even a retrogression can be a transition and perhaps a necessary means to a higher
ascent, just as the spiral bends only in order to rise anew (\textit{inclinata resurget}).

Just as it was for Goethe poetry's task ``to make reality poetic,'' not ``to realize the so-called poetic,'' so
it is religion's task to make life ideal and harmonious, not to realize arbitrary ideals set from without. Every
ideal that has significance will show itself to be a great, concentrated expression of tendencies of life that
must have stirred involuntarily before they acquire the form of thought or of image.

In principle it stands fast: only he who has honestly and uprightly worked for the values that can be found and
produced in \emph{this} world is prepared for an over-world, if there is such a thing, which only experience
will be able to decide. In my late friend Johannes Fibiger's autobiography it is related that I once, in a
conversation concerning the question whether there is another life, am supposed to have said: ``It will show
itself whether there is.'' I do not remember this utterance; but it expresses the result I have quite personally
come to. The horizon is not closed for me. But the more I have looked about me in the world of thought and in
the world of reality, the more it has seemed to me a great responsibility that they take upon themselves who
again and again hold up to human beings that \emph{this} life is worth nothing if there is no other. Those for
whom it really is a necessity of life to have faith in another life will surely notice this necessity
themselves; but they have no right to appeal to their experience unless they have made a serious attempt to find
and produce values here in this life---and when will they be able to say that they have done enough in this
respect?---No proof has yet been given that the absence of such a faith necessarily excludes any valuable
personal quality. The assumptions that individuals in consequence of their personality have formed about what
lies beyond the world of experience must not be used as a general standard of personal life's value.

Ethically regarded the demand is: make life, the life you know, as valuable as possible!---Whether a striving to
satisfy this demand necessarily presupposes a faith in the persistence of value in a certain definite form is a
question different personalities will answer differently according to their different experience. He who can
find or produce nothing valuable without a gleam of eternity standing over it stands by no means higher than he
who with strength and inwardness works in the service of the valuable, although this valuable is in his opinion
subject to the law of perishability. But he who can do without faith in the persistence of value has for his
part no right either to look down on him who in the valuable that he finds or produces sees a single link of a
great chain of values stretching into the unsurveyable. Such a faith is possible without one's coming into
conflict with epistemology or ethics. The last word must here be said by virtue of the principle of personality.
Ethics has only to watch that one does not forget life itself in one's anxiety to ``save'' its values.

If one assumes that value persists, and if one calls the principle of the persistence of value God, then it is
clear that nowhere can this principle work more immediately present than in our very striving to find and
produce values. When this is held fast, our view of life becomes no Tantalus-like chasing after the
unattainable, nor do we end in a mere not-knowing, but the poet's words hold:

\begin{quote}
\textit{In that thou seekest, thou hast already found him;}\\
\textit{in that thou askest, the answer is already won.}
\end{quote}

The eternal is in the present, in the valuable moment, ``in every gleam of sun''---in the striving that has
\textit{Excelsior!} for its motto. In the midst of time to live through eternity is true immortality, whether
there is any other immortality or not. The difference between end and means falls away in such moments and in
such a striving---as it falls away generally where true personal life is present. Thereby the difference between
religion and ethics also falls away, in that the ethical encloses the religious within itself.---

The purely philosophical interest in the way of regarding things that the whole investigation I herewith conclude
is an attempt to carry through rests on its striving to assert the continuity in spiritual development. Thereby
the religious problem acquires an analogy to all other philosophical problems; and for the philosopher it is in
the last resort not the decisive thing whether a problem can be solved or not, but whether it is rightly posed,
that is to say, as follows from the human spirit's nature and from its place in existence. In the long run the
philosophical interest will also show itself to be the human interest, the more both become clear about
themselves. For the philosopher it is therefore enough when he has done his best to point out and illuminate the
problem and the conditions of its solution. He does not lose confidence in the significance of his work, even if
only few will concede its validity and its value.

More than to make up his spiritual reckoning with the use of everything he has learned in the school of life and
of inquiry, no one is able to do. But if it is done uprightly, it may perhaps have significance for others than
...
% Endnotes, numbered continuously through the book as in the original, matching
% the \textsuperscript{N} anchors in the text. Bibliographic references, work
% titles, and volume/page citations are kept verbatim as Høffding gives them
% (playbook §2); only his connecting prose is translated.

\newcommand{\note}[1]{\medskip\noindent\textbf{#1.}\quad\ignorespaces}

\note{1} In \emph{Berlingske Tidende} for 29 November 1893 there is found on the paper's
front page the Meteorological Institute's explanation of the sad catastrophe at Harboøre.
The Institute emphasizes especially three points: 1) After a calm there often arises a
storm in the opposite direction to the wind that blew before the calm, and the sea is then
stirred up so much the more strongly, precisely on account of the calm. 2) There was low
water on Jutland's west coast, while westerly storms further north had piled up all the
water by the Norwegian coast, whence it now streamed violently as down an inclined plane
towards the Jutland coast. 3) Simultaneously with this the flood tide occurred at the
Jutland coast.---On the paper's inside is found the priest's funeral oration over the
drowned, in which it is said among other things to the survivors: ``The Lord has used this
means to convert you\ldots. If this is not to help, what means shall he then use?''---The
Harboøre priest has hardly known that he was here applying the same line of thought that
Bossuet applied in his funeral oration over Henrietta of Orleans, only that in Bossuet's
oration it is applied to the English Revolution, in the Harboøre priest's to a tidal flood.---%
That the example is typical one will not be able to deny. It has its biblical analogy in
Deutero-Isaiah's explanation of Cyrus's campaign of conquest against Babylon: Jahveh's
intention was thereby to save the people of Israel and awaken faith in the God the prophets
proclaimed. (Isaiah ch.~45.)

\note{2} In some ecclesiastical statutes for Denmark from the end of the fifteenth century it
is said: ``We forbid under penalty of excommunication that it be stated that miracles occur
here in the diocese, either in general or with naming of names, unless they have been
investigated and approved by apostolic and ordained authority.'' \emph{Dania.} III p.~348.---%
In the most recent time so many miracles occur in the Catholic world, especially in France,
that the ecclesiastical authorities have need of much acumen (and diplomacy!) to be able to
distinguish between real and false miracles---and within the real ones again between those
that stem from God and those that stem from the Devil. Cf.\ Lasserre: \emph{Vor Frue fra
Lourdes.} After the 126th French edition. Copenhagen 1894. p.~120 ff. Pesquidoux: \emph{La
renaissance catholique en France.} Paris 1899. p.~52 f.---According to Thomas Aquinas the
miracle, by which is understood ``something that surpasses nature's capacity,'' is to serve
``to reveal something supernatural.'' (Cf.\ Tessen-Wesierski: \emph{Die Grundlagen des
Wunderbegriffes nach Thomas von Aqvino.} Paderborn 1899. p.~41 f.) But when now a
(ecclesiastically sanctioned) revelation is again required in order to be certain that
``something supernatural has been revealed''? And when that revelation is itself a miracle?
How can this circle be closed---and how does one get into it?

\note{3} Aristotle: \emph{Metaphysica} Ib (p.~994 a); XII. 6--7 (p.~1071--1073).---Thomas
Aquinas: \emph{Summa theologica.} Pars I. Qv.~2. Art.~3.---Eugen Rolfes (\emph{Die
Gottesbeweise bei Thomas von Aquin und Aristoteles,} Köln 1898) goes far further than earlier
Catholic theologians in acknowledging Thomas's dependence on Aristotle. The decisive line of
thought is in reality found in Aristotle and is in Thomas only theologically arranged and
shaped in several special nuances.---A chief reason why so-called Modernism was condemned by
Pius X's encyclical of 9 September 1907 was that it rejected the cosmological proof of God's
existence. (Gisler: \emph{Der Modernismus} 1912 p.~289--96.)

\note{4} A. Harnack: \emph{Lehrbuch der Dogmengeschichte.} 3. Aufl. 1894. II. p.~75.---Cf.\
also p.~472 on the Coptic monks who held to anthropomorphism, revelled in apocalyptic images,
and defended their bodily God with their cudgels.---Even Augustine believed, according to his
own account (\emph{Confessiones} VI, 3), before his acquaintance with Ambrose, that the
Catholic Church taught a God who had human shape.

\note{5} \emph{Confessiones} III, 11--12; VI, 4; VII, 16. The expression \emph{totus ubiqve}
recalls Plotinus's ὅλου πανταχοῦ (\emph{Ennead.} III, 9, 3; V, 5, 9).---Cf.\ with this what
Spinoza calls ``that which is in the part in the same way as in the whole'' (\emph{Ethica} II,
37--38; 44). Possibly Spinoza got the expression and the concept from Bruno, who is himself
here influenced by Plotinus: \emph{Opere italiane,} especially p.~239 f.; 242; 315 (ed.\
Lagarde). Bruno has (p.~242) the same image as Plotinus for ``that which is wholly in the
whole,'' namely the voice that is heard wholly at every place in a room.

\note{6} \emph{Heinrich Suso's Leben und Schriften.} Herausg. von Diepenbrock. Regensburg 1829.
p.~212 ff.

\note{7} Liebner: \emph{Hugo St.\ Victore und die theologischen Richtungen seiner Zeit.} Leipzig
1832. p.~292; 483.---Petri Abælardi \emph{Dialogus inter philosophum, judæum et christianum,}
ed.\ Rheinwald. Berolini 1831. p.~101 ff.

\note{8} \emph{Sechzig Upanishad's des Veda,} aus dem Sanskrit übersetzt von Paul Deussen.
Leipzig 1897. p.~626.---Plato: \emph{Republic,} books 2 and 3.---H. Relandus: \emph{De
religione Muhamedanica.} Trajecti ad Rhenum 1717. p.~202 f.

\note{9} Cf.\ in \emph{Den nyere Filosofis Historie} the sections on Nicolaus Cusanus,
Copernicus, and Bruno.

\note{10} Newman: \emph{Apologia pro vita sua.} London 1879. p.~105.---A. Ségala: \emph{Le
Purgatoire.} Trad. par F. de Bénéjac. Paris 1880. p.~8--15; 46.---Thomas Aquinas teaches of hell
that it is probably beneath the earth, and that hell's fire is of the same kind as the fire here
on earth, an \emph{ignis corporeus. Summa Theol.} Suppl. Part III. Qv.~97. Art.~5--7.

\note{11} Cf.\ Edv.\ Lehmann: \emph{Zarathustra.} First part. Copenhagen 1899. p.~67.---%
\textsc{Oldenberg} conjectures that a Semitic or pre-Semitic influence took place before Iranians
and Indians separated. \emph{Aus Indien und Iran.} Berlin 1899. p.~71. In that case this influence
must later have been developed in different ways by the two different peoples, under the influence
of their different fates.

\note{12} Cf.\ \emph{Den nyere Filosofis Historie}$^3$ II p.~103--106; III p.~140--143.---Note
especially the following statement of Fichte (\emph{Appellation an das Publikum gegen die Anklage
des Atheismus.} Leipzig 1799. p.~77): ``Es ist sonderbar, diese Philosophie [Fichte's own] der
Abläugnung der Gottheit zu bezüchtigen, da sie vielmehr die Existenz der Welt in dem Sinne, wie
sie vom Dogmatismus behauptet wird, abläugnet.''

\note{13} Cf.\ \emph{Totalitet som Kategori.} Ch.~6.

\note{14} Cf.\ \emph{Relation som Kategori.} Ch.~3.

\note{15} Cf.\ \emph{Begrebet Analogi.} (Especially p.~124 ff.)

\note{16} Cf.\ \emph{Den menneskelige Tanke} p.~329--338.

\note{17} Augustine: \emph{De moribus ecclesiæ catholicæ.} cap.~27.---Cf.\ Schleiermacher:
\emph{Der christliche Glaube.} §~85: ``Gott Barmherzigkeit zuzuschreiben eignet sich mehr für das
homiletische und dichterische Sprachgebiet, als für das dogmatische.''

\note{18} \emph{De ældste Upanishader.} Ved Poul Tuxen. II. p.~41; 143--145. \emph{Sechzig
Upanishad's des Veda,} übers. Paul Deussen. p.~851.

\note{19} \textsc{Denifle} has in his treatise \emph{Meister Eckhardt's lateinische Schriften und
die Grundanschauung seiner Lehre} (Archiv für Literatur- und Kirchengeschichte des Mittelalters.
II) shown---especially by the help of the Latin writings of Eckhart first found by him---that the
German mystics were disciples of the Schoolmen and themselves practised Scholasticism. But the
difference nevertheless remains that Scholasticism attempts to assert analogy's validity for the
concept of God, while Mysticism rejects it. Through the mystics' writings there runs an
after-effect of Neoplatonism, against whose Christian representative Thomas Aquinas constantly
polemicizes, supported by Aristotle on the one side, Paul on the other.---Cf.\ Thomas Aquinas:
\emph{Summa theol.} Pars I. Qv.~13. Art.~5.---On the mystics' doctrine see Liebner: \emph{Hugo a
St.\ Victore.} p.~193; 195. \emph{Suso's Leben und Schriften,} herausg. von Diepenbrock. p.~394;
410; 424. (P.~394 it is said: ``Darum ist das kund allen wohlgelehrten Pfaffen, dass das weislose
Wesen auch namenlos ist; und darum spricht Dionysius, dass Gott sei Nichtwesen, oder ein Nicht.'')
\emph{Deutsche Theologia.} In Danish by L. H. Schmidt p.~106.---When one makes oneself familiar
with this mystical doctrine, one will have an easier time understanding the Buddhist concept of
Nirvana. For it was naturally not the mystics' meaning that the rejection of all positive
determinations should indicate that the divinity was literally nothing (or was not). Both in the
mystical concept of God and in the Buddhist concept of Nirvana it is precisely the inexhaustible
positivity that bursts every conceptual form and makes every determination impossible.

\note{20} Cf.\ on the history of the concept of the mother in religion: Ditlef Nielsen: \emph{Der
dreieinige Gott.} (1922). p.~324--371.

\note{21} Cf.\ on the concept of personality my \emph{Psykologi} (abridged edition p.~84--92).
\emph{Totalitet som Kategori.} p.~56--59.

\note{22} J. M. Mitchell: \emph{Hinduism past and present.} London 1885. p.~187.---The Greek
worship of heroes rested on a similar tendency. The local heroes stood closer to a city's or a
district's inhabitants than the great national gods. See Erwin Rohde: \emph{Psyche}$^2$ I p.~191
f.; 197 f.

\note{23} ``What is dead is unchangeable. The Christians' God is the most living and therefore the
most changeable of all beings.'' (From a letter to Wizenmann, Jacobi's orthodox friend, from a
fellow believer, on the possibility of prayer being heard.) Goltz: \emph{Thomas Wizenmann.} Ein
Beitrag zur Geschichte des inneren Glaubenskampfes christlicher Gemüther in der zweiten Hälfte des
18. Jahrhunderts. Gotha 1859. II. p.~235.

\note{24} Julius Lange: \emph{Billedkunstens Fremstilling af Menneskeskikkelsen.} (Vid. Selsk.
Skr. 6. Række). I. p.~17 f.; 31 f.;---II. p.~56.

\note{25} \emph{Vie de Ste Térèse, écrite par elle-même.} Trad. par Bouix. Chap.~29.---Cf.\
therewith Alb.\ Ritschl: \emph{Geschichte des Pietismus.} II. p.~47; 228; 279.

\note{26} Examples are found in the material from older and more recent conversion histories
collected by Leuba (\emph{A study in the psychology of religious phenomena.} American Journal of
Psychology. April 1896).

\note{27} J. Royce: \emph{Studies on Good and Evil.} New York 1898. p.~377.

\note{28} \emph{Upanishad} ved Deussen. p.~196; 317.---\emph{Gospel of Matthew} XI, 28--29.---%
Augustine: \emph{Confessiones} I, 1 (cf.\ IV, 18 and VI, 26).---\emph{Vie de St.\ Térèse écrite par
elle-même.} p.~331; 591.---S. Kierkegaard: \emph{Uvidenskabelig Efterskrift.} p.~370. (Cf.\ my book
\emph{S. Kierkegaard som Filosof} p.~37--42; 111--115).---\textsc{Royce}: \emph{The case of John
Bunyan} (in his Studies on Good and Evil. 1898).---\emph{Froude: Bunyan.} (1895)

\note{29} Cf.\ \emph{Den nyere Filosofis Historie.} I. p.~141; II p.~194; 289 f.---\emph{J. J.
Rousseau og hans Filosofi.} p.~2.---Joseph Butler: Works. Oxford 1874. II. p.~181 f.---\emph{F. D.
Maurice's Leben.} Deutsch von M. Sell, Darmstadt 1885. p.~157 and elsewhere.

\note{30} Cf.\ my treatise \emph{Filosofi som Kunst.} (Mindre Arbejder. I. p.~180--188)

% The e-book runs "p. 641; 83—88". Since the second reference is pp. 83–88, a
% first reference to p. 641 of the same book is implausible; the numeral has
% evidently absorbed a digit or run together with what followed. Left as printed
% rather than silently emended — check against the print.
\note{31} Cf.\ \emph{Oplevelse og Tydning.} p.~641; 83--88.

\note{32} Cf.\ \emph{Den nyere Filosofis Historie}$^3$. III. p.~202--206.

\note{33} Luther: \emph{Catechismus major.} (The exposition of the first commandment and of the
third article of faith.)---For Zwingli see Ed.\ Zeller: \emph{Das theologische System Zwingli's.}
Tübingen 1853. p.~147. Zwingli expressly defines \emph{fides} by \emph{fiducia,} or---in his
Swiss---\emph{gloub} by \emph{vertruwen.}---On account of the doctrine of predestination this
element of unconditional trust comes forward still more definitely in the Reformed doctrine than in
the Lutheran. Cf.\ Zeller ibid.\ p.~27.---Ludw.\ Feuerbach strongly emphasized this characteristic
of Luther's concept of faith as the thing that conditioned its difference from the earlier concept
of faith. \emph{Das Wesen des Glaubens im Sinne Luthers.} 2. Aufl. Leipzig 1855. p.~16--21. Later it
has been brought out and illuminated by Albrecht Ritschl, especially in his posthumous work
\emph{Fides implicita. Eine Untersuchung über Köhlerglauben, Glauben und Wissen, Glauben und
Kirche.} 1890. p.~58--62. In his own doctrine of faith Ritschl lays this conception of religious
faith as trust at the foundation and finds in it the possibility of separating out the purely
metaphysical elements in ecclesiastical dogmatics.

\note{34} Cf.\ \textsc{Alb.\ Ritschl}: \emph{Fides implicita.} p.~1--8; 27; 44 f.---A. Harnack:
\emph{Lehrbuch der Dogmengeschichte}$^3$. III. p.~73 ff.; 534 f.

\note{35} \emph{Troeltsch} in ``Zeitschrift für Theologie und Kirche.'' V. p.~426. Kaftan ibid.\
VI. p.~94.

\note{36} Cf.\ on Nirvana \textsc{Warren}: \emph{Buddhism in translations.} p.~59 f.; 283 f.;
372.---The Upanishads prepare Buddhism by the clear recognition that all yearning and all pain hang
together with ``twoness'' and difference. See \emph{Upanishaderne} ved Poul Tuxen I. p.~11;
40.---That the process of redemption itself must, after its conclusion, come to stand as an
illusion, because the true good does not come to be but is, is taught already in the Upanishad. See
Deussen: \emph{Die Philosophie der Upanishad's} (Allg. Gesch. d. Philos. I, 2) p.~310--322.

\note{37} In my treatise ``Sociologi og Religionsfilosofi'' (reprinted in \emph{Oplevelse og
Tydning} p.~117--141) I have given a characterization and criticism of Durkheim's work.

\note{38} In the excellent work \emph{Primitive Culture,} and later in his \emph{Text-book of
Anthropology,} \textsc{Tylor} has developed the theory of animism.

\note{39} H. Usener: \emph{Götternamen. Versuch einer Lehre von der religiösen Begriffsbildung.}
Bonn 1896. p.~280.---It appears to me that Usener overlooks tradition's significance. Only the first
time the sheaf or the Saint John's wort is worshipped is a pure momentary god formed. The later times
a ``generic concept'' operates in so far as one lets oneself be guided by earlier years' custom.---%
The theory of momentary gods is new only as regards the name and the interesting examples. Earlier
already a distinction had been drawn between short-term fetishes and lasting fetishes. See
Chantepie de la Saussaye: \emph{Lehrbuch der Religionsgeschichte.} 1. Ausg. I. p.~44.---Cf.\ on the
worship of implements and stones among Indians and Greeks: A. Lang: \emph{Myth, Ritual and Religion}
I. p.~225; 275.

\note{40} A. Lang. II. p.~30; 126. H. \textsc{Usener}: \emph{Götternamen.} p.~75 ff. \emph{Sophus
Müller: De forhistoriske Tider i Europa.} (Verdenskulturen. II). p.~98.---Cf.\ already
\textsc{Augustine}: \emph{De civitate dei.} IV. cap.~8--11.

\note{41} Karl Budde: \emph{Die Religion des Volkes Israels bis zur Verbannung.} Giessen 1900. p.~65.

\note{42} Aug.\ Comte: \emph{Cours de Philosophie positive}$^2$. V. p.~71 f.; VI p.~413.---H. Usener:
\emph{Götternamen} passim. (Especially p.~73; 316 f.; 321; 334; 343.)

\note{43} I owe this information to my colleague Professor Vilhelm Thomsen. He himself is most
inclined to hold to the first-mentioned explanation. There would then be a kinship between the stem
in ``Gud'' and in the word ``gyde'' (as well as in the Greek χέειν, whose stem χυ = Sanskrit
\emph{hu,} whence \emph{huta-,} which can mean both ``sacrificed'' and ``he to whom sacrifice is
made'').

\note{44} Deussen: \emph{Die Philosophie der Upanishad's.} (Gesch. d. Philos. I, 2). p.~282 ff.---%
\textsc{Mitchell} too (\emph{Hinduism past and present.} p.~51; 138) holds it probable that the
belief in the transmigration of souls arose through an attempt to explain individual differences.

\note{45} \emph{Brihadaranyaka Upanishad} 4, 3, 9--16. (Deussen's translation p.~408.) In the
doctrine of Zarathustra too, remnants of animism can be pointed out. H. \textsc{Oldenberg}: \emph{Aus
Indien und Iran.} p.~172--175. E. Lehmann: \emph{Zarathustra.} I. p.~79.

\note{46} Richard Garbe: \emph{Die Sankhyaphilosophie.} Eine Darstellung des indischen
Rationalismus. Leipzig 1894. p.~172--190.

\note{47} See on this Erwin Rohde: \emph{Psyche}$^2$. I. p.~211; 278 ff.;---II. p.~38 ff., 62.---%
Gomperz: \emph{Griechische Denker.} I. p.~101--110.---Oldenberg gives an interesting paralleling of
the Indian and Greek development on this point: \emph{Aus Indien und Iran.} p.~75--85.---On the
belief in resurrection in its relation to the older Israelite view of life see \textsc{Hermann
Gunkel}: \emph{Zum religionsgeschichtlichen Verständnis des neuen Testaments} (1903), p.~32 f.

\note{48} Le Page Renouf: \emph{Lectures on the origin and growth of religion as illustrated by the
religion of ancient Egypt.} London 1880. p.~182 f.---Breasted: \emph{Religion and Thought in ancient
Egypt.} (1912). p.~61 (cf.\ 79).

\note{49} Tiele: \emph{Elements of the science of religion.} I. p.~236.

\note{50} \emph{Varieties of religious experience} p.~131; 526.

\note{51} On Swedenborg's vision see Emanuel Swedenborg: \emph{Summaria expositio doctrinæ Novæ
Ecclesiæ.} Amstelodami 1769. §~119. (There is still to be noted in this vision the delicious trait
that when the angels discover that Swedenborg is thinking of the orthodox doctrine of the Trinity,
they threaten to close heaven to him, and he must expressly beg them to look more closely and note
that he reinterprets the three divine persons as three attributes of one and the same person. He
thus instructs the angels and restrains them from precipitate action.)---On Vincent de Paul's vision
see Broglie: \emph{St.\ Vincent de Paul,} Paris 1898. p.~123.---On Paul's vision see H.
\textsc{Gunkel}: \emph{Zum religionsgeschichtlichen Verständnis des neuen Testaments.} p.~90 f.

\note{52} See on this Erwin Rohde: \emph{Psyche}$^2$, passim.---Diels speaks (in his edition of
Parmenides) of ``the highly gifted leaders of the Delphic oracle, who from the eighth to the sixth
century B.C. exercised the very most important influence on religion and morals, political and social
conditions in Greece and the neighbouring lands.'' Their names are almost unknown to us. It was due
partly to the development of enlightenment (``Sophistic''), partly to that of democracy, that---in
spite of the great role that mysteries and prophetism played---no proper hierarchy developed in
Greece. Diels: \emph{Parmenides Lehrgedicht} p.~12--13.

\note{53} Cf.\ Cornill: \emph{Der israelitische Profetismus}$^2$. Strassburg 1896. p.~82--92.
\textsc{Hølscher}: \emph{Die Profeten.} 1914. p.~165--168; 262.---According to the traditional
conception, Judaism became a religion of the book far earlier.---Joh.\ Jacobsen: \emph{Om
gammeltestamentlig Teologi.} 1912. p.~59--67.

\note{54} Fr.\ Nielsen: \emph{Pavedømmet i det nittende Aarhundrede.} II. p.~216--223.---Cf.\ on the
earlier history of the \emph{Conceptio immaculata}: Harnack: \emph{Lehrbuch der
Dogmengeschichte}$^3$. III. p.~584--587.---Especially interesting is the later Cardinal Newman's
position towards the new dogma. (Hutton: \emph{Cardinal Newman.} p.~201 ff.)

\note{55} In an article in \emph{Nineteenth Century} (February 1900) on ``the continuity of
Catholicism,'' the Jesuit father Clarke says: ``Before our Lord ascended to heaven, it is related in
Holy Scripture that he showed himself to his apostles during the forty days and spoke of the kingdom
of God. (Acts I, 3.) Now the kingdom of God is in the New Testament synonymous with Christ's
Church\ldots\ and in this place there is thought first and foremost of the Church here on earth. We
learn then here that our Lord instructed his disciples about the nature of the Church he had founded
on earth, its constitution, its government, its discipline, its sacraments, and above all the holy
doctrines it was to impart to human beings\ldots\ Every doctrine laid down by the councils and every
infallible utterance of the Pope is merely the unfolding of a hitherto unfolded part of this
structure of doctrine.''---Whence this knowledge of what Jesus spoke about with the apostles during
the forty days derives, we are not told. It stands as an article of faith that what is to be believed
was imparted during that time. As is well known, it is not only from the Catholic side that ``the
forty days'' have been used to smuggle in what one has not otherwise been able to find in the New
Testament.

\note{56} \emph{Lehrbuch der Dogmengeschichte.} I. p.~16 f. The eleven factors are: 1) the
endeavour to define religion's end, the good of salvation (\emph{das Heilsgut}); 2) concepts and
statements in the canonical writings; 3) transmitted, no longer understood tradition; 4)
requirements of cult and constitution; 5) reconciliation with dominant doctrines; 6) political and
social conditions; 7) the changing ethical ideals of life; 8) so-called logical consistency, that is
to say the abstractly analogous treatment of one dogma after the scheme of another; 9) the endeavour
to reconcile different tendencies in the Church; 10) rejection of ``false doctrine''; 11) the
sanctifying power of blind habit.

\note{57} Yrjö Hirn: \emph{Det heliga Skrinet.} p.~XIII f.---Tegnér even regarded religion as
circumcised poetry. (Letter to Hagberg 26 November 1820.) In our time Jacob Burckhardt
(\emph{Weltgeschichtliche Betrachtungen} p.~69) has called poetry religion's organ.

\note{58} See besides \emph{Conf.} X (especially 8; 35--38; 65) also I, 1 (where the relation between
invocation and knowledge is touched on); III, 11 (\emph{Deus est interior intimo meo et superior
summo meo}); VI, 1 (\emph{Qværebam te foris a me, et non inveniebam deum cordis mei}). Besides:
\emph{De vera religione} c.~39 (\emph{Noli foras ire: in teipsum redi, in interiore homine habitat
veritas}).

\note{59} \emph{Upanishaderne} ved Tuxen. II. p.~110--115.

\note{60} Liebner: \emph{Hugo a St.\ Victore.} p.~41; 271; 332. \textsc{Hauréau}: \emph{Les oeuvres
de Hugues de St.\ Victor.} Paris 1886. p.~140 f.---The expression ``embrace'' or ``touch''
(\emph{venit ut tangat te, non ut videatur a te}) recalls Plotinus (cf.\ \emph{Ennead.} V, 3, 16--17
and II, 7, 36). One is involuntarily reminded here of the tale of Amor and Psyche. Both the Greek
and the Hebrew erotic have been able to furnish symbols for religious experience.---Angèle de
Foligno: \emph{Le livre des visions et instructions.} Trad. par Ernest Hello, 3.\ ed. Paris 1895.
p.~67 f.---Remarkable is the agreement in terminology between Hugh of St.\ Victor and Saint Teresa.
Cf.\ \emph{Vie de Ste.\ Térèse, écrite par elle-même.} Paris 1896. p.~181 f.; 209 f.; 275 f.

\note{61} \emph{Suso's Leben und Schriften.} Herausg. von Diepenbrock. Regensburg 1829. p.~VIII
f.---\emph{Vie de Ste Térèse.} p.~280; 382.---Of Saint Birgitta it is related that before her
``revelations'' were sent out into the world they were subjected to an orthodox theologian's
examination, so that what stemmed from the Devil and not from God might be sorted out. See H. Schück:
\emph{Sveriges Litteratur till Frihetstidens början.} Stockholm 1896. p.~95 f.

\note{62} Hauréau: \emph{Les oeuvres de Hugues de St.\ Victor.} p.~137.---\emph{Vie de Ste Térèse.}
p.~97 f.; 181.---Cf.\ Julius Lange: \emph{Menneskefiguren i Kunstens Historie.} Copenhagen 1899.
p.~266.

\note{63} Ed.\ Zeller: \emph{Das theologische System Zwingli's.} p.~31 f.

\note{64} Julius Lange: \emph{Menneskefiguren i Kunstens Historie.} p.~299.

\note{65} Augustine: \emph{Confessiones.} VI, 6; XIII, 10; 13.---Martensen: \emph{Mester Eckardt}$^1$.
p.~103.---\emph{Den nyere Filosofis Historie}$^3$. III. p.~182--86; 205 f.; IV p.~79--81.---%
\textsc{Chr.\ Schrempf}: \emph{Kierkegaard's Stellung zur Bibel und Dogma.} (Zeitschr. für Theologie
und Kirche. 1. 1891.)

\note{66} Cf.\ H. Oldenberg's characterization of the etymological school in the science of religion
in his work \emph{Aus Indien und Iran.} p.~44--55.

\note{67} Already in \emph{Den nyere Filosofis Historie}$^3$. III. p.~269 f. I have indicated this
criticism.

\note{68} James in \emph{Proceedings of the Society for Psychical Research,} June 1903. p.~32.---On
James's psychology of religion see my programme \emph{Om nogle religionsfilosofiske Arbejder fra den
nyeste Tid (1903).} (Also printed in Mindre Arbejder III.)

\note{69} Hermann Gunkel: \emph{Zum religionsgeschichtlichen Verständnis des neuen Testaments}
p.~54--58.

\note{70} Dilthey in ``Archiv für Geschichte der Philosophie'' VI. p.~96 f.

\note{71} Cf.\ Usener: \emph{Götternamen.} p.~78 f.; 177--187.---Tiele: \emph{Elements of the Science
of Religion.} I. p.~173--177; II. p.~85 f.---A characteristic spiritual interpretation of an old
barbaric custom is discussed by Cumont: \emph{Die Mysterien des Mitra.} (German trans.) p.~135--138.

\note{72} Erik Stave: \emph{Ueber den Einfluss des Parsismus auf das Judenthum.} Haarlem 1898. p.~185.

\note{73} An extraordinarily beautiful depiction of the quiet ones in the land of Israel (late Judaism)
is given by Wetter: \emph{Det romerska världsrikets religioner.} (1917). p.~204--259.

\note{74} Cf.\ on Kant's philosophy-of-religion standpoint \emph{Den nyere Filosofis Historie}$^2$. II.
p.~95 f.---Of Kant's successors, Fries has most clearly seen the symbolic and poetic character that,
in consequence of the turning point given with Kant, must be ascribed to religious ideas. See his
youthful work \emph{Wissen, Glaube und Ahnung} (1804). p.~252--257. (On the dogmas of natural
religion: p.~158 f.; 260.) In his later work \emph{Religionsphilosophie} (1832) he has again developed
his conception. Note especially the following statement (p.~88): ``Das Schönste, welches wir nur
auszudenken vermögen, scheint [for religious faith] das richtigste Bild der ewigen Wahrheit zu
sein\ldots. Diese religiöse Ueberzeugung ist nicht nur bildlich, sondern in ihrer Ausführung ganz
dichterisch. Ihre Wahrheit ist die Wahrheit im tiefen inneren Ernst des Dichters.''---The expression
``most correct'' can easily lead into dogmatism. More than in Fries himself, a dogmatic tendency comes
forward in his disciple Apelt. See his \emph{Religionsphilosophie} (1863) p.~163, where certain
definite symbols are laid down as necessary and correct.---Mr cand.\ theol.\ Knud Obel, who has helped
me with the publication of this work, made in connection with my treatment of the concept of the symbol
some remarks that seem to me so interesting that with his permission I set them down here: ``At the
moment a symbol is formed for a religious feeling, a wholly new feeling arises. In that a vivid symbol
is formed for a cosmic relation, there is called forth a feeling that is different both from the one
awakened by the relation that is to be symbolized and from the one awakened by the relation the symbol
is drawn from---precisely by these two relations' being screwed together in consciousness. The cold
universal acquires warmth through the symbol with all the feelings attached to it from the most inward
relations of life; but these everyday feelings acquire at the same time, through the idea's extension to
the greater relations, a new tone, the chord of exaltedness.''---This is quite rightly thought. But free
symbol-formation has as yet played too slight a role in the religious domain for there to be definite
and decisive experiences of how the symbol works back on feeling and on consciousness as a whole. We can
only illuminate it by the manner in which the finished dogma works back on the religious consciousness.
Let one compare, for example, the primitive Christian ideas of Jesus with orthodox religiosity's fixed
and fenced-off Christology, and the different way in which the religious consciousness shapes itself in
the two cases. There will be an analogy between the symbol's and the dogma's reactions.

\note{75} Cf.\ my \emph{Etik}$^4$. p.~42; 206; 273 f.

\note{76} Georg Simmel: \emph{Schopenhauer und Nietzsche.} (1907). p.~89.

\note{77} \emph{Reden Gotamo Buddho's.} Uebers. von Neumann. II. p.~84.---\emph{Dhammapada.} p.~91 f.;
373 f. (Tuxen's trans.)

\note{78} Augustine: \emph{Confessiones} XI, 13; XII, 18.---Martensen: \emph{Mester Eckardt.}
p.~21.---\emph{Den nyere Filosofis Historie} (the sections on Böhme and on Spinoza).

\note{79} \emph{Reden Gotamo Buddho's.} Uebers. von Neumann. I. p.~515 f.; II. p.~90; 475 ff.---%
\textsc{Warren}: \emph{Buddhism in translations,} p.~437.---\emph{Dhammapada.} v.~210 ff.\ (Tuxen's
trans.)

\note{80} Augustine: \emph{De vera religione.} cap.~40--41; cf.\ \emph{Retractiones} I, 7. \emph{De
civitate dei} XXI, 17.

\note{81} The consequence that God cannot be blessed has been drawn by Schopenhauer (\emph{Aus
Schopenhauers handschriftl.\ Nachlass.} Leipzig 1864. p.~441), S. Kierkegaard (\emph{Efterladte
Papirer} 1854--55. p.~169), and Guyau (\emph{L'irréligion de l'avenir.} p.~388).---The consequence that
compassion with the damned would make the blessedness of the saved impossible has been drawn by
Schleiermacher (\emph{Der christliche Glaube} §~163, appendix). Such consequences presuppose primary
concepts of value other than those of primitive Christianity, of Augustine, and of Thomas.---Thomas
Aquinas expressly emphasizes how the blessedness of the saved is felt the more strongly by the contrast
with the suffering of the damned: \emph{Quum contraria juxta se posita magis elucescant, beati in regno
coelesti videbunt poenas damnatorum, ut beatitudo illis magis complaceat.} (\emph{Summa Theol.} III.
Suppl. 94, 1.) Conversely the suffering of the damned is increased by their first (before the day of
judgment) seeing and afterwards (after the day of judgment) remembering the joy of the blessed (ib.\ 98,
9).---That a single human being would be able to become blessed even if all others did not, Thomas
grounds thus: \emph{Homo habet totam plenitudinem suæ perfectionis in deo\ldots. Perfectio caritatis est
essentialis beatitudini qvantum ad dilectionem dei, non qvantum ad dilectionem proximi. Unde si esset
una sola anima fruens deo, beata esset non habens proximum, qvem diligeret} (Summa. Pars II. Quæstio 4.
Art.~8).

\note{82} \emph{Summa Theol.} III. Suppl. 94, 3.

\note{83} Augustine: \emph{De moribus Manichæorum.} cap.~4.---\emph{De natura boni} cap.~10.---The
doctrine of creation is subject to the same difficulty as the doctrine of emanation.

\note{84} Thomas Aquinas: \emph{Summa Theol.} Pars I. Qv.~19. Art.~31. \emph{Quum nihil ei perfectionis
ex aliis accrescat, seqvitur, qvod alia a se eum velle non sit necessarium absolute.}

\note{85} Cf.\ note 30. \emph{Oplevelse og Tydning} p.~98--102. (Cécile V.'s new concept of the divine.)

\note{86} Cf.\ \emph{Begrebet Analogi.} p.~122; 126; 133 f.

\note{87} Cf.\ \emph{Den nyere Filosofis Historie.} The sections on Böhme, Bayle, Leibniz, Butler, and
Schelling.

\note{88} Cf.\ my treatise \emph{Pascal og Kierkegaard.} (Tilskueren 1923.)

\note{89} Wallace: \emph{Rusland.} Danish trans. I. p.~132.

\note{90} Cf.\ the more detailed development of this in my \emph{Etik}$^4$. p.~172--179.

\note{91} Jul.\ Lange: \emph{Menneskefiguren i Kunstens Historie.} p.~334.---Cf.\ my treatise
\emph{Filosofi som Kunst} (1893). (Reprinted in ``Mindre Arbejder.'' I.)

\note{92} \emph{Reden über die Religion}$^3$. p.~91.

\note{93} Warren: \emph{Buddhism in translations.} p.~59.---\emph{Die Reden Gotamo Buddho's.} Uebers.
von Neumann. I. p.~232 f.; 244--248.---II. p.~148--160.

\note{94} Deussen's translation of \emph{Upanishad.} p.~476; 479. (Liberation from Kama, i.e.\ desire.)
The name Nirvana itself occurs in the later Upanishad (ibid.\ p.~695).---Cf.\ generally on the relation
between Upanishad and Buddhism Deussen's remarks in \emph{Die Philosophie der Upanishad's.} (Gesch. der
Philos. I, 2). p.~V.

\note{95} \emph{The Dhammapada.} ed.\ Fausbøll. 2.\ ed. London 1900. p.~91.

\note{96} \emph{Die Reden Gotamo Buddho's} I. p.~516. According to another account (see \emph{Die Reden
Buddho's} II. p.~450 ff.) it was the thought of human beings' dullness and unreceptiveness, of their
disinclination to espouse ``a doctrine that goes against the stream,'' that held Buddha back. But a god
opened his eyes to the fact that there were nevertheless many noble, clear-sighted, and sensible people
in the world, and his compassion now brought him away from his first resolution.---The conversation
between Buddha and a grieving householder, to which reference is made in the following passage in the
text, is found in \emph{Reden Buddho's} II. p.~475 ff.

\note{97} Warren: \emph{Buddhism in translations.} p.~28.---\emph{Die Reden Buddho's,} übers. von
Neumann. I. p.~447.---There is nevertheless still a psychological riddle left. For while love is named
as the ninth perfection, indifference is named as the tenth and is compared with the earth, which shows
neither ``hatred nor friendliness'' towards ``the sweet or the foul'' that is thrown upon it! And
alongside the expansion conditioned by recognition, immovability is named!

\note{98} Cf.\ Tokiwo Yokoi: \emph{The ethical life and conceptions of the Japanese.} (Journal of
Ethics. VI). p.~184; 190 f.---Cf.\ Baeltz: \emph{Japansk Krigeraand} (Tilskueren. Sept.\ 1905). p.~717.

\note{99} Georges Goyau: \emph{L'Allemagne religieuse. Le Protestantisme.} Paris 1898. p.~121.

\note{100} \textsc{Sarpi}: \emph{Histoire du Concile de Trente.} Trad. franç. par Amelot de la Houssaye.
Amsterdam 1686. p.~137--149.

\note{101} On the religious movement in the first decades of the nineteenth century in its relation to
the immediately preceding time see \emph{Ledende Tanker i det nittende Aarhundrede.} p.~114--124.

\note{102} ``\emph{Die Kirchen vermögen die Theologie nicht zu entbehren, und doch auch nicht zu
ertragen. Die Theologie haftet an der Wissenschaft und ist doch keine Wissenschaft, sondern eine
Verwendung wissenschaftlicher Bildung für kirchliche Zwecke. Dieser Zwiespalt im Wesen der Theologie
braucht nicht immer so qualvoll zu sein, wie er in den beiden letzten Jahrhunderten für uns geworden
ist. Aber verschwinden kann er nicht.}'' Troeltsch: \emph{Die Selbständigkeit der Religion.} (Zeitschr.
für Theol. u. Kirche. VI). p.~109. (In the same place is also found the expression
``\emph{Stosskissen}.'')

\note{103} \emph{Aus Indien und Iran.} p.~101 f.

\note{104} Cf.\ on the difference between motive of evaluation and motive of action my \emph{Etik}$^4$.
p.~27; 60--62.

\note{105} Cf.\ Joh.\ Clausen: \emph{Lov og Evangelium i Forhold til Christendomsforkyndelsen,
forhandlet mellem Reformatorerne i Wittenberg og Agrikola fra Eisleben.} Copenhagen 1872.
p.~51--64.---That Agrikola showed lack of bearing and subtlety in the course of the dispute does not
abolish the psychological and ethical justification of his first assertion, when due regard is had to the
personal differences among those who are to be influenced.

\note{106} See further my \emph{Etik}$^4$ p.~201--206; 273 f.

\note{107} Cf.\ H. Weinel: \emph{Die Wirkungen des Geistes und der Geister im nachapostolischen
Zeitalter bis auf Irenäus.} Freiburg 1899.

\note{108} \emph{De civitate dei.} XX, 9.

\note{109} \emph{Lehrb.\ der Dogmengeschichte}$^3$. II. p.~9.

\note{110} Hutton: \emph{Cardinal Newman.} p.~110--119.---\emph{Vie de Ste Térèse écrite par
elle-même.} Trad. par Bouix. p.~165; 177.

\note{111} A. Ritschl: \emph{Geschichte des Pietismus.} II. p.~122--125; 308; 448.---A.
\textsc{Harnack}: \emph{Lehrbuch der Dogmengeschichte}$^3$. I. p.~72; III. p.~101 f.---In a similar
direction \textsc{Troeltsch} expresses himself in his treatise \emph{Die Selbständigkeit der Religion}
(Zeitschr. für Theologie u. Kirche. V--VI) and \textsc{Sabatier} in his \emph{Philosophie de la
Religion} (p.~220; 230; 237 f.; 251 f.).---Cf.\ on the problem itself my treatise: \emph{Pascal og
Kierkegaard} (Tilskueren 1923) and the article \emph{To Præster} (reprinted in ``Oplevelse og Tydning''
p.~202--208).
