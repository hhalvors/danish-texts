...
%  missing characters.
%
%  ACCURACY (2026-09-26, REPAIR-PLAYBOOK §3): sampled 12 random pp. read in full at the
%    image (seed v1: 9,34,55,97,53,54; seed v2: 86,20,27,24,38,14): 1 error = 0.08/pg
%    (rate <= ~0.4/pg at 95%) -- p.38 n.1 lost its second line "p. 33—37.", which the ABBYY
%    layer the transcription was built from had dropped; now restored. ocrdiff 0/15 real.
%    NOT a full collation. Targeted follow-up the same day: every footnote on all 53 pages
%    that carry notes (and the three run-over continuations, pp.37, 41, 69) compared word
%    for word with the image -- no further lost lines or wording differences. The p.44
%    printed note number "2" and the p.36 run-over were already logged at their sites.
% ------------------------------------------------------------
%  THE WITNESS
% ------------------------------------------------------------
...
% ============================================================
% --- p. 3 ---
\opage{3} % PAGE MAP CONFIRMED BY EYE: printed p. 3 = PDF p. 5.
...
% --- p. 4 ---
\opage{4} de Svar, den anerkender, lægger visse Former sig for Dagen, som det er
...
af de indre og ydre
% --- p. 5 ---
\opage{5} Relationer, der er afgørende for deres Bestaaen. Relation viser sig derfor at
...
% --- p. 8 ---
\opage{8} kun for dem, er forsaavidt \guillemotleft relativ\guillemotright. Men Relation
...
kan findes
% --- p. 11 ---
\opage{11} og bestemmes, des større Enhed og des større Mangfoldighed vil der paa én Gang
...
% --- p. 15 ---
\opage{15} universelle (fundamentale, formale og reale) Kategorier. Men, som jeg i femte
...
% ============================================================
% --- p. 16 ---
\opage{16} at saadan Nødvendighed ikke skulde være virkelig Nødvendighed. Ved al
...
% --- p. 18 ---
\opage{18} Grundtanke, at Forholdslovens Gyldighed for de sjælelige Fænomener godtgør
...
% --- p. 19 ---
\opage{19} Man har vel forsøgt at tillægge enhver Forestilling en Slags
...
% --- p. 21 ---
\opage{21} vil det bero, om et vist Motiv overhovedet kan blive til, og om det kan blive
det sejrende.
...
% --- p. 24 ---
\opage{24} foreligger saadan Flytning, naar der foreligger en Relation mellem to nye Led (X
...
% --- p. 27 ---
\opage{27} der øves i Naturvidenskab, Filosofi og sund Menneskeforstand
...
% --- p. 28 ---
\opage{28}hed. Heri ligger netop Tvivlens Betydning. Og den stadige
...
% --- p. 29 ---
\opage{29} Form for dette. Syntesen gaar des lettere, jo færre Afbrydelser
...
% --- p. 33 ---
\opage{33} Begreber der skulde anvendes i det enkelte Tilfælde, og
...
% --- p. 34 ---
\opage{34} muliggør Synspunkter, ud fra hvilke der ikke blot kan
...
% --- p. 35 ---
\opage{35} aldeles ens Maade i de enkelte Emner, der eksemplificerer
...
% --- p. 37 ---
\opage{37} begge ligger en Skala af Tankerækker (af hvilke nogle af de
...
\textit{Totalitet som Kategori} (Vid.\ Selsk.\ Skr.\ 1917) p.~33---37.}
% p. 38: the note runs on to a second line, "p. 33—37.", which the ABBYY text
% layer dropped (corrected 2026-09-26 from the image, accuracy sample v2).
...
paa Mu%
% --- p. 41 ---
\opage{41}% No footnote of its own; the whole footnote block on this page is the
...
% --- p. 45 ---
\opage{45} des mere nærmer Analogislutningen sig til Induktion. Men den faar stedse
...
% --- p. 46 ---
\opage{46}% One unbroken paragraph; the page carries no footnote and no paragraph
% break at all.
...
% --- p. 52 ---
\opage{52}gang mellem kvalitativt forskellige Emner i vor Oplevelse. Det er gennem
...
% --- p. 53 ---
\opage{53} et lovmæssigt Forhold mellem Emner og en rationel Forklaring af et
...
Bevægelse,
% --- p. 54 ---
\opage{54} og fortsættes gennem de Bevægelser, som denne Indvirkning fremkalder i
...
% --- p. 55 ---
\opage{55}% The sign before »til 1830« is the Danish »det er« mark: a turned c
...
% --- p. 58 ---
\opage{58} % Head read off the page image at 600 dpi. The printing sets it
...
% --- p. 60 ---
\opage{60} Verden af Kvaliteter og Successioner, fra hvilken man steg op til, hvad
...
% ============================================================
% --- p. 62 ---
\opage{62}% p. 62 CONTINUES the paragraph running from p. 61 — its first line is set
...
% --- p. 63 ---
\opage{63} umiddelbart sige os, hvad det er, der bevæger sig, --- om det er den sansede
...
% --- p. 65 ---
\opage{65} tænker de Sandheder, der bærer Tilværelsens Sammenhæng; kun den Forskel
...
% --- p. 66 ---
\opage{66}saa godt forklares ved, at Solen gik rundt om Jorden, som ved, at Jorden gik
...
% --- p. 67 ---
\opage{67} os af de absolute Steder (loca primaria), og det er da det matematiske Rum,
...
Funktion, den Syn%
% --- p. 70 ---
\opage{70}tese, hvori al Bevidsthed og al Erkendelse bestaar, foregaar i de enkelte
...
Betydning, et Grænse%
% --- p. 71 ---
\opage{71}begreb, der afviser Afslutning og hævder Muligheden af fortsat Rækkedannelse.
...
% ============================================================
% --- p. 72 ---
\opage{72} % Sub-subsection mark read off the page image at 600 dpi: GREEK DELTA (δ),
...
han (Rigtigheden af
% --- p. 76 ---
\opage{76} Einsteins Teori stadig forudsat) kunne forklare os,
...
% --- p. 80 ---
\opage{80} % p. 80: running head "Nr. 3. Harald Høffding:" omitted as running matter.
...
% --- p. 81 ---
\opage{81} det Liv, der rørte sig hos enhver af dem. Denne historiske Universalitet
...
% --- p. 82 ---
\opage{82} de principielle Vanskeligheder, der frembyder sig ved ethvert Forsøg paa
...
% --- p. 84 ---
\opage{84} dette hos Etikere, der mener at have sikret sig et \guillemotleft
...
% --- p. 87 ---
\opage{87} sørge for, at der bag den brændende Strid kan være en underjordisk
Forstaaelse.
...
% ============================================================
% --- p. 90 ---
\opage{90} de jordiske Have og betinges derfor ikke blot ved Stjernerne, men ved
Vind og Vove.
...
% --- p. 91 ---
\opage{91} virkelig udførte Arbejde kun bestemmes ved Forholdet til denne
...
% --- p. 92 ---
\opage{92}tig Konsekvens for social Etik. Det maa være en nødvendig Opgave at
...
% --- p. 94 ---
\opage{94}klæringer om, at Handlingers egentlige Moralitet ikke kan opdages
...
% --- p. 96 ---
\opage{96} og Virkelighedens Verden trænger sig ind i Mystikerens Celle med sin
...
% --- p. 98 ---
\opage{98} forskellige Religioner eller religiøse Standpunkter, som det her ikke
...
\opage{99} \section{Relationsbegrebet i Kosmologien.}\label{sec:5}
...
% --- p. 102 ---
\opage{102} Den menneskelige Tankes Liv ytrer sig i de Relationer, den formaar at
...
% --- p. 104 ---
\opage{104} at det erkendende Subjekt selv er et Emne. Ogsaa \guillemotleft the
...
vi
% --- p. 105 ---
\opage{105} bliver os dem end ikke fuldt bevidste. Der er her en Analogi mellem det
...
% --- p. 106 ---
\opage{106} derfor, som ovenfor vist, ingen Ret til at tro, at Tilværelsen er udtømt
...
% --- p. 107 ---
\opage{107} Kan der ikke vindes nogen begrundet Forvisning om, at alle Modsætninger og
...
% justification.
% --- p. 108 ---
\opage{108} det --- at det Højeste bor \guillemotleft længere inde i os, end vi selv
...
% --- p. 109 ---
\opage{109} % p. 109: the printed INDHOLD, transcribed as a page like any other rather
