...
%
%  *** SUPERSEDED — DO NOT EXTEND, REDO. (2026-08-10) ***
%
%  This translation was made from a transcription of pp. 72--76 that predates
%  the scan. The full transcription is now complete, made from the Royal Danish
%  Academy's digitisation of the 1921 printing, and collating the old Danish
%  text against that printing turned up eleven divergences in these five pages:
%  five runs of \emph{} that are not in the print at all (both Neumann and Mach
%  titles on p. 72, "points de repere", "ultimate character", "plus ultra",
%  "Tidsskrift for Fysik" — all plain roman); a missing sub-section head
%  (δ. Den nye Relativitetsteori, run in with an em dash); "kommet" for the
%  printed "kommen"; "Samlerværket" for "Sammelværket"; "Smign." for "Smlgn.";
%  a printer's error silently repaired ("Belydning", p. 75 n. 1); and a closing
%  passage that in fact belongs to p. 77.
%
%  So the base text under this translation was wrong in ways that reach the
%  English — the emphasis especially. Redo it from transcription.tex.
% ============================================================
