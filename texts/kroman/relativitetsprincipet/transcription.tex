...
% --- p. 2 ---
\opage{2} Paa Grund af den ufuldkomne Viden, vi endnu har om Elektricitetens egenlige
...
% --- p. 3 ---
\opage{3} svingninger. \emph{Newton} opstiller derfor sin Emissionsteori, der vinder
...
% --- p. 4 ---
\opage{4} melse med den Omstændighed, at Kloderne synes at kredse uden at lide ringeste
Modstand fra Æteren.
...
% --- p. 5 ---
\opage{5} da parallelle Lysstraaler fra $L$, som ved Hjælp af et svagt belagt Planspejl
...
% --- p. 6 ---
\opage{6} Vejforskellen for de to Straaler bliver saaledes med stor Tilnærmelse
\[
...
viste,
% --- p. 7 ---
\opage{7} at Apparatet i øvrigt var i Orden og at det udtrykkelig var Vejforskellen, det
...
% --- p. 8 ---
\opage{8} Tilslutning, havde en langt bredere Basis. Det hidrørte fra H. A.
...
% --- p. 9 ---
\opage{9} disse havde samme Hastighed, og, som vi skal se, gaar den \emph{Einstein}'ske
...
Operationer tager
% --- p. 10 ---
\opage{10} deres Begyndelse ved dette Tidspunkt. A sender altsaa ved Tiden 0 et Lyssignal
...
% --- p. 11 ---
\opage{11} vægelsen, er bleven $a$ Gange saa korte i $X'$-retningen, som de var
...
% --- p. 12 ---
\opage{12} Thi er $t'$ B-tiden paa Stedet $x'$, $y'$, $z'$, giver Parentesen os
...
% --- p. 13 ---
\opage{13} samme om A, som A mener om B, paa Hastighedsretningen nær, og dette kunde
...
% --- p. 14 ---
\opage{14} baade A og B den sædvanlige Opfattelse, at Lyset uafhængigt af Lyskildens
...
% --- p. 15 ---
\opage{15} anden Side ogsaa Ret i sin Fremfærd. Thi hvad enten han hviler eller ej,
...
% --- p. 16 ---
\opage{16} Komponist. Og paa samme Maade kan A's Fremfærd jo være rigtig fra A's
...
% --- p. 17 ---
\opage{17} Hertil er dog at bemærke, at denne Paastand er uholdbar. Vore allerfleste
...
% --- p. 18 ---
\opage{18} som \emph{Newton} siger, her mangler et sikkert Koordinatsystem. Ofte kan
...
% --- p. 19 ---
\opage{19} tets Hastighed med som Tilgift}. Hele Sagen er derfor her
...
\emph{Einstein}
% --- p. 20 ---
\opage{20} ikke ydet den ringeste Vejledning. Han har end ikke set, at der her var en
Opgave.
...
% --- p. 21 ---
\opage{21} For A er Kuglen altsaa bleven til en Rotationsellipsoide med Halvakserne
...
% --- p. 22 ---
\opage{22} et andet Resultat. Men Formlerne har altsaa ogsaa her gjort, hvad de var
...
\opage{24} Ja, man maa endog vente, at man i visse Tilfælde vil kunne faa endnu mere
...
% --- p. 25 ---
\opage{25} af de to Hastigheder. Men Formlerne byder os at antage, at Hastigheden i System
A kun bliver
\[
...
da ifølge al sund
% --- p. 26 ---
\opage{26} Fornuft vedblivende falde sammen med $O'$ eller i System B faa Hastigheden 0.
...
\opage{27} Lad for A $F_{2}$ komme lidt senere end $F_{1}$ og f. Eks. være en Virkning af
...
\opage{28} Derimod er det, som alt bemærket, lidt af en Inkonsekvens, at man særlig gerne
...
% --- p. 29 ---
\opage{29} Brug for, medens det i Virkeligheden slet ikke følger af dens Forudsætninger.
...
\opage{30} \emph{Lorentz} er ikke Relativist. Han antager en hvilende Æter og kan allerede
